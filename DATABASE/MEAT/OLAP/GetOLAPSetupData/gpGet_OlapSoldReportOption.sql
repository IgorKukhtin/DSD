...
BEGIN
   ...
   UNION SELECT 54 AS SortField, 'dimension' :: TVarChar AS FieldType, 'Товар' :: TVarChar AS Caption, 'Код тов.' :: TVarChar AS CaptionCode, 'GoodsName' :: TVarChar AS FieldName, 'GoodsCode' :: TVarChar AS FieldCodeName, '' :: TVarChar AS DisplayFormat
             , 'Object' :: TVarChar AS TableName, 'ObjectGoods' :: TVarChar AS TableSyn, 'GoodsId' :: TVarChar AS ConnectFieldName, 'ValueData' :: TVarChar AS VisibleFieldName, '' :: TVarChar AS VisibleFieldCode, '' :: TVarChar AS SummaryType
