...
DROP VIEW IF EXISTS MovementItem_PromoSaleGoods_View;

CREATE OR REPLACE VIEW MovementItem_PromoSaleGoods_View AS
    SELECT
...
ALTER TABLE MovementItem_PromoSaleGoods_View
  OWNER TO postgres;
...
-- тест
-- SELECT * FROM MovementItem_PromoSaleGoods_View WHERE MovementId = 34902837          