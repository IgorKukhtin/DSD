      ...
      JOIN ObjectHistory_JuridicalDetails_View AS OH_JuridicalDetails ON OH_JuridicalDetails.JuridicalId = Object_Juridical.Id
       AND OH_JuridicalDetails.OKPO IN ('32294926', '40720198', '32294897', '42751590', '41028986'
                                      ...
                                      , '32294905', '35278624', '38939423', '38183389', '34902541', '36577999'
                                        -- Ексопт ТОВ
                                      , '44708897'
                                        -- АРФАК підвязати форму друку як на Сільпо
                                      , '45675873'
                                       )
      WHERE Object_Juridical.DescId = zc_Object_Juridical()
     ...
     UNION
      ...
      JOIN ObjectHistory_JuridicalDetails_View AS OH_JuridicalDetails ON OH_JuridicalDetails.JuridicalId = Object_Juridical.Id
       AND OH_JuridicalDetails.OKPO IN ('39118745','39117631', '39118572', '39143745' -- ? + Фінєст + ? + ? + ?
                                      ...
                                      , '41201250' -- Левайс
                                      , '46052175' -- був Левайс став Меджик-Фуд 
                                      , '41200660' -- Релайз
                                      , '45268675' -- ГЛОРІ МІЛ ТОВ
                                      , '45977519' -- новому клієнту ФАЄР МІЛ ТОВ 45977519, як була у ГЛОРІ МІЛ ТОВ 45268675
                                      , '42599711' -- Пангеон
                                      , '44588869' -- Бунар
                                      , '46046161' -- АТАФ
                                      ...
                                      , '46009114' --  Був Саргас(45041508)-Став Явидар
                                    --, '45675873' --  Новий клієнт-Арфак
                                      , '45142498' -- на нового клиента Хотей 43233918
                                      , '45936798' -- на Був Аракар(45142498)-став СТОРГІР
...
-- Транспортная Новус
      ...
      FROM Object AS Object_Juridical
      JOIN ObjectHistory_JuridicalDetails_View AS OH_JuridicalDetails ON OH_JuridicalDetails.JuridicalId = Object_Juridical.Id
       AND OH_JuridicalDetails.OKPO NOT IN ('41201250', '46052175', '42599711', '41200660', '42465240', '34465801', '45293717', '42668161', '41360805', '43233918', '33259493'
                                          , '45041508'
                                          , '46009114' --  Був Саргас(45041508)-Став Явидар
                                          , '45675873' --  Новий клієнт-Арфак
                                          , '44588869' -- Бунар
      ...
      FROM Object AS Object_Juridical
      JOIN ObjectHistory_JuridicalDetails_View AS OH_JuridicalDetails ON OH_JuridicalDetails.JuridicalId = Object_Juridical.Id
       AND OH_JuridicalDetails.OKPO IN ('41201250', '46052175', '42599711', '41200660', '42465240', '34465801', '45293717', '42668161', '41360805', '43233918', '33259493'
                                      , '44588869' -- Бунар
                                      , '46046161' -- АТАФ
                                      , '44608319' -- ОЛІВІЯ ТРЕНД
                                      , '45041508'
