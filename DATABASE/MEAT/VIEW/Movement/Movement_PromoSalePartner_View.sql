...
DROP VIEW IF EXISTS Movement_PromoSalePartner_View;

CREATE OR REPLACE VIEW Movement_PromoSalePartner_View AS 
    SELECT       
    ...
    WHERE Movement_Promo.DescId = zc_Movement_PromoSalePartner()
   ;
...
-- тест
-- SELECT * FROM Movement_PromoSalePartner_View WHERE ParentId = 2641111
