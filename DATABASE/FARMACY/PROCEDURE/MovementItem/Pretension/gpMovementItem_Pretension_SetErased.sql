-- Function: gpMovementItem_Pretension_SetErased (Integer, Integer, TVarChar)

DROP FUNCTION IF EXISTS gpMovementItem_Pretension_SetErased (Integer, TVarChar);

CREATE OR REPLACE FUNCTION gpMovementItem_Pretension_SetErased(
...
-- тест
-- SELECT * FROM gpMovementItem_Pretension_SetErased (inMovementId:= 55, inJuridicalId = 1, inSession:= '2')
