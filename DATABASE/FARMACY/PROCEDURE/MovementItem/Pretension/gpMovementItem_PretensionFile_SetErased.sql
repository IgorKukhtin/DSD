-- Function: gpMovementItem_PretensionFile_SetErased (Integer, Integer, TVarChar)

DROP FUNCTION IF EXISTS gpMovementItem_PretensionFile_SetErased (Integer, TVarChar);

CREATE OR REPLACE FUNCTION gpMovementItem_PretensionFile_SetErased(
...
ALTER FUNCTION gpMovementItem_Pretension_SetErased (Integer, TVarChar) OWNER TO postgres;
...
-- тест
-- SELECT * FROM gpMovementItem_PretensionFile_SetErased (inMovementId:= 55, inJuridicalId = 1, inSession:= '2')