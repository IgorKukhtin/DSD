--- Function: gpSelect_MovementItem_LoyaltyPresentSign()


DROP FUNCTION IF EXISTS gpSelect_MovementItem_LoyaltyPresentSign (Integer, Boolean, TVarChar);

CREATE OR REPLACE FUNCTION gpSelect_MovementItem_LoyaltyPresentSign(
