...
-- тест
-- SELECT * FROM gpInsertUpdate_MovementItem_CheckPromoCode_Site (ioId:= 129222919, inMovementId:= 7784510, inGoodsId:= 373, inAmount:= 1, inPrice:= 24.57, inPriceSale := 27.3, inChangePercent := 10, inSession := '3')