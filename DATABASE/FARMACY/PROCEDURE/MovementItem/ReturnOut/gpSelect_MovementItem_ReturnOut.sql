...
BEGIN
    ...
    IF inShowAll THEN
        ...
        FROM MovementItem_Income_View AS MovementItem_Income
            FULL JOIN MovementItem_ReturnOut_View AS MovementItem_ReturnOut 
                                                  ON MovementItem_ReturnOut.MovementId = inMovementId
        ...
        WHERE 
            MovementItem_Income.MovementId = (SELECT Movement.ParentId 
                                              FROM Movement 
    ...
    ELSE
        ...
        FROM (
            ...
            JOIN MovementItem_ReturnOut_View AS MovementItem 
