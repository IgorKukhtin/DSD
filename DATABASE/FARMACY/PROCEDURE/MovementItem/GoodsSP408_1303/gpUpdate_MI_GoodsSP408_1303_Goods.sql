-- Function: gpUpdate_MI_GoodsSP408_1303_Goods()

DROP FUNCTION IF EXISTS gpUpdate_MI_GoodsSP408_1303_Goods (Integer, Integer, Integer, Integer, TVarChar);

CREATE OR REPLACE FUNCTION gpUpdate_MI_GoodsSP408_1303_Goods(
...
/*
 ...
 11.04.23                                                       *
*/
-- select * from gpUpdate_MI_GoodsSP408_1303_Goods(inId := 523696543 , inMovementId := 28341113 , inGoodsID := 12006218 , inCol := 6995 ,  inSession := '3');