...
DROP FUNCTION IF EXISTS gpInsertUpdate_MovementItem_GoodsSPRegistry_1303 (Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer
...
BEGIN
    ...
    -- сохранить запись
    PERFORM lpInsertUpdate_MovementItem_GoodsSPRegistry_1303 (ioId                  := COALESCE(ioId, 0)
