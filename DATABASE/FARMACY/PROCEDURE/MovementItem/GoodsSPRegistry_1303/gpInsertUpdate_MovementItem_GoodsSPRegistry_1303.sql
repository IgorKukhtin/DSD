-- Function: gpInsert_MovementItem_GoodsSPRegistry_1303()

DROP FUNCTION IF EXISTS gpInsertUpdate_MovementItem_GoodsSPRegistry_1303 (Integer, Integer, Integer, TFloat, TFloat, TFloat, TFloat, TFloat, TFloat, Float, TFloat, TFloat
                                                           , TVarChar, TVarChar, TVarChar, TVarChar, TVarChar, Integer, Integer, Integer, TVarChar);
DROP FUNCTION IF EXISTS gpInsertUpdate_MovementItem_GoodsSPRegistry_1303 (Integer, Integer,  Integer, Integer, Integer, Integer
...
CREATE OR REPLACE FUNCTION gpInsertUpdate_MovementItem_GoodsSPRegistry_1303(
...
BEGIN
    ...
    -- сохранить запись
    ioId := lpInsertUpdate_MovementItem_GoodsSPRegistry_1303 (ioId                  := COALESCE(ioId,0)
