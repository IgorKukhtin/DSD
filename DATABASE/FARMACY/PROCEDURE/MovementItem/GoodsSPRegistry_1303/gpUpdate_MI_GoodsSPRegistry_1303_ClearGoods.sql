-- Function: gpUpdate_MI_GoodsSPRegistry_1303_ClearGoods()

DROP FUNCTION IF EXISTS gpUpdate_MI_GoodsSPRegistry_1303_ClearGoods (Integer, Integer, TVarChar);

CREATE OR REPLACE FUNCTION gpUpdate_MI_GoodsSPRegistry_1303_ClearGoods(
...
/*
 ...
 16.05.22                                                       *
*/
-- select * from gpUpdate_MI_GoodsSPRegistry_1303_ClearGoods(inId := 514496660 , inMovementId := 27854839 ,  inSession := '3');
