...
DROP FUNCTION IF EXISTS lpInsertUpdate_MI_MarginCategory_Master2 (Integer, Integer, Integer, TFloat, TFloat, TFloat, TFloat, TFloat, TFloat, TFloat, TFloat, TFloat, Integer);

CREATE OR REPLACE FUNCTION lpInsertUpdate_MI_MarginCategory_Master2(
 INOUT ioId                  Integer   , -- Ключ объекта <Элемент документа>
    ...
    IN inRemains             TFloat    , 
    IN inPrice               TFloat    , -- Min
    IN inPriceMax            TFloat    , -- Max
...
BEGIN
   ...
   -- сохранили свойство <>
   PERFORM lpInsertUpdate_MovementItemFloat(zc_MIFloat_PriceMax(), ioId, inPriceMax);
