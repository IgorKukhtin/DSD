...
RETURNS TABLE (MovementId Integer, InvNumber_Full TVarChar, MakerName TVarChar
     ...
     vbUserId:= lpGetUserBySession (inSession);
      ...
      , tmpGoodsPromo AS (SELECT tmpGoodsPromoMain.*, ObjectLink_Child_retail.ChildObjectId AS GoodsId_retail
         ...
         FROM tmpGoodsPromo
              ...
              LEFT JOIN Object AS Object_Maker ON Object_Maker.Id = tmpGoodsPromo.JuridicalId
