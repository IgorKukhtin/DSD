...
DROP FUNCTION IF EXISTS gpInsertUpdate_MI_ConvertRemains_From_Excel (Integer, TVarChar, TVarChar, TVarChar, TVarChar, TVarChar, TVarChar, TVarChar, TVarChar, TVarChar, TFloat, TVarChar, TVarChar, Integer, TVarChar);
...
BEGIN
  ...
  BEGIN   
    ...
    /* IF COALESCE (vbId, 0) <> 0
     THEN
       PERFORM lpLog_Run_Schedule_Function('gpInsertUpdate_MI_ConvertRemains_From_Excel', False, (inID_MED_FORM::tvarchar||'  '||inMorionSP::tvarchar)::TVarChar, vbUserId);
     END IF;*/
  ...
  EXCEPTION
     WHEN others THEN 
       ...
       --PERFORM lpAddObject_Goods_Temp_Error('gpInsertUpdate_MI_ConvertRemains_From_Excel', text_var1::TVarChar, vbUserId);
  END;
