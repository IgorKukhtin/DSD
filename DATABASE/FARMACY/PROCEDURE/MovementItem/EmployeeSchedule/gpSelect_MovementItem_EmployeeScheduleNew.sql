...
-- тест
-- select * from gpSelect_MovementItem_EmployeeScheduleNew(inMovementId := 12604227 , inDate := ('01.04.2019')::TDateTime , inShowAll := 'True' , inIsErased := 'False' ,  inSession := '4183126');