...
BEGIN
   ...
   THEN
     PERFORM lpInsertUpdate_ObjectString(zc_ObjectString_Goods_CodeUKTZED(), (SELECT Object_Goods_Retail.GoodsMainId FROM Object_Goods_Retail WHERE Object_Goods_Retail.Id = inId), inCodeUKTZED);
