...
--                 , tmpTechnicalRediscount.SummWages    AS SummaTechnicalRediscount
                 ...
                 , COALESCE(MIFloat_SummaFullChargeFact.ValueData, MIFloat_SummaFullCharge.ValueData)   AS SummaFullChargeFact
                 ...
                 , CASE WHEN MIFloat_SummaFullChargeFact.ValueData IS NULL
