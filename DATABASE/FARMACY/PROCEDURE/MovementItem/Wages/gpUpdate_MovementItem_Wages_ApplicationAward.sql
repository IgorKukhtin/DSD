-- Function: gpUpdate_MovementItem_Wages_ApplicationAward()

DROP FUNCTION IF EXISTS gpUpdate_MovementItem_Wages_ApplicationAward(TDateTime, INTEGER, TFloat, TVarChar);

CREATE OR REPLACE FUNCTION gpUpdate_MovementItem_Wages_ApplicationAward(
...
BEGIN
    ...
    THEN
      ...
      WHERE MovementItem.MovementID = vbMovementId
       ...
       -- сохранили свойство <Штраф за моб. приложение>
...
-- тест
-- SELECT * FROM gpUpdate_MovementItem_Wages_ApplicationAward (CURRENT_DATE, inSession:= '3')