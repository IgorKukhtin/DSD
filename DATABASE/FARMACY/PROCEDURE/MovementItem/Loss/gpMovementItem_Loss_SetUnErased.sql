...
BEGIN
  ...
  PERFORM lpInsertUpdate_MovementFloat_TotalSummLoss (vbMovementId);

END;
$BODY$
  LANGUAGE plpgsql VOLATILE;
ALTER FUNCTION gpMovementItem_Loss_SetUnErased (Integer, TVarChar) OWNER TO postgres;
...
-- тест
-- SELECT * FROM gpMovementItem_Loss_SetUnErased (inMovementId:= 55, inSession:= '2')
