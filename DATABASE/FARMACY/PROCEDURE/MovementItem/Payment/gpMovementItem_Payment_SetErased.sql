-- Function: gpMovementItem_Payment_SetErased (Integer, Integer, TVarChar)

DROP FUNCTION IF EXISTS gpMovementItem_Payment_SetErased (Integer, TVarChar);

CREATE OR REPLACE FUNCTION gpMovementItem_Payment_SetErased(
...
BEGIN
    --vbUserId:= lpCheckRight(inSession, zc_Enum_Process_SetErased_MI_Payment());
    vbUserId := inSession;
...
ALTER FUNCTION gpMovementItem_Payment_SetErased (Integer, TVarChar) OWNER TO postgres;
