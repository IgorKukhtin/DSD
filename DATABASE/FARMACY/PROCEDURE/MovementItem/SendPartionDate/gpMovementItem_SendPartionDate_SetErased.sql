-- Function: gpMovementItem_SendPartionDate_SetErased (Integer, Integer, TVarChar)

DROP FUNCTION IF EXISTS gpMovementItem_SendPartionDate_SetErased (Integer, TVarChar);

CREATE OR REPLACE FUNCTION gpMovementItem_SendPartionDate_SetErased(
...
BEGIN
    --vbUserId:= lpCheckRight(inSession, zc_Enum_Process_SetErased_MI_SendPartionDate());
    vbUserId := inSession;
...
ALTER FUNCTION gpMovementItem_SendPartionDate_SetErased (Integer, TVarChar) OWNER TO postgres;
