-- Function: gpMovementItem_GoodsSP_SetErased (Integer, Integer, TVarChar)

DROP FUNCTION IF EXISTS gpMovementItem_GoodsSP_SetErased (Integer, TVarChar);

CREATE OR REPLACE FUNCTION gpMovementItem_GoodsSP_SetErased(
...
-- тест
-- SELECT * FROM gpMovementItem_GoodsSP_SetErased (inMovementId:= 55, inSession:= '3')
