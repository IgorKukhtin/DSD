    ...
    vbIsOne := COALESCE ( (SELECT MovementBoolean_One.ValueData
      ...
      , tmpCheck AS (SELECT tmpCheck_Mov.Id                     AS MI_Id
           ...
           SELECT MI_Sign.Id
                ...
                , MIFloat_ChangeAmount.ValueData           AS ChangeAmount
           ...
           FROM tmpMI AS MI_Sign
               ...
               LEFT JOIN MovementItemFloat AS MIFloat_ChangeAmount
                                           ON MIFloat_ChangeAmount.MovementItemId = MI_Sign.Id
                                          AND MIFloat_ChangeAmount.DescId = zc_MIFloat_ChangeAmount()
