-- Function: gpInsert_MovementItem_GoodsSPSearch_1303()

DROP FUNCTION IF EXISTS gpInsertUpdate_MovementItem_GoodsSPSearch_1303 (Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer
                                                                        , TVarChar, TVarChar, TDateTime, TDateTime, TFloat, Integer, TFloat, Integer, TDateTime
                                                                        , Integer, Integer, TVarChar);

CREATE OR REPLACE FUNCTION gpInsertUpdate_MovementItem_GoodsSPSearch_1303(
...
BEGIN
    ...
    -- сохранить запись
    PERFORM lpInsertUpdate_MovementItem_GoodsSPSearch_1303 (ioId                  := COALESCE(ioId, 0)
