...
DROP FUNCTION IF EXISTS lpInsertUpdate_MovementItem_GoodsSPSearch_1303 (Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer
