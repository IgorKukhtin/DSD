--- Function: gpSelect_MovementItem_LoyaltyInfo()


DROP FUNCTION IF EXISTS gpSelect_MovementItem_LoyaltyInfo (Integer, TVarChar);

CREATE OR REPLACE FUNCTION gpSelect_MovementItem_LoyaltyInfo(
...
-- select * from gpSelect_MovementItem_LoyaltyInfo(inMovementId := 2,  inSession := '3'::TVarChar);