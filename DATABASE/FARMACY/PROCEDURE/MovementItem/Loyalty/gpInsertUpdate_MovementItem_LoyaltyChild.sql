...
DROP FUNCTION IF EXISTS gpInsertUpdate_MovementItem_LoyaltyChild (Integer, Integer, Integer, Boolean, TVarChar);

CREATE OR REPLACE FUNCTION gpInsertUpdate_MovementItem_LoyaltyChild(
