-- Function: gpUnhook_Movement_Loyalty_CheckSale()

DROP FUNCTION IF EXISTS gpUnhook_Movement_Loyalty_CheckSale (Integer, TVarChar);

CREATE OR REPLACE FUNCTION gpUnhook_Movement_Loyalty_CheckSale(
