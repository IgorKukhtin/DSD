...
ALTER FUNCTION gpMovementItem_PriceList_SetUnErased (Integer, TVarChar) OWNER TO postgres;
...
-- тест
-- SELECT * FROM gpMovementItem_PriceList_SetUnErased (inMovementId:= 55, inJuridicalId = 1, inSession:= '2')
