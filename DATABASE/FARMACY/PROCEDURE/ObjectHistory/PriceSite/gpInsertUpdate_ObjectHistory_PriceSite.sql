...
DROP FUNCTION IF EXISTS gpInsertUpdate_Object_PriceSite (Integer, Integer, TFloat, TFloat, Boolean, TVarChar);
...
select * from gpInsertUpdate_Object_PriceSite(ioId := 0 , inGoodsId := 12358 , inPrice := 441.1 , inPercentMarkup := 0 , inFix := 'False' ,  inSession := '3');