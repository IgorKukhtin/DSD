...
DROP FUNCTION IF EXISTS gpInsertUpdate_Movement_LoadPriceList_3Contract
...
BEGIN
    ...
    DELETE FROM LoadPriceListItem WHERE LoadPriceListId IN
      (SELECT Id FROM LoadPriceList WHERE JuridicalId = inJuridicalId  AND COALESCE (ContractId, 0) IN (inContractId1, inContractId2, inContractId3)
    ...
    -- сохранили - inContractId3 and inPrice3
    PERFORM lpInsertUpdate_Movement_LoadPriceList_Contract (inJuridicalId   := inJuridicalId
