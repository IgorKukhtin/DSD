-- Function: lpInsert_Movement_Send_RemainsSun_SAUA

DROP FUNCTION IF EXISTS lpInsert_Movement_Send_RemainsSun_SAUA (TDateTime, Integer, Integer, Integer);

CREATE OR REPLACE FUNCTION lpInsert_Movement_Send_RemainsSun_SAUA(
...
BEGIN
     ...
     INSERT INTO _tmpUnit_SUN (UnitId, KoeffInSUN, KoeffOutSUN, Value_T1, Value_T2, DayIncome, DaySendSUN, DaySendSUNAll, Limit_N, isLock_CheckMSC, isLock_CloseGd, isLock_ClosePL)
     ...
     INSERT INTO  (GoodsId, GoodsId_PairSun)
...
/*             , CASE -- если у парного ост = 0, не отдаем
        ...
        WHERE -- !!!Отключили парные!!!
          ...
          AND _tmpRemains_Partion.Amount > 0
...
select * from lpInsert_Movement_Send_RemainsSun_SAUA(inOperDate := ('26.10.2020')::TDateTime ,  inSession := '3');