      ...
      WITH
        ...
        , ContainerPD AS (SELECT ContainerAll.Id
                               ...
                               , CASE WHEN Min(ObjectDate_ExpirationDate.ValueData) <= vbDate_0  THEN 6      -- просрочено
                                      WHEN Min(ObjectDate_ExpirationDate.ValueData) <= vbDate_1  THEN 4      -- Меньше 1 месяца
                                      WHEN Min(ObjectDate_ExpirationDate.ValueData) <= vbDate_3  THEN 3      -- Меньше 3 месяца
