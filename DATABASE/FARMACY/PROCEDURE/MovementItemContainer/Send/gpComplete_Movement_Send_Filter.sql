-- Function: gpComplete_Movement_Send_Filter()

DROP FUNCTION IF EXISTS gpComplete_Movement_Send_Filter  (Integer, TVarChar);

CREATE OR REPLACE FUNCTION gpComplete_Movement_Send_Filter(
...
-- тест
-- SELECT * FROM gpComplete_Movement_Send_Filter (inMovementId:= 29207, inSession:= '3')
*/