-- Function: gpSetErased_Movement_OrderInternalPromo (Integer, TVarChar)

DROP FUNCTION IF EXISTS gpSetErased_Movement_OrderInternalPromo (Integer, TVarChar);

CREATE OR REPLACE FUNCTION gpSetErased_Movement_OrderInternalPromo(
...
-- тест
-- SELECT * FROM gpSetErased_Movement_OrderInternalPromo (inMovementId:= 149639, inSession:= zfCalc_UserAdmin())
