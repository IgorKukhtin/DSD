-- Function: gpSetErased_Movement_GoodsSPInform_1303 (Integer, TVarChar)

DROP FUNCTION IF EXISTS gpSetErased_Movement_GoodsSPInform_1303 (Integer, TVarChar);

CREATE OR REPLACE FUNCTION gpSetErased_Movement_GoodsSPInform_1303(
...
-- тест
-- SELECT * FROM gpSetErased_Movement_GoodsSPInform_1303 (inMovementId:= 149639, inSession:= zfCalc_UserAdmin())
