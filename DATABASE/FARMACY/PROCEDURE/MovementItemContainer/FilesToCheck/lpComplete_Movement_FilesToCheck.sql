 -- Function: lpComplete_Movement_FilesToCheck (Integer, Integer)

DROP FUNCTION IF EXISTS lpComplete_Movement_FilesToCheck (Integer, Integer);

CREATE OR REPLACE FUNCTION lpComplete_Movement_FilesToCheck(
...
AS
$BODY$
   DECLARE vbFilesToCheckId Integer;
BEGIN
     ...
     PERFORM lpComplete_Movement (inMovementId := inMovementId
                                , inDescId     := zc_Movement_FilesToCheck()
                                , inUserId     := inUserId
                                 );
