-- Function: gpSetErased_Movement_ConvertRemains (Integer, TVarChar)

DROP FUNCTION IF EXISTS gpSetErased_Movement_ConvertRemains (Integer, TVarChar);

CREATE OR REPLACE FUNCTION gpSetErased_Movement_ConvertRemains(
...
-- тест
-- SELECT * FROM gpSetErased_Movement_ConvertRemains (inMovementId:= 149639, inSession:= zfCalc_UserAdmin())
