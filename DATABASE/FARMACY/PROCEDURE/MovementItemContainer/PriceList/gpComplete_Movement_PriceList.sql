...
DROP FUNCTION IF EXISTS gpComplete_Movement_PriceList (Integer, Boolean, TVarChar);
...
-- SELECT * FROM gpComplete_Movement_PriceList (inMovementId:= 579, inIsLastComplete:= FALSE, inSession:= '2')
