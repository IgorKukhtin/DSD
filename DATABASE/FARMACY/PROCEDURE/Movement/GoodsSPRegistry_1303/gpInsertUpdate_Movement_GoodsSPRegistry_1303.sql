...
BEGIN
     ...
     --vbUserId:= lpCheckRight (inSession, zc_Enum_Process_InsertUpdate_Movement_GoodsSPRegistry_1303());
     vbUserId := inSession;
     ...
     -- сохранили <Документ>
     ioId := lpInsertUpdate_Movement (ioId, zc_Movement_GoodsSPRegistry_1303(), inInvNumber, inOperDate, NULL);
