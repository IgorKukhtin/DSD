...
BEGIN
     ...
     RETURN QUERY
         SELECT 0                            AS Id
              , CAST (NEXTVAL ('Movement_GoodsSPRegistry_1303_seq') AS TVarChar) AS InvNumber
...
-- тест
-- SELECT * FROM gpGet_Movement_GoodsSPRegistry_1303 (inMovementId:= 1, inOperDate:= '01.01.2018', inSession:= '3')