-- Function: gpGet_Movement_LayoutFile()

DROP FUNCTION IF EXISTS gpGet_Movement_LayoutFile (Integer, TDateTime, TVarChar);

CREATE OR REPLACE FUNCTION gpGet_Movement_LayoutFile(
...
BEGIN
     ...
     RETURN QUERY
         SELECT
               0 AS Id
             , CAST (NEXTVAL ('Movement_LayoutFile_seq') AS TVarChar) AS InvNumber
...
-- тест
-- select * from gpGet_Movement_LayoutFile(inMovementId := 18340672 , inOperDate := ('23.04.2020')::TDateTime ,  inSession := '3');