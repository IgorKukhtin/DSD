-- Function: gpSelect_Movement_LoyaltyPresent()

DROP FUNCTION IF EXISTS gpSelect_Movement_LoyaltyPresent (TDateTime, TDateTime, Boolean, TVarChar);

CREATE OR REPLACE FUNCTION gpSelect_Movement_LoyaltyPresent(
...
/*
 ...
 28.09.20                                                       *
*/
-- select * from gpSelect_Movement_LoyaltyPresent(inStartDate := ('13.03.2016')::TDateTime ,inEndDate := ('13.03.2020')::TDateTime , inIsErased:= true, inSession := '3');
