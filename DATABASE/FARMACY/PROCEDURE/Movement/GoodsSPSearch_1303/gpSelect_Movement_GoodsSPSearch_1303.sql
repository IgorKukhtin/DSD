-- Function: gpSelect_Movement_GoodsSPSearch_1303()

DROP FUNCTION IF EXISTS gpSelect_Movement_GoodsSPSearch_1303 (TDateTime, TDateTime, Boolean, TVarChar);

CREATE OR REPLACE FUNCTION gpSelect_Movement_GoodsSPSearch_1303(
...
BEGIN
     ...
     -- vbUserId:= lpCheckRight (inSession, zc_Enum_Process_Select_Movement_GoodsSPSearch_1303());
