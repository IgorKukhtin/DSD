-- Function: gpInsert_Movement_GoodsSPInform_1303_Mask()

DROP FUNCTION IF EXISTS gpInsert_Movement_GoodsSPInform_1303_Mask (Integer, TDateTime, TVarChar);

CREATE OR REPLACE FUNCTION gpInsert_Movement_GoodsSPInform_1303_Mask(
...
BEGIN
     ...
     SELECT gpInsertUpdate_Movement_GoodsSPInform_1303 (ioId            := 0
                                                      , inInvNumber     := CAST (NEXTVAL ('Movement_GoodsSPInform_1303_seq') AS TVarChar)
     ...
     INTO vbMovementId
     FROM gpGet_Movement_GoodsSPInform_1303 (ioId, inOperDate, inSession) AS tmp;
                                                    
     -- записываем строки документа
     PERFORM lpInsertUpdate_MovementItem_GoodsSPInform_1303  (ioId                 := 0
     ...
     FROM gpSelect_MovementItem_GoodsSPInform_1303 (ioId, 'False', 'False', inSession)  AS tmp;                        
