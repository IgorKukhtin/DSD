-- Function: gpSelect_Movement_SendDriverSun()

DROP FUNCTION IF EXISTS gpSelect_Movement_SendDriverSun (TDateTime, TDateTime, Boolean, TVarChar);

CREATE OR REPLACE FUNCTION gpSelect_Movement_SendDriverSun(
    IN inDriver        Integer , --
...
ALTER FUNCTION gpSelect_Movement_SendDriverSun (Integer, TVarChar) OWNER TO postgres;
...
-- тест
-- SELECT * FROM gpSelect_Movement_SendDriverSun (inDriver := 0, inSession:= '3')