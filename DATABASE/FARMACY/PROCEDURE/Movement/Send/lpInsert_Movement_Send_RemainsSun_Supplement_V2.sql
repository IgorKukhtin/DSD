...
BEGIN
 ...
 --raise notice 'Value 05: %', (select Count(*) from _tmpGoods_PromoUnit_Supplement_V2);      
     ...
     INSERT INTO  _tmpRemains_all_Supplement_V2 (UnitId, GoodsId, Price, MCS, AmountRemains, AmountNotSend, AmountSalesDay, 
     ...
     UPDATE _tmpRemains_all_Supplement_V2 SET Give = floor(_tmpRemains_all_Supplement_V2.AmountRemains - COALESCE(_tmpRemains_all_Supplement_V2.AmountNotSend, 0) -
                                                                           CASE WHEN COALESCE(_tmpRemains_all_Supplement_V2.MCS, 0) < 1 AND 1 > COALESCE(_tmpRemains_all_Supplement_V2.AmountSalesDay, 0) 
                                                                                THEN 1 
                                                                                WHEN COALESCE(_tmpRemains_all_Supplement_V2.MCS, 0) > COALESCE(_tmpRemains_all_Supplement_V2.AmountSalesDay, 0) 
                                                                                THEN COALESCE(_tmpRemains_all_Supplement_V2.MCS, 0) 
