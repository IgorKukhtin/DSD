...
DROP FUNCTION IF EXISTS gpSelect_Movement_ChoiceRelatedProduct (TVarChar);

CREATE OR REPLACE FUNCTION gpSelect_Movement_ChoiceRelatedProduct(
...
/*
 ...
 13.10.20                                                       *
*/
-- select * from gpSelect_Movement_ChoiceRelatedProduct(inSession := '3');
