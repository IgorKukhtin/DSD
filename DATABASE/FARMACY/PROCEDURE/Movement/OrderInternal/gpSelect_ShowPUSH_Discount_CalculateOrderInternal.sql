-- Function: gpSelect_ShowPUSH_Discount_CalculateOrderInternal(TVarChar)

DROP FUNCTION IF EXISTS gpSelect_ShowPUSH_Discount_CalculateOrderInternal(integer,TVarChar);

CREATE OR REPLACE FUNCTION gpSelect_ShowPUSH_Discount_CalculateOrderInternal(
...
-- SELECT * FROM gpSelect_ShowPUSH_Discount_CalculateOrderInternal(22749117, '3')

select * from gpSelect_ShowPUSH_Discount_CalculateOrderInternal(inMovementID := 22824229 ,  inSession := '3');