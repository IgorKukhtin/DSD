...
BEGIN
  ...
  THEN
    ...
    THEN
      outText := 'Товар подтвержден и клиент получил СМС уведомление.'||CHR(13)||CHR(13)||' По удалению обратитесь к ВИП отделу.';    
    ELSE
      outText := 'Товар подтвержден.'||CHR(13)||CHR(13)||' По удалению обратитесь к ВИП отделу.';    
    END IF;
...
--    vbText := 'По заказу есть наличие по всему товару'||CHR(13)||CHR(13)||' Удалить полностью чек?';
    vbText := 'По заказу есть наличие по всему товару'||CHR(13)||CHR(13)||' По удалению обратитесь к ВИП отделу.';
...
--    vbText := 'По заказу есть наличие на часть товара. Можно удалить только некоторые позиции, а не весь заказ. '||CHR(13)||CHR(13)||' Удалить полностью чек?';  
    vbText := 'По заказу есть наличие на часть товара. Можно удалить только некоторые позиции, а не весь заказ. '||CHR(13)||CHR(13)||' По удалению обратитесь к ВИП отделу.';  
  END IF;
