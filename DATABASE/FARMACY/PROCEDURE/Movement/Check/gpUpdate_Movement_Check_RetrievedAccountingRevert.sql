-- Function: gpUpdate_Movement_Check_RetrievedAccountingRevert()

DROP FUNCTION IF EXISTS gpUpdate_Movement_Check_RetrievedAccountingRevert(Integer, Boolean, TVarChar);

CREATE OR REPLACE FUNCTION gpUpdate_Movement_Check_RetrievedAccountingRevert(
