...
select * from gpSelect_Movement_Check(inStartDate := ('10.10.2022')::TDateTime , inEndDate := ('26.10.2022')::TDateTime , inIsErased := 'False' , inIsSP := 'False' , inIsVip := 'False' , inUnitId := 377606 ,  inSession := '3');