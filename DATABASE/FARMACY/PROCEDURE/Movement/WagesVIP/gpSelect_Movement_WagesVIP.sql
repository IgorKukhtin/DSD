-- Function: gpSelect_Movement_WagesVIP()

DROP FUNCTION IF EXISTS gpSelect_Movement_WagesVIP (TDateTime, TDateTime, Boolean, TVarChar);

CREATE OR REPLACE FUNCTION gpSelect_Movement_WagesVIP(
...
ALTER FUNCTION gpSelect_Movement_WagesVIP (TDateTime, TDateTime, Boolean, TVarChar) OWNER TO postgres;
...
-- тест
-- 
SELECT * FROM gpSelect_Movement_WagesVIP (inStartDate:= '01.08.2016', inEndDate:= '01.08.2016', inIsErased := FALSE, inSession:= zfCalc_UserAdmin());