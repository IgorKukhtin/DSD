-- Function: gpSelect_Movement_CheckHelsiPUSU()

  DROP FUNCTION IF EXISTS gpSelect_Movement_CheckHelsiPUSU (TVarChar);

CREATE OR REPLACE FUNCTION gpSelect_Movement_CheckHelsiPUSU(
...
-- тест
-- 
SELECT * FROM gpSelect_Movement_CheckHelsiPUSU (inSession:= '3')