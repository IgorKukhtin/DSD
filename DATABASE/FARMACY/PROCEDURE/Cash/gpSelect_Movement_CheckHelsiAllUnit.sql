...
RETURNS TABLE (
  ord integer,
  parentname public.tvarchar,
  unitid integer,
  unitcode integer,
  unitname public.tvarchar,
  id integer,
  invnumber public.tvarchar,
  operdate public.tdatetime,
  totalsumm public.tfloat,
  cashregistername public.tvarchar,
  paidtypename public.tvarchar,
  fiscalchecknumber public.tvarchar,
  invnumbersp public.tvarchar,
  confirmationcodesp public.tvarchar,
  spkindname public.tvarchar,
  movementitemid integer,
  goodsid integer,
  goodscode integer,
  goodsname public.tvarchar,
  amount public.tfloat,
  price public.tfloat,
  summ public.tfloat,
  pricesale public.tfloat,
