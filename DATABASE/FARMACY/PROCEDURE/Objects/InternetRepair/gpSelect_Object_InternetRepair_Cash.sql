-- Function: gpSelect_Object_InternetRepair_Cash(Boolean, TVarChar)

DROP FUNCTION IF EXISTS gpSelect_Object_InternetRepair_Cash (Boolean, TVarChar);

CREATE OR REPLACE FUNCTION gpSelect_Object_InternetRepair_Cash(
    ...
    RETURN QUERY 
       ...
       FROM Object AS Object_InternetRepair
           ...
           INNER JOIN ObjectLink AS ObjectLink_InternetRepair
                                ...
                                AND ObjectLink_InternetRepair.ChildObjectId = vbUnitId
       ...
       WHERE Object_InternetRepair.DescId = zc_Object_InternetRepair()
         AND Object_InternetRepair.isErased = False;

END;
$BODY$
  LANGUAGE plpgsql VOLATILE;
  ALTER FUNCTION gpSelect_Object_InternetRepair_Cash (TVarChar) OWNER TO postgres;
...
-- тест
-- 
SELECT * FROM gpSelect_Object_InternetRepair_Cash (zfCalc_UserAdmin())