...
DROP FUNCTION IF EXISTS gpSelect_Object_Personal_Choice (TDateTime, TDateTime, Boolean, Boolean, TVarChar);

CREATE OR REPLACE FUNCTION gpSelect_Object_Personal_Choice(
...
ALTER FUNCTION gpSelect_Object_Personal_Choice (TDateTime, TDateTime, Boolean, Boolean, TVarChar) OWNER TO postgres;
