...
DROP FUNCTION IF EXISTS gpInsertUpdate_Object_LinkGoodsRetail_Load (TVarChar, TVarChar, Integer, TVarChar);

CREATE OR REPLACE FUNCTION gpInsertUpdate_Object_LinkGoodsRetail_Load(
