...
DROP FUNCTION IF EXISTS gpInsertUpdate_Object_Unit(Integer, Integer, TVarChar, TVarChar, TVarChar, TFloat, TFloat, TFloat, TFloat, TFloat, TFloat, TFloat,
                                                   ...
                                                   Integer, TVarChar, Boolean, Boolean, Integer, TVarChar, Boolean, Integer, Boolean, TVarChar, TVarChar, TVarChar, TVarChar, TVarChar);
...
BEGIN
   ...
   -- Токен аптечной сети в МИС «Каштан»
   PERFORM lpInsertUpdate_ObjectString(zc_ObjectString_Unit_TokenKashtan(), ioId, TRIM(inTokenKashtan));

   -- ID аптеки в Telegram
   PERFORM lpInsertUpdate_ObjectString(zc_ObjectString_Unit_TelegramId(), ioId, TRIM(inTelegramId));
