...
RETURNS TABLE (Id Integer, PriceChange TFloat, FixValue TFloat
             , PercentMarkupStart TFloat, StartDate TDateTime
             , PriceChangeEnd TFloat, FixValueEnd TFloat
             , PercentMarkupEnd TFloat, StartDateEnd TDateTime
