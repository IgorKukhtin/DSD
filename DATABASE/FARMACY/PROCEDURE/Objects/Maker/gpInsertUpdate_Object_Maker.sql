...
DROP FUNCTION IF EXISTS gpInsertUpdate_Object_Maker (Integer,Integer,TVarChar, Integer, Integer, Integer, TDateTime, TDateTime, TFloat, TFloat, Boolean, Boolean, Boolean, Boolean, Boolean, Boolean, Boolean, Boolean, Boolean, Boolean, TVarChar);
...
CREATE OR REPLACE FUNCTION gpInsertUpdate_Object_Maker(
 INOUT ioId              Integer   ,    -- ключ объекта <Производитель>
    ...
    IN inisReport8       Boolean,       -- 	отправлять "отчет остаток по поставщикам на конец периода"
...
BEGIN
   ...
   -- сохранили свойство <>
   PERFORM lpInsertUpdate_ObjectBoolean(zc_ObjectBoolean_Maker_Report8(), ioId, inisReport8);
   -- сохранили свойство <>
