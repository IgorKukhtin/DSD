...
BEGIN
  ...
  , tmpObject AS (SELECT Object_EmailSettings.Id             AS EmailSettingsId
       ...
       SELECT tmpObject.EmailSettingsId AS Id
            ...
            , tmpEnum.EmailKindId
            , tmpEnum.EmailKindName
            , tmpEnum.EmailToolsId
            , tmpEnum.EmailToolsName
             
       FROM tmpEnum
         LEFT JOIN tmpObject ON tmpObject.EmailKindId = tmpEnum.EmailKindId
                            AND tmpObject.EmailToolsId = tmpEnum.EmailToolsId
       WHERE tmpEnum.EmailKindId = inEmailKindId OR inEmailKindId = 0
