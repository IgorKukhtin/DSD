...
RETURNS TABLE (Id Integer, Code Integer, Name TVarChar
             ...
             , DailyNormSP TFloat, DailyÑompensationSP TFloat
...
BEGIN
   ...
   RETURN QUERY 
       SELECT 
           ...
           , ObjectFloat_Goods_DailyÑompensationSP.ValueData  AS DailyÑompensationSP
       ...
       FROM ObjectBoolean AS ObjectBoolean_Goods_SP 
            ...
            LEFT JOIN ObjectFloat AS ObjectFloat_Goods_DailyÑompensationSP
                                  ON ObjectFloat_Goods_DailyÑompensationSP.ObjectId = Object_Goods.Id
                                 AND ObjectFloat_Goods_DailyÑompensationSP.DescId = zc_ObjectFloat_Goods_DailyÑompensationSP() 
