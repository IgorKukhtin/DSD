-- Function: gpSelect_Object_Goods_Cash()

DROP FUNCTION IF EXISTS gpSelect_Object_Goods_Cash(Integer, Integer, TVarChar);

CREATE OR REPLACE FUNCTION gpSelect_Object_Goods_Cash(
...
RETURNS TABLE (Id Integer, GoodsMainId Integer, Code Integer, IdBarCode TVarChar, Name TVarChar
             ...
             , DoesNotShare Boolean, AllowDivision Boolean
...
select * from gpSelect_Object_Goods_Cash(inContractId := 0 , inRetailId := 0 ,  inSession := '3');