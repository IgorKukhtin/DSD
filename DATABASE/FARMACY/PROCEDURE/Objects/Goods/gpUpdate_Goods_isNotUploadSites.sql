...
DROP FUNCTION IF EXISTS gpUpdate_Goods_isNotUploadSites(Integer, Boolean, TVarChar);

CREATE OR REPLACE FUNCTION gpUpdate_Goods_isNotUploadSites(
...
BEGIN
   ...
   PERFORM lpInsertUpdate_ObjectBoolean (zc_ObjectBoolean_Goods_isNotUploadSites(), tmpGoods.GoodsId, inisNotUploadSites)
...
-- тест
-- SELECT * FROM gpUpdate_Goods_isNotUploadSites
