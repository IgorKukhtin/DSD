...
--           , ObjectString.ValueData                           AS GoodsCode
           ...
           , CASE WHEN Object_Goods_View.isFirst = TRUE THEN zc_Color_GreenL() WHEN Object_Goods_View.isSecond = TRUE THEN zc_Color_Red()  ELSE zc_Color_White() END AS Color_calc
