    ...
    FROM Object_Goods_Main AS Object_Goods_Main
        ...
        LEFT JOIN ObjectBoolean AS ObjectBoolean_Second
          ...
          LEFT JOIN ObjectBoolean AS ObjectBoolean_Goods_SpecCondition
                                  ON ObjectBoolean_Goods_SpecCondition.ObjectId = Object_Goods_Main.Id
          ...
          LEFT JOIN ObjectLink AS ObjectLink_Goods_Area
                               ON ObjectLink_Goods_Area.ObjectId = Object_Goods_Main.Id
