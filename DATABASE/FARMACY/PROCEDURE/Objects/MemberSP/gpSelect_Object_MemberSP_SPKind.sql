-- Function: gpSelect_Object_MemberSP_SPKind(TVarChar)

DROP FUNCTION IF EXISTS gpSelect_Object_MemberSP_SPKind(TVarChar);

CREATE OR REPLACE FUNCTION gpSelect_Object_MemberSP_SPKind(
...
-- тест
-- 
SELECT * FROM gpSelect_Object_MemberSP_SPKind('3')