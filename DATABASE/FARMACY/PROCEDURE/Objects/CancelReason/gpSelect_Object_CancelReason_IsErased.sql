-- Function: gpSelect_Object_CancelReason_IsErased (Integer, TVarChar)

-- DROP FUNCTION gpSelect_Object_CancelReason_IsErased (Integer, TVarChar);

CREATE OR REPLACE FUNCTION gpSelect_Object_CancelReason_IsErased(
...
ALTER FUNCTION gpSelect_Object_CancelReason_IsErased (Integer, TVarChar) OWNER TO postgres;
