-- Function: gpSelect_GoodsOnUnitRemains_ForCostless

DROP FUNCTION IF EXISTS gpSelect_GoodsOnUnitRemains_ForCostless (Integer, TVarChar);

CREATE OR REPLACE FUNCTION gpSelect_GoodsOnUnitRemains_ForCostless(
...
ALTER FUNCTION gpSelect_GoodsOnUnitRemains_ForCostless (Integer, TVarChar) OWNER TO postgres;
...
-- тест
-- SELECT * FROM gpSelect_GoodsOnUnitRemains_ForCostless (inUnitId := 377606, inSession:= '3')
