...
SELECT OBJECT_Unit.valuedata, p.* FROM gpSelect_GoodsOnUnit_ForSiteMobile ( COALESCE(lpGet_DefaultValue('zc_Object_Unit', '3'), ''), '18200689', zfCalc_UserSite()) AS p
