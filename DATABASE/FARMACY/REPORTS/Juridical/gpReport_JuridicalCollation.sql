...
CREATE OR REPLACE FUNCTION gpreport_juridicalcollation(
  ...
  RETURNS TABLE(movementsumm tfloat, startremains tfloat, endremains tfloat, debet tfloat, kredit tfloat, movementsumm_currency tfloat, startremains_currency tfloat, endremains_currency tfloat, debet_currency tfloat, kredit_currency tfloat, operdate tdatetime, invnumber tvarchar, invnumberpartner tvarchar, accountcode integer, accountname tvarchar, contractcode integer, contractname tvarchar, contracttagname tvarchar, contractstatekindcode integer, contractcomment tvarchar, paidkindid integer, paidkindname tvarchar, infomoneygroupcode integer, infomoneygroupname tvarchar, infomoneydestinationcode integer, infomoneydestinationname tvarchar, infomoneycode integer, infomoneyname tvarchar, movementid integer, itemname tvarchar, operationsort integer, fromname tvarchar, toname tvarchar) AS
$BODY$
BEGIN
