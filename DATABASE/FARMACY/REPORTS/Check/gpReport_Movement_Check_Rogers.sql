-- Function:  gpReport_Movement_Check_Rogers()

DROP FUNCTION IF EXISTS gpReport_Movement_Check_Rogers (Integer, Integer, TDateTime, TDateTime, Boolean, Boolean, Boolean, TVarChar);

CREATE OR REPLACE FUNCTION  gpReport_Movement_Check_Rogers(
...
-- тест
-- SELECT * FROM gpReport_Movement_Check_Rogers (inUnitId:= 0, inDateStart:= '20150801'::TDateTime, inDateFinal:= '20150810'::TDateTime, inIsPartion:= FALSE, inSession:= '3')