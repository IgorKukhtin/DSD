-- Function: gpReport_Movement_CheckSite()

DROP FUNCTION IF EXISTS gpReport_Movement_CheckSite (TDateTime, TDateTime, Integer, Boolean, Boolean, Boolean, Boolean, Boolean, TVarChar);

CREATE OR REPLACE FUNCTION gpReport_Movement_CheckSite(
    IN inDateStart       TDateTime , --
    IN inDateFinal       TDateTime , --
    IN inUnitId          Integer , --
    IN inIsRegularSales  Boolean ,
    IN inisVIP           Boolean ,
    IN inisSite          Boolean ,
