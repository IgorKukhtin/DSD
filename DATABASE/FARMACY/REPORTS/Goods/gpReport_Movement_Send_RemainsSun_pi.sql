-- Function: gpReport_Movement_Send_RemainsSun_pi()

DROP FUNCTION IF EXISTS gpReport_Movement_Send_RemainsSun_pi (TDateTime, TVarChar);

CREATE OR REPLACE FUNCTION gpReport_Movement_Send_RemainsSun_pi(
    ...
    vbDate_0 := inOperDate
     ...
     INSERT INTO _tmpResult (DriverId, DriverName
          ...
          SELECT COALESCE (vbDriverId_1, 0)                              :: Integer  AS DriverId
               ...
               , tmp.Amount_next_res
               , tmp.Summ_next_res
          FROM lpInsert_Movement_Send_RemainsSun_pi (inOperDate := inOperDate
