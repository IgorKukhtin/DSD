...
BEGIN
    ...
    WITH
        ...
        -- товары промо
     SELECT ObjectLink_Child_R.ChildObjectId  AS GoodsId        -- здесь товар
...
select * from gpReport_MovementCheck_Promo(inMakerId := 2336609 , inStartDate := ('05.06.2023')::TDateTime , inEndDate := ('11.06.2023')::TDateTime ,  inSession := '3');
