...
CREATE OR REPLACE FUNCTION gpReport_Send_RemainsSun_express(
...
-- select * from gpReport_Send_RemainsSun_express(inOperDate := ('05.04.2020 12:00:00')::TDateTime ,  inSession := '3');
