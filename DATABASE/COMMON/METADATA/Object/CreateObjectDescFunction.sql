...
CREATE OR REPLACE FUNCTION c_Object_AssetGroup() RETURNS Integer AS $BODY$BEGIN RETURN (SELECT Id FROM ObjectDesc WHERE Code = 'c_Object_AssetGroup'); END; $BODY$ LANGUAGE PLPGSQL IMMUTABLE;
