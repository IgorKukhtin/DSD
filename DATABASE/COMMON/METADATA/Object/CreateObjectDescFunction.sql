...
INSERT INTO ObjectDesc (Code, ItemName)
  SELECT 'zc_Object_ReceiptCost', '«‡Ú‡Ú˚ ‚ ÂˆÂÔÚÛ‡ı' WHERE NOT EXISTS (SELECT * FROM ObjectDesc WHERE Code = 'zc_Object_ReceiptCost');
...
INSERT INTO ObjectDesc (Code, ItemName)
  SELECT 'zc_Object_ReceiptChild', '—ÓÒÚ‡‚Îˇ˛˘ËÂ ÂˆÂÔÚÛ' WHERE NOT EXISTS (SELECT * FROM ObjectDesc WHERE Code = 'zc_Object_ReceiptChild');


/*-------------------------------------------------------------------------------
 »—“Œ–»ﬂ –¿«–¿¡Œ“ »: ƒ¿“¿, ¿¬“Œ–
               ‘ÂÎÓÌ˛Í ».¬.    ÛıÚËÌ ».¬.    ÎËÏÂÌÚ¸Â‚  .».
 08.07.13         * ÔÂÂıÓ‰ ‚ÒÂ„Ó Ì‡ ÕŒ¬”ﬁ —’≈Ã”
 28.06.13                                        * ÕŒ¬¿ﬂ —’≈Ã¿
*/
