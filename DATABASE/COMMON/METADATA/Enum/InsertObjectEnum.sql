...
BEGIN
     ...
     PERFORM lpInsertUpdate_Object_Enum (inId:= zc_Enum_ContractConditionKind_BonusPercentIncomeReturnS(), inDescId:= zc_Object_ContractConditionKind(), inCode:= 33, inName:= '% бонуса за приход-возврат, ставка за СУММУ' , inEnumName:= 'zc_Enum_ContractConditionKind_BonusPercentIncomeReturnS');
