-- Function: gp_test_insert2(tvarchar)

-- DROP FUNCTION gp_test_insert2(tvarchar);

CREATE OR REPLACE FUNCTION gp_test_insert2(session tvarchar)
  RETURNS void AS
$BODY$DECLARE
  k INTEGER := 0;
  MovementId Integer;   
...
END;$BODY$
  ...
  COST 100;
ALTER FUNCTION gp_test_insert2(tvarchar)
  OWNER TO postgres;
