-- Function: gpReport_SaleByTransferDebtIn ()
...
CREATE OR REPLACE FUNCTION gpReport_SaleByTransferDebtIn (
...
-- тест
--select * from gpReport_SaleByTransferDebtIn(inStartDate := ('01.01.2016')::TDateTime , inEndDate := ('10.05.2016')::TDateTime , inPartnerId := 17784 , inJuridicalId := 0 , inRetailId := 0 , inBranchId := 0 , inContractId := 16591 , inPaidKindId := 3 , inGoodsId := 2156 , inGoodsKindId := 0 , inPrice := 127.25 ,  inSession := '5');