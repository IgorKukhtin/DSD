...
-- тест
-- SELECT * FROM gpReport_Send_PartionCell (inStartDate:= '27.12.2023', inEndDate:= '04.01.2024', inUnitId:= 8451, inIsMovement:= false, inSession:= zfCalc_UserAdmin()); -- Склад Реализации
