-- Function: gpReport_GoodsMI_TransferDebt (TDateTime, TDateTime, Integer, Integer, Integer, Integer, Integer, TVarChar)
...
-- тест
-- SELECT * FROM gpReport_GoodsMI_TransferDebt (inStartDate:= '01.01.2014', inEndDate:= '01.01.2014', inDescId:= zc_Movement_TransferDebtOut(), inGoodsGroupId:= 0, inUnitId:= 0, inSession:= zfCalc_UserAdmin());
