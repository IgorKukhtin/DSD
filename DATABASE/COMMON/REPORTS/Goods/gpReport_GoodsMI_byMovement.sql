...
-- тест
-- SELECT * FROM gpReport_GoodsMI_byMovement (inStartDate:= '01.01.2014', inEndDate:= '01.01.2014', inDescId:= 5, inJuridicalId:= 15616, inGoodsGroupId:= 0, inSession:= zfCalc_UserAdmin());
