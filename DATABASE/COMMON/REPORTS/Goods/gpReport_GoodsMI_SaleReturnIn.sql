...
-- and (MIContainer.MovementId = 24930340  or vbUserId <> 5)
                         ...
                         WHERE (_tmpJuridical.JuridicalId > 0 OR vbIsJuridical_where = FALSE)
                           AND (MILinkObject_Branch.ObjectId = inBranchId OR COALESCE (inBranchId, 0) = 0 OR _tmpJuridicalBranch.JuridicalId > 0)
 ...
 , tmpGoodsPropertyValue AS (SELECT tmpGoodsProperty.GoodsPropertyId
 ...
 , tmpObject_GoodsPropertyValueGroup_basis AS (SELECT tmpObject_GoodsPropertyValue.GoodsId
     ...
     FROM tmpOperationGroup
          ...
          LEFT JOIN tmpObject_GoodsPropertyValueGroup ON tmpObject_GoodsPropertyValueGroup.GoodsPropertyId = tmpOperationGroup.GoodsPropertyId
                                                     AND tmpObject_GoodsPropertyValueGroup.GoodsId = tmpMI.GoodsId
...
-- 
/*
select * FROM gpReport_GoodsMI_SaleReturnIn(inStartDate := ('01.10.2025')::TDateTime , inEndDate := ('31.10.2025')::TDateTime , inBranchId := 0 , inAreaId := 0 , inRetailId := 0 , inJuridicalId := 6329185 , inPaidKindId := 3 
