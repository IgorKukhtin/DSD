...
DROP FUNCTION IF EXISTS gpReport_JuridicalSold_AssetNoBalance (TDateTime, TDateTime, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Boolean, TVarChar);

CREATE OR REPLACE FUNCTION gpReport_JuridicalSold_AssetNoBalance(
     ...
     WITH tmpContractCondition AS
        ...
        , tmpContainer AS (SELECT Container.Id AS ContainerId
                           ...
                           FROM ContainerLinkObject AS CLO_Juridical
                                INNER JOIN Container ON Container.Id = CLO_Juridical.ContainerId AND Container.DescId = zc_Container_SummAsset()
...
-- тест
-- SELECT * FROM gpReport_JuridicalSold_AssetNoBalance (inStartDate:= '01.01.2016', inEndDate:= '01.01.2016', inAccountId:= null, inInfoMoneyId:= null, inInfoMoneyGroupId:= null, inInfoMoneyDestinationId:= null, inPaidKindId:= null, inBranchId:= null, inJuridicalGroupId:= null, inCurrencyId:= null, inIsPartionMovement:= FALSE, inSession:= zfCalc_UserAdmin()); 
