...
--and Object_PersonalServiceList.Id = 7775704
                                )
     --документы начисления за период по выбранным ведомостям
   ...
   , tmpMI_Child AS (WITH
    ...
    SELECT Movement.Id                     AS MovementId
         ...
         , Object_PersonalServiceList.Id     AS PersonalServiceListCode
