...
*/
         ...
         , tmpOperationGroupAll AS (SELECT tmp.OperDate
                                    ...
                                    FROM (SELECT tmpOperationGroup.OperDate
                                               ...
                                               , SUM (tmpOperationGroup.Amount) :: TFloat AS Amount_Weight         -- ∆.¬ ‘¿ “
                                               , SUM (tmpOperationGroup.AmountPartner - tmpOperationGroup.Amount_f2) :: TFloat AS AmountPartner_Weight  -- ¬≈— Õ¿ À¿ƒ. ¡Õ
                                               ...
                                               , SUM ((tmpOperationGroup.Amount - tmpOperationGroup.AmountPartner + tmpOperationGroup.Amount_f2 )) :: TFloat AS AmountWeight_diff  -- ÓÚ Á‡„ÓÚÓ‚ËÚÂÎˇ- ËÁÎË¯ÂÍ,Í„
         ...
         , tmpOperationGroup AS (SELECT '01. ∆.¬ ‘¿ “' AS Col_Name    
                                      , 1 AS Num
                                ...
                                UNION
                                 ...
                                 FROM tmpOperationGroupAll
                                UNION
                                 SELECT '03. —Â‰. ¬ÂÒ 1 „ÓÎÓ‚˚' AS Col_Name
                                      , 3 AS Num
                                      , tmpOperationGroupAll.OperDate
                                      , tmpOperationGroupAll.JuridicalId
                                 ...
                                 FROM tmpOperationGroupAll
                                UNION
                                 SELECT '04. ¬≈— Õ¿ À¿ƒ. ¡Õ' AS Col_Name
                                      , 4 AS Num    
                                      , tmpOperationGroupAll.OperDate
                                      , tmpOperationGroupAll.JuridicalId
                                      , tmpOperationGroupAll.AmountPartner_Weight
                                      , 12713983  AS Color_calc   -- ÁÂÎÂÌ‡ˇ ·ÂÊ  -- ÔÓˇ˜Â 6608867
                                    --  , zc_PivotSummartType_Sum() :: Integer AS SummType
                                 FROM tmpOperationGroupAll
                                UNION
                                 SELECT '05. ÷≈Õ¿-Õ¿ À¿ƒ. ¡Õ' AS Col_Name
                                      , 5 AS Num     
                                      , tmpOperationGroupAll.OperDate
                                      , tmpOperationGroupAll.JuridicalId
                                      , tmpOperationGroupAll.PricePartner
                                      , 12713983 AS Color_calc   -- ÁÂÎÂÌ‡ˇ ·ÂÊ
                                    --  , zc_PivotSummartType_Average() :: Integer AS SummType
                                 FROM tmpOperationGroupAll
                                UNION
                                 SELECT '06. ¬—≈√Œ —”ÃÃ¿ ¡Õ' AS Col_Name
                                      , 6 AS Num       
                                      , tmpOperationGroupAll.OperDate
                                      , tmpOperationGroupAll.JuridicalId
                                 ...
                                 FROM tmpOperationGroupAll
                                UNION
                                 SELECT '07. ‰ÓÔÎ‡Ú‡ Á‡ ‚ÂÒ, Í„' AS Col_Name
                                      , 7 AS Num       
                                      , tmpOperationGroupAll.OperDate
                                      , tmpOperationGroupAll.JuridicalId
                                 ...
                                 FROM tmpOperationGroupAll
                                UNION
                                 SELECT '08. ƒŒœÀ¿“¿ ¬≈—-Õ¿À, „Ì' AS Col_Name
                                      , 8 AS Num       
                                      , tmpOperationGroupAll.OperDate
                                      , tmpOperationGroupAll.JuridicalId
                                ...
                                UNION
                                 ...
                                 FROM tmpOperationGroupAll
                                UNION
                                 SELECT '10. ƒŒœÀ¿“¿  Œœ≈… », „Ì' AS Col_Name
                                      , 10 AS Num       
                                      , tmpOperationGroupAll.OperDate
                                      , tmpOperationGroupAll.JuridicalId
                                 ...
                                 FROM tmpOperationGroupAll
                                UNION
                                 SELECT '11. ¬—≈√Œ ƒŒœÀ¿“¿ Á‡„ÓÚÓ‚ËÚÂÎ˛' AS Col_Name
                                      , 11 AS Num
                                      , tmpOperationGroupAll.OperDate
                                      , tmpOperationGroupAll.JuridicalId
                                 ...
                                 FROM tmpOperationGroupAll
                                UNION
                                 SELECT '12. ŒÚ Á‡„ÓÚÓ‚ËÚÂÎˇ- ËÁÎË¯ÂÍ,Í„' AS Col_Name
                                      , 12 AS Num      
                                      , tmpOperationGroupAll.OperDate
                                      , tmpOperationGroupAll.JuridicalId
                                      , tmpOperationGroupAll.AmountWeight_diff
                                      , zc_Color_White() AS Color_calc   -- ˆ‚ÂÚ  ¯ËÙÚ‡
                                     -- , zc_PivotSummartType_Sum() :: Integer AS SummType
                                 FROM tmpOperationGroupAll
                                UNION
                                 SELECT '13. ÓÚ Á‡„ÓÚÓ‚˘ËÍ-ˆÂÌ‡' AS Col_Name
                                      , 13 AS Num      
                                      , tmpOperationGroupAll.OperDate
                                      , tmpOperationGroupAll.JuridicalId
                                ...
                                UNION
                                 ...
                                 FROM tmpOperationGroupAll
                                UNION
                                 SELECT '18. ˆÂÌ‡ —¬»Õ»Õ¿ Õ/ ' AS Col_Name
                                      , 18 AS Num
                                      , tmpOperationGroupAll.OperDate
                                      , tmpOperationGroupAll.JuridicalId
                                ...
                                UNION
                                 ...
                                 FROM tmpOperationGroupAll
                                UNION
                                 SELECT '25. “‡ÍÒË+ÍÓÏ‡Ì‰ËÓ‚.' AS Col_Name
                                      , 25 AS Num
                                      , tmpOperationGroupAll.OperDate
                                      , tmpOperationGroupAll.JuridicalId
      ...
      SELECT tmpOperationGroup.Num
           ...
           , 0 AS SummType  -- , tmpOperationGroup.SummType   :: Integer
