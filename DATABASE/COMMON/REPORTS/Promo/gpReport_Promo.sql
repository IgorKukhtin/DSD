...
-- тест
-- select * from gpSelect_Report_Promo(inStartDate := ('04.04.2019')::TDateTime , inEndDate := ('01.05.2019')::TDateTime , inIsPromo := 'False' , inIsTender := 'False' ,inIsGoodsKind := 'true', inUnitId := 0 ,  inSession := '5'::TVarchar)
