...
CREATE OR REPLACE FUNCTION gpSelect_Report_Wage_Sum(
    ...
    IN inDateFinal      TDateTime, --дата окончани€ периода
...
--Ќастройки
    ...
    FROM
        ...
        --PositionLevel разр€д должности
        ...
        --PersonalCount  кол-во сотрудников в подразделении/должности/разр€де
        ...
        --HoursPlan  1.ќбщ.пл.ч.в мес. на человека
        ...
        --HoursDay  2.ƒневной пл.ч. на человека
...
Select * from gpSelect_Report_Wage_Sum(
    ...
    inDateFinal      := '20150731'::TDateTime, --дата окончани€ периода
