  ...
  , tmpUnit_Reestr_from AS (SELECT DISTINCT Setting_Wage_1.UnitId, COALESCE (Setting_Wage_1.FromId, 0) AS FromId
   ...
   -- , Setting.UnitName
    ...
    -- ,Setting.FromName
       ...
       , tmpMovement_PersonalComplete.KoeffHoursWork_car :: TFloat AS AmountOnOneMember
...
-- тест
-- SELECT * FROM gpSelect_Report_Wage_Model (inStartDate:= '02.11.2019', inEndDate:= '02.11.2019', inUnitId:= 8439, inModelServiceId:= 632844, inMemberId:= 0, inPositionId:= 0, inSession:= '5');
