...
*/
-- тест
-- SELECT * FROM gpReport_MIProtocol (inStartDate:= '07.11.2016' ::TDateTime, inEndDate:= '11.11.2017'::TDateTime, inUnitId:= 0, inUserId:= 0, inGoodsGroupId:= 0, inGoodsId:= 0, inIsMovement:=TRUE, inSession:= '5'::TVarChar);
