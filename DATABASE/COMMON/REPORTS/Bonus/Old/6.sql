-- Function: lpreport_checkbonus_test(tdatetime, tdatetime, integer, integer, integer, integer, boolean, boolean, boolean, tvarchar)

-- DROP FUNCTION lpreport_checkbonus_test(tdatetime, tdatetime, integer, integer, integer, integer, boolean, boolean, boolean, tvarchar);
...
$BODY$
  ...
  COST 100
  ROWS 1000;
ALTER FUNCTION lpreport_checkbonus_test(tdatetime, tdatetime, integer, integer, integer, integer, boolean, boolean, boolean, tvarchar)
  OWNER TO admin;
