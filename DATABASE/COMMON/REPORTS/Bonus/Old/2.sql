-- Function: lpreport_checkbonus(tdatetime, tdatetime, integer, integer, integer, boolean, tvarchar)

-- DROP FUNCTION lpreport_checkbonus(tdatetime, tdatetime, integer, integer, integer, boolean, tvarchar);
...
$BODY$
  ...
  COST 100
  ROWS 1000;
ALTER FUNCTION lpreport_checkbonus(tdatetime, tdatetime, integer, integer, integer, boolean, tvarchar)
  OWNER TO admin;
