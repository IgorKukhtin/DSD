-- Function: lpreport_checkbonus22(tdatetime, tdatetime, integer, integer, integer, boolean, tvarchar)

-- DROP FUNCTION lpreport_checkbonus22(tdatetime, tdatetime, integer, integer, integer, boolean, tvarchar);

CREATE OR REPLACE FUNCTION lpreport_checkbonus22(
...
$BODY$
  ...
  COST 100
  ROWS 1000;
ALTER FUNCTION lpreport_checkbonus22(tdatetime, tdatetime, integer, integer, integer, boolean, tvarchar)
  OWNER TO admin;
