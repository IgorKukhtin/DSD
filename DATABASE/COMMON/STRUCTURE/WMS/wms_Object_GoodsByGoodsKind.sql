...
CREATE TABLE wms_Object_GoodsByGoodsKind(
   ...
   WeightOnBox_Sh      TFloat  , -- +Вес нетто в ящ. (E2/E3) для категории шт.
   WeightOnBox_Nom     TFloat  , -- +Вес нетто в ящ. (E2/E3) для категории 
   WeightOnBox_Ves     TFloat  , -- +Вес нетто в ящ. (E2/E3) для категории 
   ...
   WeightOnBox         TFloat  , -- !!!***Вес нетто в ящ (E2/E3) - по всем категориям
