...
WITH tmp AS (SELECT ContainerId, Amount_1, Amount_2, Amount_3, Amount_4, Amount_5, VerId_1, VerId_2, VerId_3, VerId_4, VerId_5, Amount_data_real_1, Amount_data_real_2, Amount_data_real_3, Amount_data_real_4, Amount_data_real_5 FROM gpReport_Container_data (inStartDate:= '01.12.2025', inSession:= '5'))
