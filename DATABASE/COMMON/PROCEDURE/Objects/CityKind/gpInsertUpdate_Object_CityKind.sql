...
DROP FUNCTION IF EXISTS gpInsertUpdate_Object_CityKind(Integer,Integer,TVarChar,TVarChar);
...
ALTER FUNCTION gpInsertUpdate_Object_CityKind (Integer,Integer,TVarChar,TVarChar) OWNER TO postgres;
