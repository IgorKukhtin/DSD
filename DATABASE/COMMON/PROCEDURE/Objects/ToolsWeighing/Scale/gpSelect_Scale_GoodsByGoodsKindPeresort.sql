-- Function: gpSelect_Scale_GoodsByGoodsKindPeresort()

DROP FUNCTION IF EXISTS gpSelect_Scale_GoodsByGoodsKindPeresort (Integer, Integer, TVarChar);
DROP FUNCTION IF EXISTS gpSelect_Scale_GoodsByGoodsKindPeresort (Integer, Integer, Integer, TVarChar);

CREATE OR REPLACE FUNCTION gpSelect_Scale_GoodsByGoodsKindPeresort(
...
-- тест
-- SELECT * FROM gpSelect_Scale_GoodsByGoodsKindPeresort (inGoodsId_in:= 0, inGoodsKindId_in:= 0, inBranchCode:= 0, inSession:=zfCalc_UserAdmin())
