-- Function: lfGet_Object_AccountByInfoMoney (Integer, Integer, Integer)

-- DROP FUNCTION lfGet_Object_AccountByInfoMoney (Integer, Integer, Integer);

CREATE OR REPLACE FUNCTION lfGet_Object_AccountByInfoMoney(IN inAccountGroupId Integer, IN inAccountDirectionId Integer, IN inInfoMoneyDestinationId Integer)
...
ALTER FUNCTION lfGet_Object_AccountByInfoMoney (Integer, Integer, Integer) OWNER TO postgres;
...
-- тест
-- SELECT * FROM lfGet_Object_AccountByInfoMoney ()
