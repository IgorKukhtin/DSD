...
$BODY$BEGIN
   ...
   ELSE
       ...
       SELECT 
           ...
           , Object_AccountDirection.ValueData      AS AccountGroupName
           , Object_AccountDirection.Id             AS AccountGroupId

           , Object_InfoMoneyDestination.ValueData  AS AccountGroupName
           , Object_InfoMoneyDestination.Id         AS AccountGroupId

           , Object_InfoMoney.ValueData      AS AccountGroupName
           , Object_InfoMoney.Id             AS AccountGroupId
