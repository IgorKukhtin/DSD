...
BEGIN
   ...
   WITH tmpPersonal AS (SELECT lfSelect.MemberId
       ...
       SELECT Object_OrderFinance.Id           AS Id
            ...
            , CASE WHEN vbUserId = 5 AND 1=0 THEN 'ФИО' ELSE Object_Member_insert.ValueData END :: TVarChar   AS MemberName_insert   
            ...
            , CASE WHEN vbUserId = 5 AND 1=0 THEN 'ФИО' ELSE Object_Member_insert_2.ValueData END :: TVarChar   AS MemberName_insert_2   
            ...
            , CASE WHEN vbUserId = 5 AND 1=0 THEN 'ФИО' ELSE Object_Member_insert_3.ValueData END :: TVarChar   AS MemberName_insert_3   
            ...
            , CASE WHEN vbUserId = 5 AND 1=0 THEN 'ФИО' ELSE Object_Member_insert_4.ValueData END :: TVarChar   AS MemberName_insert_4   
            ...
            , CASE WHEN vbUserId = 5 AND 1=0 THEN 'ФИО' ELSE Object_Member_insert_5.ValueData END :: TVarChar   AS MemberName_insert_5   
            ...
            , CASE WHEN vbUserId = 6 AND 1=0 THEN 'ФИО' ELSE Object_Member_insert_6.ValueData END :: TVarChar   AS MemberName_insert_6   
            ...
            , CASE WHEN vbUserId = 5 AND 1=0 THEN 'ФИО' ELSE Object_Member_insert_7.ValueData END :: TVarChar   AS MemberName_insert_7   
            ...
            , CASE WHEN vbUserId = 5 AND 1=0 THEN 'ФИО' ELSE Object_Member_insert_8.ValueData END :: TVarChar   AS MemberName_insert_8   
            ...
            , CASE WHEN vbUserId = 5 AND 1=0 THEN 'ФИО' ELSE Object_Member_insert_9.ValueData END :: TVarChar   AS MemberName_insert_9   
            ...
            , CASE WHEN vbUserId = 5 AND 1=0 THEN 'ФИО' ELSE Object_Member_insert_10.ValueData END :: TVarChar   AS MemberName_insert_10   
            ...
            , CASE WHEN vbUserId = 5 AND 1=0 THEN 'ФИО' ELSE Object_Member_insert_11.ValueData END :: TVarChar   AS MemberName_insert_11   
            ...
            , CASE WHEN vbUserId = 5 AND 1=0 THEN 'ФИО' ELSE Object_Member_insert_12.ValueData END :: TVarChar   AS MemberName_insert_12   
            ...
            , CASE WHEN vbUserId = 5 AND 1=0 THEN 'ФИО' ELSE Object_Member_insert_13.ValueData END :: TVarChar   AS MemberName_insert_13   
            ...
            , CASE WHEN vbUserId = 5 AND 1=0 THEN 'ФИО' ELSE Object_Member_insert_14.ValueData END :: TVarChar   AS MemberName_insert_14   
            ...
            , CASE WHEN vbUserId = 5 AND 1=0 THEN 'ФИО' ELSE Object_Member_insert_15.ValueData END :: TVarChar   AS MemberName_insert_15   
            ...
            , CASE WHEN vbUserId = 5 AND 1=0 THEN 'ФИО-1' ELSE Object_Member_1.ValueData END :: TVarChar AS MemberName_1
