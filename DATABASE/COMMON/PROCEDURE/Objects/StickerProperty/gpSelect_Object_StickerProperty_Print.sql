...
-- [frxDBDHeader."Info"]
            ...
            , CASE WHEN ObjectBlob_Sticker_InfoTop.ValueData     <> '' AND 1=1 THEN ObjectBlob_Sticker_InfoTop.ValueData
                   ...
                   ELSE 'ОПЕРАТОР РИНКУ (ВИРОБНИК): ТОВ "АЛАН".'
         || CHR (13) || 'МІСЦЕЗНАХОДЖЕННЯ ОПЕРАТОРА РИНКУ ТА ПОТУЖНОСТЕЙ ВИРОБНИЦТВА: ВУЛ. СТАРТОВА, 26, М. ДНІПРО, 49041, УКРАЇНА,'
         || CHR (13) || 'ТЕЛ.: +38 (056) 777-18-45. ЕКСПЛУАТАЦІЙНИЙ ДОЗВІЛ № 04-23-213 РМ'
