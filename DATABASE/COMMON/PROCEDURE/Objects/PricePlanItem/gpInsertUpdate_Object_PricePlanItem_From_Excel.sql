-- Function: gpInsertUpdate_Object_PricePlanItem_From_Excel (Integer, Integer, TFloat, TVarChar)

DROP FUNCTION IF EXISTS gpInsertUpdate_Object_PricePlanItem_From_Excel (TDateTime, Integer, Integer, TVarChar, TFloat, TVarChar);

CREATE OR REPLACE FUNCTION gpInsertUpdate_Object_PricePlanItem_From_Excel(
...
BEGIN
    ...
    --
    PERFORM lpInsertUpdate_ObjectHistory_PricePlanItem (ioId          := 0
