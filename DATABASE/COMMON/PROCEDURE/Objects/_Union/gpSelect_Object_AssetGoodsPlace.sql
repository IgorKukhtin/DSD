-- Function: gpSelect_Object_AssetGoodsPlace()

DROP FUNCTION IF EXISTS gpSelect_Object_AssetGoodsPlace(TVarChar);

CREATE OR REPLACE FUNCTION gpSelect_Object_AssetGoodsPlace(
     ...
     WHERE Object_Asset.DescId = zc_Object_Asset() 
      ...
      UNION All
       SELECT Distinct
        ...
        FROM ContainerLinkObject  as CLO_AssetTo
           INNER JOIN Container ON Container.Id = CLO_AssetTo.ContainerId 
                  AND Container.DescId = zc_Container_Count()
           INNER JOIN Object AS Object_Goods on Container.ObjectId = Object_Goods.Id
        ...
        WHERE CLO_AssetTo.DescId = zc_ContainerLinkObject_AssetTo()
          AND CLO_AssetTo.ObjectId <>0
...
ALTER FUNCTION gpSelect_Object_AssetGoodsPlace(TVarChar) OWNER TO postgres;
...
-- тест
--SELECT * FROM gpSelect_Object_AssetGoodsPlace (zfCalc_UserAdmin())
