-- Function: gpInsertUpdate_Object_MemberCardF1_From_Excel()

DROP FUNCTION IF EXISTS gpInsertUpdate_Object_MemberCardF1_From_Excel (TVarChar, TVarChar, TVarChar, TVarChar);

CREATE OR REPLACE FUNCTION gpInsertUpdate_Object_MemberCardF1_From_Excel(
    IN inINN                 TVarChar  ,    -- Код ИНН
    IN inCard                TVarChar  ,    -- № карты ф1
...
BEGIN
   ...
   ELSE
      -- сохранили свойство <>
      PERFORM lpInsertUpdate_ObjectString( zc_ObjectString_Member_CardBank(), vbMemberId, inCard);
