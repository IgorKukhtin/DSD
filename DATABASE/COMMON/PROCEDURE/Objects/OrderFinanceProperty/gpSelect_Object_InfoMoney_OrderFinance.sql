-- Function: gpSelect_Object_InfoMoney_OrderFinance()

DROP FUNCTION IF EXISTS gpSelect_Object_InfoMoney_OrderFinance(Boolean, TVarChar);

CREATE OR REPLACE FUNCTION gpSelect_Object_InfoMoney_OrderFinance(
...
-- тест
-- SELECT * FROM gpSelect_Object_InfoMoney_OrderFinance ('2')