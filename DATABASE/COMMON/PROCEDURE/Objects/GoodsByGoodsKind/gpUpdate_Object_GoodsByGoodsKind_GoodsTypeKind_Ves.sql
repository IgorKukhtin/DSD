-- Function: gpUpdate_Object_GoodsByGoodsKind_GoodsTypeKind_Ves ();

DROP FUNCTION IF EXISTS  gpUpdate_Object_GoodsByGoodsKind_GoodsTypeKind_Ves (Integer, Integer, Integer, Boolean, TVarChar);

CREATE OR REPLACE FUNCTION gpUpdate_Object_GoodsByGoodsKind_GoodsTypeKind_Ves(
...
BEGIN
   ...
   THEN
         -- сохранили свойство <>
         PERFORM lpInsertUpdate_ObjectLink (zc_ObjectLink_GoodsByGoodsKind_GoodsTypeKind_Ves(), inId, zc_Enum_GoodsTypeKind_Ves());
   ...
   ELSE
         -- сохранили свойство <>
         PERFORM lpInsertUpdate_ObjectLink (zc_ObjectLink_GoodsByGoodsKind_GoodsTypeKind_Ves(), inId, Null);
   END IF;
