-- Function: gpUpdate_Object_GoodsByGoodsKind_GoodsTypeKind_Sh ();

DROP FUNCTION IF EXISTS  gpUpdate_Object_GoodsByGoodsKind_GoodsTypeKind_Sh (Integer, Integer, Integer, Boolean, TVarChar);

CREATE OR REPLACE FUNCTION gpUpdate_Object_GoodsByGoodsKind_GoodsTypeKind_Sh(
...
BEGIN
   ...
   ELSE
         -- сохранили свойство <>
         PERFORM lpInsertUpdate_ObjectLink (zc_ObjectLink_GoodsByGoodsKind_GoodsTypeKind_Sh(), inId, Null);
   END IF;
