...
BEGIN
   ...
   THEN 
       RAISE EXCEPTION 'Ошибка.Значение Товар = <%> + Вид товара = <%> уже есть в справочнике. Дублирование запрещено.', lfGet_Object_ValueData (inGoodsId), lfGet_Object_ValueData (inGoodsKindId);
   END IF;   
