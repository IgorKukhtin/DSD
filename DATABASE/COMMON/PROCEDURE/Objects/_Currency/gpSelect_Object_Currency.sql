...
RETURNS TABLE (Id Integer, Code Integer, Name TVarChar, isErased boolean, FullName TVarChar) AS
$BODY$BEGIN
   ...
   , Object.ValueData
   , Object.isErased
   , ObjectString.ValueData AS FullName
   FROM Object
   JOIN ObjectString
     ON ObjectString.ObjectId = Object.Id
    AND ObjectString.DescId = zc_objectString_Currency_FullName()
