...
RETURNS TABLE (Id Integer, Code Integer, Name TVarChar, BasisCode Integer,
               ...
               RouteTTId Integer, RouteTTCode Integer, RouteTTName TVarChar,
...
BEGIN
   ...
   RETURN QUERY
     ...
     SELECT
         ...
         , Object_RouteTT.ObjectCode       AS RouteTTCode
 ...
 UNION ALL
     ...
     FROM tmpIsErased
         ...
         LEFT JOIN ObjectLink AS ObjectLink_Partner_UnitCommerc
                              ON ObjectLink_Partner_UnitCommerc.ObjectId = Object_Partner.Id
                             AND ObjectLink_Partner_UnitCommerc.DescId = zc_ObjectLink_Partner_UnitCommerc() 
                             AND COALESCE (ObjectLink_Partner_RouteTT.ChildObjectId, 0) = 0  --если в маршруте ““ пусто - только тогда показываем zc_ObjectLink_Partner_UnitCommerc
