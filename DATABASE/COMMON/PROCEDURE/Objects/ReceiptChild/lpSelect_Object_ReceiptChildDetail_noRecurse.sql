-- Function: lpSelect_Object_ReceiptChildDetail_noRecurse()

DROP FUNCTION IF EXISTS lpSelect_Object_ReceiptChildDetail_noRecurse (Boolean);

CREATE OR REPLACE FUNCTION lpSelect_Object_ReceiptChildDetail_noRecurse (
...
BEGIN
     ...
     INSERT INTO tmpReceipt_multi (ReceiptId_parent, ReceiptId, GoodsId_in, GoodsKindId_in, Amount_in, GoodsId_out, GoodsKindId_out, Amount_out, ReceiptChildId, Koeff)
      ...
      RETURN QUERY
      WITH temp1 (ReceiptId_parent, ReceiptId_from, ReceiptId, GoodsId_in, GoodsKindId_in, Amount_in, ReceiptChildId, GoodsId_out, GoodsKindId_out, Amount_out, isStart, isCost)
...
-- тест
--  SELECT * FROM lpSelect_Object_ReceiptChildDetail_noRecurse (TRUE)
