...
/*
   ...
   */
   ...
   END IF;
   -- + Сушко О.О.
   IF COALESCE (inJuridicalBasisId, 0) <> zc_Juridical_Basis() AND vbUserId NOT IN (zfCalc_UserAdmin() :: Integer, zfCalc_UserMain(), 13246443)
   THEN
   ...
   -- сохранили свойство <>
   PERFORM lpInsertUpdate_ObjectBoolean (zc_ObjectBoolean_Contract_ReExch(), ioId, inisReExch);
