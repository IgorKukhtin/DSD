...
-- SELECT * FROM gpInsertUpdate_Object_ReportExternal (ioId:= 0, inName:= 'gpReport_ProfitLoss_by',                inSession:= zfCalc_UserAdmin()); -- +
-- SELECT * FROM gpInsertUpdate_Object_ReportExternal (ioId:= 0, inName:= 'gpReport_ProfitLoss_bi',                inSession:= zfCalc_UserAdmin()); -- +
...
-- SELECT * FROM gpInsertUpdate_Object_ReportExternal (ioId:= 0, inName:= 'gpReport_Branch_App1_New',       inSession:= zfCalc_UserAdmin()); -- +
-- SELECT * FROM gpInsertUpdate_Object_ReportExternal (ioId:= 0, inName:= 'gpReport_Branch_App1_Full',      inSession:= zfCalc_UserAdmin()); -- +
...
-- SELECT * FROM gpInsertUpdate_Object_ReportExternal (ioId:= 0, inName:= 'gpReport_Branch_App1_Month',     inSession:= zfCalc_UserAdmin()); -- +
...
-- -- SELECT * FROM gpInsertUpdate_Object_ReportExternal (ioId:= 0, inName:= 'gpSelect_Movement_Inventory_mobile',inSession:= zfCalc_UserAdmin()); -- +
...
-- SELECT * FROM gpInsertUpdate_Object_ReportExternal (ioId:= 0, inName:= 'gpSelect_Report_Promo_Result',inSession:= zfCalc_UserAdmin()); -- +
-- SELECT * FROM gpInsertUpdate_Object_ReportExternal (ioId:= 0, inName:= 'gpSelect_Report_Promo_Result_Month',inSession:= zfCalc_UserAdmin()); -- +
...
-- SELECT * FROM gpInsertUpdate_Object_ReportExternal (ioId:= 0, inName:= 'gpReport_PrintForms_byMovement',inSession:= zfCalc_UserAdmin()); -- +
-- SELECT * FROM gpInsertUpdate_Object_ReportExternal (ioId:= 0, inName:= 'gpReport_SaleTare_Gofro',inSession:= zfCalc_UserAdmin()); -- +

-- SELECT * FROM gpInsertUpdate_Object_ReportExternal (ioId:= 0, inName:= 'gpReport_JuridicalCollation',           inSession:= zfCalc_UserAdmin()); -- + !!!
-- SELECT * FROM gpInsertUpdate_Object_ReportExternal (ioId:= 0, inName:= 'gpReport_JuridicalCollation',           inSession:= zfCalc_UserAdmin()); -- + !!!
