-- Function: gpComplete_Movement_StaffListClose()

DROP FUNCTION IF EXISTS gpComplete_Movement_StaffListClose (Integer, TVarChar);

CREATE OR REPLACE FUNCTION gpComplete_Movement_StaffListClose(
