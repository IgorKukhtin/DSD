...
-- тест
-- SELECT * FROM lpUpdate_Movement_Send_DocumentKind (inIsUpdate:= TRUE, inStartDate:= '13.07.2016', inEndDate:= '15.07.2016', inUnitId:= 0, inUserId:= zfCalc_UserAdmin() :: Integer) -- Цех Упаковки
-- SELECT * FROM lpUpdate_Movement_Send_DocumentKind (inIsUpdate:= FALSE, inStartDate:= '13.07.2016', inEndDate:= '15.07.2016', inUnitId:= 0, inUserId:= zfCalc_UserAdmin() :: Integer) -- Цех Упаковки
