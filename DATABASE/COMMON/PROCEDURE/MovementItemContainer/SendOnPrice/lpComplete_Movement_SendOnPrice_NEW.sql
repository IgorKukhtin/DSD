                     ...
                     FROM (SELECT tmpItem_start.GoodsId, tmpItem_start.GoodsKindId
                           ...
                           FROM (SELECT DISTINCT _tmpItem.MovementItemId, _tmpItem.GoodsId, _tmpItem.GoodsKindId
                                 ...
                                 WHERE _tmpItem.InfoMoneyDestinationId IN (zc_Enum_InfoMoneyDestination_20900() -- Ирна
                                  ...
                                  AND (_tmpItem.OperCount_start <> 0 OR _tmpItem.OperCount_Partner_start <> 0)
                                ) AS tmpItem_start
                     ...
                     FROM (SELECT tmpItem_start.GoodsId, tmpItem_start.GoodsKindId
                          ...
                          FULL JOIN (SELECT _tmpItem.GoodsId, _tmpItem.GoodsKindId
                                     ...
                                     GROUP BY _tmpItem.GoodsId, _tmpItem.GoodsKindId
                                      ...
                                      ON tmpItem.GoodsId     = tmpItem_start.GoodsId
                                     AND tmpItem.GoodsKindId = tmpItem_start.GoodsKindId
                     WHERE COALESCE (tmpItem_start.OperCount_Partner_start, 0)        <> COALESCE (tmpItem.OperCount_Partner, 0)
                    )
            )
        AND inUserId IN (5, zc_Enum_Process_Auto_PrimeCost() :: Integer)
        --AND 1=0
...
-- ;
    ...
    ;
     ...
     -- таблица - оптимизация
     INSERT INTO _tmpList_CLO (ContainerId_From)
       SELECT DISTINCT _tmpItemSumm.ContainerId_From FROM _tmpItemSumm
      ;
     -- оптимизация
     ANALYZE _tmpList_CLO;
     ...
     UPDATE _tmpItemSumm SET -- у покупателя
                             ContainerId_Transit_01 = lpInsertUpdate_ContainerSumm_Goods (inOperDate               := vbOperDate
                                                                                        ...
                                                                                        , inInfoMoneyDestinationId := _tmpItemSumm_find.InfoMoneyDestinationId
                                                                                        , inInfoMoneyId            := _tmpItemSumm_find.InfoMoneyId
                                                                                        , inInfoMoneyId_Detail     := _tmpItemSumm_find.InfoMoneyId_Detail
                                                                                        , inContainerId_Goods      := _tmpItemSumm_find.ContainerId_GoodsTransit_01 -- Счет - кол-во Транзит
                                                                                        , inGoodsId                := _tmpItemSumm_find.GoodsId
                                                                                        , inGoodsKindId            := _tmpItemSumm_find.GoodsKindId
                                                                                        , inIsPartionSumm          := _tmpItemSumm_find.isPartionSumm
                                                                                        , inPartionGoodsId         := _tmpItemSumm_find.PartionGoodsId
                                                                                        , inAssetId                := _tmpItemSumm_find.AssetId
                                                                                         )
                             -- Разница в весе
                           , ContainerId_Transit_02 = CASE WHEN _tmpItemSumm_find.ContainerId_GoodsTransit_02 <> 0 THEN
                                                      lpInsertUpdate_ContainerSumm_Goods (inOperDate               := vbOperDate
                                                                                        ...
                                                                                        , inInfoMoneyId            := _tmpItemSumm_find.InfoMoneyId
                                                                                        , inInfoMoneyId_Detail     := _tmpItemSumm_find.InfoMoneyId_Detail
                                                                                        , inContainerId_Goods      := _tmpItemSumm_find.ContainerId_GoodsTransit_02 -- Счет - кол-во Транзит
                                                                                        , inGoodsId                := _tmpItemSumm_find.GoodsId
                                                                                        , inGoodsKindId            := _tmpItemSumm_find.GoodsKindId
                                                                                        , inIsPartionSumm          := _tmpItemSumm_find.isPartionSumm
                                                                                        , inPartionGoodsId         := _tmpItemSumm_find.PartionGoodsId
                           ...
                           , ContainerId_Transit_51 = CASE WHEN isRestoreAccount_60000 = TRUE THEN
                                                      ...
                                                      END
                             -- Разница в весе
                           , ContainerId_Transit_52 = CASE WHEN isRestoreAccount_60000 = TRUE AND _tmpItemSumm_find.ContainerId_GoodsTransit_02 <> 0 THEN
                                                      lpInsertUpdate_ContainerSumm_Goods (inOperDate               := vbOperDate
                                                                                        , inUnitId                 := _tmpItemSumm_find.UnitId
                                                                                        , inCarId                  := _tmpItemSumm_find.CarId
                                                                                        , inMemberId               := _tmpItemSumm_find.MemberId
                                                      ...
                                                      END
                             -- Скидка в весе
                           , ContainerId_Transit_53 = CASE WHEN _tmpItemSumm_find.ContainerId_GoodsTransit_53 <> 0 THEN
                                                      lpInsertUpdate_ContainerSumm_Goods (inOperDate               := vbOperDate
                                                                                        , inUnitId                 := _tmpItemSumm_find.UnitId
                                                                                        , inCarId                  := _tmpItemSumm_find.CarId
                                                                                        , inMemberId               := _tmpItemSumm_find.MemberId
                                                                                        ...
                                                                                        , inInfoMoneyId            := _tmpItemSumm_find.InfoMoneyId
                                                                                        , inInfoMoneyId_Detail     := _tmpItemSumm_find.InfoMoneyId_Detail
                                                                                        , inContainerId_Goods      := _tmpItemSumm_find.ContainerId_GoodsTransit_53 -- Счет - кол-во Транзит
                                                                                        , inGoodsId                := _tmpItemSumm_find.GoodsId
                                                                                        , inGoodsKindId            := _tmpItemSumm_find.GoodsKindId
                                                                                        , inIsPartionSumm          := _tmpItemSumm_find.isPartionSumm
                                                                                        , inPartionGoodsId         := _tmpItemSumm_find.PartionGoodsId
                                                      ...
                                                      ELSE 0
                                                      END
     FROM (WITH _tmpItemSumm_find AS (SELECT DISTINCT _tmpItemSumm.MovementItemId, _tmpItemSumm.ContainerId_GoodsFrom, _tmpItemSumm.ContainerId_From FROM _tmpItemSumm)
             , tmpCLO AS (SELECT * FROM ContainerLinkObject AS CLO WHERE CLO.ContainerId IN (SELECT DISTINCT _tmpList_CLO.ContainerId_From FROM _tmpList_CLO)
                                                                     AND CLO.DescId IN (zc_ContainerLinkObject_JuridicalBasis()
                                                                                      ...
                                                                                      , zc_ContainerLinkObject_GoodsKind()
                                                                                      , zc_ContainerLinkObject_PartionGoods()
                                                                                      , zc_ContainerLinkObject_AssetTo()
           ...
           --
           SELECT _tmpItemSumm_find.MovementItemId, _tmpItemSumm_find.ContainerId_GoodsFrom, _tmpItemSumm_find.ContainerId_From
                , _tmpItem.ContainerId_GoodsTransit_01
                , _tmpItem.ContainerId_GoodsTransit_02
                , _tmpItem.ContainerId_GoodsTransit_53
                , _tmpItem.InfoMoneyDestinationId
                , _tmpItem.isPartionSumm
           ...
           FROM _tmpItemSumm_find
                INNER JOIN _tmpItem ON _tmpItem.MovementItemId        = _tmpItemSumm_find.MovementItemId
                                   ...
                                   AND _tmpItem.isLossMaterials       = FALSE -- !!!если НЕ списание!!!
                LEFT JOIN tmpCLO AS CLO_JuridicalBasis ON CLO_JuridicalBasis.ContainerId = _tmpItemSumm_find.ContainerId_From
                                                                   AND CLO_JuridicalBasis.DescId = zc_ContainerLinkObject_JuridicalBasis()
                LEFT JOIN tmpCLO AS CLO_Business ON CLO_Business.ContainerId = _tmpItemSumm_find.ContainerId_From
                                                             AND CLO_Business.DescId = zc_ContainerLinkObject_Business()
                LEFT JOIN tmpCLO AS CLO_InfoMoney ON CLO_InfoMoney.ContainerId = _tmpItemSumm_find.ContainerId_From
                                                              AND CLO_InfoMoney.DescId = zc_ContainerLinkObject_InfoMoney()
                LEFT JOIN tmpCLO AS CLO_InfoMoneyDetail ON CLO_InfoMoneyDetail.ContainerId = _tmpItemSumm_find.ContainerId_From
                                                                    AND CLO_InfoMoneyDetail.DescId = zc_ContainerLinkObject_InfoMoneyDetail()
                LEFT JOIN tmpCLO AS CLO_Goods ON CLO_Goods.ContainerId = _tmpItemSumm_find.ContainerId_From
                                                          AND CLO_Goods.DescId = zc_ContainerLinkObject_Goods()
                LEFT JOIN tmpCLO AS CLO_GoodsKind ON CLO_GoodsKind.ContainerId = _tmpItemSumm_find.ContainerId_From
                                                              AND CLO_GoodsKind.DescId = zc_ContainerLinkObject_GoodsKind()
                LEFT JOIN tmpCLO AS CLO_PartionGoods ON CLO_PartionGoods.ContainerId = _tmpItemSumm_find.ContainerId_From
                                                                 AND CLO_PartionGoods.DescId = zc_ContainerLinkObject_PartionGoods()
                LEFT JOIN tmpCLO AS CLO_Asset ON CLO_Asset.ContainerId = _tmpItemSumm_find.ContainerId_From
                                                          AND CLO_Asset.DescId = zc_ContainerLinkObject_AssetTo()
                LEFT JOIN tmpCLO AS CLO_Unit ON CLO_Unit.ContainerId = _tmpItemSumm_find.ContainerId_From
                                                         AND CLO_Unit.DescId = zc_ContainerLinkObject_Unit()
                LEFT JOIN tmpCLO AS CLO_Car ON CLO_Car.ContainerId = _tmpItemSumm_find.ContainerId_From
                                                        AND CLO_Car.DescId = zc_ContainerLinkObject_Car()
                LEFT JOIN tmpCLO AS CLO_Member ON CLO_Member.ContainerId = _tmpItemSumm_find.ContainerId_From
     ...
     INSERT INTO ResourseProtocol (UserId
        ...
        SELECT inUserId
             ...
             , CLOCK_TIMESTAMP() AS Time5
               -- ProcName
             , 'lpComplete_Movement_SendOnPrice_NEW'
               -- ProtocolData
