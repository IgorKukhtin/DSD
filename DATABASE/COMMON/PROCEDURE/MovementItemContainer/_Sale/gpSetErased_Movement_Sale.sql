...
BEGIN
     ...
     -- vbUserId:= PERFORM lpCheckRight(inSession, zc_Enum_Process_SetErased_Sale());
     vbUserId:=2;
...
-- тест
-- SELECT * FROM gpSetErased_Movement_Sale (inMovementId:= 149639, inSession:= zfCalc_UserAdmin())
