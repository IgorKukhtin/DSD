-- Function: gpComplete_Movement_OrderReturnTare()

DROP FUNCTION IF EXISTS gpComplete_Movement_OrderReturnTare (Integer, TVarChar);

CREATE OR REPLACE FUNCTION gpComplete_Movement_OrderReturnTare(
