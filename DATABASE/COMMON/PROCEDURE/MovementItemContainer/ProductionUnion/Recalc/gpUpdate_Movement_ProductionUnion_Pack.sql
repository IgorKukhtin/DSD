...
-- тест
-- SELECT * FROM gpUpdate_Movement_ProductionUnion_Pack (inStartDate:= '24.09.2016', inEndDate:= '24.09.2016', inUnitId:= 8451, inSession:= zc_Enum_Process_Auto_PrimeCost() :: TVarChar) -- Цех Упаковки
