...
BEGIN
     ...
     -- таблица - элементы по контрагенту, со всеми свойствами для формирования Аналитик в проводках
     CREATE TEMP TABLE _tmpItem_SummPartner_To (ContainerId Integer, AccountId Integer, ContainerId_ProfitLoss_70201 Integer, BusinessId Integer, GoodsId Integer, OperSumm_Partner TFloat) ON COMMIT DROP;
