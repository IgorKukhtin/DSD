-- Function: gpUpdate_Status_OrderRK()

DROP FUNCTION IF EXISTS gpUpdate_Status_OrderRK (Integer, Integer, TVarChar);

CREATE OR REPLACE FUNCTION gpUpdate_Status_OrderRK(
...
BEGIN
     ...
     CASE inStatusCode
         ...
         WHEN zc_Enum_StatusCode_Complete() THEN
            --
            PERFORM gpComplete_Movement_OrderRK (inMovementId, inSession);
