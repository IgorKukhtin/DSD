-- Function: gpInsertUpdateMobileEffie_MI_OrderExternal()

DROP FUNCTION IF EXISTS gpInsertUpdateMobileEffie_MI_OrderExternal (TVarChar, TVarChar, Integer, Integer, TFloat, TFloat, TFloat, TVarChar);

CREATE OR REPLACE FUNCTION gpInsertUpdateMobileEffie_MI_OrderExternal(
...
-- тест
/* SELECT * FROM gpInsertUpdateMobileEffie_MI_OrderExternal (inGUID:= '{FFA0D4A2-3278-4B3B-A477-692067AFB021}'
