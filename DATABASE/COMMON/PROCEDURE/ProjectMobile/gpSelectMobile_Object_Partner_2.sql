-- Function: gpSelectMobile_Object_Partner_2 (TDateTime, TVarChar)

DROP FUNCTION IF EXISTS gpSelectMobile_Object_Partner_2 (TDateTime, TVarChar);

CREATE OR REPLACE FUNCTION gpSelectMobile_Object_Partner_2 (
...
-- тест
-- SELECT * FROM gpSelectMobile_Object_Partner_2 (inSyncDateIn := zc_DateStart(), inSession := zfCalc_UserAdmin())
