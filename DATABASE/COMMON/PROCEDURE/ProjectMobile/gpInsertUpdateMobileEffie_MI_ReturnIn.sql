-- Function: gpInsertUpdateMobileEffie_MI_ReturnIn()

--DROP FUNCTION IF EXISTS gpInsertUpdateMobileEffie_MI_ReturnIn (TVarChar, TVarChar, Integer, Integer, TFloat, TFloat, TFloat, TVarChar);
DROP FUNCTION IF EXISTS gpInsertUpdateMobileEffie_MI_ReturnIn (TVarChar, TVarChar, Integer, Integer, TFloat, TFloat, TFloat, Integer, TVarChar);

CREATE OR REPLACE FUNCTION gpInsertUpdateMobileEffie_MI_ReturnIn(
...
-- тест
/* SELECT * FROM gpInsertUpdateMobileEffie_MI_ReturnIn (inGUID:= '{A2F91EC1-9A34-4A77-A145-5A3290DFDD71}'
