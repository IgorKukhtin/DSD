     ...
     RETURN QUERY
       WITH tmpPersonal AS (SELECT vbMemberId                AS MemberId
                                 ...
                                 , CASE (SELECT Object.ObjectCode FROM Object WHERE Object.Id = vbBranchId)
                                        ...
                                        WHEN 20 THEN 8459    -- филиал Полтава   - Склад ГП ф.Вінниця
                                 ...
                                 , CASE (SELECT Object.ObjectCode FROM Object WHERE Object.Id = vbBranchId)
                                        ...
                                        WHEN 18 THEN 11921036-- Филиал Винница   - Склад повернень ф.Вінниця
                                        WHEN 20 THEN 8461    -- филиал Полтава   - Склад Возвратов
