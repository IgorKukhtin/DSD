-- Function: gpInit_SequencesMaster()

DROP FUNCTION IF EXISTS _replica.gpInit_SequencesMaster();
DROP FUNCTION IF EXISTS _replica.gpInit_SequencesMaster(TVarChar, TVarChar, TVarChar, TVarChar);
