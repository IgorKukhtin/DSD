...
DROP FUNCTION IF EXISTS gpGet_ObjectHistory_PricePlanItem_error (Integer, TVarChar);

CREATE OR REPLACE FUNCTION gpGet_ObjectHistory_PricePlanItem_error(
...
BEGIN
   ...
   vbUserId:= lpCheckRight (inSession, zc_Enum_Process_InsertUpdate_ObjectHistory_PricePlanItem()); -- zc_Enum_Process_InsertUpdate_OH_PricePlanItem_zero
