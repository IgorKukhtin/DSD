...
-- SELECT * FROM lpCheck_MovementItemReport ('12.11.2014', '12.11.2014') WHERE (Amount <> Amount_check) ORDER BY 2
-- SELECT * FROM lpCheck_MovementItemReport ('02.01.2015', '02.28.2015') WHERE (Amount <> Amount_check) ORDER BY 2
