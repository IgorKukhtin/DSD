...
BEGIN
     ...
     -- vbUserId:= lpCheckRight (inSession, zc_Enum_Process_Select_Movement_SendOnPrice());
     vbUserId:= inSession;
...
/*
BEGIN;
 SELECT * FROM gpSelect_Movement_SendOnPrice_Print (inMovementId := 135428, inSession:= '2');
COMMIT;
*/