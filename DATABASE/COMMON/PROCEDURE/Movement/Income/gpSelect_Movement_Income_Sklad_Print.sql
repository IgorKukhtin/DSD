-- Function: gpSelect_Movement_Income_Sklad_Print()

DROP FUNCTION IF EXISTS gpSelect_Movement_Income_Sklad_Print (Integer,  TVarChar);

CREATE OR REPLACE FUNCTION gpSelect_Movement_Income_Sklad_Print(
...
BEGIN
  ...
  , tmpMI AS (SELECT MovementItem.ObjectId AS GoodsId
       ...
       WHERE tmpMI.Amount <> 0 OR tmpMI.AmountPacker <> 0
...
-- тест
-- SELECT * FROM gpSelect_Movement_Income_Sklad_Print (inMovementId := 29953999, inSession:= '5'); -- FETCH ALL "<unnamed portal 10>";
