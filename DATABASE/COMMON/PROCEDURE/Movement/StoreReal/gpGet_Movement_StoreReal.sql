...
RETURNS TABLE (
  ...
  , TotalCountKg TFloat, TotalSummPVAT TFloat
)
AS
$BODY$
  ...
  ELSE
    RETURN QUERY
      SELECT
        ...
        , MS_GUID.ValueData                          AS GUID
        , MD_Insert.ValueData                        AS InsertDate 
      ...
      FROM Movement
        ...
        LEFT JOIN MovementString AS MS_GUID 
                                 ON MS_GUID.MovementId = Movement.Id
                                AND MS_GUID.DescId = zc_MovementString_GUID()
        ...
        LEFT JOIN Object AS Object_User ON Object_User.Id = MLO_Insert.ObjectId
