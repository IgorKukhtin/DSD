-- Function: gpMovement_PromoAdvertising_SetUnErased (Integer, TVarChar)

DROP FUNCTION IF EXISTS gpMovement_PromoAdvertising_SetUnErased (Integer, TVarChar);

CREATE OR REPLACE FUNCTION gpMovement_PromoAdvertising_SetUnErased(
...
ALTER FUNCTION gpMovement_PromoAdvertising_SetUnErased (Integer, TVarChar) OWNER TO postgres;
