-- Function: gpMovement_InfoMoney_SetUnErased (Integer, TVarChar)

DROP FUNCTION IF EXISTS gpMovement_InfoMoney_SetUnErased (Integer, TVarChar);

CREATE OR REPLACE FUNCTION gpMovement_InfoMoney_SetUnErased(
