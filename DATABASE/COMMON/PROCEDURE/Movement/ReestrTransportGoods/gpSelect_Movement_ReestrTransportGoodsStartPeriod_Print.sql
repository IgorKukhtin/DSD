-- Function: gpSelect_Movement_ReestrTransportGoodsStartPeriod_Print(tdatetime, tdatetime, boolean, tvarchar)

DROP FUNCTION IF EXISTS gpSelect_Movement_ReestrTransportGoodsStartPeriod_Print (TDateTime, TDateTime, Boolean, Integer, Integer, TVarChar);

CREATE OR REPLACE FUNCTION gpSelect_Movement_ReestrTransportGoodsStartPeriod_Print(
