     ...
     FROM 
          (SELECT SUM (tmpMI.OperCount_Master)  AS OperCount_Master
            ...
            FROM (SELECT MovementItem.ObjectId AS GoodsId
                       ...
                       , SUM (CASE WHEN Movement.DescId IN (zc_Movement_TransferDebtIn(), zc_Movement_TransferDebtOut())
                  ...
                  FROM Movement
                       INNER JOIN MovementItem ON MovementItem.MovementId = Movement.Id AND MovementItem.isErased = FALSE
