...
DROP FUNCTION IF EXISTS gpSelect_Movement_ProductionSeparate_Ceh_Print (Integer, TVarChar);
...
ALTER FUNCTION gpSelect_Movement_ProductionSeparate_Ceh_Print (Integer,TVarChar) OWNER TO postgres;
