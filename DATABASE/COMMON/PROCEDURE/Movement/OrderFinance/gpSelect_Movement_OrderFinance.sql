...
BEGIN
     ...
     WITH tmpStatus AS (SELECT zc_Enum_Status_Complete()   AS StatusId
       ...
       SELECT
         ...
         --, 'ФИО-1' :: TVarChar                AS UserMember_1
         --, 'ФИО-2' :: TVarChar                AS UserMember_2

           , MovementString_Comment.ValueData       AS Comment

           , Object_Insert.ValueData                AS InsertName
         --, 'ФИО' :: TVarChar                AS InsertName
       ...
       FROM (SELECT tmpMovement.*
            ...
            -- Ограничение прав
            LEFT JOIN tmp_OrderFinance_user ON tmp_OrderFinance_user.OrderFinanceId = MovementLinkObject_OrderFinance.ObjectId
