...
DROP FUNCTION IF EXISTS gpGet_Movement_OrderFinance_FileName_group (Integer, TVarChar);

CREATE OR REPLACE FUNCTION gpGet_Movement_OrderFinance_FileName_group(
...
-- тест
-- SELECT * FROM gpGet_Movement_OrderFinance_FileName_group (inMovementId:= 14022564, inSession:= zfCalc_UserAdmin()) -- zc_Enum_ExportKind_Mida35273055()
