-- Function: gpMovement_PromoSalePartner_SetErased (Integer, Integer, TVarChar)

DROP FUNCTION IF EXISTS gpMovement_PromoSalePartner_SetErased (Integer, TVarChar);

CREATE OR REPLACE FUNCTION gpMovement_PromoSalePartner_SetErased(
