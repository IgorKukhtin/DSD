...
-- тест
-- SELECT * FROM gpSelect_Movement_BankAccount_Personal (inStartDate:= '01.01.2015', inEndDate:= '01.01.2015', inBankAccountId:= 14462, inIsServiceDate:= FALSE, inIsErased:= FALSE, inSession:= zfCalc_UserAdmin())
