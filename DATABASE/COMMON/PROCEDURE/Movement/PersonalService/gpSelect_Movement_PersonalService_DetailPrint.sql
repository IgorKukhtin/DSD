       ...
       SELECT
           ...
           , (COALESCE (MovementFloat_TotalSummService.ValueData, 0)
            ...
            -- + COALESCE (MovementFloat_TotalSummSocialAdd.ValueData, 0)
              ...
              -- !!!временно!!!
           , (COALESCE (MovementFloat_TotalSummMinus.ValueData, 0) + COALESCE (MovementFloat_TotalSummFine.ValueData, 0)) ::TFloat AS TotalSummMinus
           , MovementFloat_TotalSummFine.ValueData           AS TotalSummFine
   ...
   , tmpMaster AS (SELECT tmpAll.MovementItemId                AS Id
            ...
            --            , tmpAll.SummSocialAdd        :: TFloat AS SummSocialAdd
                   ...
                   WHERE 0 <> tmpAll.SummToPay
                      ...
                      OR 0 <> tmpAll.SummService /*+ COALESCE (tmpMIContainer.SummNalog, 0)*/ + tmpAll.SummHoliday + tmpAll.SummHosp
...
--            , tmpAll.SummToPay        :: TFloat AS AmountToPay
            ...
            , tmpAll.SummService            :: TFloat AS SummService
              -- !!!временно!!!
            , (tmpAll.SummHoliday + tmpAll.SummHosp) :: TFloat AS SummHoliday
            , tmpAll.SummHosp               :: TFloat AS SummHosp
            , tmpAll.SummCard               :: TFloat AS SummCard
            , tmpAll.SummCardSecond         :: TFloat AS SummCardSecond
            , tmpAll.SummCardSecondCash     :: TFloat AS SummCardSecondCash
...
--            , tmpAll.SummCardRecalc       :: TFloat AS SummCardRecalc
              -- !!!временно!!!
            , (tmpAll.SummMinus + tmpAll.SummFine) :: TFloat AS SummMinus
            , tmpAll.SummFine               :: TFloat AS SummFine
...
--            , tmpAll.SummSocialAdd        :: TFloat AS SummSocialAdd
            ...
            , (tmpAll.SummService + COALESCE (tmpAll.SummAdd, 0) + COALESCE (tmpAll.SummNalogRet, 0)
                                  + COALESCE (tmpAll.SummHoliday, 0) + COALESCE (tmpAll.SummHosp, 0)
                                  - COALESCE (tmpAll.SummMinus, 0) - COALESCE (tmpAll.SummFine, 0) - COALESCE (tmpAll.SummNalog, 0)) :: TFloat AS TotalSumm
