...
DROP FUNCTION IF EXISTS gpSelect_Movement_PersonalServiceChoice (TDateTime, TDateTime, Boolean, TVarChar);
DROP FUNCTION IF EXISTS gpSelect_Movement_PersonalServiceChoice (TDateTime, TDateTime, Boolean, Integer, TVarChar);
...
BEGIN
     ...
     WITH tmpStatus AS (SELECT zc_Enum_Status_Complete()   AS StatusId
       ...
       FROM (SELECT Movement.id
            ...
            JOIN MovementLinkObject AS MovementLinkObject_PersonalServiceList
                                         ON MovementLinkObject_PersonalServiceList.MovementId = Movement.Id
                                        AND MovementLinkObject_PersonalServiceList.DescId = zc_MovementLinkObject_PersonalServiceList()
            JOIN Object AS Object_PersonalServiceList ON Object_PersonalServiceList.Id = MovementLinkObject_PersonalServiceList.ObjectId
...
--ALTER FUNCTION gpSelect_Movement_PersonalServiceChoice (TDateTime, TDateTime, Boolean, TVarChar) OWNER TO postgres;
...
-- тест
-- SELECT * FROM gpSelect_Movement_PersonalServiceChoice (inStartDate:= '30.01.2014', inEndDate:= '01.02.2015', inIsErased := FALSE, inSession:= '2')
