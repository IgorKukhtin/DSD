-- Function: gpselect_movement_ReestrReturnOutstartperiod_print(tdatetime, tdatetime, boolean, tvarchar)

DROP FUNCTION IF EXISTS gpSelect_Movement_ReestrReturnOutStartPeriod_Print (TDateTime, TDateTime, Integer, Integer, Integer, Boolean, Boolean, TVarChar);

CREATE OR REPLACE FUNCTION gpSelect_Movement_ReestrReturnOutStartPeriod_Print(
     ...
     OPEN Cursor2 FOR
       WITH 
               ...
               tmpMI AS (SELECT MovementItem.Id            AS MovementItemId
                         ...
                         WHERE Movement.DescId = zc_Movement_ReestrReturnOut() 
...
-- тест
-- SELECT * FROM gpSelect_Movement_ReestrReturnOutStartPeriod_Print(inStartDate := ('26.12.2016')::TDateTime , inEndDate := ('31.12.2016')::TDateTime , inPersonalId := 0 ,  inPersonalTradeId := 0, inReestrKindId := 640043  , inIsReestrKind := 'False' , inIsShowAll := 'True' ,  inSession := '5'); --FETCH ALL "<unnamed portal 37>";
