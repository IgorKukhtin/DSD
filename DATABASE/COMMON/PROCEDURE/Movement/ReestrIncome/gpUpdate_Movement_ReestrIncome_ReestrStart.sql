-- Function: gpUpdate_Movement_ReestrIncome_ReestrStart()

DROP FUNCTION  IF EXISTS gpUpdate_Movement_ReestrIncome_ReestrStart(TVarChar,TVarChar,TVarChar,TVarChar);

CREATE OR REPLACE FUNCTION gpUpdate_Movement_ReestrIncome_ReestrStart(
...
-- тест
--select * from gpUpdate_Movement_ReestrIncome_ReestrStart(ioId := 0 , inDriver := 'Демчик'  , inMember := 'Демчик' , inCar := '5115' ,  inSession := '5');
