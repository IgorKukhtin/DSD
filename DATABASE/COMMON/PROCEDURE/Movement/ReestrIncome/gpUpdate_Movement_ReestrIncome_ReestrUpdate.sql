-- Function: gpInsert_Object_ReestrIncomeUpdate()

DROP FUNCTION  IF EXISTS gpUpdate_Movement_ReestrIncome_ReestrUpdate(TVarChar,TVarChar);

CREATE OR REPLACE FUNCTION gpUpdate_Movement_ReestrIncome_ReestrUpdate(
...
-- тест
-- SELECT * FROM gpUpdate_Movement_ReestrIncome_ReestrUpdate()
--select * from gpUpdate_Movement_ReestrIncome_ReestrUpdate (inDriver := 'Демчик',  inSession := '5');
