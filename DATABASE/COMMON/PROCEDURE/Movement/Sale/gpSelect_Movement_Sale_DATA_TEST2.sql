...
and 1=0
            LEFT JOIN Object AS Object_PaidKind ON Object_PaidKind.Id = null -- MovementLinkObject_PaidKind.ObjectId and Object_PaidKind.DescId = zc_Object_PaidKind()
and 1=0
...
and 1=0
            LEFT JOIN Object AS Object_PriceList ON Object_PriceList.Id = null -- MovementLinkObject_PriceList.ObjectId
and 1=0
...
and 1=0
            LEFT JOIN Object AS Object_CurrencyDocument ON Object_CurrencyDocument.Id = null -- MovementLinkObject_CurrencyDocument.ObjectId
and 1=0
...
and 1=0
            LEFT JOIN Object AS Object_CurrencyPartner ON Object_CurrencyPartner.Id = null -- MovementLinkObject_CurrencyPartner.ObjectId
and 1=0
...
and 1=0
            LEFT JOIN Object AS Object_ReestrKind ON Object_ReestrKind.Id = null -- MovementLinkObject_ReestrKind.ObjectId
and 1=0
...
and 1=0
            ...
            LEFT JOIN Object AS Object_TaxKind_Master
                             ON Object_TaxKind_Master.Id = null -- MovementLinkObject_DocumentTaxKind_Master.ObjectId
...
and 1=0
            ...
            LEFT JOIN Object AS Object_RouteGroup ON Object_RouteGroup.Id = null -- COALESCE (ObjectLink_Route_RouteGroup.ChildObjectId, Object_Route.Id)
and 1=0
