...
BEGIN
     ...
     --             AND PrintForms_View.DescId = zc_Movement_Sale()
            ...
            LEFT JOIN PrintForms_View AS PrintForms_View_Default
                  ...
                  AND PrintForms_View_Default.PaidKindId = COALESCE (CASE WHEN MovementLinkObject_PaidKind.ObjectId IN (zc_Enum_PaidKind_FirstForm_kaz(), zc_Enum_PaidKind_FirstForm_eur()) THEN zc_Enum_PaidKind_FirstForm() ELSE MovementLinkObject_PaidKind.ObjectId END, zc_Enum_PaidKind_SecondForm())
