-- Function: gpSelect_Movement_WeighingPartner_protocol()

DROP FUNCTION IF EXISTS gpSelect_Movement_WeighingPartner_protocol (TDateTime, TDateTime, Boolean, Integer, TVarChar);

CREATE OR REPLACE FUNCTION gpSelect_Movement_WeighingPartner_protocol(
...
BEGIN
     ...
     /*WITH tmpUserAdmin AS (SELECT ObjectLink_UserRole_View.UserId FROM ObjectLink_UserRole_View WHERE RoleId = zc_Enum_Role_Admin() AND ObjectLink_UserRole_View.UserId = vbUserId)
       ...
       WITH tmpStatus AS (SELECT zc_Enum_Status_Complete() AS StatusId
        ...
        , tmpMLM_Parent AS (SELECT MovementLinkMovement.*
                            FROM MovementLinkMovement
                            WHERE MovementLinkMovement.MovementId IN (SELECT DISTINCT tmpMovement.ParentId FROM tmpMovement)
        ...
        , tmpMovementDate AS (SELECT *
                              ...
                              WHERE MovementDate.MovementId IN (SELECT DISTINCT tmpMovement.Id FROM tmpMovement)
                                AND MovementDate.DescId IN (zc_MovementDate_EndBegin()
        ...
        , tmpMovementFloat AS (SELECT *
                              ...
                              WHERE MovementFloat.MovementId IN (SELECT DISTINCT tmpMovement.Id FROM tmpMovement)
                                AND MovementFloat.DescId IN (zc_MovementFloat_BranchCode()
                                                           ...
                                                           , zc_MovementFloat_ChangePercentAmount()
        ...
        , tmpMovementBoolean AS (SELECT *
                                 ...
                                 WHERE MovementBoolean.MovementId IN (SELECT DISTINCT tmpMovement.Id FROM tmpMovement)
                                   AND MovementBoolean.DescId IN (zc_MovementBoolean_DocPartner()
                                                                , zc_MovementBoolean_List()
                                                                , zc_MovementBoolean_PriceWithVAT()
                                                                , zc_MovementBoolean_Reason1()
                                                                , zc_MovementBoolean_Reason2()
                                                                 )
                                 )
        ...
        , tmpMLO AS (SELECT *
                     ...
                     WHERE MovementLinkObject.MovementId IN (SELECT DISTINCT tmpMovement.Id FROM tmpMovement)
                       AND MovementLinkObject.DescId IN (zc_MovementLinkObject_Contract()
                                                       ...
                                                       , zc_MovementLinkObject_PersonalComplete1()
                                                       , zc_MovementLinkObject_PersonalComplete2()
                                                       , zc_MovementLinkObject_PersonalComplete3()
                                                       , zc_MovementLinkObject_PersonalComplete4()
                                                       , zc_MovementLinkObject_PersonalComplete5()
                                                       , zc_MovementLinkObject_PersonalComplete6()
                                                       , zc_MovementLinkObject_PersonalComplete7()
                                                       , zc_MovementLinkObject_PersonalComplete8()
                                                       , zc_MovementLinkObject_PersonalGroup()
                                                       , zc_MovementLinkObject_PersonalStick1()
                                                       , zc_MovementLinkObject_PositionComplete1()
                                                       , zc_MovementLinkObject_PositionComplete2()
                                                       , zc_MovementLinkObject_PositionComplete3()
                                                       , zc_MovementLinkObject_PositionComplete4()
                                                       , zc_MovementLinkObject_PositionComplete5()
                                                       , zc_MovementLinkObject_PositionComplete6()
                                                       , zc_MovementLinkObject_PositionComplete7()
                                                       , zc_MovementLinkObject_PositionComplete8()
                                                       , zc_MovementLinkObject_PositionStick1()
       ...
       SELECT  Movement.Id
             ...
             , COALESCE (Object_Member.ValueData, Object_PersonalDriver.ValueData) AS PersonalDriverName
       ...
       FROM tmpMovement AS Movement
            ...
            LEFT JOIN tmpMLM_Parent AS MovementLinkMovement_TransportGoods
            ...
            LEFT JOIN tmpMovementString AS MovementString_IP
            ...
            LEFT JOIN tmpMovementFloat AS MovementFloat_ChangePercentAmount
            ...
            LEFT JOIN tmpMLO AS MovementLinkObject_Personal1_Stick
            ...
            LEFT JOIN tmpMLO AS MovementLinkObject_Position1_Stick
            ...
            LEFT JOIN tmpMLO AS MovementLinkObject_Personal1
            ...
            LEFT JOIN tmpMLO AS MovementLinkObject_Personal2
            ...
            LEFT JOIN tmpMLO AS MovementLinkObject_Personal3
            ...
            LEFT JOIN tmpMLO AS MovementLinkObject_Personal4
            ...
            LEFT JOIN tmpMLO AS MovementLinkObject_Personal5
            ...
            LEFT JOIN tmpMLO AS MovementLinkObject_Personal6
            ...
            LEFT JOIN tmpMLO AS MovementLinkObject_Personal7
            ...
            LEFT JOIN tmpMLO AS MovementLinkObject_Personal8
            ...
            LEFT JOIN tmpMLO AS MovementLinkObject_Position1
            ...
            LEFT JOIN tmpMLO AS MovementLinkObject_Position2
            ...
            LEFT JOIN tmpMLO AS MovementLinkObject_Position3
            ...
            LEFT JOIN tmpMLO AS MovementLinkObject_Position4
            ...
            LEFT JOIN tmpMLO AS MovementLinkObject_Position5
            ...
            LEFT JOIN tmpMLO AS MovementLinkObject_Position6
            ...
            LEFT JOIN tmpMLO AS MovementLinkObject_Position7
            ...
            LEFT JOIN tmpMLO AS MovementLinkObject_Position8
            ...
            LEFT JOIN tmpMLM_Parent AS MovementLinkMovement_Tax
            ...
            LEFT JOIN tmpMLM AS MovementLinkMovement_ReturnIn
...
--
            ...
            LEFT JOIN tmpMLM_Parent AS MovementLinkMovement_Promo
...
-- тест
--   SELECT * FROM gpSelect_Movement_WeighingPartner_protocol (inStartDate:= '01.06.2025', inEndDate:= '01.06.2025', inJuridicalBasisId:= zc_Juridical_Basis(), inIsErased:= FALSE, inSession:= zfCalc_UserAdmin())

 --SELECT * FROM gpSelect_Movement_WeighingPartner_protocol (inStartDate:= '01.11.2025', inEndDate:= '01.11.2025', inJuridicalBasisId:= zc_Juridical_Basis(), inIsErased:= FALSE, inSession:= zfCalc_UserAdmin())
