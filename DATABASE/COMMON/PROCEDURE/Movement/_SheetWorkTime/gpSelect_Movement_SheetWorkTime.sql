-- Function: gpSelect_Movement_SheetWorkTime()

-- DROP FUNCTION gpSelect_Movement_SheetWorkTime (TDateTime, TDateTime, TVarChar);

CREATE OR REPLACE FUNCTION gpSelect_Movement_SheetWorkTime(
