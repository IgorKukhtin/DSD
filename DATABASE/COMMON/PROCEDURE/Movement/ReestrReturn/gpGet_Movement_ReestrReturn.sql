-- FunctiON: gpGet_Movement_ReestReturn (Integer, TVarChar)

DROP FUNCTION IF EXISTS gpGet_Movement_ReestrReturn (Integer, TVarChar);

CREATE OR REPLACE FUNCTION gpGet_Movement_ReestrReturn(
...
-- тест
-- SELECT * FROM gpGet_Movement_ReestReturn (inMovementId:= 0 ::integer,  inSession:= '5'::TVarChar)
--select * from gpGet_Movement_ReestrReturn(inMovementId := 0 ,  inSession := '5');
