...
--!           ||' control_date="' || '3'                               ||'"' -- Параметр, определяющий каким образом СУСК должна следить за сроками годности товара на складе:"0" – Не учитывать"1" – По сроку годности"2" – По дате окончания срока годности"3" – По дате производства и дате окончания срока годности.Значение по умолчанию: 0
