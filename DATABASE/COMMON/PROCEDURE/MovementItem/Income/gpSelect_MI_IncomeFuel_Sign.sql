...
-- тест
-- SELECT * FROM gpSelect_MI_IncomeFuel_Sign (inMovementId:= 4135607, inIsErased:= TRUE,  inSession:= zfCalc_UserAdmin())
-- SELECT * FROM gpSelect_MI_IncomeFuel_Sign (inMovementId:= 4135607, inIsErased:= FALSE, inSession:= zfCalc_UserAdmin())
