-- Function: gpSelect_MovementItem_BankStatement()

-- DROP FUNCTION gpSelect_MovementItem_BankStatement (Integer, Boolean, TVarChar);

CREATE OR REPLACE FUNCTION gpSelect_MovementItem_BankStatement(
...
BEGIN
     ...
     -- PERFORM lpCheckRight (inSession, zc_Enum_Process_Select_MovementItem_BankStatement());
...
ALTER FUNCTION gpSelect_MovementItem_BankStatement (Integer, Boolean, TVarChar) OWNER TO postgres;
...
-- тест
-- SELECT * FROM gpSelect_MovementItem_BankStatement (inMovementId:= 25173, inShowAll:= TRUE, inSession:= '2')
-- SELECT * FROM gpSelect_MovementItem_BankStatement (inMovementId:= 25173, inShowAll:= FALSE, inSession:= '2')
