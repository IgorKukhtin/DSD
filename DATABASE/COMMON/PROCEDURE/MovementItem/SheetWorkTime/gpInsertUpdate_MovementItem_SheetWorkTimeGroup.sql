...
BEGIN
    ...
    THEN
       ...
       PERFORM gpInsertUpdate_MovementItem_SheetWorkTime (inMemberId, inPositionId, inPositionLevelId, inUnitId, inPersonalGroupId, inStorageLineId, inOperDate, '0', NULL, FALSE, inSession); -- zc_Enum_WorkTimeKind_Work()
    ELSE
