-- Function: gpSelect_MI_ReestrReturnOut()

DROP FUNCTION IF EXISTS gpSelect_MI_ReestrReturnOut(Integer, Boolean, TVarChar);

CREATE OR REPLACE FUNCTION gpSelect_MI_ReestrReturnOut(
...
RETURNS TABLE  (Id Integer, LineNum Integer, MemberId Integer, MemberCode Integer, MemberName TVarChar, InsertDate TDateTime, isErased Boolean
              , MovementId_ReturnOut Integer, BarCode_ReturnOut TVarChar, InvNumber_ReturnOut TVarChar, OperDate_ReturnOut TDateTime, StatusCode_ReturnOut Integer, StatusName_ReturnOut TVarChar
              , Checked Boolean
...
BEGIN
     ...
     SELECT  tmp.MovementItemId                           AS Id
           ...
           , Movement_ReturnOut.Id                           AS MovementId_ReturnOut
           ...
           , Object_Status.ObjectCode                     AS StatusCode_ReturnOut
           , Object_Status.ValueData                      AS StatusName_ReturnOut
       ...
       FROM tmpMI AS tmp
            ...
            LEFT JOIN Movement AS Movement_ReturnOut  ON Movement_ReturnOut.Id = tmp.MovementId_ReturnOut
            LEFT JOIN Object AS Object_Status ON Object_Status.Id = Movement_ReturnOut.StatusId

            LEFT JOIN MovementBoolean AS MovementBoolean_Checked
                                      ON MovementBoolean_Checked.MovementId =  Movement_ReturnOut.Id
...
-- тест
-- SELECT * FROM gpSelect_MI_ReestrReturnOut (inMovementId:= 4353346, inIsErased:= True, inSession:= zfCalc_UserAdmin())
