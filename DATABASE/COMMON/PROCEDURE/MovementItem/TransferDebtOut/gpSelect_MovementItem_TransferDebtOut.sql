...
ALTER FUNCTION gpSelect_MovementItem_TransferDebtOut (Integer, Boolean, Boolean, TVarChar) OWNER TO postgres;
...
-- тест
--SELECT * FROM gpSelect_MovementItem_TransferDebtOut (inMovementId:= 4229, inShowAll:= True, inisErased:= True, inSession:= '2')
