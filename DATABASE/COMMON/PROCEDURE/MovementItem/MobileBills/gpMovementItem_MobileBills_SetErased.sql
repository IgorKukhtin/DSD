-- Function: gpMovementItem_MobileBills_SetErased (Integer, Integer, TVarChar)

DROP FUNCTION IF EXISTS gpMovementItem_MobileBills_SetErased (Integer, TVarChar);

CREATE OR REPLACE FUNCTION gpMovementItem_MobileBills_SetErased(
...
-- тест
-- SELECT * FROM gpMovementItem_MobileBills_SetErased (inMovementId:= 55, inJuridicalId = 1, inSession:= '2')
