...
DROP FUNCTION IF EXISTS gpGet_MI_WeighingProduction_Box (Integer, Boolean, Boolean, TVarChar);
     ...
     tmpBox AS (SELECT MAX (tmp.BoxId_1) AS BoxId_1, MAX (tmp.BoxName_1) AS BoxName_1
                ...
                FROM (
                      SELECT CASE WHEN spSelect.NPP = 1 THEN spSelect.Id ELSE 0 END    AS BoxId_1
                           ...
                           , CASE WHEN spSelect.NPP = 3 THEN spSelect.Name ELSE '' END AS BoxName_3
                           , CASE WHEN spSelect.NPP = 4 THEN spSelect.Id ELSE 0 END    AS BoxId_4
                           , CASE WHEN spSelect.NPP = 4 THEN spSelect.Name ELSE '' END AS BoxName_4
                           , CASE WHEN spSelect.NPP = 5 THEN spSelect.Id ELSE 0 END    AS BoxId_5
                           , CASE WHEN spSelect.NPP = 5 THEN spSelect.Name ELSE '' END AS BoxName_5
                           , CASE WHEN spSelect.NPP = 6 THEN spSelect.Id ELSE 0 END    AS BoxId_6
                           , CASE WHEN spSelect.NPP = 6 THEN spSelect.Name ELSE '' END AS BoxName_6
                           , CASE WHEN spSelect.NPP = 7 THEN spSelect.Id ELSE 0 END    AS BoxId_7
                           , CASE WHEN spSelect.NPP = 7 THEN spSelect.Name ELSE '' END AS BoxName_7
                           , CASE WHEN spSelect.NPP = 8 THEN spSelect.Id ELSE 0 END    AS BoxId_8
                           , CASE WHEN spSelect.NPP = 8 THEN spSelect.Name ELSE '' END AS BoxName_8
                           , CASE WHEN spSelect.NPP = 9 THEN spSelect.Id ELSE 0 END    AS BoxId_9
                           , CASE WHEN spSelect.NPP = 9 THEN spSelect.Name ELSE '' END AS BoxName_9
                           , CASE WHEN spSelect.NPP = 10 THEN spSelect.Id ELSE 0 END    AS BoxId_10
                           , CASE WHEN spSelect.NPP = 10 THEN spSelect.Name ELSE '' END AS BoxName_10
       ...
       SELECT
          ...
          /* , CASE WHEN tmpBox.BoxId_1 = MILinkObject_Box1.ObjectId THEN Object_Box1.Id
                  WHEN tmpBox.BoxId_1 = MILinkObject_Box2.ObjectId THEN Object_Box2.Id
                  WHEN tmpBox.BoxId_1 = MILinkObject_Box3.ObjectId THEN Object_Box3.Id
                  WHEN tmpBox.BoxId_1 = MILinkObject_Box4.ObjectId THEN Object_Box4.Id
                  WHEN tmpBox.BoxId_1 = MILinkObject_Box5.ObjectId THEN Object_Box5.Id
             END   ::Integer AS BoxId_1
           , CASE WHEN tmpBox.BoxId_2 = MILinkObject_Box1.ObjectId THEN Object_Box1.Id
                  WHEN tmpBox.BoxId_2 = MILinkObject_Box2.ObjectId THEN Object_Box2.Id
                  WHEN tmpBox.BoxId_2 = MILinkObject_Box3.ObjectId THEN Object_Box3.Id
                  WHEN tmpBox.BoxId_2 = MILinkObject_Box4.ObjectId THEN Object_Box4.Id
                  WHEN tmpBox.BoxId_2 = MILinkObject_Box5.ObjectId THEN Object_Box5.Id
             END   ::Integer AS BoxId_2
           , CASE WHEN tmpBox.BoxId_3 = MILinkObject_Box1.ObjectId THEN Object_Box1.Id
                  WHEN tmpBox.BoxId_3 = MILinkObject_Box2.ObjectId THEN Object_Box2.Id
                  WHEN tmpBox.BoxId_3 = MILinkObject_Box3.ObjectId THEN Object_Box3.Id
                  WHEN tmpBox.BoxId_3 = MILinkObject_Box4.ObjectId THEN Object_Box4.Id
                  WHEN tmpBox.BoxId_3 = MILinkObject_Box5.ObjectId THEN Object_Box5.Id
             END   ::Integer AS BoxId_3
           , CASE WHEN tmpBox.BoxId_4 = MILinkObject_Box1.ObjectId THEN Object_Box1.Id
                  WHEN tmpBox.BoxId_4 = MILinkObject_Box2.ObjectId THEN Object_Box2.Id
                  WHEN tmpBox.BoxId_4 = MILinkObject_Box3.ObjectId THEN Object_Box3.Id
                  WHEN tmpBox.BoxId_4 = MILinkObject_Box4.ObjectId THEN Object_Box4.Id
                  WHEN tmpBox.BoxId_4 = MILinkObject_Box5.ObjectId THEN Object_Box5.Id
             END   ::Integer AS BoxId_4
           , CASE WHEN tmpBox.BoxId_5 = MILinkObject_Box1.ObjectId THEN Object_Box1.Id
                  WHEN tmpBox.BoxId_5 = MILinkObject_Box2.ObjectId THEN Object_Box2.Id
                  WHEN tmpBox.BoxId_5 = MILinkObject_Box3.ObjectId THEN Object_Box3.Id
                  WHEN tmpBox.BoxId_5 = MILinkObject_Box4.ObjectId THEN Object_Box4.Id
                  WHEN tmpBox.BoxId_5 = MILinkObject_Box5.ObjectId THEN Object_Box5.Id
             END   ::Integer AS BoxId_5
           , CASE WHEN tmpBox.BoxId_6 = MILinkObject_Box1.ObjectId THEN Object_Box1.Id
                  WHEN tmpBox.BoxId_6 = MILinkObject_Box2.ObjectId THEN Object_Box2.Id
                  WHEN tmpBox.BoxId_6 = MILinkObject_Box3.ObjectId THEN Object_Box3.Id
                  WHEN tmpBox.BoxId_6 = MILinkObject_Box4.ObjectId THEN Object_Box4.Id
                  WHEN tmpBox.BoxId_6 = MILinkObject_Box5.ObjectId THEN Object_Box5.Id
             END   ::Integer AS BoxId_6
           , CASE WHEN tmpBox.BoxId_7 = MILinkObject_Box1.ObjectId THEN Object_Box1.Id
                  WHEN tmpBox.BoxId_7 = MILinkObject_Box2.ObjectId THEN Object_Box2.Id
                  WHEN tmpBox.BoxId_7 = MILinkObject_Box3.ObjectId THEN Object_Box3.Id
                  WHEN tmpBox.BoxId_7 = MILinkObject_Box4.ObjectId THEN Object_Box4.Id
                  WHEN tmpBox.BoxId_7 = MILinkObject_Box5.ObjectId THEN Object_Box5.Id
             END   ::Integer AS BoxId_7
           , CASE WHEN tmpBox.BoxId_8 = MILinkObject_Box1.ObjectId THEN Object_Box1.Id
                  WHEN tmpBox.BoxId_8 = MILinkObject_Box2.ObjectId THEN Object_Box2.Id
                  WHEN tmpBox.BoxId_8 = MILinkObject_Box3.ObjectId THEN Object_Box3.Id
                  WHEN tmpBox.BoxId_8 = MILinkObject_Box4.ObjectId THEN Object_Box4.Id
                  WHEN tmpBox.BoxId_8 = MILinkObject_Box5.ObjectId THEN Object_Box5.Id
             END   ::Integer AS BoxId_8
           , CASE WHEN tmpBox.BoxId_9 = MILinkObject_Box1.ObjectId THEN Object_Box1.Id
                  WHEN tmpBox.BoxId_9 = MILinkObject_Box2.ObjectId THEN Object_Box2.Id
                  WHEN tmpBox.BoxId_9 = MILinkObject_Box3.ObjectId THEN Object_Box3.Id
                  WHEN tmpBox.BoxId_9 = MILinkObject_Box4.ObjectId THEN Object_Box4.Id
                  WHEN tmpBox.BoxId_9 = MILinkObject_Box5.ObjectId THEN Object_Box5.Id
             END   ::Integer AS BoxId_9
           , CASE WHEN tmpBox.BoxId_10 = MILinkObject_Box1.ObjectId THEN Object_Box1.Id
                  WHEN tmpBox.BoxId_10 = MILinkObject_Box2.ObjectId THEN Object_Box2.Id
                  WHEN tmpBox.BoxId_10 = MILinkObject_Box3.ObjectId THEN Object_Box3.Id
                  WHEN tmpBox.BoxId_10 = MILinkObject_Box4.ObjectId THEN Object_Box4.Id
                  WHEN tmpBox.BoxId_10 = MILinkObject_Box5.ObjectId THEN Object_Box5.Id
             END   ::Integer AS BoxId_10

           , CASE WHEN tmpBox.BoxId_1 = MILinkObject_Box1.ObjectId THEN Object_Box1.ValueData
                  WHEN tmpBox.BoxId_1 = MILinkObject_Box2.ObjectId THEN Object_Box2.ValueData
                  WHEN tmpBox.BoxId_1 = MILinkObject_Box3.ObjectId THEN Object_Box3.ValueData
                  WHEN tmpBox.BoxId_1 = MILinkObject_Box4.ObjectId THEN Object_Box4.ValueData
                  WHEN tmpBox.BoxId_1 = MILinkObject_Box5.ObjectId THEN Object_Box5.ValueData
             END   ::TVarChar AS BoxName_1
           , CASE WHEN tmpBox.BoxId_2 = MILinkObject_Box1.ObjectId THEN Object_Box1.ValueData
                  WHEN tmpBox.BoxId_2 = MILinkObject_Box2.ObjectId THEN Object_Box2.ValueData
                  WHEN tmpBox.BoxId_2 = MILinkObject_Box3.ObjectId THEN Object_Box3.ValueData
                  WHEN tmpBox.BoxId_2 = MILinkObject_Box4.ObjectId THEN Object_Box4.ValueData
                  WHEN tmpBox.BoxId_2 = MILinkObject_Box5.ObjectId THEN Object_Box5.ValueData
             END   ::TVarChar AS BoxName_2
           , CASE WHEN tmpBox.BoxId_3 = MILinkObject_Box1.ObjectId THEN Object_Box1.ValueData
                  WHEN tmpBox.BoxId_3 = MILinkObject_Box2.ObjectId THEN Object_Box2.ValueData
                  WHEN tmpBox.BoxId_3 = MILinkObject_Box3.ObjectId THEN Object_Box3.ValueData
                  WHEN tmpBox.BoxId_3 = MILinkObject_Box4.ObjectId THEN Object_Box4.ValueData
                  WHEN tmpBox.BoxId_3 = MILinkObject_Box5.ObjectId THEN Object_Box5.ValueData
             END   ::TVarChar AS BoxName_3
           , CASE WHEN tmpBox.BoxId_4 = MILinkObject_Box1.ObjectId THEN Object_Box1.ValueData
                  WHEN tmpBox.BoxId_4 = MILinkObject_Box2.ObjectId THEN Object_Box2.ValueData
                  WHEN tmpBox.BoxId_4 = MILinkObject_Box3.ObjectId THEN Object_Box3.ValueData
                  WHEN tmpBox.BoxId_4 = MILinkObject_Box4.ObjectId THEN Object_Box4.ValueData
                  WHEN tmpBox.BoxId_4 = MILinkObject_Box5.ObjectId THEN Object_Box5.ValueData
             END   ::TVarChar AS BoxName_4
           , CASE WHEN tmpBox.BoxId_5 = MILinkObject_Box1.ObjectId THEN Object_Box1.ValueData
                  WHEN tmpBox.BoxId_5 = MILinkObject_Box2.ObjectId THEN Object_Box2.ValueData
                  WHEN tmpBox.BoxId_5 = MILinkObject_Box3.ObjectId THEN Object_Box3.ValueData
                  WHEN tmpBox.BoxId_5 = MILinkObject_Box4.ObjectId THEN Object_Box4.ValueData
                  WHEN tmpBox.BoxId_5 = MILinkObject_Box5.ObjectId THEN Object_Box5.ValueData
             END   ::TVarChar AS BoxName_5
           , CASE WHEN tmpBox.BoxId_6 = MILinkObject_Box1.ObjectId THEN Object_Box1.ValueData
                  WHEN tmpBox.BoxId_6 = MILinkObject_Box2.ObjectId THEN Object_Box2.ValueData
                  WHEN tmpBox.BoxId_6 = MILinkObject_Box3.ObjectId THEN Object_Box3.ValueData
                  WHEN tmpBox.BoxId_6 = MILinkObject_Box4.ObjectId THEN Object_Box4.ValueData
                  WHEN tmpBox.BoxId_6 = MILinkObject_Box5.ObjectId THEN Object_Box5.ValueData
             END   ::TVarChar AS BoxName_6
           , CASE WHEN tmpBox.BoxId_7 = MILinkObject_Box1.ObjectId THEN Object_Box1.ValueData
                  WHEN tmpBox.BoxId_7 = MILinkObject_Box2.ObjectId THEN Object_Box2.ValueData
                  WHEN tmpBox.BoxId_7 = MILinkObject_Box3.ObjectId THEN Object_Box3.ValueData
                  WHEN tmpBox.BoxId_7 = MILinkObject_Box4.ObjectId THEN Object_Box4.ValueData
                  WHEN tmpBox.BoxId_7 = MILinkObject_Box5.ObjectId THEN Object_Box5.ValueData
             END   ::TVarChar AS BoxName_7
           , CASE WHEN tmpBox.BoxId_8 = MILinkObject_Box1.ObjectId THEN Object_Box1.ValueData
                  WHEN tmpBox.BoxId_8 = MILinkObject_Box2.ObjectId THEN Object_Box2.ValueData
                  WHEN tmpBox.BoxId_8 = MILinkObject_Box3.ObjectId THEN Object_Box3.ValueData
                  WHEN tmpBox.BoxId_8 = MILinkObject_Box4.ObjectId THEN Object_Box4.ValueData
                  WHEN tmpBox.BoxId_8 = MILinkObject_Box5.ObjectId THEN Object_Box5.ValueData
             END   ::TVarChar AS BoxName_8
           , CASE WHEN tmpBox.BoxId_9 = MILinkObject_Box1.ObjectId THEN Object_Box1.ValueData
                  WHEN tmpBox.BoxId_9 = MILinkObject_Box2.ObjectId THEN Object_Box2.ValueData
                  WHEN tmpBox.BoxId_9 = MILinkObject_Box3.ObjectId THEN Object_Box3.ValueData
                  WHEN tmpBox.BoxId_9 = MILinkObject_Box4.ObjectId THEN Object_Box4.ValueData
                  WHEN tmpBox.BoxId_9 = MILinkObject_Box5.ObjectId THEN Object_Box5.ValueData
             END   ::TVarChar AS BoxName_9
           , CASE WHEN tmpBox.BoxId_10 = MILinkObject_Box1.ObjectId THEN Object_Box1.ValueData
                  WHEN tmpBox.BoxId_10 = MILinkObject_Box2.ObjectId THEN Object_Box2.ValueData
                  WHEN tmpBox.BoxId_10 = MILinkObject_Box3.ObjectId THEN Object_Box3.ValueData
                  WHEN tmpBox.BoxId_10 = MILinkObject_Box4.ObjectId THEN Object_Box4.ValueData
                  WHEN tmpBox.BoxId_10 = MILinkObject_Box5.ObjectId THEN Object_Box5.ValueData
             END   ::TVarChar AS BoxName_10
           */             
       FROM MovementItem
