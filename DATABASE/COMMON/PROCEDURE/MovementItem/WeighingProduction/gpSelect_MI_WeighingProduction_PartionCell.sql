 -- Function: gpSelect_MI_WeighingProduction_PartionCell()

DROP FUNCTION IF EXISTS gpSelect_MI_WeighingProduction_PartionCell (Integer, Boolean, TVarChar);

CREATE OR REPLACE FUNCTION gpSelect_MI_WeighingProduction_PartionCell(
...
BEGIN
     ...
     -- vbUserId := PERFORM lpCheckRight (inSession, zc_Enum_Process_Select_MovementItem_WeighingProduction());
...
-- тест
-- SELECT * FROM gpSelect_MI_WeighingProduction_PartionCell (inMovementId:= 25173, inIsErased:= FALSE, inSession:= '9818')
