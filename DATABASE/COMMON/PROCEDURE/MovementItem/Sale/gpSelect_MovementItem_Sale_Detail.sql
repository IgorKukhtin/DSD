-- Function: gpSelect_MovementItem_Sale_Detail()

DROP FUNCTION IF EXISTS gpSelect_MovementItem_Sale_Detail (Integer, Boolean, TVarChar);

CREATE OR REPLACE FUNCTION gpSelect_MovementItem_Sale_Detail(
...
-- тест
-- SELECT * FROM gpSelect_MovementItem_Sale_Detail (inMovementId:= 20155651 ,  inIsErased:= FALSE, inSession:= '9818')     --34384969 
