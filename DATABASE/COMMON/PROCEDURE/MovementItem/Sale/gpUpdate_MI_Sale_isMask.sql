-- Function: gpUpdate_MI_Sale_isMask()

DROP FUNCTION IF EXISTS gpUpdate_MI_Sale_isMask (Integer, Integer, TVarChar);


CREATE OR REPLACE FUNCTION gpUpdate_MI_Sale_isMask(
...
BEGIN
     ...
     --cохраняем                  
     PERFORM lpInsertUpdate_MovementItem_Sale (ioId                 := COALESCE (tmpMI.MovementItemId,0) ::Integer
                                             ...
                                             , inAmountChangePercent:= 0     ::TFloat
