...
-- тест
-- SELECT * FROM gpSelect_MovementItem_Sale_Commerc (inMovementId:= 4229, inPriceListId:=0, inOperDate:= CURRENT_TIMESTAMP, inShowAll:= TRUE, inisErased:= True, inSession:= '2')
