...
CREATE OR REPLACE FUNCTION gpUpdateMI_OrderInternal_AmountNextSecond_to(
...
BEGIN
    ...
    THEN
        -- сохранили
        PERFORM lpInsertUpdate_MovementItemFloat (zc_MIFloat_AmountNextSecond(),  inId, inAmount);
...
-- тест
-- SELECT * FROM gpUpdateMI_OrderInternal_AmountNextSecond_to (inMovementId:= 7343799, inOperDate:= '31.10.2017', inSession:= zfCalc_UserAdmin());
