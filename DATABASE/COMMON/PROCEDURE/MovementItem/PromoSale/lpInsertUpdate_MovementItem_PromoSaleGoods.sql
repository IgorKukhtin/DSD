-- Function: lpInsertUpdate_MovementItem_PromoSaleGoods()

DROP FUNCTION IF EXISTS lpInsertUpdate_MovementItem_PromoSaleGoods (Integer, Integer, Integer, TFloat, TFloat, TFloat, TFloat, TFloat, TFloat, TFloat, TFloat, TFloat, Integer, Integer, TVarChar, Integer);

CREATE OR REPLACE FUNCTION lpInsertUpdate_MovementItem_PromoSaleGoods(
