...
ALTER FUNCTION gpSelect_MovementItem_StoreReal (Integer, Integer, TDateTime, Boolean, Boolean, TVarChar) OWNER TO postgres;
...
-- тест
-- SELECT * FROM gpSelect_MovementItem_StoreReal (inMovementId:= 25173, inPriceListId:= zc_PriceList_Basis(), inOperDate:= CURRENT_TIMESTAMP, inShowAll:= TRUE, inIsErased:= TRUE, inSession:= zfCalc_UserAdmin())
-- SELECT * FROM gpSelect_MovementItem_StoreReal (inMovementId:= 25173, inPriceListId:= zc_PriceList_Basis(), inOperDate:= CURRENT_TIMESTAMP, inShowAll:= FALSE, inIsErased:= TRUE, inSession:= zfCalc_UserAdmin())
