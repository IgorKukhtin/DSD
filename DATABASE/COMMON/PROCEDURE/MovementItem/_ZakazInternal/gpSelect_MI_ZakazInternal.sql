-- Function: gpSelect_MovementItem_ZakazInternal()

-- DROP FUNCTION gpSelect_MovementItem_ZakazInternal (Integer, Boolean, TVarChar);

CREATE OR REPLACE FUNCTION gpSelect_MovementItem_ZakazInternal(
...
ALTER FUNCTION gpSelect_MovementItem_ZakazInternal (Integer, Boolean, TVarChar) OWNER TO postgres;
...
-- тест
-- SELECT * FROM gpSelect_MovementItem_ZakazInternal (inMovementId:= 25173, inShowAll:= TRUE, inSession:= '2')
-- SELECT * FROM gpSelect_MovementItem_ZakazInternal (inMovementId:= 25173, inShowAll:= FALSE, inSession:= '2')
