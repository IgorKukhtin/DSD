...
DROP FUNCTION IF EXISTS lpInsertUpdate_MI_SaleCommerc_Child (Integer, Integer, Integer, Integer, Integer, TFloat, TFloat, TFloat, TFloat, TFloat, TFloat, TFloat, Integer);


CREATE OR REPLACE FUNCTION lpInsertUpdate_MI_SaleCommerc_Child(
