...
-- DROP FUNCTION gpInsertUpdate_MovementItem_ReturnOut();
...
BEGIN
     ...
     -- PERFORM lpCheckRight (inSession, zc_Enum_Process_InsertUpdate_MovementItem_ReturnOut());
     vbUserId := inSession;
...
-- тест
-- SELECT * FROM gpInsertUpdate_MovementItem_ReturnOut (ioId:= 0, inMovementId:= 10, inGoodsId:= 1, inAmount:= 0, inAmountPartner:= 0, inPrice:= 1, inCountForPrice:= 1, inLiveWeight:= 0, inHeadCount:= 0, inPartionGoods:= '', inGoodsKindId:= 0, inSession:= '2')
