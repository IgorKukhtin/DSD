...
BEGIN
    ...
    INTO vbPersonalId, vbMemberId, vbisMain, vbPositionId, vbUnitId, vbPersonalServiceListId 
     FROM (WITH tmpPersonal AS (SELECT ObjectLink_Personal_Member.ObjectId      AS PersonalId
           ...
           FROM tmpPersonal
                LEFT JOIN ObjectLink AS ObjectLink_Personal_Position
                                     ON ObjectLink_Personal_Position.ObjectId = tmpPersonal.PersonalId
     ...
     PERFORM lpInsertUpdate_MovementItem_PersonalService (ioId                 := gpSelect.Id
       ...
       FROM (WITH
            ...
            */
          SELECT COALESCE (tmpMI.Id,0)                                   ::Integer AS Id
          ...
          FROM (SELECT vbPersonalId AS PersonalId
                     , vbMemberId   AS MemberId
                     , vbisMain     AS isMain
                     , vbPositionId AS PositionId
                     , vbUnitId     AS UnitId
