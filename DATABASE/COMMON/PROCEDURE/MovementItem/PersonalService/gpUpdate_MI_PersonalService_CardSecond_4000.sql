...
--рабочая
DROP FUNCTION IF EXISTS gpUpdate_MI_PersonalService_CardSecond_4000 (Integer, TVarChar);

CREATE OR REPLACE FUNCTION gpUpdate_MI_PersonalService_CardSecond_4000(
...
-- тест
-- SELECT * FROM gpUpdate_MI_PersonalService_CardSecond_4000 (inMovementId:= 12977959, inSession:= zfCalc_UserAdmin())
