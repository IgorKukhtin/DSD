-- Function: gpUpdateMIChild_OrderExternal_Amount_report()

DROP FUNCTION IF EXISTS gpUpdateMIChild_OrderExternal_Amount_report (TDateTime, TDateTime, Integer, Integer, Integer, Integer, TVarChar);

CREATE OR REPLACE FUNCTION gpUpdateMIChild_OrderExternal_Amount_report(
...
BEGIN
     ...
     ---
     PERFORM gpUpdateMIChild_OrderExternal_Amount (tmp.Id, inSession)
