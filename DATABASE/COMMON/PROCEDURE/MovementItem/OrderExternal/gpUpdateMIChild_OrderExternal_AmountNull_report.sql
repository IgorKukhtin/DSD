-- Function: gpUpdateMIChild_OrderExternal_AmountNull_report()

DROP FUNCTION IF EXISTS gpUpdateMIChild_OrderExternal_AmountNull_report (TDateTime, TDateTime, Integer, Integer, Integer, Integer, TVarChar);

CREATE OR REPLACE FUNCTION gpUpdateMIChild_OrderExternal_AmountNull_report(
