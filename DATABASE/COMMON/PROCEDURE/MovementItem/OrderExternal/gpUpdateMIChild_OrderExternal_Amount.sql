...
--return;
     ...
     -- данные из документа 
      ...
      WHERE Movement.Id = inMovementId;
       ...
       -- Результат
       CREATE TEMP TABLE tmpMIChild (GoodsId Integer, GoodsKindId Integer
   ...
   WITH tmpPartner AS (SELECT Object.Id AS PartnerId
      ...
      INSERT INTO tmpMI  (GoodsId, GoodsKindId, Amount, AmountSecond
                           ...
                           SELECT  MovementItem.ObjectId                         AS GoodsId
                                 ...
                                 , SUM( COALESCE (MIFloat_AmountSecond.ValueData,0))     :: TFloat       AS AmountSecond
                            FROM MovementItem 
 ...
 ;
   ...
   -- сохранили
   PERFORM lpInsertUpdate_MI_OrderExternal_Child (ioId                 := 0 :: integer
