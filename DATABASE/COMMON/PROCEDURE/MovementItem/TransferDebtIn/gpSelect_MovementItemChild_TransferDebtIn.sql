-- Function: gpSelect_MovementItemChild_TransferDebtIn()

DROP FUNCTION IF EXISTS gpSelect_MovementItemChild_TransferDebtIn (Integer, Boolean, TVarChar);

CREATE OR REPLACE FUNCTION gpSelect_MovementItemChild_TransferDebtIn(
...
ALTER FUNCTION gpSelect_MovementItemChild_TransferDebtIn (Integer, Boolean, TVarChar) OWNER TO postgres;
...
-- SELECT * FROM gpSelect_MovementItemChild_TransferDebtIn (inMovementId:= 3662505 ::Integer , inisErased := 'False'::Boolean , inSession := '5'::TVarChar);
