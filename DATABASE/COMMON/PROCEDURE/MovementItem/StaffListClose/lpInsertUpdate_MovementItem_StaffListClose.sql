-- Function: lpInsertUpdate_MovementItem_StaffListClose()

DROP FUNCTION IF EXISTS lpInsertUpdate_MovementItem_StaffListClose (Integer, Integer, Integer, TFloat, Integer);

CREATE OR REPLACE FUNCTION lpInsertUpdate_MovementItem_StaffListClose(
