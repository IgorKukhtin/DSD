...
BEGIN
     ...
     WITH
      ...
      , tmpCell AS (SELECT DISTINCT
                          ROW_NUMBER() OVER (PARTITION BY tmp.MovementItemId, tmp.GoodsId, tmp.GoodsKindName ORDER BY tmp.OperDate ASC) AS Ord
                        , 1 AS CellNum
                        , tmp.GoodsId, tmp.GoodsName, tmp.GoodsKindName
             ...
             UNION SELECT DISTINCT ROW_NUMBER() OVER (PARTITION BY tmp.MovementItemId, tmp.GoodsId, tmp.GoodsKindName ORDER BY tmp.OperDate ASC) AS Ord
                        , 2 AS CellNum, tmp.GoodsId, tmp.GoodsName, tmp.GoodsKindName, CASE WHEN COALESCE (tmp.PartionCell_2, '') = '' OR COALESCE (tmp.PartionCell_2, '') = '"NULL"' THEN '' ELSE tmp.PartionCell_2 END AS PartionCellName,  tmp.OperDate, tmp.MovementItemId, tmp.UserId
                        , tmp.MovementId, tmp.InvNumber_full, tmp.PartionGoodsDate FROM tmpProtocol_All AS tmp
             UNION SELECT DISTINCT ROW_NUMBER() OVER (PARTITION BY tmp.MovementItemId, tmp.GoodsId, tmp.GoodsKindName ORDER BY tmp.OperDate ASC) AS Ord
                        , 3 AS CellNum, tmp.GoodsId, tmp.GoodsName, tmp.GoodsKindName, CASE WHEN COALESCE (tmp.PartionCell_3, '') = '' OR COALESCE (tmp.PartionCell_3, '') = '"NULL"' THEN '' ELSE tmp.PartionCell_3 END AS PartionCellName,tmp.OperDate, tmp.MovementItemId, tmp.UserId
                        , tmp.MovementId, tmp.InvNumber_full, tmp.PartionGoodsDate FROM tmpProtocol_All AS tmp
             UNION SELECT DISTINCT ROW_NUMBER() OVER (PARTITION BY tmp.MovementItemId, tmp.GoodsId, tmp.GoodsKindName ORDER BY tmp.OperDate ASC) AS Ord
                        , 4 AS CellNum, tmp.GoodsId, tmp.GoodsName, tmp.GoodsKindName, CASE WHEN COALESCE (tmp.PartionCell_4, '') = '' OR COALESCE (tmp.PartionCell_4, '') = '"NULL"' THEN '' ELSE tmp.PartionCell_4 END AS PartionCellName,  tmp.OperDate, tmp.MovementItemId, tmp.UserId
                        , tmp.MovementId, tmp.InvNumber_full, tmp.PartionGoodsDate FROM tmpProtocol_All AS tmp
             UNION SELECT DISTINCT ROW_NUMBER() OVER (PARTITION BY tmp.MovementItemId, tmp.GoodsId, tmp.GoodsKindName ORDER BY tmp.OperDate ASC) AS Ord
                        , 5 AS CellNum, tmp.GoodsId, tmp.GoodsName, tmp.GoodsKindName, CASE WHEN COALESCE (tmp.PartionCell_5, '') = '' OR COALESCE (tmp.PartionCell_5, '') = '"NULL"' THEN '' ELSE tmp.PartionCell_5 END AS PartionCellName,  tmp.OperDate, tmp.MovementItemId, tmp.UserId
                        , tmp.MovementId, tmp.InvNumber_full, tmp.PartionGoodsDate FROM tmpProtocol_All AS tmp
             UNION SELECT DISTINCT ROW_NUMBER() OVER (PARTITION BY tmp.MovementItemId, tmp.GoodsId, tmp.GoodsKindName ORDER BY tmp.OperDate ASC) AS Ord
                        , 6 AS CellNum, tmp.GoodsId, tmp.GoodsName, tmp.GoodsKindName, CASE WHEN COALESCE (tmp.PartionCell_6, '') = '' OR COALESCE (tmp.PartionCell_6, '') = '"NULL"' THEN '' ELSE tmp.PartionCell_6 END AS PartionCellName,  tmp.OperDate, tmp.MovementItemId, tmp.UserId
                        , tmp.MovementId, tmp.InvNumber_full, tmp.PartionGoodsDate FROM tmpProtocol_All AS tmp
             UNION SELECT DISTINCT ROW_NUMBER() OVER (PARTITION BY tmp.MovementItemId, tmp.GoodsId, tmp.GoodsKindName ORDER BY tmp.OperDate ASC) AS Ord
                        , 7 AS CellNum, tmp.GoodsId, tmp.GoodsName, tmp.GoodsKindName, CASE WHEN COALESCE (tmp.PartionCell_7, '') = '' OR COALESCE (tmp.PartionCell_7, '') = '"NULL"' THEN '' ELSE tmp.PartionCell_7 END AS PartionCellName,  tmp.OperDate, tmp.MovementItemId, tmp.UserId
                        , tmp.MovementId, tmp.InvNumber_full, tmp.PartionGoodsDate FROM tmpProtocol_All AS tmp
             UNION SELECT DISTINCT ROW_NUMBER() OVER (PARTITION BY tmp.MovementItemId, tmp.GoodsId, tmp.GoodsKindName ORDER BY tmp.OperDate ASC) AS Ord
                        , 8 AS CellNum, tmp.GoodsId, tmp.GoodsName, tmp.GoodsKindName, CASE WHEN COALESCE (tmp.PartionCell_8, '') = '' OR COALESCE (tmp.PartionCell_8, '') = '"NULL"' THEN '' ELSE tmp.PartionCell_8 END AS PartionCellName,  tmp.OperDate, tmp.MovementItemId, tmp.UserId
                        , tmp.MovementId, tmp.InvNumber_full, tmp.PartionGoodsDate FROM tmpProtocol_All AS tmp
             UNION SELECT DISTINCT ROW_NUMBER() OVER (PARTITION BY tmp.MovementItemId, tmp.GoodsId, tmp.GoodsKindName ORDER BY tmp.OperDate ASC) AS Ord
                        , 9 AS CellNum, tmp.GoodsId, tmp.GoodsName, tmp.GoodsKindName, CASE WHEN COALESCE (tmp.PartionCell_9, '') = '' OR COALESCE (tmp.PartionCell_9, '') = '"NULL"' THEN '' ELSE tmp.PartionCell_9 END AS PartionCellName,  tmp.OperDate, tmp.MovementItemId, tmp.UserId
                        , tmp.MovementId, tmp.InvNumber_full, tmp.PartionGoodsDate FROM tmpProtocol_All AS tmp
             UNION SELECT DISTINCT ROW_NUMBER() OVER (PARTITION BY tmp.MovementItemId, tmp.GoodsId, tmp.GoodsKindName ORDER BY tmp.OperDate ASC) AS Ord
                        , 10 AS CellNum, tmp.GoodsId, tmp.GoodsName, tmp.GoodsKindName, CASE WHEN COALESCE (tmp.PartionCell_10, '') = '' OR COALESCE (tmp.PartionCell_10, '') = '"NULL"' THEN '' ELSE tmp.PartionCell_10 END AS PartionCellName, tmp.OperDate, tmp.MovementItemId, tmp.UserId
                        , tmp.MovementId, tmp.InvNumber_full, tmp.PartionGoodsDate FROM tmpProtocol_All AS tmp
             UNION SELECT DISTINCT ROW_NUMBER() OVER (PARTITION BY tmp.MovementItemId, tmp.GoodsId, tmp.GoodsKindName ORDER BY tmp.OperDate ASC) AS Ord
                        , 11 AS CellNum, tmp.GoodsId, tmp.GoodsName, tmp.GoodsKindName, CASE WHEN COALESCE (tmp.PartionCell_11, '') = '' OR COALESCE (tmp.PartionCell_11, '') = '"NULL"' THEN '' ELSE tmp.PartionCell_11 END AS PartionCellName, tmp.OperDate, tmp.MovementItemId, tmp.UserId
                        , tmp.MovementId, tmp.InvNumber_full, tmp.PartionGoodsDate FROM tmpProtocol_All AS tmp
             UNION SELECT DISTINCT ROW_NUMBER() OVER (PARTITION BY tmp.MovementItemId, tmp.GoodsId, tmp.GoodsKindName ORDER BY tmp.OperDate ASC) AS Ord
                        , 12 AS CellNum, tmp.GoodsId, tmp.GoodsName, tmp.GoodsKindName, CASE WHEN COALESCE (tmp.PartionCell_12, '') = '' OR COALESCE (tmp.PartionCell_12, '') = '"NULL"' THEN '' ELSE tmp.PartionCell_12 END AS PartionCellName, tmp.OperDate, tmp.MovementItemId, tmp.UserId
                        , tmp.MovementId, tmp.InvNumber_full, tmp.PartionGoodsDate FROM tmpProtocol_All AS tmp
             UNION SELECT DISTINCT ROW_NUMBER() OVER (PARTITION BY tmp.MovementItemId, tmp.GoodsId, tmp.GoodsKindName ORDER BY tmp.OperDate ASC) AS Ord
                        , 13 AS CellNum, tmp.GoodsId, tmp.GoodsName, tmp.GoodsKindName, CASE WHEN COALESCE (tmp.PartionCell_13, '') = '' OR COALESCE (tmp.PartionCell_13, '') = '"NULL"' THEN '' ELSE tmp.PartionCell_3 END AS PartionCellName,  tmp.OperDate, tmp.MovementItemId, tmp.UserId
                        , tmp.MovementId, tmp.InvNumber_full, tmp.PartionGoodsDate FROM tmpProtocol_All AS tmp
             UNION SELECT DISTINCT ROW_NUMBER() OVER (PARTITION BY tmp.MovementItemId, tmp.GoodsId, tmp.GoodsKindName ORDER BY tmp.OperDate ASC) AS Ord
                        , 14 AS CellNum, tmp.GoodsId, tmp.GoodsName, tmp.GoodsKindName, CASE WHEN COALESCE (tmp.PartionCell_14, '') = '' OR COALESCE (tmp.PartionCell_14, '') = '"NULL"' THEN '' ELSE tmp.PartionCell_4 END AS PartionCellName,  tmp.OperDate, tmp.MovementItemId, tmp.UserId
                        , tmp.MovementId, tmp.InvNumber_full, tmp.PartionGoodsDate FROM tmpProtocol_All AS tmp
             UNION SELECT DISTINCT ROW_NUMBER() OVER (PARTITION BY tmp.MovementItemId, tmp.GoodsId, tmp.GoodsKindName ORDER BY tmp.OperDate ASC) AS Ord
                        , 15 AS CellNum, tmp.GoodsId, tmp.GoodsName, tmp.GoodsKindName, CASE WHEN COALESCE (tmp.PartionCell_15, '') = '' OR COALESCE (tmp.PartionCell_15, '') = '"NULL"' THEN '' ELSE tmp.PartionCell_5 END AS PartionCellName,  tmp.OperDate, tmp.MovementItemId, tmp.UserId 
                        , tmp.MovementId, tmp.InvNumber_full, tmp.PartionGoodsDate FROM tmpProtocol_All AS tmp
             UNION SELECT DISTINCT ROW_NUMBER() OVER (PARTITION BY tmp.MovementItemId, tmp.GoodsId, tmp.GoodsKindName ORDER BY tmp.OperDate ASC) AS Ord
                        , 16 AS CellNum, tmp.GoodsId, tmp.GoodsName, tmp.GoodsKindName, CASE WHEN COALESCE (tmp.PartionCell_16, '') = '' OR COALESCE (tmp.PartionCell_16, '') = '"NULL"' THEN '' ELSE tmp.PartionCell_6 END AS PartionCellName,  tmp.OperDate, tmp.MovementItemId, tmp.UserId
                        , tmp.MovementId, tmp.InvNumber_full, tmp.PartionGoodsDate FROM tmpProtocol_All AS tmp
             UNION SELECT DISTINCT ROW_NUMBER() OVER (PARTITION BY tmp.MovementItemId, tmp.GoodsId, tmp.GoodsKindName ORDER BY tmp.OperDate ASC) AS Ord
                        , 17 AS CellNum, tmp.GoodsId, tmp.GoodsName, tmp.GoodsKindName, CASE WHEN COALESCE (tmp.PartionCell_17, '') = '' OR COALESCE (tmp.PartionCell_17, '') = '"NULL"' THEN '' ELSE tmp.PartionCell_7 END AS PartionCellName,  tmp.OperDate, tmp.MovementItemId, tmp.UserId
                        , tmp.MovementId, tmp.InvNumber_full, tmp.PartionGoodsDate FROM tmpProtocol_All AS tmp
             UNION SELECT DISTINCT ROW_NUMBER() OVER (PARTITION BY tmp.MovementItemId, tmp.GoodsId, tmp.GoodsKindName ORDER BY tmp.OperDate ASC) AS Ord
                        , 18 AS CellNum, tmp.GoodsId, tmp.GoodsName, tmp.GoodsKindName, CASE WHEN COALESCE (tmp.PartionCell_18, '') = '' OR COALESCE (tmp.PartionCell_18, '') = '"NULL"' THEN '' ELSE tmp.PartionCell_8 END AS PartionCellName,  tmp.OperDate, tmp.MovementItemId, tmp.UserId
                        , tmp.MovementId, tmp.InvNumber_full, tmp.PartionGoodsDate FROM tmpProtocol_All AS tmp
             UNION SELECT DISTINCT ROW_NUMBER() OVER (PARTITION BY tmp.MovementItemId, tmp.GoodsId, tmp.GoodsKindName ORDER BY tmp.OperDate ASC) AS Ord
                        , 19 AS CellNum, tmp.GoodsId, tmp.GoodsName, tmp.GoodsKindName, CASE WHEN COALESCE (tmp.PartionCell_19, '') = '' OR COALESCE (tmp.PartionCell_19, '') = '"NULL"' THEN '' ELSE tmp.PartionCell_9 END AS PartionCellName,  tmp.OperDate, tmp.MovementItemId, tmp.UserId
                        , tmp.MovementId, tmp.InvNumber_full, tmp.PartionGoodsDate FROM tmpProtocol_All AS tmp
             UNION SELECT DISTINCT ROW_NUMBER() OVER (PARTITION BY tmp.MovementItemId, tmp.GoodsId, tmp.GoodsKindName ORDER BY tmp.OperDate ASC) AS Ord
                        , 20 AS CellNum, tmp.GoodsId, tmp.GoodsName, tmp.GoodsKindName, CASE WHEN COALESCE (tmp.PartionCell_20, '') = '' OR COALESCE (tmp.PartionCell_20, '') = '"NULL"' THEN '' ELSE tmp.PartionCell_10 END AS PartionCellName, tmp.OperDate, tmp.MovementItemId, tmp.UserId
                        , tmp.MovementId, tmp.InvNumber_full, tmp.PartionGoodsDate FROM tmpProtocol_All AS tmp
             UNION SELECT DISTINCT ROW_NUMBER() OVER (PARTITION BY tmp.MovementItemId, tmp.GoodsId, tmp.GoodsKindName ORDER BY tmp.OperDate ASC) AS Ord
                        , 21 AS CellNum, tmp.GoodsId, tmp.GoodsName, tmp.GoodsKindName, CASE WHEN COALESCE (tmp.PartionCell_21, '') = '' OR COALESCE (tmp.PartionCell_21, '') = '"NULL"' THEN '' ELSE tmp.PartionCell_11 END AS PartionCellName, tmp.OperDate, tmp.MovementItemId, tmp.UserId
                        , tmp.MovementId, tmp.InvNumber_full, tmp.PartionGoodsDate FROM tmpProtocol_All AS tmp
             UNION SELECT DISTINCT ROW_NUMBER() OVER (PARTITION BY tmp.MovementItemId, tmp.GoodsId, tmp.GoodsKindName ORDER BY tmp.OperDate ASC) AS Ord
                        , 22 AS CellNum, tmp.GoodsId, tmp.GoodsName, tmp.GoodsKindName, CASE WHEN COALESCE (tmp.PartionCell_22, '') = '' OR COALESCE (tmp.PartionCell_22, '') = '"NULL"' THEN '' ELSE tmp.PartionCell_12 END AS PartionCellName, tmp.OperDate, tmp.MovementItemId, tmp.UserId
                        , tmp.MovementId, tmp.InvNumber_full, tmp.PartionGoodsDate FROM tmpProtocol_All AS tmp
                   )
...
-- тест
-- select * from gpReport_PartionCell_GoodsHistory (inStartDate := ('30.01.2024')::TDateTime, inEndDate := ('30.01.2025')::TDateTime, inPartionCellId := 11347398, inUnitId := 8459, inisDetail := False, inIsRePack := 'False' ,  inSession := '9457');
