-- Function: gpMovementItem_SendOnPrice_Branch_SetErased (Integer, Integer, TVarChar)

DROP FUNCTION IF EXISTS gpMovementItem_SendOnPrice_Branch_SetErased (Integer, TVarChar);

CREATE OR REPLACE FUNCTION gpMovementItem_SendOnPrice_Branch_SetErased(
...
-- тест
-- SELECT * FROM gpMovementItem_SendOnPrice_Branch_SetErased (inMovementId:= 55, inJuridicalId = 1, inSession:= '2')
