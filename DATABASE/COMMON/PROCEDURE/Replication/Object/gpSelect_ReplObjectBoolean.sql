...
DROP FUNCTION IF EXISTS gpSelect_ReplObjectBoolean (TVarChar, Integer, Integer, Integer, TVarChar);
...
-- тест
-- SELECT * FROM gpSelect_ReplObjectBoolean  (inSessionGUID:= CURRENT_TIMESTAMP :: TVarChar, inStartId:= 0, inEndId:= 0, inDataBaseId:= 0, inSession:= zfCalc_UserAdmin()) -- ORDER BY 1
