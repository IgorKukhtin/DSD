...
-- Связь товаров с базовым (Производство) - ***это последний уровень ПФ-ГП, по которому делается закладка в цехе, выбирается один товар для всех видов***
GoodsId_basis
GoodsCode_basis
GoodsName_basis

-- Связь товаров с главным (Производство) -- ***выбираются все рецептуры и для каждой выбирается первый уровень, потом один товар для всех видов***
GoodsId_main
GoodsCode_main
GoodsName_main
