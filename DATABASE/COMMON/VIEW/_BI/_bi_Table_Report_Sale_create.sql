...
/*
-- select count(*) from _bi_Table_Report_Sale
TRUNCATE TABLE _bi_Table_Report_Sale;
*/

      IF NOT (EXISTS (SELECT table_name FROM INFORMATION_SCHEMA.tables WHERE table_name ILIKE ('_bi_Table_Report_Sale')))
      THEN
           -- DROP TABLE _bi_Table_Report_Sale
           --
           CREATE TABLE _bi_Table_Report_Sale (
              ...
              --
              CONSTRAINT pk_bi_Table_Report_Sale PRIMARY KEY (Id)
           );

          -- CREATE INDEX idx_bi_Table_Report_Sale_OperDate ON _bi_Table_Report_Sale (OperDate);

          GRANT ALL ON TABLE PUBLIC._bi_Table_Report_Sale TO admin;
          GRANT ALL ON TABLE PUBLIC._bi_Table_Report_Sale TO project;
