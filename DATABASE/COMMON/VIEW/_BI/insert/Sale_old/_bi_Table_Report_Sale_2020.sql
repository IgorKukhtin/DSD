...
WHERE OperDate BETWEEN '01.01.2020' AND '29.02.2020'
;


-- *** 2 - '01.03.2020' AND '30.04.2020'
  INSERT INTO _bi_Table_Report_Sale
            (
              -- Id Документа
              MovementId     ,
...
WHERE OperDate BETWEEN '01.03.2020' AND '30.04.2020'
;


-- *** 3 - '01.05.2020' AND '30.06.2020'
  INSERT INTO _bi_Table_Report_Sale
            (
              -- Id Документа
              MovementId     ,
...
WHERE OperDate BETWEEN '01.05.2020' AND '30.06.2020'
;


-- *** 4 - '01.07.2020' AND '31.08.2020'
  INSERT INTO _bi_Table_Report_Sale
            (
              -- Id Документа
              MovementId     ,
...
WHERE OperDate BETWEEN '01.07.2020' AND '31.08.2020'
;


-- *** 5 - '01.09.2020' AND '31.10.2020'
  INSERT INTO _bi_Table_Report_Sale
            (
              -- Id Документа
              MovementId     ,
...
WHERE OperDate BETWEEN '01.09.2020' AND '31.10.2020'
;

-- *** 6 - '01.11.2020' AND '31.12.2020'
  INSERT INTO _bi_Table_Report_Sale
            (
              -- Id Документа
              MovementId     ,
...
WHERE OperDate BETWEEN '01.11.2020' AND '31.12.2020'
;
