...
WHERE OperDate BETWEEN '01.01.2023' AND '28.02.2023'
;


-- *** 2 - '01.03.2023' AND '30.04.2023'
  INSERT INTO _bi_Table_Report_Sale
            (
              -- Id Документа
              MovementId     ,
...
WHERE OperDate BETWEEN '01.03.2023' AND '30.04.2023'
;


-- *** 3 - '01.05.2023' AND '30.06.2023'
  INSERT INTO _bi_Table_Report_Sale
            (
              -- Id Документа
              MovementId     ,
...
WHERE OperDate BETWEEN '01.05.2023' AND '30.06.2023'
;


-- *** 4 - '01.07.2023' AND '31.08.2023'
  INSERT INTO _bi_Table_Report_Sale
            (
              -- Id Документа
              MovementId     ,
...
WHERE OperDate BETWEEN '01.07.2023' AND '31.08.2023'
;


-- *** 5 - '01.09.2023' AND '31.10.2023'
  INSERT INTO _bi_Table_Report_Sale
            (
              -- Id Документа
              MovementId     ,
...
WHERE OperDate BETWEEN '01.09.2023' AND '31.10.2023'
;

-- *** 6 - '01.11.2023' AND '31.12.2023'
  INSERT INTO _bi_Table_Report_Sale
            (
              -- Id Документа
              MovementId     ,
...
WHERE OperDate BETWEEN '01.11.2023' AND '31.12.2023'
;
