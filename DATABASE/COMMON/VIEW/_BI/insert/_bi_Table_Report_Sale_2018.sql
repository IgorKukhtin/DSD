...
WHERE OperDate BETWEEN '01.01.2018' AND '28.02.2018'
;


-- *** 2 - '01.03.2018' AND '30.04.2018'
  INSERT INTO _bi_Table_Report_Sale
            (
              -- Id Документа
              MovementId     ,
...
WHERE OperDate BETWEEN '01.03.2018' AND '30.04.2018'
;


-- *** 3 - '01.05.2018' AND '30.06.2018'
  INSERT INTO _bi_Table_Report_Sale
            (
              -- Id Документа
              MovementId     ,
...
WHERE OperDate BETWEEN '01.05.2018' AND '30.06.2018'
;


-- *** 4 - '01.07.2018' AND '31.08.2018'
  INSERT INTO _bi_Table_Report_Sale
            (
              -- Id Документа
              MovementId     ,
...
WHERE OperDate BETWEEN '01.07.2018' AND '31.08.2018'
;


-- *** 5 - '01.09.2018' AND '31.10.2018'
  INSERT INTO _bi_Table_Report_Sale
            (
              -- Id Документа
              MovementId     ,
...
WHERE OperDate BETWEEN '01.09.2018' AND '31.10.2018'
;

-- *** 6 - '01.11.2018' AND '31.12.2018'
  INSERT INTO _bi_Table_Report_Sale
            (
              -- Id Документа
              MovementId     ,
...
WHERE OperDate BETWEEN '01.11.2018' AND '31.12.2018'
;
