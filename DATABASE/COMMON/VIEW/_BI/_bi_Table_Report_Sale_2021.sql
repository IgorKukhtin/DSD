...
WHERE OperDate BETWEEN '01.01.2021' AND '28.02.2021'
;


-- *** 2 - '01.03.2021' AND '30.04.2021'
  INSERT INTO _bi_Table_Report_Sale
            (
              -- Id Документа
              MovementId     ,
...
WHERE OperDate BETWEEN '01.03.2021' AND '30.04.2021'
;


-- *** 3 - '01.05.2021' AND '30.06.2021'
  INSERT INTO _bi_Table_Report_Sale
            (
              -- Id Документа
              MovementId     ,
...
WHERE OperDate BETWEEN '01.05.2021' AND '30.06.2021'
;


-- *** 4 - '01.07.2021' AND '31.08.2021'
  INSERT INTO _bi_Table_Report_Sale
            (
              -- Id Документа
              MovementId     ,
...
WHERE OperDate BETWEEN '01.07.2021' AND '31.08.2021'
;


-- *** 5 - '01.09.2021' AND '31.10.2021'
  INSERT INTO _bi_Table_Report_Sale
            (
              -- Id Документа
              MovementId     ,
...
WHERE OperDate BETWEEN '01.09.2021' AND '31.10.2021'
;

-- *** 6 - '01.11.2021' AND '31.12.2021'
  INSERT INTO _bi_Table_Report_Sale
            (
              -- Id Документа
              MovementId     ,
...
WHERE OperDate BETWEEN '01.11.2021' AND '31.12.2021'
;
