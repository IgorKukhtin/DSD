-- View: _bi_Report_Sale_View_2017

DROP VIEW IF EXISTS _bi_Report_Sale_View_2017;
...
CREATE OR REPLACE VIEW _bi_Report_Sale_View_2017
AS
              ...
              FROM tmpAnalyzer
                   ...
                   INNER JOIN MovementItemContainer AS MIContainer
                                                 ...
                                                 --AND MIContainer.OperDate   BETWEEN inStartDate AND inEndDate
                                                   AND MIContainer.OperDate   BETWEEN '01.01.2017' AND '31.12.2017'
                   -- Юр. Лицо
...
ALTER TABLE _bi_Report_Sale_View_2017  OWNER TO postgres;
...
-- тест
-- SELECT * FROM _bi_Report_Sale_View_2017 WHERE OperDate BETWEEN CURRENT_DATE - INTERVAL '1 DAY' AND CURRENT_DATE
