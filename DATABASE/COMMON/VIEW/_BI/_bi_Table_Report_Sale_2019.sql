...
WHERE OperDate BETWEEN '01.01.2019' AND '28.02.2019'
;


-- *** 2 - '01.03.2019' AND '30.04.2019'
  INSERT INTO _bi_Table_Report_Sale
            (
              -- Id Документа
              MovementId     ,
...
WHERE OperDate BETWEEN '01.03.2019' AND '30.04.2019'
;


-- *** 3 - '01.05.2019' AND '30.06.2019'
  INSERT INTO _bi_Table_Report_Sale
            (
              -- Id Документа
              MovementId     ,
...
WHERE OperDate BETWEEN '01.05.2019' AND '30.06.2019'
;


-- *** 4 - '01.07.2019' AND '31.08.2019'
  INSERT INTO _bi_Table_Report_Sale
            (
              -- Id Документа
              MovementId     ,
...
WHERE OperDate BETWEEN '01.07.2019' AND '31.08.2019'
;


-- *** 5 - '01.09.2019' AND '31.10.2019'
  INSERT INTO _bi_Table_Report_Sale
            (
              -- Id Документа
              MovementId     ,
...
WHERE OperDate BETWEEN '01.09.2019' AND '31.10.2019'
;

-- *** 6 - '01.11.2019' AND '31.12.2019'
  INSERT INTO _bi_Table_Report_Sale
            (
              -- Id Документа
              MovementId     ,
...
WHERE OperDate BETWEEN '01.11.2019' AND '31.12.2019'
;
