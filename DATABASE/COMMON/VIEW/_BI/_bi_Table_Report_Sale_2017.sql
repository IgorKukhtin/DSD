...
WHERE OperDate BETWEEN '01.01.2017' AND '28.02.2017'
;


-- *** 2 - '01.03.2017' AND '30.04.2017'
  INSERT INTO _bi_Table_Report_Sale
            (
              -- Id Документа
              MovementId     ,
...
WHERE OperDate BETWEEN '01.03.2017' AND '30.04.2017'
;


-- *** 3 - '01.05.2017' AND '30.06.2017'
  INSERT INTO _bi_Table_Report_Sale
            (
              -- Id Документа
              MovementId     ,
...
WHERE OperDate BETWEEN '01.05.2017' AND '30.06.2017'
;


-- *** 4 - '01.07.2017' AND '31.08.2017'
  INSERT INTO _bi_Table_Report_Sale
            (
              -- Id Документа
              MovementId     ,
...
WHERE OperDate BETWEEN '01.07.2017' AND '31.08.2017'
;


-- *** 5 - '01.09.2017' AND '31.10.2017'
  INSERT INTO _bi_Table_Report_Sale
            (
              -- Id Документа
              MovementId     ,
...
WHERE OperDate BETWEEN '01.09.2017' AND '31.10.2017'
;

-- *** 6 - '01.11.2017' AND '31.12.2017'
  INSERT INTO _bi_Table_Report_Sale
            (
              -- Id Документа
              MovementId     ,
...
WHERE OperDate BETWEEN '01.11.2017' AND '31.12.2017'
;
