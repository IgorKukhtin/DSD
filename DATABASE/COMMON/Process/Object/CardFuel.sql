...
PERFORM lpInsertUpdate_Object_Enum (inId:= zc_Enum_Process_InsertUpdate_Object_CardFuel()
                                  ...
                                  , inCode:= 1
                                  , inName:= 'Справочник <'||(SELECT ItemName FROM ObjectDesc WHERE Id = zc_Object_CardFuel())||'> - сохранение данных.'
...
PERFORM lpInsertUpdate_Object_Enum (inId:= zc_Enum_Process_Get_Object_CardFuel()
                                  , inDescId:= zc_Object_Process()
                                  , inCode:= 2
                                  , inName:= 'Справочник <'||(SELECT ItemName FROM ObjectDesc WHERE Id = zc_Object_CardFuel())||'> - выбор данных.'
...
PERFORM lpInsertUpdate_Object_Enum (inId:= zc_Enum_Process_Select_Object_CardFuel()
                                  , inDescId:= zc_Object_Process()
                                  , inCode:= 3
                                  , inName:= 'Справочник <'||(SELECT ItemName FROM ObjectDesc WHERE Id = zc_Object_CardFuel())||'> - получение данных.'
...
PERFORM lpInsertUpdate_Object_Enum (inId:= zc_Enum_Process_Select_Object_SourceFuel()
                                  , inDescId:= zc_Object_Process()
                                  , inCode:= 4
                                  , inName:= 'Справочник <Источник заправки> - получение данных.'
