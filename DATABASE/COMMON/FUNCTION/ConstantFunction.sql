...
--
CREATE OR REPLACE FUNCTION zc_Box_E2() RETURNS Integer AS $BODY$BEGIN RETURN (SELECT Id AS Id FROM Object WHERE ValueData = 'Е2' AND DescId = zc_Object_Box()); END;  $BODY$ LANGUAGE PLPGSQL IMMUTABLE;
*/
