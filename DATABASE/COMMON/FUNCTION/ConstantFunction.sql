...
CREATE OR REPLACE FUNCTION zc_DateStart_Container_Virt() RETURNS TDateTime AS $BODY$BEGIN RETURN ('31.07.2026'); END; $BODY$ LANGUAGE PLPGSQL IMMUTABLE;
...
CREATE OR REPLACE FUNCTION zc_PriceList_BasisComerc() RETURNS Integer AS $BODY$BEGIN RETURN (18841); END; $BODY$ LANGUAGE PLPGSQL IMMUTABLE; -- 18841
...
CREATE OR REPLACE FUNCTION zc_Branch_Irna() RETURNS Integer AS $BODY$BEGIN RETURN (8109544); END; $BODY$ LANGUAGE PLPGSQL IMMUTABLE;
...
CREATE OR REPLACE FUNCTION zc_Unit_Paper() RETURNS Integer AS $BODY$BEGIN RETURN (12168074); END; $BODY$ LANGUAGE PLPGSQL IMMUTABLE;
...
-- zc_Enum_PaidKind_FirstForm_pav()
-- zc_Enum_PaidKind_FirstForm_kaz()
-- zc_Enum_PaidKind_FirstForm_eur()
