...
CREATE OR REPLACE FUNCTION zc_PriceList_Fuel() RETURNS Integer AS $BODY$BEGIN RETURN (0); END; $BODY$ LANGUAGE PLPGSQL IMMUTABLE; -- select * from object where ValueData = 'Цены ГСМ' AND DescId = zc_object_PriceList()
