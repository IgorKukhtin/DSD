...
DROP FUNCTION IF EXISTS gpInsertUpdate_Movement_PriceListGotthardt_Load (TDateTime, Integer, TVarChar, TVarChar, TVarChar, TFloat, TFloat, TFloat, TVarChar, TVarChar);

CREATE OR REPLACE FUNCTION gpInsertUpdate_Movement_PriceListGotthardt_Load(
