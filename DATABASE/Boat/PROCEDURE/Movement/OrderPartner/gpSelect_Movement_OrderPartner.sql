-- Function: gpSelect_Movement_OrderPartner()

DROP FUNCTION IF EXISTS gpSelect_Movement_OrderPartner (TDateTime, TDateTime, Boolean, TVarChar);

CREATE OR REPLACE FUNCTION gpSelect_Movement_OrderPartner(
...
BEGIN
     ...
     WITH tmpStatus AS (SELECT zc_Enum_Status_Complete()   AS StatusId
        ...
        , Movement_OrderPartner AS (SELECT Movement_OrderPartner.Id
                                         , Movement_OrderPartner.InvNumber
                                         , MovementString_InvNumberPartner.ValueData  AS InvNumberPartner
                                         , Movement_OrderPartner.OperDate             AS OperDate
                                         , MovementDate_OperDatePartner.ValueData     AS OperDatePartner
                                         , Movement_OrderPartner.StatusId             AS StatusId
        ...
        SELECT Movement_OrderPartner.Id
             , zfConvert_StringToNumber (Movement_OrderPartner.InvNumber) ::Integer AS InvNumber
             , Movement_OrderPartner.InvNumberPartner
             , Movement_OrderPartner.OperDate
             , Movement_OrderPartner.OperDatePartner
        ...
        FROM Movement_OrderPartner

        LEFT JOIN Object AS Object_Status ON Object_Status.Id = Movement_OrderPartner.StatusId
        LEFT JOIN Object AS Object_From   ON Object_From.Id   = Movement_OrderPartner.FromId
        LEFT JOIN Object AS Object_To     ON Object_To.Id     = Movement_OrderPartner.ToId
        LEFT JOIN Object AS Object_PaidKind ON Object_PaidKind.Id = Movement_OrderPartner.PaidKindId
        LEFT JOIN Movement AS Movement_Invoice ON Movement_Invoice.Id = Movement_OrderPartner.MovementId_Invoice
        ...
        LEFT JOIN MovementFloat AS MovementFloat_TotalCount
                                ON MovementFloat_TotalCount.MovementId = Movement_OrderPartner.Id
...
-- тест
-- SELECT * FROM gpSelect_Movement_OrderPartner (inStartDate:= '29.01.2016', inEndDate:= '01.02.2016', inIsErased := FALSE, inSession:= '2')