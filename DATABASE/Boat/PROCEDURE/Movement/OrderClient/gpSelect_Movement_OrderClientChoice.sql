...
CREATE OR REPLACE FUNCTION gpSelect_Movement_OrderClientChoice(
...
-- тест
-- SELECT * FROM gpSelect_Movement_OrderClientChoice (inStartDate:= '29.01.2016', inEndDate:= '01.02.2016', inClientId:=0 , inIsErased := FALSE, inSession:= zfCalc_UserAdmin())
