...
BEGIN
   ...
   PERFORM lpCheckUnique_Object_ValueData (ioId, zc_Object_ReceiptService(), inName);
   -- проверка уникальности для свойства <Код Страна>
   PERFORM lpCheckUnique_Object_ObjectCode (ioId, zc_Object_ReceiptService(), ioCode);
