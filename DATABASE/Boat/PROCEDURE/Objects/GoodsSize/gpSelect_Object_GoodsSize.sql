...
DROP FUNCTION IF EXISTS gpSelect_Object_GoodsSize (Boolean, TVarChar);
...
BEGIN
   ...
   RETURN QUERY
       ...
       SELECT
           ...
           , Object_GoodsSize.isErased       AS isErased
       FROM Object AS Object_GoodsSize
          ...
          LEFT JOIN ObjectLink AS ObjectLink_Insert
                               ON ObjectLink_Insert.ObjectId = Object_GoodsSize.Id
                              AND ObjectLink_Insert.DescId = zc_ObjectLink_Protocol_Insert()
          LEFT JOIN Object AS Object_Insert ON Object_Insert.Id = ObjectLink_Insert.ChildObjectId 

          LEFT JOIN ObjectDate AS ObjectDate_Insert
                               ON ObjectDate_Insert.ObjectId = Object_GoodsSize.Id
                              AND ObjectDate_Insert.DescId = zc_ObjectDate_Protocol_Insert()
       WHERE Object_GoodsSize.DescId = zc_Object_GoodsSize()
         AND (Object_GoodsSize.isErased = FALSE OR inIsShowAll = TRUE)
       ;
