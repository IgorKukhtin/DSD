 -- Function: gpSelect_Object_ProdColorItems_byOrder()

DROP FUNCTION IF EXISTS gpSelect_Object_ProdColorItems_byOrder (Integer, Boolean, Boolean, Boolean, TVarChar);

CREATE OR REPLACE FUNCTION gpSelect_Object_ProdColorItems_byOrder(
...
-- тест
-- SELECT * FROM gpSelect_Object_ProdColorItems_byOrder (0,false,false,false, zfCalc_UserAdmin())
