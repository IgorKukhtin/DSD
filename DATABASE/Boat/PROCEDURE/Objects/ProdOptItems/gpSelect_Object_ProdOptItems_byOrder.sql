-- Function: gpSelect_Object_ProdOptItems_byOrder()

DROP FUNCTION IF EXISTS gpSelect_Object_ProdOptItems_byOrder (Boolean, Boolean, Boolean, TVarChar);

CREATE OR REPLACE FUNCTION gpSelect_Object_ProdOptItems_byOrder(
...
-- тест
-- SELECT * FROM gpSelect_Object_ProdOptItems_byOrder (0,false, false, false, zfCalc_UserAdmin())
