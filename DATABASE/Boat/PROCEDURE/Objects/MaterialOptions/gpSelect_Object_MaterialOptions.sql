...
DROP FUNCTION IF EXISTS gpSelect_Object_MaterialOptions (Boolean, TVarChar);

CREATE OR REPLACE FUNCTION gpSelect_Object_MaterialOptions(
...
-- тест
-- SELECT * FROM gpSelect_Object_MaterialOptions (inIsShowAll:= TRUE, inSession:= zfCalc_UserAdmin())
