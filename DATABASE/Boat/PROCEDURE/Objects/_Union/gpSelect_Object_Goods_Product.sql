-- Function: gpSelect_Object_Goods_Product()

DROP FUNCTION IF EXISTS gpSelect_Object_Goods_Product (TVarChar);

CREATE OR REPLACE FUNCTION gpSelect_Object_Goods_Product(
     ...
     RETURN QUERY
      ...
      UNION
       ...
       SELECT Object_Product.Id               AS Id
            ...
            , ObjectDesc.ItemName                    AS DescName
            , ObjectString_CIN.ValueData             AS Article
       ...
       FROM Object AS Object_Product
           LEFT JOIN ObjectDesc ON ObjectDesc.Id = Object_Product.DescId
...
-- тест
-- SELECT * FROM gpSelect_Object_Goods_Product ( inSession := zfCalc_UserAdmin())
