...
RETURNS TABLE (Id Integer, InvNumber TVarChar, OperDate TVarChar
             , StatusId Integer, Status TVarChar
             , TotalCount TVarChar
             , UnitName TVarChar
             , Comment TVarChar 
             , isList Boolean
...
-- тест
-- 
SELECT * FROM gpSelect_Movement_MobileInventory (inStartDate:= '01.01.2024', inEndDate:= '21.02.2024', inIsErased:= FALSE, inSession:= zfCalc_UserAdmin())