-- Function: gpSelect_MovementItem_InventoryDetail()

DROP FUNCTION IF EXISTS gpSelect_MovementItem_InventoryDetail (Integer, Boolean, TVarChar);

CREATE OR REPLACE FUNCTION gpSelect_MovementItem_InventoryDetail(
...
SELECT * FROM gpSelect_MovementItem_InventoryDetail (inMovementId := 3179 , inIsErased := 'False' ,  inSession := zfCalc_UserAdmin());