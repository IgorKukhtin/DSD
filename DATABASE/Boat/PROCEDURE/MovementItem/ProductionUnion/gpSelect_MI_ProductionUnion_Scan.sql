-- Function: gpSelect_MI_ProductionUnion_Scan()

DROP FUNCTION IF EXISTS gpSelect_MI_ProductionUnion_Scan (Integer, Boolean, TVarChar);

CREATE OR REPLACE FUNCTION gpSelect_MI_ProductionUnion_Scan(
...
-- тест
-- SELECT * FROM gpSelect_MI_ProductionUnion_Scan (inMovementId := 3208 , inIsErased := 'False' ,  inSession := zfCalc_UserAdmin());