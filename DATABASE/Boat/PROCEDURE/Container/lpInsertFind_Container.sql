...
DROP FUNCTION IF EXISTS lpInsertFind_Container (Integer, Integer, Integer, Integer, Boolean, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer);
...
BEGIN
     ...
     vbKeyValue = CASE WHEN inPartionId > 0 THEN inPartionId :: TVarChar || '-' ELSE '' END
               || COALESCE (inIsReserve, FALSE) :: TVarChar
     ...
     THEN
         ...
         -- добавили Остаток
         INSERT INTO Container (DescId, ObjectId, PartionId, ParentId, Amount, KeyValue, WhereObjectId, isReserve)
                        VALUES (inContainerDescId, inObjectId, inPartionId, CASE WHEN inParentId = 0 THEN NULL ELSE inParentId END, 0, vbKeyValue, vbWhereObjectId, COALESCE (inIsReserve, FALSE))
