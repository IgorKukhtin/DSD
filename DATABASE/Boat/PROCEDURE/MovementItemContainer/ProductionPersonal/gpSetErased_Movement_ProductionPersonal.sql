-- Function: gpSetErased_Movement_ProductionPersonal (Integer, TVarChar)

DROP FUNCTION IF EXISTS gpSetErased_Movement_ProductionPersonal (Integer, TVarChar);

CREATE OR REPLACE FUNCTION gpSetErased_Movement_ProductionPersonal(
...
BEGIN
    ...
    --vbUserId:= lpCheckRight (inSession, zc_Enum_Process_SetErased_ProductionPersonal());
