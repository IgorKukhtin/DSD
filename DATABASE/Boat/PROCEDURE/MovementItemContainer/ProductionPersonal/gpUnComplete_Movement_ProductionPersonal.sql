-- Function: gpUnComplete_Movement_ProductionPersonal (Integer, TVarChar)

DROP FUNCTION IF EXISTS gpUnComplete_Movement_ProductionPersonal (Integer, TVarChar);

CREATE OR REPLACE FUNCTION gpUnComplete_Movement_ProductionPersonal(
...
BEGIN
    ...
    --vbUserId:= lpCheckRight (inSession, zc_Enum_Process_UnComplete_ProductionPersonal());
