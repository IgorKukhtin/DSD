...
CREATE OR REPLACE FUNCTION zc_BarCodePref_Object() RETURNS TVarChar AS $BODY$BEGIN RETURN ('0000'); END; $BODY$ LANGUAGE PLPGSQL IMMUTABLE;
...
CREATE OR REPLACE FUNCTION zc_InvNumber_Status_Erased()    RETURNS TVarChar AS $BODY$BEGIN RETURN ('удален-'); END; $BODY$ LANGUAGE PLPGSQL IMMUTABLE;
...
-- CREATE OR REPLACE FUNCTION zc_Unit_Sklad() RETURNS Integer AS $BODY$BEGIN RETURN (35139); END; $BODY$ LANGUAGE PLPGSQL IMMUTABLE;
