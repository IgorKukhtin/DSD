-- Function: gpSelect_ObjectHistory_ServiceItemLast ()

DROP FUNCTION IF EXISTS gpSelect_ObjectHistory_ServiceItemLast (Integer, Integer, TVarChar);

CREATE OR REPLACE FUNCTION gpSelect_ObjectHistory_ServiceItemLast(
...
-- тест
-- SELECT * FROM gpSelect_ObjectHistory_ServiceItemLast (1, 0, zfCalc_UserAdmin())
