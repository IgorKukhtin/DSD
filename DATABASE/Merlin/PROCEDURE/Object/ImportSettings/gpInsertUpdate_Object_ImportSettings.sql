...
BEGIN
   ...
   PERFORM lpCheckUnique_Object_ValueData (ioId, zc_Object_ImportSettings(), inName, vbUserId);
   -- проверка уникальности <Код>
   PERFORM lpCheckUnique_Object_ObjectCode (ioId, zc_Object_ImportSettings(), vbCode_calc, vbUserId);
