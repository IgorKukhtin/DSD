-- Function: gpGet_Object_UnitPrior(Integer, TVarChar)

DROP FUNCTION IF EXISTS gpGet_Object_UnitPrior (Integer, TVarChar);

CREATE OR REPLACE FUNCTION gpGet_Object_UnitPrior(
...
-- тест
-- 
select * from gpGet_Object_UnitPrior(inId := 52460 ,  inSession := '5');