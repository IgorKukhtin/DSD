-- Function: gpSelect_Object_Unit_byParent (Integer, Boolean, TVarChar)

DROP FUNCTION IF EXISTS gpSelect_Object_Unit_byParent (Integer, Boolean, TVarChar);

CREATE OR REPLACE FUNCTION gpSelect_Object_Unit_byParent(
