...
-- !!! загрузка Примечание Приход/расход
...
-- !!! загрузка Примечание Движение денег
...
-- !!! загрузка Детально Приход/расход
...
-- !!! загрузка ObjectHistory_ServiceItem
...
-- !!! загрузка документов CashJournal
...
-- 30000; "Денежные средства"; 30100; "касса"
