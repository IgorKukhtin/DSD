-- Function: lpInsertUpdate_MI_GoodsAccount_Child()

DROP FUNCTION IF EXISTS lpInsertUpdate_MI_GoodsAccount_Child (Integer, Integer, Integer, Integer, Integer, Integer, TFloat, TFloat, TFloat, Integer);

CREATE OR REPLACE FUNCTION lpInsertUpdate_MI_GoodsAccount_Child(
