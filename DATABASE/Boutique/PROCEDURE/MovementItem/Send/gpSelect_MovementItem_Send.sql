...
-- тест
--select * from gpSelect_MovementItem_Send(inMovementId := 7 , inShowAll := 'True' , inIsErased := 'False' ,  inSession := '2');
--select * from gpSelect_MovementItem_Send(inMovementId := 7 , inShowAll := 'False' , inIsErased := 'False' ,  inSession := '2');