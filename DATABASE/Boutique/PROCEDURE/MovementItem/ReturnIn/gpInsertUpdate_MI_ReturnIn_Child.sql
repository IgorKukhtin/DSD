...
BEGIN
     ...
     THEN
         ...
         INSERT INTO _tmp_MI_Master (MovementItemId, AmountToPay)
            WITH tmpMI AS (SELECT MovementItem.Id AS MovementItemId
                                  -- Сумма к оплате за возврат ГРН - !!!возвращаем ВСЕ сколько можно вернуть денег за продажу!!!
     ...
     -- "сложно" пересчитали "итоговые" суммы по ВСЕМ элементам - здесь возвраты
