-- Function: lpInsertUpdate_MI_ReturnIn_Child()

DROP FUNCTION IF EXISTS lpInsertUpdate_MI_ReturnIn_Child (Integer, Integer, Integer, Integer, Integer, Integer, TFloat, TFloat, TFloat, Integer);

CREATE OR REPLACE FUNCTION lpInsertUpdate_MI_ReturnIn_Child(
