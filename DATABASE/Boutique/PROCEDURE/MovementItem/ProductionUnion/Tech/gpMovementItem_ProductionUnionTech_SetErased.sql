-- Function: gpMovementItem_ProductionUnionTech_SetErased (Integer, Integer, TVarChar)

DROP FUNCTION IF EXISTS gpMovementItem_ProductionUnionTech_SetErased (Integer, TVarChar);

CREATE OR REPLACE FUNCTION gpMovementItem_ProductionUnionTech_SetErased(
...
ALTER FUNCTION gpMovementItem_ProductionUnionTech_SetErased (Integer, TVarChar) OWNER TO postgres;
...
-- тест
-- SELECT * FROM gpMovementItem_ProductionUnionTech_SetErased (inMovementId:= 55, inJuridicalId = 1, inSession:= '2')
