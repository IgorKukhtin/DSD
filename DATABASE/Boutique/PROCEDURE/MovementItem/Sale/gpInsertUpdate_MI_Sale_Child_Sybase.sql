-- Function: gpInsertUpdate_MI_Sale_Child_Sybase()

DROP FUNCTION IF EXISTS gpInsertUpdate_MI_Sale_Child_Sybase (Integer, Integer, Integer, TFloat, TFloat, TVarChar);


CREATE OR REPLACE FUNCTION gpInsertUpdate_MI_Sale_Child_Sybase(
...
BEGIN
     ...
     PERFORM    gpInsertUpdate_MI_Sale_Child(
...
-- тест
-- select * from gpInsertUpdate_MI_Sale_Child_Sybase()