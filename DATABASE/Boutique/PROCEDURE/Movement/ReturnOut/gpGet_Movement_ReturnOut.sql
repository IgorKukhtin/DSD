-- Function: gpGet_Movement_ReturnOut (Integer, TVarChar)
...
BEGIN
     ...
     -- vbUserId := lpCheckRight (inSession, zc_Enum_Process_Get_Movement_ReturnOut());
...
-- тест
-- SELECT * FROM gpGet_Movement_ReturnOut (inMovementId:= 1, inOperDate:= CURRENT_DATE, inSession:= zfCalc_UserAdmin())
