         ...
         OPEN Cursor1 FOR
           ...
           SELECT
               ...
               , Object_Goods.ValueData         AS GoodsName
                 -- ukr
               , (CASE WHEN TRIM (ObjectString_Composition_UKR.ValueData) NOT IN ('-', '')
                            THEN ObjectString_Composition_UKR.ValueData
                       WHEN TRIM (Object_Composition.ValueData) NOT IN ('-', '')
                            THEN Object_Composition.ValueData
                       ELSE ''
