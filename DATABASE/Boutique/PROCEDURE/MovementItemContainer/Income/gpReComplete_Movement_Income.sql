-- Function: gpReComplete_Movement_Income(integer, tvarchar)

DROP FUNCTION IF EXISTS gpReComplete_Movement_Income (Integer, TVarChar);
...
BEGIN
    ...
    THEN
        ...
        PERFORM gpUpdate_Status_Income(inMovementId := inMovementId,
