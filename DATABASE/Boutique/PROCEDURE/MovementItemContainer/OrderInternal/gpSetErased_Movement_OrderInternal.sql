-- Function: gpSetErased_Movement_OrderInternal (Integer, TVarChar)

DROP FUNCTION IF EXISTS gpSetErased_Movement_OrderInternal (Integer, TVarChar);

CREATE OR REPLACE FUNCTION gpSetErased_Movement_OrderInternal(
...
-- тест
-- SELECT * FROM gpSetErased_Movement_OrderInternal (inMovementId:= 149639, inSession:= zfCalc_UserAdmin())
