...
DROP FUNCTION IF EXISTS gpReComplete_Movement_Sale (Integer, TVarChar);
...
-- тест
-- SELECT * FROM gpReComplete_Movement_Sale (inMovementId:= 1100, inSession:= zfCalc_UserAdmin())
