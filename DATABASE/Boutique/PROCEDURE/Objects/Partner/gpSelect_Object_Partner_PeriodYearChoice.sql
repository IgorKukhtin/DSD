...
DROP FUNCTION IF EXISTS gpSelect_Object_Partner_PeriodYearChoice ();

CREATE OR REPLACE FUNCTION gpSelect_Object_Partner_PeriodYearChoice()
RETURNS TABLE (
             Id               Integer
           , Code             Integer
           , Name             TVarChar
...
BEGIN
     ...
     -- Результат
     RETURN QUERY 
     SELECT DISTINCT ObjectFloat_PeriodYear.ValueData AS PeriodYear
