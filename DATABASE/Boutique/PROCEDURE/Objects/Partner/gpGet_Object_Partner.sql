...
RETURNS TABLE (Id Integer, Code Integer, Name TVarChar, BrandNameId Integer, BrandName TVarChar, FabrikaNameId Integer, FabrikaName TVarChar, PeriodNameId Integer, PeriodName TVarChar, PeriodYear TFloat) 
AS
$BODY$
BEGIN
