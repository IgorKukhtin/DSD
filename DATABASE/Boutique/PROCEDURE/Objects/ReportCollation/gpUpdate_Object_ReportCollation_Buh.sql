-- Function: gpUpdate_Object_ReportCollation_Buh(Integer,Integer,TVarChar,Integer,Integer,Integer,TVarChar)
...
BEGIN
     ...
     vbUserId := lpCheckRight (inSession, zc_Enum_Process_Insert_Object_ReportCollation_Buh());
...
-- тест
-- SELECT * FROM gpUpdate_Object_ReportCollation_Buh(inBarCode := '201000923136' ,  inSession := '5');
