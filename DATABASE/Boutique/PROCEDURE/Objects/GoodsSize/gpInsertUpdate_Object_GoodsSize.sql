...
CREATE OR REPLACE FUNCTION gpInsertUpdate_Object_GoodsSize(
 INOUT ioId           Integer,       -- ключ объекта <GoodsSize>
    IN inCode         Integer,       -- свойство <Код GoodsSize>
    IN inName         TVarChar,      -- главное Название GoodsSize
...
BEGIN
   ...
   -- проверка уникальности для свойства <Наименование GoodsSize>
   PERFORM lpCheckUnique_Object_ValueData(ioId, zc_Object_GoodsSize(), inName); 
   -- проверка уникальности для свойства <Код GoodsSizeа>
