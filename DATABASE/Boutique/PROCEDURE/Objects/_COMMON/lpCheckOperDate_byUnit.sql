...
BEGIN
     ...
     THEN
         RAISE EXCEPTION 'Ошибка.Для <%> изменение данных возможно только с <%>', lfGet_Object_ValueData_sh (inUnitId_by), zfConvert_DateToString (DATE_TRUNC ('DAY', CURRENT_TIMESTAMP - INTERVAL '14 HOUR'));
     END IF;
