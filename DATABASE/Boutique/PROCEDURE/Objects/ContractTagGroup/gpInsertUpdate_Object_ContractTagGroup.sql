...
ALTER FUNCTION gpInsertUpdate_Object_ContractTagGroup (Integer, Integer, TVarChar, TVarChar) OWNER TO postgres;
...
-- тест
-- SELECT * FROM gpInsertUpdate_Object_ContractTagGroup(ioId:=null, inCode:=null, inName:='Торговая сеть 1', inSession:='2')