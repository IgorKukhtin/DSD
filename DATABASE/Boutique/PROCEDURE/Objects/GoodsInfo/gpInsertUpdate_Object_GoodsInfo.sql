...
CREATE OR REPLACE FUNCTION gpInsertUpdate_Object_GoodsInfo(
 INOUT ioId           Integer,       -- ключ объекта <GoodsInfo>
    IN inCode         Integer,       -- свойство <Код GoodsInfoа>
    IN inName         TVarChar,      -- главное Название GoodsInfoа
...
BEGIN
   ...
   -- проверка уникальности для свойства <Наименование GoodsInfoа>
   PERFORM lpCheckUnique_Object_ValueData(ioId, zc_Object_GoodsInfo(), inName); 
   -- проверка уникальности для свойства <Код GoodsInfoа>
