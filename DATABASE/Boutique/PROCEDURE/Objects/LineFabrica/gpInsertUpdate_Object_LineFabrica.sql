...
CREATE OR REPLACE FUNCTION gpInsertUpdate_Object_LineFabrica(
 INOUT ioId           Integer,       -- ключ объекта <LineFabrica>
    IN inCode         Integer,       -- свойство <Код LineFabrica>
    IN inName         TVarChar,      -- главное Название LineFabrica
...
BEGIN
   ...
   -- проверка уникальности для свойства <Наименование LineFabrica>
   PERFORM lpCheckUnique_Object_ValueData(ioId, zc_Object_LineFabrica(), inName); 
   -- проверка уникальности для свойства <Код LineFabrica>
