...
union select '10501', 'Результат основной деятельности', 'Сумма возвратов', 'Возвраты по ценам продажи'
union select '10502', 'Результат основной деятельности', 'Сумма возвратов', 'Скидка в Возвратах'
...
union select '20105', 'Административные расходы', 'Содержание админ', 'Прочие ТМЦ'
union select '20106', 'Административные расходы', 'Содержание админ', 'МНМА'
union select '20107', 'Административные расходы', 'Содержание админ', 'ГСМ'
...
union select '30105', 'Расходы по магазинам', 'Содержание магазины', 'Прочие ТМЦ'
union select '30106', 'Расходы по магазинам', 'Содержание магазины', 'МНМА'
union select '30107', 'Расходы по магазинам', 'Содержание магазины', 'ГСМ'
union select '30201', 'Расходы по магазинам', 'Списания', 'Товары'
union select '30202', 'Расходы по магазинам', 'Списания', 'Инвентарь'
