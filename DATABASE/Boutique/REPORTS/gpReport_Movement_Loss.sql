...
BEGIN
    ...
    WITH
     ...
     , tmpData  AS  (SELECT tmpMovementLoss.InvNumber
                          ...
                          , SUM (COALESCE (MI_Loss.Amount, 0) * COALESCE (MIFloat_OperPriceList.ValueData, 0))  AS AmountPriceListSumm
                          , SUM (COALESCE (MI_Loss.Amount, 0) * COALESCE (Object_PartionGoods.PriceSale,0))     AS SaleSumm
