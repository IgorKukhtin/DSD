object WeighingProductionJournal_protocolForm: TWeighingProductionJournal_protocolForm
  Left = 0
  Top = 0
  Caption = #1046#1091#1088#1085#1072#1083' '#1076#1086#1082#1091#1084#1077#1085#1090#1086#1074' <'#1042#1079#1074#1077#1096#1080#1074#1072#1085#1080#1077' ('#1087#1088#1086#1080#1079#1074#1086#1076#1089#1090#1074#1086')> ('#1087#1088#1086#1090#1086#1082#1086#1083')'
  ClientHeight = 427
  ClientWidth = 1240
  Color = clBtnFace
  ...
  object cxGrid: TcxGrid
    ...
    object cxGridDBTableView: TcxGridDBTableView
      ...
      object Count_user: TcxGridDBColumn
        Caption = #1050#1086#1083'-'#1074#1086' '#1087#1086#1083#1100#1079'.'
        DataBinding.FieldName = 'Count_user'
        PropertiesClassName = 'TcxCurrencyEditProperties'
        Properties.DisplayFormat = ',0.####;-,0.####; ;'
        HeaderAlignmentHorz = taCenter
        HeaderAlignmentVert = vaCenter
        HeaderHint = #1050#1086#1083'-'#1074#1086' '#1087#1086#1083#1100#1079#1086#1074#1072#1090#1077#1083#1077#1081
      ...
      object isNumSecurity: TcxGridDBColumn
        Caption = #1054#1093#1088#1072#1085#1072' ('#1076#1072'/'#1085#1077#1090')'
        DataBinding.FieldName = 'isNumSecurity'
        HeaderAlignmentHorz = taCenter
        HeaderAlignmentVert = vaCenter
        Options.Editing = False
        Width = 70
  ...
  object dsdStoredProc: TdsdStoredProc
    StoredProcName = 'gpSelect_Movement_WeighingProduction_protocol'
    DataSet = ClientDataSet
    DataSets = <
      item
        DataSet = ClientDataSet
