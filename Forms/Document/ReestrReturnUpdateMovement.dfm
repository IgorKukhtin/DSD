inherited ReestrReturnUpdateMovementForm: TReestrReturnUpdateMovementForm
  Caption = #1059#1089#1090#1072#1085#1086#1074#1080#1090#1100' '#1074#1080#1079#1091' '#1074' '#1074#1086#1079#1074#1088#1072#1090#1072#1093
  ClientHeight = 405
  ClientWidth = 1001
  ...
  object edReestrKind: TcxButtonEdit [3]
    ...
    TabOrder = 7
    Text = #1041#1091#1093#1075#1072#1083#1090#1077#1088#1080#1103' '#1076#1083#1103' '#1080#1089#1087#1088#1072#1074#1083#1077#1085#1080#1103
    Width = 225
  end
  ...
  inherited spSelect: TdsdStoredProc
    StoredProcName = 'gpSelect_MI_ReestrReturnUser'
    Params = <
      item
        Name = 'instartdate'
        Value = 41640d
  ...
  object spUpdateMI: TdsdStoredProc
    StoredProcName = 'gpUpdate_MI_ReestrReturn'
    DataSets = <>
    OutputType = otResult
    Params = <
      item
  ...
  object spSelectPrintPeriod: TdsdStoredProc
    StoredProcName = 'gpSelect_Movement_ReestrReturnPeriod_Print'
    DataSet = PrintHeaderCDS
    DataSets = <
      item
        DataSet = PrintHeaderCDS
