...
type
  TSendDebtMemberJournalForm = class(TParentForm)
    ...
    MemberFromCode: TcxGridDBColumn;
    MemberFromName: TcxGridDBColumn;
    JuridicalBasisFromName: TcxGridDBColumn;
    ...
    MemberToCode: TcxGridDBColumn;
    MemberToName: TcxGridDBColumn;
    CarToName: TcxGridDBColumn;
    JuridicalBasisToName: TcxGridDBColumn;
...
initialization
  RegisterClass(TSendDebtMemberJournalForm);
