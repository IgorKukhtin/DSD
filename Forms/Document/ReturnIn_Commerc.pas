...
type
  TReturnIn_CommercForm = class(TAncestorDocumentForm)
    cxLabel3: TcxLabel;
    edTo: TcxButtonEdit;
    ...
    cxGridDetail_commerc: TcxGrid;
    cxGridDBTableViewDetail_commerc: TcxGridDBTableView;
    Amount_ch2: TcxGridDBColumn;
    isErased_ch2: TcxGridDBColumn;
    cxGridLevelDetail_commerc: TcxGridLevel;
    spSelectDetail_commerc: TdsdStoredProc;
    DBViewAddOnDetail_commerc: TdsdDBViewAddOn;
    cxLabel28: TcxLabel;
    edReturnKind: TcxButtonEdit;
    GuidesReturnKind: TdsdGuides;
    actReturnKindOpenForm: TOpenChoiceForm;
    DetailCDS_commerc: TClientDataSet;
    DetailDS_commerc: TDataSource;
...
var
  ReturnIn_CommercForm: TReturnIn_CommercForm;
...
initialization
  RegisterClass(TReturnIn_CommercForm);
