...
type
  TSendDebtForm = class(TParentForm)
    ...
    cInfoMoneyFromName: TcxGridDBColumn;
    ...
    ContractFromChoiceForm: TOpenChoiceForm;
    ...
    cInfoMoneyDestinationFromName: TcxGridDBColumn;
    ...
    ContractToChoiceForm: TOpenChoiceForm;
  private
  public
  end;
