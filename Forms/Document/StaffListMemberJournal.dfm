inherited StaffListMemberJournalForm: TStaffListMemberJournalForm
  ...
  inherited spMovementComplete: TdsdStoredProc
    StoredProcName = 'gpComplete_Movement_StaffListMember'
    Left = 80
    Top = 320
  end
  inherited spMovementUnComplete: TdsdStoredProc
    StoredProcName = 'gpUnComplete_Movement_StaffListMember'
    Left = 80
    Top = 384
  end
  inherited spMovementSetErased: TdsdStoredProc
    StoredProcName = 'gpSetErased_Movement_StaffListMember'
    Left = 208
    Top = 376
  end
  ...
  inherited spMovementReComplete: TdsdStoredProc
    StoredProcName = 'gpReComplete_Movement_StaffListMember'
    Left = 176
    Top = 304
  end
  ...
  object spSelectPrint: TdsdStoredProc
    StoredProcName = 'gpSelect_Movement_StaffListMember_Print'
    DataSet = PrintItemsCDS
    DataSets = <
      item
        DataSet = PrintItemsCDS
