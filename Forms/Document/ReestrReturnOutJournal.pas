...
type
  TReestrReturnOutJournalForm = class(TAncestorJournalForm)
...
var
  ReestrReturnOutJournalForm: TReestrReturnOutJournalForm;

implementation

{$R *.dfm}
initialization
  RegisterClass(TReestrReturnOutJournalForm);
end.
