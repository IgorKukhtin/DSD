unit TaxCorrectiveJournalChoice;
...
type
  TTaxCorrectiveJournalChoiceForm = class(TAncestorJournalForm)
...
var
  TaxCorrectiveJournalChoiceForm: TTaxCorrectiveJournalChoiceForm;

implementation

{$R *.dfm}
initialization
  RegisterClass(TTaxCorrectiveJournalChoiceForm);
end.
