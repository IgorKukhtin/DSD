object OrderFinanceMovementSBForm: TOrderFinanceMovementSBForm
        ...
        object cxGridDBTableViewChild: TcxGridDBTableView
          ...
          DataController.Summary.DefaultGroupSummaryItems = <
            ...
            item
              Format = ',0.####'
              Kind = skSum
              Column = AmountPlan_next_ch2
            end
            item
              Format = ',0.####'
              Kind = skSum
              Column = AmountPlan_1_ch2
            end
            item
              Format = ',0.####'
              Kind = skSum
              Column = AmountPlan_2_ch2
            end
            item
              Format = ',0.####'
              Kind = skSum
              Column = AmountPlan_3_ch2
            end
            item
              Format = ',0.####'
              Kind = skSum
              Column = AmountPlan_4_ch2
            end
            item
              Format = ',0.####'
              Kind = skSum
              Column = AmountPlan_5_ch2
            end>
          DataController.Summary.FooterSummaryItems = <
            item
              Format = ',0.####'
          ...
          object AmountPlan_next_ch2: TcxGridDBColumn
            Caption = #1055#1083#1072#1090#1077#1078#1085#1099#1081' '#1087#1083#1072#1085' '#1085#1072' '#1085#1077#1076#1077#1083#1102
            DataBinding.FieldName = 'AmountPlan_next'
            PropertiesClassName = 'TcxCurrencyEditProperties'
            Properties.DisplayFormat = ',0.00;-,0.00; ;'
          ...
          object OperDate_next_ch2: TcxGridDBColumn
            Caption = #1044#1072#1090#1072' '#1087#1083#1072#1085
            DataBinding.FieldName = 'OperDate_next'
            PropertiesClassName = 'TcxCurrencyEditProperties'
            Properties.DisplayFormat = ',0.00;-,0.00; ;'
          ...
          object AmountPlan_1_ch2: TcxGridDBColumn
            Caption = #1055#1083#1072#1090#1077#1078#1085#1099#1081' '#1087#1083#1072#1085' 1.'#1087#1085'.'
            DataBinding.FieldName = 'AmountPlan_1'
            PropertiesClassName = 'TcxCurrencyEditProperties'
            Properties.DisplayFormat = ',0.00;-,0.00; ;'
            Visible = False
          ...
          object AmountPlan_2_ch2: TcxGridDBColumn
            Caption = #1055#1083#1072#1090#1077#1078#1085#1099#1081' '#1087#1083#1072#1085' 2.'#1074#1090'.'
            DataBinding.FieldName = 'AmountPlan_2'
            PropertiesClassName = 'TcxCurrencyEditProperties'
            Properties.DisplayFormat = ',0.00;-,0.00; ;'
            Visible = False
          ...
          object AmountPlan_3_ch2: TcxGridDBColumn
            Caption = #1055#1083#1072#1090#1077#1078#1085#1099#1081' '#1087#1083#1072#1085' 3.'#1089#1088'.'
            DataBinding.FieldName = 'AmountPlan_3'
            PropertiesClassName = 'TcxCurrencyEditProperties'
            Properties.DisplayFormat = ',0.00;-,0.00; ;'
            Visible = False
          ...
          object AmountPlan_4_ch2: TcxGridDBColumn
            Caption = #1055#1083#1072#1090#1077#1078#1085#1099#1081' '#1087#1083#1072#1085' 4.'#1095#1090'.'
            DataBinding.FieldName = 'AmountPlan_4'
            PropertiesClassName = 'TcxCurrencyEditProperties'
            Properties.DisplayFormat = ',0.00;-,0.00; ;'
            Visible = False
          ...
          object AmountPlan_5_ch2: TcxGridDBColumn
            Caption = #1055#1083#1072#1090#1077#1078#1085#1099#1081' '#1087#1083#1072#1085' 5.'#1087#1090'.'
            DataBinding.FieldName = 'AmountPlan_5'
            PropertiesClassName = 'TcxCurrencyEditProperties'
            Properties.DisplayFormat = ',0.00;-,0.00; ;'
            Visible = False
          ...
          object isAmountPlan_1_ch2: TcxGridDBColumn
            Caption = '1.'#1087#1085'.'
            DataBinding.FieldName = 'isAmountPlan_1'
            Visible = False
            HeaderAlignmentHorz = taCenter
          ...
          object isAmountPlan_2_ch2: TcxGridDBColumn
            Caption = '2.'#1074#1090'.'
            DataBinding.FieldName = 'isAmountPlan_2'
            Visible = False
            HeaderAlignmentHorz = taCenter
          ...
          object isAmountPlan_3_ch2: TcxGridDBColumn
            Caption = '3.'#1089#1088'.'
            DataBinding.FieldName = 'isAmountPlan_3'
            Visible = False
            HeaderAlignmentHorz = taCenter
          ...
          object isAmountPlan_4_ch2: TcxGridDBColumn
            Caption = '4.'#1095#1090'.'
            DataBinding.FieldName = 'isAmountPlan_4'
            Visible = False
            HeaderAlignmentHorz = taCenter
          ...
          object isAmountPlan_5_ch2: TcxGridDBColumn
            Caption = '5.'#1087#1090'.'
            DataBinding.FieldName = 'isAmountPlan_5'
            Visible = False
            HeaderAlignmentHorz = taCenter
    ...
    object cxTabSheetDetail: TcxTabSheet
      ...
      object cxGrid1: TcxGrid
        ...
        object cxGridDBTableView1: TcxGridDBTableView
          ...
          OptionsView.Indicator = True
          Styles.StyleSheet = dmMain.cxGridTableViewStyleSheet
          object ContractCode_ch3: TcxGridDBColumn
            Caption = #1050#1086#1076' '#1076#1086#1075'.'
            DataBinding.FieldName = 'ContractCode'
            Visible = False
            HeaderAlignmentHorz = taCenter
          ...
          object ContractName_ch3: TcxGridDBColumn
            Caption = #8470' '#1076#1086#1075'.'
            DataBinding.FieldName = 'ContractName'
            HeaderAlignmentHorz = taCenter
            HeaderAlignmentVert = vaCenter
          ...
          object JuridicalName_inf_ch3: TcxGridDBColumn
            Caption = #1070#1088'.'#1083#1080#1094#1086' ('#1080#1085#1092'.)'
            DataBinding.FieldName = 'JuridicalName_inf'
            Visible = False
            HeaderAlignmentHorz = taCenter
          ...
          object InvNumber_Child_ch3: TcxGridDBColumn
            Caption = #8470' '#1079#1072#1103#1074#1082#1080' (1'#1057')'
            DataBinding.FieldName = 'InvNumber_Child'
            HeaderAlignmentHorz = taCenter
            HeaderAlignmentVert = vaCenter
          ...
          object InvNumber_Invoice_Child_ch3: TcxGridDBColumn
            Caption = #8470' '#1089#1095#1077#1090#1072
            DataBinding.FieldName = 'InvNumber_Invoice_Child'
            HeaderAlignmentHorz = taCenter
            HeaderAlignmentVert = vaCenter
          ...
          object Comment_master_ch3: TcxGridDBColumn
            Caption = '***'#1055#1088#1080#1084#1077#1095#1072#1085#1080#1077
          ...
          object OperDate_next_ch3: TcxGridDBColumn
            Caption = '***'#1044#1072#1090#1072' '#1087#1083#1072#1085
            DataBinding.FieldName = 'OperDate_next'
            PropertiesClassName = 'TcxDateEditProperties'
            Properties.DisplayFormat = 'DD.MM.YYYY'
          ...
          object AmountPlan_next_ch3: TcxGridDBColumn
            Caption = #1055#1083#1072#1090#1077#1078#1085#1099#1081' '#1087#1083#1072#1085' '#1085#1072' '#1085#1077#1076#1077#1083#1102
            DataBinding.FieldName = 'AmountPlan_next'
            PropertiesClassName = 'TcxCurrencyEditProperties'
            Properties.DecimalPlaces = 2
          ...
          object Amount_Detail_ch3: TcxGridDBColumn
            Caption = #1057#1086#1075#1083#1072#1089#1086#1074#1072#1085#1086' '#1082' '#1086#1087#1083#1072#1090#1077
          ...
          object OperDate_Detail_ch3: TcxGridDBColumn
            Caption = #1044#1072#1090#1072' '#1087#1083#1072#1085
          ...
          object isAmountPlan_ch3: TcxGridDBColumn
  ...
  object spSelectMI: TdsdStoredProc
    StoredProcName = 'gpSelect_MovementItem_OrderFinanceSB_2'
    DataSet = MasterCDS
    DataSets = <
      item
        DataSet = MasterCDS
  ...
  object dxBarManager: TdxBarManager
    ...
    object bbOut: TdxBarSubItem
      ...
      ItemLinks = <
        ...
        item
          Visible = True
          ItemName = 'bbExport_msg_0'
        end
        item
          Visible = True
          ItemName = 'bbExport_msg_1'
        end>
    end
    ...
    object bbUpdate_SignWait_1_Yes: TdxBarButton
      Action = mactUpdate_SignWait_1_Yes
      Category = 0
    end
    ...
    object bbExport_msg_1: TdxBarButton
      Action = mactExport_msg_1
      Category = 0
    end
    ...
    object bbExport_msg_0: TdxBarButton
      Action = mactExport_msg_0
      Category = 0
    end
  end
  ...
  object ActionList: TActionList
    ...
    object mactUpdate_SignWait_1_Yes: TMultiAction
      Category = 'Sign_1'
      MoveParams = <>
      ActionList = <
        item
      ...
      Hint = #1054#1090#1087#1088#1072#1074#1080#1090#1100' '#1056#1091#1082#1086#1074#1086#1076#1080#1090#1077#1083#1102
    end
    ...
    object actGet_Export_Email_msg_1: TdsdExecStoredProc
      Category = 'Export_Email_msg'
      MoveParams = <>
      PostDataSetBeforeExecute = False
      StoredProc = spGet_Export_Email_msg_1
      StoredProcList = <
        item
          StoredProc = spGet_Export_Email_msg_1
        end>
      Caption = 'actGet_Export_Email_msg_1'
    end
    object mactExport_msg_1: TMultiAction
      Category = 'Export_Email_msg'
      MoveParams = <>
      ActionList = <
        item
          Action = actGet_Export_Email_msg_1
        end
        item
          Action = actSMTPFile
        end>
      QuestionBeforeExecute = 
        #1044#1077#1081#1089#1090#1074#1080#1090#1077#1083#1100#1085#1086' '#1086#1090#1087#1088#1072#1074#1080#1090#1100' '#1059#1074#1077#1076#1086#1084#1083#1077#1085#1080#1077' '#1087#1086#1089#1083#1077' '#1057#1086#1075#1083#1072#1089#1086#1074#1072#1085#1080#1103' '#1056#1091#1082#1086#1074#1086#1076#1080#1090 +
        #1077#1083#1077#1084'?'
      InfoAfterExecute = #1059#1074#1077#1076#1086#1084#1083#1077#1085#1080#1077' '#1087#1086#1089#1083#1077' '#1057#1086#1075#1083#1072#1089#1086#1074#1072#1085#1080#1103' '#1056#1091#1082#1086#1074#1086#1076#1080#1090#1077#1083#1077#1084' '#1086#1090#1087#1088#1072#1074#1083#1077#1085#1086
      Caption = #1059#1074#1077#1076#1086#1084#1083#1077#1085#1080#1077' '#1087#1086#1089#1083#1077' '#1057#1086#1075#1083#1072#1089#1086#1074#1072#1085#1080#1103' '#1056#1091#1082#1086#1074#1086#1076#1080#1090#1077#1083#1077#1084
      Hint = #1059#1074#1077#1076#1086#1084#1083#1077#1085#1080#1077' '#1087#1086#1089#1083#1077' '#1057#1086#1075#1083#1072#1089#1086#1074#1072#1085#1080#1103' '#1056#1091#1082#1086#1074#1086#1076#1080#1090#1077#1083#1077#1084
      ImageIndex = 53
    end
    ...
    object actGet_Export_Email_msg_0: TdsdExecStoredProc
      Category = 'Export_Email_msg'
      MoveParams = <>
      PostDataSetBeforeExecute = False
      StoredProc = spGet_Export_Email_msg_0
      StoredProcList = <
        item
          StoredProc = spGet_Export_Email_msg_0
        end>
      Caption = 'actGet_Export_Email_msg_0'
    end
    object mactExport_msg_0: TMultiAction
      Category = 'Export_Email_msg'
      MoveParams = <>
      ActionList = <
        item
          Action = actGet_Export_Email_msg_0
        end
        item
          Action = actSMTPFile
        end>
      QuestionBeforeExecute = #1044#1077#1081#1089#1090#1074#1080#1090#1077#1083#1100#1085#1086' '#1086#1090#1087#1088#1072#1074#1080#1090#1100' '#1059#1074#1077#1076#1086#1084#1083#1077#1085#1080#1077' '#1056#1091#1082#1086#1074#1086#1076#1080#1090#1077#1083#1102'?'
      InfoAfterExecute = #1059#1074#1077#1076#1086#1084#1083#1077#1085#1080#1077' '#1056#1091#1082#1086#1074#1086#1076#1080#1090#1077#1083#1102' '#1076#1083#1103' '#1057#1086#1075#1083#1072#1089#1086#1074#1072#1085#1080#1103' '#1086#1090#1087#1088#1072#1074#1083#1077#1085#1086
      Caption = #1059#1074#1077#1076#1086#1084#1083#1077#1085#1080#1077' '#1056#1091#1082#1086#1074#1086#1076#1080#1090#1077#1083#1102' '#1076#1083#1103' '#1057#1086#1075#1083#1072#1089#1086#1074#1072#1085#1080#1103
      Hint = #1059#1074#1077#1076#1086#1084#1083#1077#1085#1080#1077' '#1056#1091#1082#1086#1074#1086#1076#1080#1090#1077#1083#1102' '#1076#1083#1103' '#1057#1086#1075#1083#1072#1089#1086#1074#1072#1085#1080#1103
      ImageIndex = 53
    end
  end
  ...
  object spGet_Export_Email_msg_1: TdsdStoredProc
  ...
  object spGet_Export_Email_msg_0: TdsdStoredProc
    StoredProcName = 'gpGet_Movement_OrderFinance_Email_send_msg'
    DataSet = ExportEmailCDS
    DataSets = <
      item
