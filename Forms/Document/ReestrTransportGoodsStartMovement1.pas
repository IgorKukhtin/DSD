unit ReestrTransportGoodsStartMovement;
...
type
  TReestrTransportGoodsStartMovementForm = class(TAncestorDocumentForm)
...
initialization
  RegisterClass(TReestrTransportGoodsStartMovementForm);
