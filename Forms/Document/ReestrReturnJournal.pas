...
type
  TReestrReturnJournalForm = class(TAncestorJournalForm)
...
var
  ReestrReturnJournalForm: TReestrReturnJournalForm;

implementation

{$R *.dfm}
initialization
  RegisterClass(TReestrReturnJournalForm);
end.
