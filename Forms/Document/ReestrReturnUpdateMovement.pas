unit ReestrReturnUpdateMovement;
...
type
  TReestrReturnUpdateMovementForm = class(TAncestorJournalForm)
...
var
  ReestrReturnUpdateMovementForm: TReestrReturnUpdateMovementForm;

implementation

{$R *.dfm}
initialization
  RegisterClass(TReestrReturnUpdateMovementForm);
end.
