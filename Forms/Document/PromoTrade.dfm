inherited PromoTradeForm: TPromoTradeForm
        ...
        inherited cxGridDBTableView: TcxGridDBTableView
          DataController.Summary.DefaultGroupSummaryItems = <
            ...
            item
              Format = ',0.####'
              Kind = skSum
              Column = SummWithOutVATPlan_new
            end
            item
              Format = ',0.####'
              Kind = skSum
              Column = SummWithVATPlan_new
            end>
          ...
          object PriceIn: TcxGridDBColumn
            Caption = #1057#1077#1073'-'#1090#1100', '#1075#1088#1085'/'#1082#1075
            ...
            HeaderAlignmentHorz = taCenter
            HeaderAlignmentVert = vaCenter
            HeaderHint = #1057#1077#1073'-'#1090#1100', '#1075#1088#1085'/'#1082#1075
            Options.Editing = False
            Width = 112
          end
          object PriceIn_calc: TcxGridDBColumn
          ...
          object ChangePrice: TcxGridDBColumn
            Caption = #1057#1077#1073'-'#1090#1100' '#1088#1072#1089#1093#1086#1076#1099', '#1075#1088#1085'/'#1082#1075
          ...
          object SummWithOutVATPlan_new: TcxGridDBColumn
            Caption = #1057#1091#1084#1084#1072' '#1087#1083#1072#1085' ('#1084#1077#1089'.), '#1073#1077#1079' '#1091#1095#1077#1090#1072' '#1053#1044#1057' ('#1085#1086#1074'.'#1079#1085'. '#1089#1082#1080#1076#1082#1072')'
            DataBinding.FieldName = 'SummWithOutVATPlan_new'
            PropertiesClassName = 'TcxCurrencyEditProperties'
            Properties.DisplayFormat = ',0.####;-,0.####; ;'
            HeaderAlignmentHorz = taCenter
            HeaderAlignmentVert = vaCenter
          ...
          object SummWithVATPlan_new: TcxGridDBColumn
            Caption = #1057#1091#1084#1084#1072' '#1087#1083#1072#1085' ('#1084#1077#1089'.), '#1089' '#1091#1095#1077#1090#1086#1084' '#1053#1044#1057' ('#1085#1086#1074'.'#1079#1085'. '#1089#1082#1080#1076#1082#1072')'
            DataBinding.FieldName = 'SummWithVATPlan_new'
            PropertiesClassName = 'TcxCurrencyEditProperties'
            Properties.DisplayFormat = ',0.####;-,0.####; ;'
            HeaderAlignmentHorz = taCenter
            HeaderAlignmentVert = vaCenter
          ...
          object PromoTax: TcxGridDBColumn
    ...
    object tsOkupaemost: TcxTabSheet
      ...
      object GridOkup: TcxGrid
        ...
        object cxGridDBTableViewOkup: TcxGridDBTableView
          ...
          object ChangePercent_mi_ch4: TcxGridDBColumn
            Caption = '% '#1057#1082#1080#1076#1082#1080
  ...
  inherited DataPanel: TPanel
    ...
    object cxLabel24: TcxLabel
      ...
      Caption = '% '#1087#1086' '#1082#1088#1077#1076#1080#1090#1091', '#1075#1086#1076' ('#1086#1082#1091#1087#1072#1077#1084#1086#1089#1090#1100')'
      ParentShowHint = False
      ShowHint = True
    end
    object edPersentOnCredit: TcxCurrencyEdit
      Left = 794
      Top = 126
      EditValue = 18.500000000000000000
      Properties.DecimalPlaces = 4
      Properties.DisplayFormat = ',0.####'
  ...
  inherited ActionList: TActionList
    Left = 55
    Top = 207
    object actSelectPrintOkup_new: TdsdPrintAction [0]
      Category = 'Print'
      MoveParams = <>
      StoredProc = spSelectPrintOkupNew
      StoredProcList = <
        item
          StoredProc = spSelectPrintOkupNew
        end>
      Caption = #1058#1069#1054' ('#1044#1083#1103' '#1087#1077#1095#1072#1090#1080') ('#1085#1086#1074#1086#1077')'
      Hint = #1058#1069#1054' ('#1044#1083#1103' '#1087#1077#1095#1072#1090#1080') ('#1085#1086#1074#1086#1077')'
      ImageIndex = 17
      DataSets = <
        item
    ...
    object actSelectPrintOkup: TdsdPrintAction [1]
      Category = 'Print'
      MoveParams = <>
      StoredProc = spSelectPrintOkup
      StoredProcList = <
        item
          StoredProc = spSelectPrintOkup
        end>
      Caption = #1058#1069#1054' ('#1044#1083#1103' '#1087#1077#1095#1072#1090#1080') ('#1090#1077#1082#1091#1097#1077#1077')'
      Hint = #1058#1069#1054' ('#1044#1083#1103' '#1087#1077#1095#1072#1090#1080') ('#1090#1077#1082#1091#1097#1077#1077')'
      ImageIndex = 23
      DataSets = <
        item
          DataSet = PrintHeaderCDS
    ...
    object actChoicePartner: TOpenChoiceForm [2]
      Category = 'Goods'
      MoveParams = <>
    ...
    object actUpdateMov3DS: TdsdUpdateDataSet [3]
      Category = 'TradeSign'
      MoveParams = <>
      PostDataSetBeforeExecute = False
    ...
    object actChoiceMember: TOpenChoiceForm [4]
      Category = 'TradeSign'
      MoveParams = <>
      PostDataSetBeforeExecute = False
    ...
    object actUpdate_PromoTradeHistory: TdsdExecStoredProc
      ...
      Caption = #1056#1072#1089#1095#1077#1090' '#1076#1072#1085#1085#1099#1093' '#1087#1088#1086#1076#1072#1078#1072', '#1074#1086#1079#1074#1088#1072#1090', '#1087#1088#1086#1089#1088#1086#1095#1082#1072', '#1089'/'#1089
      Hint = #1056#1072#1089#1095#1077#1090' '#1076#1072#1085#1085#1099#1093' '#1087#1088#1086#1076#1072#1078#1072', '#1074#1086#1079#1074#1088#1072#1090', '#1087#1088#1086#1089#1088#1086#1095#1082#1072', '#1089'/'#1089
      ImageIndex = 45
      QuestionBeforeExecute = #1044#1077#1081#1089#1090#1074#1080#1090#1077#1083#1100#1085#1086' '#1086#1073#1085#1086#1074#1080#1090#1100' '#1076#1072#1085#1085#1099#1077' '#1087#1088#1086#1076#1072#1078#1072', '#1074#1086#1079#1074#1088#1072#1090', '#1087#1088#1086#1089#1088#1086#1095#1082#1072', '#1089'/'#1089'?'
    ...
    object macUpdate_calc: TMultiAction
      ...
      Caption = #1056#1072#1089#1095#1077#1090' '#1076#1072#1085#1085#1099#1093' '#1062#1077#1085#1099' '#1089'/'#1089
      Hint = #1056#1072#1089#1095#1077#1090' '#1076#1072#1085#1085#1099#1093' '#1062#1077#1085#1099' '#1089'/'#1089
      ImageIndex = 76
    end
  end
  ...
  inherited BarManager: TdxBarManager
    ...
    inherited Bar: TdxBar
      ItemLinks = <
        ...
        item
          Visible = True
          ItemName = 'bbSelectPrintOkup_new'
        end
        item
          Visible = True
          ItemName = 'dxBarStatic'
  ...
  inherited spInsertUpdateMIMaster: TdsdStoredProc
    ...
    Params = <
      ...
      item
        Name = 'inPricePromo_new'
        Value = Null
        Component = MasterCDS
        ComponentItem = 'PricePromo_new'
        DataType = ftFloat
        ParamType = ptInput
        MultiSelectSeparator = ','
      end
  ...
  object spSelectPrintOkupNew: TdsdStoredProc
    StoredProcName = 'gpSelect_MI_PromoTradeOkupaemost_Print'
    DataSet = PrintHeaderCDS
    DataSets = <
      item
