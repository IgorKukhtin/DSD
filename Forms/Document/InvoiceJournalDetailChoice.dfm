object InvoiceJournalDetailChoiceForm: TInvoiceJournalDetailChoiceForm
  Left = 0
  Top = 0
  Caption = #1046#1091#1088#1085#1072#1083' '#1076#1086#1082#1091#1084#1077#1085#1090#1086#1074' <'#1057#1095#1077#1090'> ('#1076#1077#1090#1072#1083#1100#1085#1086')'
  ClientHeight = 426
  ClientWidth = 998
  Color = clBtnFace
  ...
  object cxGrid: TcxGrid
    ...
    object cxGridDBTableView: TcxGridDBTableView
      ...
      object TotalSumm: TcxGridDBColumn
        ...
        HeaderAlignmentHorz = taCenter
        HeaderAlignmentVert = vaCenter
        HeaderHint = #1048#1090#1086#1075#1086' '#1089#1091#1084#1084#1072' '#1087#1086' '#1076#1086#1082#1091#1084#1077#1085#1090#1091' '#1057#1095#1077#1090' ('#1089' '#1091#1095#1077#1090#1086#1084' '#1053#1044#1057' '#1080' '#1089#1082#1080#1076#1082#1080')'
        Options.Editing = False
        Width = 84
      end
