...
uses
  ...
  cxContainer, Vcl.ComCtrls, dxCore, cxDateUtils, ChoicePeriod, cxLabel,
  cxTextEdit, cxMaskEdit, cxDropDownEdit, cxCalendar, Vcl.ExtCtrls, dsdCommon;

type
  TWeek_DateForm = class(TAncestorEnumForm)
