inherited Sale_OrderForm: TSale_OrderForm
  ...
  inherited ActionList: TActionList
    ...
    object actPrintTax_Us: TdsdPrintAction [11]
      Category = 'Print_Tax'
      MoveParams = <>
    ...
    object actDialog_QualityDoc: TdsdOpenForm [12]
      Category = 'Print_QualityDoc'
      MoveParams = <>
    ...
    object actRefreshPrice: TdsdDataSetRefresh [37]
      Category = 'DSDLib'
      MoveParams = <>
      StoredProc = spSelect
      StoredProcList = <
    ...
    object actTax: TdsdExecStoredProc [38]
      Category = 'DSDLib'
      MoveParams = <>
      PostDataSetBeforeExecute = False
      StoredProc = spTax
