unit ReestrIncomeStartMovement;
...
type
  TReestrIncomeStartMovementForm = class(TAncestorDocumentForm)
    ...
    BarCode_Income: TcxGridDBColumn;
...
initialization
  RegisterClass(TReestrIncomeStartMovementForm);
