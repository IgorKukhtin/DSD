unit WeighingPartnerJournal_protocol;
...
type
  TWeighingPartnerJournal_protocolForm = class(TParentForm)
...
initialization
  RegisterClass(TWeighingPartnerJournal_protocolForm);
