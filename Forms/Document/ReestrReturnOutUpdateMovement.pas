unit ReestrReturnOutUpdateMovement;
...
type
  TReestrReturnOutUpdateMovementForm = class(TAncestorJournalForm)
...
var
  ReestrReturnOutUpdateMovementForm: TReestrReturnOutUpdateMovementForm;

implementation

{$R *.dfm}
initialization
  RegisterClass(TReestrReturnOutUpdateMovementForm);
end.
