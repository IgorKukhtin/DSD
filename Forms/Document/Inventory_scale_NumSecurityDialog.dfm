object Inventory_scale_NumSecurityDialogForm: TInventory_scale_NumSecurityDialogForm
  Left = 0
  Top = 0
  ...
  object spUpdate_Movement: TdsdStoredProc
    StoredProcName = 'gpUpdate_Movement_WeighingProduction_Movement'
    DataSets = <>
    OutputType = otResult
    Params = <
      item
