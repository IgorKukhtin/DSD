unit WeighingProductionItemJournal;
...
type
  TWeighingProductionItemJournalForm = class(TParentForm)
    ...
    StartWeighingMI: TcxGridDBColumn;
    cxLabel3: TcxLabel;
...
initialization
  RegisterClass(TWeighingProductionItemJournalForm);
