inherited ReturnIn_PartnerJournalForm: TReturnIn_PartnerJournalForm
  ...
  inherited ActionList: TActionList
    Left = 15
    Top = 130
    object actPrintPack_copy3: TdsdPrintAction [0]
      Category = 'PrintPack'
      MoveParams = <
        item
          FromParam.Name = 'id'
    ...
    object actExport_file_csv: TdsdStoredProcExportToFile [5]
      Category = 'Export_Csv'
      MoveParams = <>
    ...
    inherited actRefresh: TdsdDataSetRefresh [6]
    end
    inherited actUnComplete: TdsdChangeMovementStatus [7]
    end
    inherited actComplete: TdsdChangeMovementStatus [8]
    end
    inherited actSetErased: TdsdChangeMovementStatus [9]
    end
    ...
    object actPrintPack: TdsdPrintAction [14]
      Category = 'PrintPack'
      MoveParams = <
        item
          FromParam.Name = 'id'
    ...
    inherited actShowErased: TBooleanStoredProcAction [15]
    end
    ...
    inherited mactReCompleteList: TMultiAction [17]
    end
    inherited actGridToExcel: TdsdGridToExcel [18]
    end
    inherited mactCompleteList: TMultiAction [19]
    end
    inherited actInsertMask: TdsdInsertUpdateAction [20]
    end
    inherited mactUnCompleteList: TMultiAction [21]
    end
    inherited spReCompete: TdsdExecStoredProc [22]
    end
    inherited MovementProtocolOpenForm: TdsdOpenForm [24]
    end
    inherited mactSimpleReCompleteList: TMultiAction [25]
    end
    inherited mactSimpleCompleteList: TMultiAction [26]
    end
    inherited mactSimpleUncompleteList: TMultiAction [27]
    end
    ...
    object actCheckedList: TMultiAction
      ...
      Hint = #1059#1089#1090#1072#1085#1086#1074#1080#1090#1100' '#1087#1088#1080#1079#1085#1072#1082' "'#1055#1088#1086#1074#1077#1088#1077#1085'" '#1074#1089#1077#1084' '#1076#1086#1082#1091#1084#1077#1085#1090#1072#1084
      ImageIndex = 58
    end
    ...
    object macPrint_Grid: TMultiAction
      ...
      QuestionBeforeExecute = #1044#1077#1081#1089#1090#1074#1080#1090#1077#1083#1100#1085#1086' '#1074#1099#1087#1086#1083#1085#1080#1090#1100' '#1087#1072#1082#1077#1090#1085#1091#1102' '#1087#1077#1095#1072#1090#1100' (1 '#1082#1086#1087#1080#1103')? '
      ...
      Caption = #1055#1077#1095#1072#1090#1100' '#1074' '#1087#1072#1082#1077#1090#1077' (1 '#1082#1086#1087#1080#1103')'
      Hint = #1055#1077#1095#1072#1090#1100' '#1074' '#1087#1072#1082#1077#1090#1077' (1 '#1082#1086#1087#1080#1103')'
      ImageIndex = 44
    end
    object mactPrintPack_copy2: TMultiAction
      Category = 'PrintPack'
      MoveParams = <
        item
          FromParam.Name = 'id'
    ...
    object mactPrintPack_copy3: TMultiAction
      Category = 'PrintPack'
      MoveParams = <
        item
          FromParam.Name = 'id'
    ...
    object macPrint_Pack_list2: TMultiAction
      Category = 'PrintPack'
      MoveParams = <
        item
          FromParam.Name = 'id'
    ...
    object macPrint_Pack_list3: TMultiAction
      Category = 'PrintPack'
      MoveParams = <
        item
          FromParam.Name = 'id'
    ...
    object macPrint_Grid3: TMultiAction
      Category = 'PrintPack'
      MoveParams = <
        item
          FromParam.Name = 'id'
      ...
      ActionList = <
        item
          Action = macPrint_Pack_list3
        end
        item
          Action = actRefresh
        end>
      QuestionBeforeExecute = #1044#1077#1081#1089#1090#1074#1080#1090#1077#1083#1100#1085#1086' '#1074#1099#1087#1086#1083#1085#1080#1090#1100' '#1087#1072#1082#1077#1090#1085#1091#1102' '#1087#1077#1095#1072#1090#1100' (3 '#1082#1086#1087#1080#1080')? '
      InfoAfterExecute = #1055#1077#1095#1072#1090#1100' '#1074' '#1087#1072#1082#1077#1090#1077' '#1074#1099#1087#1086#1083#1085#1077#1085#1072
      Caption = #1055#1077#1095#1072#1090#1100' '#1074' '#1087#1072#1082#1077#1090#1077' (3 '#1082#1086#1087#1080#1080')'
      Hint = #1055#1077#1095#1072#1090#1100' '#1074' '#1087#1072#1082#1077#1090#1077' (3 '#1082#1086#1087#1080#1080')'
      ImageIndex = 44
    end
    object macPrint_Grid2: TMultiAction
      Category = 'PrintPack'
      MoveParams = <
        item
          FromParam.Name = 'id'
      ...
      ActionList = <
        item
          Action = macPrint_Pack_list2
        end
        item
          Action = actRefresh
        end>
      QuestionBeforeExecute = #1044#1077#1081#1089#1090#1074#1080#1090#1077#1083#1100#1085#1086' '#1074#1099#1087#1086#1083#1085#1080#1090#1100' '#1087#1072#1082#1077#1090#1085#1091#1102' '#1087#1077#1095#1072#1090#1100' (2 '#1082#1086#1087#1080#1080')? '
      InfoAfterExecute = #1055#1077#1095#1072#1090#1100' '#1074' '#1087#1072#1082#1077#1090#1077' '#1074#1099#1087#1086#1083#1085#1077#1085#1072
      Caption = #1055#1077#1095#1072#1090#1100' '#1074' '#1087#1072#1082#1077#1090#1077' (2 '#1082#1086#1087#1080#1080')'
  ...
  inherited BarManager: TdxBarManager
    ...
    object bbPrintCorr: TdxBarButton
    ...
    object bbsPrint: TdxBarSubItem
      ...
      ItemLinks = <
        ...
        item
          Visible = True
          ItemName = 'bbmacPrint_Grid2'
        end
        item
          Visible = True
          ItemName = 'bbmacPrint_Grid3'
        end>
    end
    ...
    object bbmacPrint_Grid2: TdxBarButton
      Action = macPrint_Grid2
      Category = 0
    end
