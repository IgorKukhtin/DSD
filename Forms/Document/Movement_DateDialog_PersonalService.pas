unit Movement_DateDialog_PersonalService;
...
type
  TMovement_DateDialog_PersonalServiceForm = class(TParentForm)
    cxButton1: TcxButton;
    cxButton2: TcxButton;
    deEnd: TcxDateEdit;
    deStart: TcxDateEdit;
...
initialization
  RegisterClass(TMovement_DateDialog_PersonalServiceForm);
