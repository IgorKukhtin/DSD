inherited BankAccountMovementForm: TBankAccountMovementForm
  ...
  object ceInvNumber: TcxCurrencyEdit [3]
    Left = 8
    Top = 23
    Enabled = False
  ...
  object ceBankAccount: TcxButtonEdit [7]
    Left = 276
    Top = 23
    Properties.Buttons = <
      item
  ...
  object ceAmountIn: TcxCurrencyEdit [8]
    Left = 8
    Top = 68
  ...
  object ceAmountOut: TcxCurrencyEdit [10]
    Left = 148
    Top = 68
    Properties.DecimalPlaces = 2
    Properties.DisplayFormat = ',0.00'
  ...
  object ceCurrency: TcxButtonEdit [23]
    Left = 8
    Top = 159
    Properties.Buttons = <
      item
