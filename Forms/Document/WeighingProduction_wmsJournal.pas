unit WeighingProduction_wmsJournal;
...
type
  TWeighingProduction_wmsJournalForm = class(TParentForm)
...
initialization
  RegisterClass(TWeighingProduction_wmsJournalForm);
