...
type
  TMemberHolidayJournalForm = class(TAncestorJournalForm)
    bbTax: TdxBarButton;
    ...
    BeginDateEnd: TcxGridDBColumn;
    MemberName: TcxGridDBColumn;
    MemberMainName: TcxGridDBColumn;
...
{$R *.dfm}
initialization
  RegisterClass(TMemberHolidayJournalForm);
end.
