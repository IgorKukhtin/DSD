inherited OrderGoodsJournalForm: TOrderGoodsJournalForm
  Caption = #1046#1091#1088#1085#1072#1083' '#1076#1086#1082#1091#1084#1077#1085#1090#1086#1074' <'#1055#1083#1072#1085#1080#1088#1086#1074#1072#1085#1080#1077' '#1055#1088#1086#1076#1072#1078' '#1087#1086' '#1090#1086#1074#1072#1088#1072#1084'>'
  ClientHeight = 535
  ClientWidth = 876
      ...
      inherited cxGrid: TcxGrid
        ...
        inherited cxGridDBTableView: TcxGridDBTableView
          ...
          object OrderPeriodKindName: TcxGridDBColumn
            ...
            HeaderAlignmentHorz = taCenter
            HeaderAlignmentVert = vaCenter
            HeaderHint = #1042#1080#1076' '#1087#1077#1088#1080#1086#1076#1072' '#1087#1083#1072#1085#1080#1088#1086#1074#1072#1085#1080#1103
            Width = 150
          end
  ...
  inherited ActionList: TActionList
    ...
    inherited actInsert: TdsdInsertUpdateAction
      FormName = 'TOrderGoodsForm'
      FormNameParam.Value = 'TOrderGoodsForm'
    end
  ...
  inherited spSelect: TdsdStoredProc
    StoredProcName = 'gpSelect_Movement_OrderGoods'
    Params = <
      item
        Name = 'instartdate'
        Value = 41640d
  ...
  inherited spMovementComplete: TdsdStoredProc
    StoredProcName = 'gpComplete_Movement_OrderGoods'
    Params = <
      item
        Name = 'inmovementid'
        Value = Null
  ...
  inherited spMovementUnComplete: TdsdStoredProc
    StoredProcName = 'gpUnComplete_Movement_OrderGoods'
    Params = <
      item
        Name = 'inmovementid'
        Value = Null
  ...
  inherited spMovementSetErased: TdsdStoredProc
    StoredProcName = 'gpSetErased_Movement_OrderGoods'
    Params = <
      item
        Name = 'inmovementid'
        Value = Null
  ...
  inherited spMovementReComplete: TdsdStoredProc
    StoredProcName = 'gpReComplete_Movement_OrderGoods'
    Left = 176
    Top = 432
  end
