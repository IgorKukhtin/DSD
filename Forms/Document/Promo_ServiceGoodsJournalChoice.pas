unit Promo_ServiceGoodsJournalChoice;
...
var
  Promo_ServiceGoodsJournalChoiceForm: TPromo_ServiceGoodsJournalChoiceForm;

implementation

{$R *.dfm}
initialization
  RegisterClass(TPromo_ServiceGoodsJournalChoiceForm);
end.
