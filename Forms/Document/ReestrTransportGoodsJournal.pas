unit ReestrTransportGoodsJournal;
...
type
  TReestrTransportGoodsJournalForm = class(TAncestorJournalForm)
...
var
  ReestrTransportGoodsJournalForm: TReestrTransportGoodsJournalForm;

implementation

{$R *.dfm}
initialization
  RegisterClass(TReestrTransportGoodsJournalForm);
end.
