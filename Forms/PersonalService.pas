...
type
  TPersonalServiceForm = class(TParentForm)
    cxGrid: TcxGrid;
    ...
    clFrom: TcxGridDBColumn;
    clTo: TcxGridDBColumn;
    clPaidKind: TcxGridDBColumn;
    clInfoMoney: TcxGridDBColumn;
    clUnit: TcxGridDBColumn;
    clPosition: TcxGridDBColumn;
    clServiceDate: TcxGridDBColumn;
...
var
  PersonalServiceForm: TPersonalServiceForm;
