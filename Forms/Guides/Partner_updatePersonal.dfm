object Partner_updatePersonalForm: TPartner_updatePersonalForm
  Left = 0
  Top = 0
  Caption = #1057#1087#1088#1072#1074#1086#1095#1085#1080#1082' <'#1050#1086#1085#1090#1088#1072#1075#1077#1085#1090#1099'>('#1080#1079#1084#1077#1085#1077#1085#1080#1077' '#1058#1055')'
  ClientHeight = 464
  ClientWidth = 1000
  Color = clBtnFace
  ...
  object spUpdate_Personal: TdsdStoredProc
    StoredProcName = 'gpUpdateObject_Partner_Personal'
    DataSets = <>
    OutputType = otResult
    Params = <
      item
