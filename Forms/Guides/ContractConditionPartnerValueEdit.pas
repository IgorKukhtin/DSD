unit ContractConditionPartnerValueEdit;
...
type
  TContractConditionPartnerValueEditForm = class(TParentForm)
    cxButton1: TcxButton;
    cxButton2: TcxButton;
    ...
    cxLabel1: TcxLabel;
    edContractConditionKind: TcxButtonEdit;
    cxLabel2: TcxLabel;
    edJuridical: TcxButtonEdit;
    GuidesJuridical: TdsdGuides;
    GuidesContractCondition: TdsdGuides;
  private
...
initialization
  RegisterClass(TContractConditionPartnerValueEditForm);
