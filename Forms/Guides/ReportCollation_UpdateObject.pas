unit ReportCollation_UpdateObject;
...
type
  TReportCollation_UpdateObjectForm = class(TAncestorJournalForm)
    N13: TMenuItem;
    miInvoice: TMenuItem;
    miOrdSpr: TMenuItem;
    miDesadv: TMenuItem;
...
var
  ReportCollation_UpdateObjectForm: TReportCollation_UpdateObjectForm;

implementation

{$R *.dfm}
initialization
  RegisterClass(TReportCollation_UpdateObjectForm);
end.
