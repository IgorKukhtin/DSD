object Route_SelfForm: TRoute_SelfForm
  Left = 0
  Top = 0
  Caption = #1057#1087#1088#1072#1074#1086#1095#1085#1080#1082' <'#1052#1072#1088#1096#1088#1091#1090#1099' - '#1089#1072#1084#1086#1074#1099#1074#1086#1079'>'
  ClientHeight = 395
  ClientWidth = 823
  Color = clBtnFace
  ...
  object dsdStoredProc: TdsdStoredProc
    StoredProcName = 'gpSelect_Object_Route_Self'
    DataSet = ClientDataSet
    DataSets = <
      item
        DataSet = ClientDataSet
