...
type
  TSettingsServiceItemEditForm = class(TParentForm)
    cxButton1: TcxButton;
    cxButton2: TcxButton;
    ...
    cxLabel3: TcxLabel;
    edSettingsService: TcxButtonEdit;
    cxLabel4: TcxLabel;
    edInfoMoneyDestination: TcxButtonEdit;
    GuidesSettingsService: TdsdGuides;
...
initialization
  RegisterClass(TSettingsServiceItemEditForm);
