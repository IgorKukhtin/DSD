object GoodsListIncome_byReportEditForm: TGoodsListIncome_byReportEditForm
  Left = 0
  Top = 0
  ...
  Caption = #1055#1077#1088#1077#1089#1095#1077#1090' '#1076#1072#1085#1085#1099#1093' '#1089#1087#1088#1072#1074#1086#1095#1085#1080#1082#1072' <'#1058#1086#1074#1072#1088#1099' '#1076#1083#1103' '#1087#1086#1089#1090#1072#1074#1097#1080#1082#1072'>'
  ClientHeight = 386
  ClientWidth = 447
  Color = clBtnFace
  ...
  object spReport: TdsdStoredProc
    StoredProcName = 'gpInsertUpdate_Object_GoodsListIncome_byReport'
    DataSets = <>
    OutputType = otResult
    Params = <
      item
