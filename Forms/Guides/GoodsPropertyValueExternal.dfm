object GoodsPropertyValueExternalForm: TGoodsPropertyValueExternalForm
  Left = 0
  Top = 0
  Caption = #1057#1087#1088#1072#1074#1086#1095#1085#1080#1082' <'#1047#1085#1072#1095#1077#1085#1080#1103' '#1076#1083#1103' '#1089#1074#1086#1081#1089#1090#1074' '#1090#1086#1074#1072#1088#1086#1074'> ('#1055#1086#1082#1091#1087#1072#1090#1077#1083#1100')'
  ClientHeight = 430
  ClientWidth = 986
  Color = clBtnFace
  ...
  object spInsertUpdate: TdsdStoredProc
    StoredProcName = 'gpInsertUpdate_Object_GoodsPropertyValue_External'
    DataSets = <>
    OutputType = otResult
    Params = <
      item
      ...
      item
        Name = 'inArticleExternal'
        Value = Null
        Component = ClientDataSet
        ComponentItem = 'ArticleExternal'
        DataType = ftString
        ParamType = ptInput
        MultiSelectSeparator = ','
      end
