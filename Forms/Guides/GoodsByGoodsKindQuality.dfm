object GoodsByGoodsKindQualityForm: TGoodsByGoodsKindQualityForm
  Left = 0
  Top = 0
  Caption = #1057#1087#1088#1072#1074#1086#1095#1085#1080#1082' '#1058#1086#1074#1072#1088'+'#1042#1080#1076' <'#1055#1072#1088#1072#1084#1077#1090#1088#1099' '#1082#1072#1095#1077#1089#1090#1074#1077#1085#1085#1086#1075#1086' '#1091#1076#1086#1089#1090#1086#1074#1077#1088#1077#1085#1080#1103'>'
  ClientHeight = 347
  ClientWidth = 1039
  Color = clBtnFace
  ...
  object cxGrid: TcxGrid
    ...
    object cxGridDBTableView: TcxGridDBTableView
      ...
      object Value1_gk: TcxGridDBColumn
        ...
        HeaderAlignmentHorz = taCenter
        HeaderAlignmentVert = vaCenter
        HeaderHint = #1076#1083#1103' '#1074#1080#1076#1072' '#1090#1086#1074#1072#1088#1072' - '#1042#1080#1076' '#1086#1073#1086#1083#1086#1085#1082#1080', '#8470'4'
        Width = 70
      end
  ...
  object spSelect: TdsdStoredProc
    StoredProcName = 'gpSelect_Object_GoodsByGoodsKindQuality'
    DataSet = ClientDataSet
    DataSets = <
      item
        DataSet = ClientDataSet
  ...
  object spInsertUpdateObject: TdsdStoredProc
    StoredProcName = 'gpInsertUpdate_Object_GoodsByGoodsKindQuality'
    DataSets = <>
    OutputType = otResult
    Params = <
      item
      ...
      item
        ...
        Value = Null
        Component = ClientDataSet
        ComponentItem = 'Value11_gk'
        DataType = ftString
        ParamType = ptInput
        MultiSelectSeparator = ','
      end
      item
        Name = 'inNormInDays_gk'
        Value = Null
        Component = ClientDataSet
        ComponentItem = 'NormInDays_gk'
        DataType = ftFloat
        ParamType = ptInput
        MultiSelectSeparator = ','
      end
