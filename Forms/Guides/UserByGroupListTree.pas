...
uses
  ...
  dsdAddOn, dxBarExtItems, cxCheckBox, cxSplitter, dxSkinsCore, dxSkinBlack,
...
type
  TUserByGroupListTreeForm = class(TParentForm)
    cxGrid: TcxGrid;
...
initialization
  RegisterClass(TUserByGroupListTreeForm);
