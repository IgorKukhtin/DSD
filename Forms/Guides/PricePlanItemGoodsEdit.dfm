object PricePlanItemGoodsEditForm: TPricePlanItemGoodsEditForm
  Left = 0
  Top = 0
  Caption = #1044#1086#1073#1072#1074#1080#1090#1100'/'#1048#1079#1084#1077#1085#1080#1090#1100' <'#1062#1077#1085#1091'> ('#1087#1083#1072#1085')'
  ClientHeight = 217
  ClientWidth = 412
  Color = clBtnFace
  ...
  object spGet: TdsdStoredProc
    StoredProcName = 'gpGet_ObjectHistory_PricePlanItem'
    DataSets = <>
    OutputType = otResult
    Params = <
      item
