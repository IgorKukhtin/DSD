object MemberSheetWorkTimeForm: TMemberSheetWorkTimeForm
  Left = 0
  Top = 0
  Caption = #1057#1087#1088#1072#1074#1086#1095#1085#1080#1082' <'#1044#1086#1089#1090#1091#1087' '#1082' '#1058#1072#1073#1077#1083#1102' '#1088#1072#1073#1086#1095#1077#1075#1086' '#1074#1088#1077#1084#1077#1085#1080'>'
  ClientHeight = 374
  ClientWidth = 950
  Color = clBtnFace
  ...
  object ActionList: TActionList
    ...
    object actInsert: TdsdInsertUpdateAction
      ...
      ShortCut = 45
      ImageIndex = 0
      FormName = 'TMemberSheetWorkTimeEditForm'
      FormNameParam.Value = 'TMemberSheetWorkTimeEditForm'
  ...
  object spSelect: TdsdStoredProc
    StoredProcName = 'gpSelect_Object_MemberSheetWorkTime'
    DataSet = ClientDataSet
    DataSets = <
      item
        DataSet = ClientDataSet
  ...
  object spUpdate: TdsdStoredProc
    StoredProcName = 'gpInsertUpdate_Object_MemberSheetWorkTime'
    DataSets = <>
    OutputType = otResult
    Params = <
      item
