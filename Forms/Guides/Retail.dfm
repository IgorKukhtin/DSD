object RetailForm: TRetailForm
  ...
  object ActionList: TActionList
    ...
    object actStartLoad: TMultiAction
      ...
      QuestionBeforeExecute = #1053#1072#1095#1072#1090#1100' '#1079#1072#1075#1088#1091#1079#1082#1091' '#1057#1086#1090#1088#1091#1076#1085#1080#1082' (KAM) '#1080#1079' '#1092#1072#1081#1083#1072' ?'
      ...
      Caption = #1047#1072#1075#1088#1091#1079#1080#1090#1100' '#1080#1079' '#1101#1082#1089#1077#1083#1103' '#1057#1086#1090#1088#1091#1076#1085#1080#1082' (KAM)'
      Hint = #1047#1072#1075#1088#1091#1079#1080#1090#1100' '#1080#1079' '#1101#1082#1089#1077#1083#1103' '#1057#1086#1090#1088#1091#1076#1085#1080#1082' (KAM)'
      ImageIndex = 41
    end
  end
  ...
  object spGetImportSettingId: TdsdStoredProc
    ...
    Params = <
      item
        Name = 'inDefaultKey'
        Value = 'TRetailForm;zc_Object_ImportSetting_Retail_KAM'
        DataType = ftString
        ParamType = ptInput
        MultiSelectSeparator = ','
      end
