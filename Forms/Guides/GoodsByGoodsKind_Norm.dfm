inherited GoodsByGoodsKind_NormForm: TGoodsByGoodsKind_NormForm
  Caption = #1057#1087#1088#1072#1074#1086#1095#1085#1080#1082' <'#1055#1072#1088#1072#1084#1077#1090#1088#1099' '#1058#1086#1074#1072#1088' '#1080' '#1042#1080#1076' '#1090#1086#1074#1072#1088#1072'> ('#1085#1086#1088#1084#1072')'
  ClientHeight = 420
  ClientWidth = 1030
  ExplicitWidth = 1046
  ExplicitHeight = 458
  ...
  object spUpdate: TdsdStoredProc
    StoredProcName = 'gpUpdate_Object_GoodsByGoodsKind_Norm'
    DataSets = <>
    OutputType = otResult
    Params = <
      item
