...
uses
  ...
  dxSkinXmas2008Blue, dsdCommon, Vcl.ExtCtrls;

type
  TContractJuridicalChoiceForm = class(TAncestorEnumForm)
...
registerClass(TContractJuridicalChoiceForm);
