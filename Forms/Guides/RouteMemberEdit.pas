...
uses
  ...
  cxLabel, cxTextEdit, dsdGuides, cxMaskEdit, cxButtonEdit, cxMemo;

type
  TRouteMemberEditForm = class(TParentForm)
    cxButton1: TcxButton;
    cxButton2: TcxButton;
    Код: TcxLabel;
...
initialization
  RegisterClass(TRouteMemberEditForm);
