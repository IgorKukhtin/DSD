unit MobileGoodsByGoodsKind_Object;
...
type
  TMobileGoodsByGoodsKind_ObjectForm = class(TParentForm)
...
initialization
  RegisterClass(TMobileGoodsByGoodsKind_ObjectForm);
