unit Report_JuridicalDefermentPayment_Branch;
...
type
  TReport_JuridicalDefermentPayment_BranchForm = class(TAncestorReportForm)
...
initialization
  RegisterClass(TReport_JuridicalDefermentPayment_BranchForm);
