unit Report_ProductionUnion_TaxExitUpdateDialog;
...
type
  TReport_ProductionUnion_TaxExitUpdateDialogForm = class(TParentForm)
    cxButton1: TcxButton;
    cxButton2: TcxButton;
    deEnd: TcxDateEdit;
    deStart: TcxDateEdit;
...
initialization
  RegisterClass(TReport_ProductionUnion_TaxExitUpdateDialogForm);
