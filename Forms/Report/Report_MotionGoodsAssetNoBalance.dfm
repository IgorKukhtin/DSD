object Report_MotionGoodsAssetNoBalanceForm: TReport_MotionGoodsAssetNoBalanceForm
  Left = 0
  Top = 0
  Caption = #1054#1090#1095#1077#1090' <'#1044#1074#1080#1078#1077#1085#1080#1077' '#1054#1057' ('#1079#1072#1073#1072#1083#1072#1085#1089')>'
  ClientHeight = 545
  ClientWidth = 1344
  Color = clBtnFace
  ...
  object cxGrid: TcxGrid
    ...
    object cxGridDBTableView: TcxGridDBTableView
      ...
      object PartnerName_Partion: TcxGridDBColumn
      ...
      object Release_Partion: TcxGridDBColumn
      ...
      object Year_car: TcxGridDBColumn
        Caption = #1043#1086#1076' '#1074#1099#1087#1091#1089#1082#1072' ('#1072#1074#1090#1086')'
        DataBinding.FieldName = 'Year_car'
        HeaderAlignmentHorz = taCenter
        HeaderAlignmentVert = vaCenter
        Options.Editing = False
        Width = 80
  ...
  object dxBarManager: TdxBarManager
    ...
    object dxBarManagerBar1: TdxBar
      ...
      ItemLinks = <
        ...
        item
          Visible = True
          ItemName = 'bbPrint_PP_3'
        end
        item
          Visible = True
          ItemName = 'bbPrint_PP_3_3'
        end
        item
          Visible = True
          ItemName = 'bbPrint_PP_3_1'
        end
        item
          Visible = True
          ItemName = 'dxBarStatic'
    ...
    object bbPrint_PP_3_3: TdxBarButton
      Action = actPrint_PP_3_3
      Category = 0
    end
    object bbPrint_PP_3_1: TdxBarButton
      Action = actPrint_PP_3_1
      Category = 0
      ImageIndex = 15
    end
  end
  object ActionList: TActionList
    ...
    object actPrint_PP_3_1: TdsdPrintAction
      Category = 'DSDLib'
      MoveParams = <>
      StoredProcList = <>
      Caption = #1040#1082#1090' '#1087#1088#1080#1077#1084#1086'-'#1087#1077#1088#1077#1076#1072#1095#1080' ('#1054#1057') '#1072#1074#1090#1086
      Hint = #1040#1082#1090' '#1087#1088#1080#1077#1084#1086'-'#1087#1077#1088#1077#1076#1072#1095#1080' ('#1054#1057') '#1072#1074#1090#1086
      ImageIndex = 21
      DataSets = <
        item
          UserName = 'frxDBDMaster'
          IndexFieldNames = 'NumGroup_print;LocationName;CarName;AssetToName;GoodsName;'
          GridView = cxGridDBTableView
        end>
      Params = <
        item
    ...
    object actPrint_PP_3_3: TdsdPrintAction
      Category = 'DSDLib'
      MoveParams = <>
      StoredProcList = <>
      Caption = #1040#1082#1090' '#1087#1088#1080#1077#1084#1086'-'#1087#1077#1088#1077#1076#1072#1095#1080' ('#1054#1057')'
      Hint = #1040#1082#1090' '#1087#1088#1080#1077#1084#1086'-'#1087#1077#1088#1077#1076#1072#1095#1080' ('#1054#1057')'
      ImageIndex = 21
      DataSets = <
        item
          UserName = 'frxDBDMaster'
          IndexFieldNames = 
            'NumGroup_print;LocationName;AssettoGroupName;AssetToName;GoodsNa' +
            'me;Release_Partion;Model_Partion'
          GridView = cxGridDBTableView
        end>
      Params = <
        item
    ...
    object actPrint_PP_3_2: TdsdPrintAction
      Category = 'DSDLib'
      MoveParams = <>
      StoredProcList = <>
      Caption = #1040#1082#1090' '#1087#1088#1080#1077#1084#1086'-'#1087#1077#1088#1077#1076#1072#1095#1080' ('#1054#1057') '#1086#1092#1110#1089
      Hint = #1040#1082#1090' '#1087#1088#1080#1077#1084#1086'-'#1087#1077#1088#1077#1076#1072#1095#1080' ('#1054#1057') '#1086#1092#1110#1089
      ImageIndex = 18
      DataSets = <
        item
          UserName = 'frxDBDMaster'
    ...
    object actPrint_PP: TdsdPrintAction
      ...
      MoveParams = <>
      StoredProcList = <>
      Caption = #1040#1082#1090' '#1087#1088#1080#1077#1084#1086'-'#1087#1077#1088#1077#1076#1072#1095#1080
      Hint = #1040#1082#1090' '#1087#1088#1080#1077#1084#1086'-'#1087#1077#1088#1077#1076#1072#1095#1080
      ImageIndex = 18
      DataSets = <
        item
          UserName = 'frxDBDMaster'
          IndexFieldNames = 
            'AssettoGroupName;AssetToName;GoodsName;Release_Partion;Model_Par' +
            'tion'
          GridView = cxGridDBTableView
        end>
      Params = <
      ...
      ReportName = #1040#1082#1090' '#1087#1088#1080#1077#1084#1086'-'#1087#1077#1088#1077#1076#1072#1095#1080' ('#1054#1057' '#1079#1072#1073#1072#1083#1072#1085#1089')'
      ReportNameParam.Value = #1040#1082#1090' '#1087#1088#1080#1077#1084#1086'-'#1087#1077#1088#1077#1076#1072#1095#1080' ('#1054#1057' '#1079#1072#1073#1072#1083#1072#1085#1089')'
      ReportNameParam.DataType = ftString
      ReportNameParam.MultiSelectSeparator = ','
      PrinterNameParam.Value = ''
      PrinterNameParam.DataType = ftString
  ...
  object spReport: TdsdStoredProc
    StoredProcName = 'gpReport_MotionGoods_AssetNoBalance'
    DataSet = MasterCDS
    DataSets = <
      item
        DataSet = MasterCDS
