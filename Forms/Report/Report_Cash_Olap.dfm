object Report_Cash_OlapForm: TReport_Cash_OlapForm
  ...
  object cxDBPivotGrid: TcxDBPivotGrid
    ...
    Groups = <>
    OptionsView.RowGrandTotalWidth = 638
    TabOrder = 1
    ...
    object pvStartAmountD: TcxDBPivotGridField
      Area = faData
      AreaIndex = 5
      AllowedAreas = [faFilter, faData]
      IsCaptionAssigned = True
    ...
    object pvStartAmountK: TcxDBPivotGridField
      Area = faData
      AreaIndex = 7
      AllowedAreas = [faFilter, faData]
      IsCaptionAssigned = True
    ...
    object pvStartAmount_Currency: TcxDBPivotGridField
      Area = faData
      AreaIndex = 4
      AllowedAreas = [faFilter, faData]
      IsCaptionAssigned = True
    ...
    object pvStartAmountD_Currency: TcxDBPivotGridField
      Area = faData
      AreaIndex = 6
      AllowedAreas = [faFilter, faData]
      IsCaptionAssigned = True
    ...
    object pvStartAmountK_Currency: TcxDBPivotGridField
      Area = faData
      AreaIndex = 8
      AllowedAreas = [faFilter, faData]
      IsCaptionAssigned = True
    ...
    object pvEndAmountD: TcxDBPivotGridField
      Area = faData
      AreaIndex = 0
      AllowedAreas = [faFilter, faData]
      IsCaptionAssigned = True
    ...
    object pvEndAmountK: TcxDBPivotGridField
      Area = faData
      AreaIndex = 15
      AllowedAreas = [faFilter, faData]
      IsCaptionAssigned = True
    ...
    object pvEndAmount_Currency: TcxDBPivotGridField
      Area = faData
      AreaIndex = 14
      AllowedAreas = [faFilter, faData]
      IsCaptionAssigned = True
    ...
    object pvEndAmountD_Currency: TcxDBPivotGridField
      Area = faData
      AreaIndex = 1
      AllowedAreas = [faFilter, faData]
      IsCaptionAssigned = True
    ...
    object pvEndAmountK_Currency: TcxDBPivotGridField
      Area = faData
      AreaIndex = 16
      AllowedAreas = [faFilter, faData]
      IsCaptionAssigned = True
