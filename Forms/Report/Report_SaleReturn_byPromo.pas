unit Report_SaleReturn_byPromo;
...
type
  TReport_SaleReturn_byPromoForm = class(TParentForm)
    ...
    cxLabel25: TcxLabel;
    deOperDatePromo: TcxDateEdit;
    edInvNumberPromo: TcxButtonEdit;
...
initialization
  RegisterClass(TReport_SaleReturn_byPromoForm);
