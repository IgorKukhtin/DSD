unit Report_GoodsMI_IncomeByPartnerDialog;
...
type
  TReport_GoodsMI_IncomeByPartnerDialogForm = class(TParentForm)
    cxButton1: TcxButton;
    cxButton2: TcxButton;
    deEnd: TcxDateEdit;
    deStart: TcxDateEdit;
...
initialization
  RegisterClass(TReport_GoodsMI_IncomeByPartnerDialogForm);
