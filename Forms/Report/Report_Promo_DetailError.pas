...
type
  TReport_Promo_DetailErrorForm = class(TAncestorReportForm)
    ...
    macInsertUpdate_list: TMultiAction;
...
{$R *.dfm}
initialization
  RegisterClass(TReport_Promo_DetailErrorForm);
