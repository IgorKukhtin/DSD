unit Report_PersonalGroupSummAdd;
...
type
  TReport_PersonalGroupSummAddForm = class(TAncestorReportForm)
    ...
    NormHour: TcxGridDBColumn;
    Hour_work: TcxGridDBColumn;
...
{$R *.dfm}
initialization
  RegisterClass(TReport_PersonalGroupSummAddForm);
