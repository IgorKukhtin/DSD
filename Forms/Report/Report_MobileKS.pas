...
type
  TReport_MobileKSForm = class(TParentForm)
    ...
    N4: TMenuItem;
    N5: TMenuItem;
    cxGridDBTableViewDateList: TcxGridDBColumn;
    cxGrid1: TcxGrid;
    gridReport: TcxGridDBTableView;
    gridReportMobilePhone: TcxGridDBColumn;
    gridReportEmployeeName: TcxGridDBColumn;
    gridReportRegion: TcxGridDBColumn;
    gridReportTotalSum: TcxGridDBColumn;
    gridReportTariffName: TcxGridDBColumn;
    gridReportMonthly: TcxGridDBColumn;
    gridReportNavigator: TcxGridDBColumn;
    gridReportLim: TcxGridDBColumn;
    gridReportLimOver: TcxGridDBColumn;
    gridReportLimDuty: TcxGridDBColumn;
    cxGridLevel1: TcxGridLevel;
    DataSource1: TDataSource;
    ClientDataSet1: TClientDataSet;
    dsdStoredProc1: TdsdStoredProc;
    dsdDBViewAddOn1: TdsdDBViewAddOn;
    gridReportBillDate: TcxGridDBColumn;
