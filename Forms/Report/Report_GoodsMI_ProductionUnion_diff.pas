unit Report_GoodsMI_ProductionUnion_diff;
...
type
  TReport_GoodsMI_ProductionUnion_diffForm = class(TAncestorReportForm)
...
{$R *.dfm}
initialization
  RegisterClass(TReport_GoodsMI_ProductionUnion_diffForm);
