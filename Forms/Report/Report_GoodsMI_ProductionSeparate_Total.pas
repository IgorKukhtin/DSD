unit Report_GoodsMI_ProductionSeparate_Total;
...
type
  TReport_GoodsMI_ProductionSeparate_TotalForm = class(TAncestorReportForm)
...
{$R *.dfm}
initialization
  RegisterClass(TReport_GoodsMI_ProductionSeparate_TotalForm);
