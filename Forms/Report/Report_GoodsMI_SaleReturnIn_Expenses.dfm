inherited Report_GoodsMI_SaleReturnIn_ExpensesForm: TReport_GoodsMI_SaleReturnIn_ExpensesForm
  Caption = #1054#1090#1095#1077#1090' <'#1055#1088#1086#1076#1072#1078#1072' / '#1042#1086#1079#1074#1088#1072#1090' '#1087#1086' '#1087#1086#1082#1091#1087#1072#1090#1077#1083#1103#1084'> (+'#1079#1072#1090#1088#1072#1090#1099')'
  ClientHeight = 387
  ClientWidth = 1362
  ...
  inherited spSelect: TdsdStoredProc
    StoredProcName = 'gpReport_GoodsMI_SaleReturnIn_Expenses'
    DataSets = <
      item
        DataSet = MasterCDS
      end
