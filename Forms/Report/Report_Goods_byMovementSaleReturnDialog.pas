unit Report_Goods_byMovementSaleReturnDialog;
...
type
  TReport_Goods_byMovementSaleReturnDialogForm = class(TParentForm)
    cxButton1: TcxButton;
    cxButton2: TcxButton;
    deEnd: TcxDateEdit;
    deStart: TcxDateEdit;
...
initialization
  RegisterClass(TReport_Goods_byMovementSaleReturnDialogForm);
