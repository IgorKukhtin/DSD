unit Report_GoodsMI_SaleReturnIn_Expenses;
...
type
  TReport_GoodsMI_SaleReturnIn_ExpensesForm = class(TAncestorReportForm)
...
{$R *.dfm}
initialization
  RegisterClass(TReport_GoodsMI_SaleReturnIn_ExpensesForm);
