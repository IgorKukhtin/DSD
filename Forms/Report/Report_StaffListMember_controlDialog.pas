unit Report_StaffListMember_controlDialog;
...
type
  TReport_StaffListMember_controlDialogForm = class(TAncestorDialogForm)
    cxLabel17: TcxLabel;
...
initialization
  RegisterClass(TReport_StaffListMember_controlDialogForm);
end.
