unit Report_OrderReturnTare_SaleByTransport;
...
type
  TReport_OrderReturnTare_SaleByTransportForm = class(TAncestorReportForm)
...
initialization
  RegisterClass(TReport_OrderReturnTare_SaleByTransportForm);
