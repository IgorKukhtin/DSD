unit Report_StaffListMember_byPersonal;
...
type
  TReport_StaffListMember_byPersonalForm = class(TAncestorReportForm)
    cxLabel3: TcxLabel;
...
{$R *.dfm}
initialization
  RegisterClass(TReport_StaffListMember_byPersonalForm);
end.
