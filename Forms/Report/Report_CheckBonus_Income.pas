...
type
  TReport_CheckBonus_IncomeForm = class(TAncestorReportForm)
    ...
    Sum_IncomeFact: TcxGridDBColumn;
...
{$R *.dfm}
initialization
  RegisterClass(TReport_CheckBonus_IncomeForm);
