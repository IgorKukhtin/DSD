unit Report_GoodsMI_SaleReturnInNotOlap;
...
type
  TReport_GoodsMI_SaleReturnInNotOlapForm = class(TAncestorReportForm)
...
{$R *.dfm}
initialization
  RegisterClass(TReport_GoodsMI_SaleReturnInNotOlapForm);
