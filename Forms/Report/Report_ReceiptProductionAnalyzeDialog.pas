unit Report_ReceiptProductionAnalyzeDialog;
...
type
  TReport_ReceiptProductionAnalyzeDialogForm = class(TParentForm)
    cxButton1: TcxButton;
    cxButton2: TcxButton;
    deEnd: TcxDateEdit;
    deStart: TcxDateEdit;
...
initialization
  RegisterClass(TReport_ReceiptProductionAnalyzeDialogForm);
