      ...
      inherited cxGrid: TcxGrid
        ...
        inherited cxGridDBTableView: TcxGridDBTableView
          ...
          object OperDate_Master: TcxGridDBColumn
            ...
            HeaderAlignmentHorz = taCenter
            HeaderAlignmentVert = vaCenter
            HeaderHint = #1044#1072#1090#1072' ('#1089#1082#1083#1072#1076') '#1076#1086#1082'. '#1087#1088#1086#1076#1072#1078#1080' / '#1087#1077#1088#1077#1084#1077#1097'.'#1087#1086' '#1094#1077#1085#1077
            Width = 60
          end
          object OperDatePartner_Master: TcxGridDBColumn
            ...
            HeaderAlignmentHorz = taCenter
            HeaderAlignmentVert = vaCenter
            HeaderHint = #1044#1072#1090#1072' '#1076#1086#1082'. '#1091' '#1087#1086#1082#1091#1087'. '#1087#1088#1086#1076#1072#1078#1080' / '#1087#1077#1088#1077#1084#1077#1097'.'#1087#1086' '#1094#1077#1085#1077
            Width = 60
          end
          ...
          object Amount_child_one: TcxGridDBColumn
            ...
            DataBinding.FieldName = 'Amount_child_one'
            PropertiesClassName = 'TcxCurrencyEditProperties'
            Properties.DecimalPlaces = 4
            Properties.DisplayFormat = ',0.####;-,0.####; ;'
            Visible = False
          ...
          object Amount_child_sec: TcxGridDBColumn
            Caption = #1048#1090#1086#1075#1086' '#1088#1077#1079#1077#1088#1074'-2'
          ...
          object Amount_diff: TcxGridDBColumn
            ...
            HeaderAlignmentHorz = taCenter
            HeaderAlignmentVert = vaCenter
            HeaderHint = #1048#1090#1086#1075#1086' '#1085#1077' '#1093#1074#1072#1090#1072#1077#1090' '#1076#1083#1103' '#1088#1077#1079#1077#1088#1074#1072
            Options.Editing = False
            Width = 87
          end
    ...
    object actPrint_byRemains: TdsdPrintAction
      ...
      DataSets = <
        item
          DataSet = ItemsCDS
          UserName = 'frxDBDMaster'
          IndexFieldNames = 'ToName;GoodsGroupName;GoodsName_SubSend;GoodsKindName'
        end>
      Params = <
        item
          Name = 'StartDate'
    ...
    object actPrintReservRetail: TdsdPrintAction
      ...
      DataSets = <
        item
          UserName = 'frxDBDMaster'
          IndexFieldNames = 
            'OperDate_CarInfo_date;GoodsGroupName;GoodsName;GoodsKindName;Ope' +
            'rDate_CarInfo;'
