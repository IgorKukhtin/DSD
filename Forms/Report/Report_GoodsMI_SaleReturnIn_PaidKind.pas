unit Report_GoodsMI_SaleReturnIn_PaidKind;
...
type
  TReport_GoodsMI_SaleReturnIn_PaidKindForm = class(TAncestorReportForm)
...
{$R *.dfm}
initialization
  RegisterClass(TReport_GoodsMI_SaleReturnIn_PaidKindForm);
