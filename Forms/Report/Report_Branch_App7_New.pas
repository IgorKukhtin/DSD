...
type
  TReport_Branch_App7_NewForm = class(TAncestorReportForm)
    Amount7: TcxGridDBColumn;
    Amount9: TcxGridDBColumn;
    Amount12: TcxGridDBColumn;
    FormParams: TdsdFormParams;
    NomStr: TcxGridDBColumn;
    cxLabel3: TcxLabel;
...
{$R *.dfm}
initialization
  RegisterClass(TReport_Branch_App7_NewForm);
