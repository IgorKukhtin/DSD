object GuideSubjectDocForm: TGuideSubjectDocForm
  Left = 578
  Top = 242
  ...
  object GridPanel: TPanel
    ...
    object cxDBGrid: TcxGrid
      ...
      object cxDBGridDBTableView: TcxGridDBTableView
        ...
        object SubjectDocCode: TcxGridDBColumn
  ...
  object ParamsPanel: TPanel
    ...
    BevelOuter = bvNone
    TabOrder = 1
    object gbSubjectDocCode: TGroupBox
      Left = 0
      Top = 0
      Width = 137
      Height = 41
      ...
      Caption = #1050#1086#1076
      TabOrder = 0
      object EditSubjectDocCode: TEdit
        Left = 5
        Top = 17
        Width = 125
        Height = 22
        TabOrder = 0
        Text = 'EditSubjectDocCode'
        OnChange = EditSubjectDocCodeChange
        OnEnter = EditSubjectDocCodeEnter
        OnKeyDown = EditSubjectDocCodeKeyDown
        OnKeyPress = EditSubjectDocCodeKeyPress
      end
    end
    object gbSubjectDocName: TGroupBox
      Left = 137
      Top = 0
      Width = 594
      Height = 41
      ...
      Caption = #1053#1072#1079#1074#1072#1085#1080#1077
      TabOrder = 1
      object EditSubjectDocName: TEdit
        Left = 5
        Top = 17
        Width = 332
        Height = 22
        TabOrder = 0
        Text = 'EditSubjectDocName'
        OnChange = EditSubjectDocNameChange
        OnEnter = EditSubjectDocNameEnter
        OnKeyDown = EditSubjectDocNameKeyDown
        OnKeyPress = EditSubjectDocNameKeyPress
      end
    end
  end
