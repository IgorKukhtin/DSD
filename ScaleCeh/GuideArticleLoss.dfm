object GuideArticleLossForm: TGuideArticleLossForm
  Left = 578
  Top = 242
  ...
  object ParamsPanel: TPanel
    ...
    BevelOuter = bvNone
    TabOrder = 1
    object gbArticleLossCode: TGroupBox
      Left = 0
      Top = 0
      Width = 137
      Height = 41
      ...
      Caption = #1050#1086#1076
      TabOrder = 0
      object EditArticleLossCode: TEdit
        Left = 5
        Top = 17
        Width = 125
        Height = 22
        TabOrder = 0
        Text = 'EditArticleLossCode'
        OnChange = EditArticleLossCodeChange
        OnEnter = EditArticleLossCodeEnter
        OnKeyDown = EditArticleLossCodeKeyDown
        OnKeyPress = EditArticleLossCodeKeyPress
      end
    end
    object gbArticleLossName: TGroupBox
      Left = 137
      Top = 0
      Width = 594
      Height = 41
      ...
      Caption = #1053#1072#1079#1074#1072#1085#1080#1077
      TabOrder = 1
      object EditArticleLossName: TEdit
        Left = 5
        Top = 17
        Width = 332
        Height = 22
        TabOrder = 0
        Text = 'EditArticleLossName'
        OnChange = EditArticleLossNameChange
        OnEnter = EditArticleLossNameEnter
        OnKeyDown = EditArticleLossNameKeyDown
        OnKeyPress = EditArticleLossNameKeyPress
      end
    end
  end
