object GuidePersonalGroupForm: TGuidePersonalGroupForm
  Left = 578
  Top = 242
  Caption = #1057#1087#1088#1072#1074#1086#1095#1085#1080#1082' <'#8470' '#1041#1088#1080#1075#1072#1076#1099'>'
  ClientHeight = 572
  ClientWidth = 731
  Color = clBtnFace
  ...
  object GridPanel: TPanel
    ...
    object cxDBGrid: TcxGrid
      ...
      object cxDBGridDBTableView: TcxGridDBTableView
        ...
        object PersonalGroupCode: TcxGridDBColumn
          Caption = #1050#1086#1076
          DataBinding.FieldName = 'PersonalGroupCode'
  ...
  object ParamsPanel: TPanel
    ...
    BevelOuter = bvNone
    TabOrder = 1
    object gbPersonalGroupCode: TGroupBox
      Left = 0
      Top = 0
      Width = 137
      Height = 41
      ...
      object EditPersonalGroupCode: TEdit
        ...
        Height = 22
        TabOrder = 0
        Text = 'EditPersonalGroupCode'
        OnChange = EditPersonalGroupCodeChange
        OnEnter = EditPersonalGroupCodeEnter
        OnKeyDown = EditPersonalGroupCodeKeyDown
        OnKeyPress = EditPersonalGroupCodeKeyPress
      end
    end
    object gbPersonalGroupName: TGroupBox
      Left = 137
      Top = 0
      Width = 594
      Height = 41
      ...
      Caption = #1053#1072#1079#1074#1072#1085#1080#1077
      TabOrder = 1
      object EditPersonalGroupName: TEdit
        Left = 6
        Top = 16
        Width = 332
        Height = 22
        TabOrder = 0
        Text = 'EditPersonalGroupName'
        OnChange = EditPersonalGroupNameChange
        OnEnter = EditPersonalGroupNameEnter
        OnKeyDown = EditPersonalGroupNameKeyDown
        OnKeyPress = EditPersonalGroupNameKeyPress
      end
    end
  end
