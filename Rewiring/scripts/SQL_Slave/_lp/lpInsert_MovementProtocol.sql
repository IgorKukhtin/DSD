...
BEGIN
  ...
  THEN
    ...
    -- Сохранили
    INSERT INTO _replica.MovementProtocol_Rewiring (Transaction_Id, MovementId, OperDate, UserId, ProtocolData, isInsert)
                                            VALUES (txid_current(), inMovementId, CURRENT_TIMESTAMP, inUserId, vbProtocolXML, inIsInsert);
