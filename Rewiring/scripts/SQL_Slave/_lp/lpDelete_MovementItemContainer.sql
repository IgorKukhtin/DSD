...
BEGIN
    ...
    -- Если роль перепроводка то пишем в _Rewiring 
    IF _replica.zc_isUserRewiring() = TRUE
    THEN

      -- Удалить все проводки если вдруг ранее перепроводили
      
      DELETE FROM _replica.MovementItemContainer_Rewiring  WHERE MovementId = inMovementId;
