...
/*    IF zc_IsLockTable() = TRUE
    ...
    THEN
     -- сохранили проводки
     INSERT INTO _replica.MovementItemContainer_Rewiring 
                                       (DescId, Transaction_Id, MovementDescId, MovementId, MovementItemId, ParentId, ContainerId
                                ...
                                VALUES (inDescId, txid_current(), inMovementDescId, inMovementId, inMovementItemId, inParentId, inContainerId
