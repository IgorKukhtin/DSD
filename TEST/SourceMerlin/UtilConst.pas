...
Type
  ...
  TdsdProject = (prProject, prFarmacy, prBoutique, prBoat, prMerlin) ;
...
var
  ...
  LocalProcedurePath: string = '..\DATABASE\Merlin\PROCEDURE\';
  FunctionPath: string = '..\DATABASE\Merlin\Function\';
  ReportsPath: string = '..\DATABASE\Merlin\Reports\';
  ViewPath: string = '..\DATABASE\Merlin\View\';
  LocalViewPath: string = '..\DATABASE\Merlin\View\';
  ProcessPath: string = '..\DATABASE\Merlin\PROCESS\';
  LocalProcessPath: string = '..\DATABASE\Merlin\PROCESS\';
  gc_AdminPassword: string = 'Админ';
