...
var
  CreateStructurePath: string = '..\DATABASE\Boutique\STRUCTURE\';
...
const
  StructurePath = '..\DATABASE\Boutique\STRUCTURE\';
  FunctionsPath = '..\DATABASE\Boutique\FUNCTION\';
  UpdateStructurePath = '..\DATABASE\Boutique\UPDATESTRUCTURE\';
