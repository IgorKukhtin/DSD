...
// exit;
  ...
  LoadReportFromFile('Отчет по обвалке в документе', ReportPath + '\Отчеты (производство)\Отчет по обвалке в документе.fr3');
  ...
  LoadReportFromFile('Накладная по обвалке', ReportPath + '\Отчеты (производство)\Накладная по обвалке.fr3');
