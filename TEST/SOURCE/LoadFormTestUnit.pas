...
uses CommonDataUnit, StorageUnit, FormStorageUnit, Classes,
     AuthenticationUnit, SysUtils;
...
initialization
  TestFramework.RegisterTest('LoadForm', TLoadFormTest.Suite);
