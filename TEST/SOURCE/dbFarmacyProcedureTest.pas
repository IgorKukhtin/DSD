...
begin
  ...
  ExecFile(CommonProcedurePath + 'OBJECTS\ContractÑonditionKind\gpSelect_Object_ContractÑonditionKind.sql', ZQuery);
...
initialization
  TestFramework.RegisterTest('Ïðîöåäóðû', TdbProcedureTest.Suite);
