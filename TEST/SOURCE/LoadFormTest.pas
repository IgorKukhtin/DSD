...
begin
  ...
  TdsdFormStorageFactory.GetStorage.Save(GetForm('TCash_BranchForm'));
  TdsdFormStorageFactory.GetStorage.Load('TCash_BranchForm');
{
...
begin
  ...
  //Категория (Признак дог.)
  TdsdFormStorageFactory.GetStorage.Save(GetForm('TContractTagKindForm'));
  TdsdFormStorageFactory.GetStorage.Load('TContractTagKindForm');
  TdsdFormStorageFactory.GetStorage.Save(GetForm('TContractTagKindEditForm'));
  TdsdFormStorageFactory.GetStorage.Load('TContractTagKindEditForm');
end;
...
begin
  ...
  {
  TdsdFormStorageFactory.GetStorage.Save(GetForm('TInfoMoney_OrderFinanceForm'));
  TdsdFormStorageFactory.GetStorage.Load('TInfoMoney_OrderFinanceForm');
...
begin
{
  ...
  TdsdFormStorageFactory.GetStorage.Save(GetForm('TChangeСurrencyUserDialogForm'));
  TdsdFormStorageFactory.GetStorage.Load('TChangeСurrencyUserDialogForm');
...
begin
  ...
  TdsdFormStorageFactory.GetStorage.Load('TSaleCommercForm');
  TdsdFormStorageFactory.GetStorage.Save(GetForm('TSaleCommercJournalForm'));
  TdsdFormStorageFactory.GetStorage.Load('TSaleCommercJournalForm');
end;
...
begin
  TdsdFormStorageFactory.GetStorage.Save(GetForm('TReport_OrderExternal_WeighingPartnerForm'));
  TdsdFormStorageFactory.GetStorage.Load('TReport_OrderExternal_WeighingPartnerForm');
  //exit;
  {
...
begin
  ...
  TdsdFormStorageFactory.GetStorage.Save(GetForm('TReport_CommercBonusForm'));
  TdsdFormStorageFactory.GetStorage.Load('TReport_CommercBonusForm');
  TdsdFormStorageFactory.GetStorage.Save(GetForm('TReport_CommercBonusDialogForm'));
  TdsdFormStorageFactory.GetStorage.Load('TReport_CommercBonusDialogForm');
  exit;
{
...
begin
  ...
  TdsdFormStorageFactory.GetStorage.Save(GetForm('TReport_SoldTable_Commerc_tableForm'));
  TdsdFormStorageFactory.GetStorage.Load('TReport_SoldTable_Commerc_tableForm');
...
procedure TLoadFormTest.LoadPromoSchemaKindFormTest;
begin
  TdsdFormStorageFactory.GetStorage.Save(GetForm('TPromoSchemaKindForm'));
  TdsdFormStorageFactory.GetStorage.Load('TPromoSchemaKindForm');
end;

procedure TLoadFormTest.LoadPromoDiscountKindFormTest;
begin
  TdsdFormStorageFactory.GetStorage.Save(GetForm('TPromoDiscountKindForm'));
  TdsdFormStorageFactory.GetStorage.Load('TPromoDiscountKindForm');
end;
...
procedure TLoadFormTest.LoadRouteTTFormTest;
begin
  TdsdFormStorageFactory.GetStorage.Save(GetForm('TRouteTTForm'));
  TdsdFormStorageFactory.GetStorage.Load('TRouteTTForm');
  TdsdFormStorageFactory.GetStorage.Save(GetForm('TRouteTTEditForm'));
  TdsdFormStorageFactory.GetStorage.Load('TRouteTTEditForm');
 end;
...
begin
 ...
 procedure TLoadFormTest.LoadStaffListMovementFormTest;
begin

  TdsdFormStorageFactory.GetStorage.Save(GetForm('TStaffListJournalForm'));
