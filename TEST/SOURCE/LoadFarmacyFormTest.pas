...
begin
  ...
  TdsdFormStorageFactory.GetStorage.Save(GetForm('TDiscountExternalSupplierEditForm'));
  TdsdFormStorageFactory.GetStorage.Load('TDiscountExternalSupplierEditForm');
  TdsdFormStorageFactory.GetStorage.Save(GetForm('TDiscountExternalSupplierForm'));
  TdsdFormStorageFactory.GetStorage.Load('TDiscountExternalSupplierForm');
  ...
  TdsdFormStorageFactory.GetStorage.Load('TRecalcMCSShedulerForm');
{
  ...
  TdsdFormStorageFactory.GetStorage.Save(GetForm('TRecalcMCSShedulerMainDialogForm'));
  TdsdFormStorageFactory.GetStorage.Load('TRecalcMCSShedulerMainDialogForm');
...
begin
    ...
    TdsdFormStorageFactory.GetStorage.Save(GetForm('TUKTZEDForm'));
    TdsdFormStorageFactory.GetStorage.Load('TUKTZEDForm');
    TdsdFormStorageFactory.GetStorage.Save(GetForm('TUKTZEDEditForm'));
    TdsdFormStorageFactory.GetStorage.Load('TUKTZEDEditForm')
...
{    TdsdFormStorageFactory.GetStorage.Save(GetForm('TGoodsAdditionalEditForm'));
    ...
    TdsdFormStorageFactory.GetStorage.Save(GetForm('TGoodsWagesForm'));
    TdsdFormStorageFactory.GetStorage.Load('TGoodsWagesForm');
    TdsdFormStorageFactory.GetStorage.Save(GetForm('TGoodsSiteForm'));
    TdsdFormStorageFactory.GetStorage.Load('TGoodsSiteForm');
    TdsdFormStorageFactory.GetStorage.Save(GetForm('TGoodsCashForm'));
    TdsdFormStorageFactory.GetStorage.Load('TGoodsCashForm');
...
begin
  ...
  TdsdFormStorageFactory.GetStorage.Save(GetForm('TListDiffFormVIPSendRemainForm'));
  TdsdFormStorageFactory.GetStorage.Load('TListDiffFormVIPSendRemainForm');
end;
