...
begin
  TdsdFormStorageFactory.GetStorage.Save
    (GetForm('TMarginCategory_MovementForm'));
  ...
  //
  TdsdFormStorageFactory.GetStorage.Save
    (GetForm('TReport_SAMP_AnalysisDialogForm'));
...
begin
  //
  TdsdFormStorageFactory.GetStorage.Save
    (GetForm('TReport_Check_byPromoCodeForm'));
...
begin
  ...
  TdsdFormStorageFactory.GetStorage.Save
    (GetForm('TOrderExternalJournalChoiceForm'));
