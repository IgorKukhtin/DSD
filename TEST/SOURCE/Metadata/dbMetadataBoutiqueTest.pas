...
var
  MetadataPath: string = '..\DATABASE\Boutique\METADATA\';
...
// пустой файл  ExecFile(MetadataPath + 'Movement\CreateMovementLinkMovementDescFunction.sql', ZQuery);
