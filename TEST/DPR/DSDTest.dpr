...
uses
  ...
  InfoMoneyGroup in '..\..\Forms\InfoMoneyGroup.pas' {TInfoMoneyGroupForm},
  InfoMoneyGroupEdit in '..\..\Forms\InfoMoneyGroupEdit.pas' {TInfoMoneyGroupEditForm},
  ...
  InfoMoney in '..\..\Forms\InfoMoney.pas' {TInfoMoneyForm},
  InfoMoneyEdit in '..\..\Forms\InfoMoneyEdit.pas' {TInfoMoneyEditForm},
  AccountGroup in '..\..\Forms\AccountGroup.pas' {TAccountGroupForm},
  AccountGroupEdit in '..\..\Forms\AccountGroupEdit.pas' {TAccountGroupEditForm},
  AccountDirection in '..\..\Forms\AccountDirection.pas' {TAccountDirectionForm},
  AccountDirectionEdit in '..\..\Forms\AccountDirectionEdit.pas' {TAccountDirectionEditForm},
  ProfitLossGroup in '..\..\Forms\ProfitLossGroup.pas' {TProfitLossGroupForm},
  ProfitLossGroupEdit in '..\..\Forms\ProfitLossGroupEdit.pas' {TProfitLossGroupEditForm},
  ProfitLossDirection in '..\..\Forms\ProfitLossDirection.pas' {TProfitLossDirectionForm},
  ProfitLossDirectionEdit in '..\..\Forms\ProfitLossDirectionEdit.pas' {TProfitLossDirectionEditForm},
  Account in '..\..\Forms\Account.pas' {AccountForm},
  AccountEdit in '..\..\Forms\AccountEdit.pas' {TAccountEditForm};
