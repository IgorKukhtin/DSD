...
var
  CreateStructurePath: string = '..\DATABASE\Boat\STRUCTURE\';
...
const
  StructurePath = '..\DATABASE\Boat\STRUCTURE\';
  FunctionsPath = '..\DATABASE\Boat\FUNCTION\';
  UpdateStructurePath = '..\DATABASE\Boat\UPDATESTRUCTURE\';
