...
var
  ...
  ConnectionPath: string = '..\INIT\Boat_init.php';
  SQLiteFile: string = '';
...
//  gc_AdminPassword: string = 'Admin';
  ...
  ProcedurePath: string = '..\DATABASE\Boat\PROCEDURE\';
  LocalProcedurePath: string = '..\DATABASE\Boat\PROCEDURE\';
  FunctionPath: string = '..\DATABASE\Boat\Function\';
  ReportsPath: string = '..\DATABASE\Boat\Reports\';
  ViewPath: string = '..\DATABASE\Boat\View\';
  LocalViewPath: string = '..\DATABASE\Boat\View\';
  ProcessPath: string = '..\DATABASE\Boat\PROCESS\';
  LocalProcessPath: string = '..\DATABASE\Boat\PROCESS\';
