...
uses
  ...
  ChoicePeriod, dxSkinsCore, dxSkinsDefaultPainters, dxSkinscxPCPainter,
  dxSkinsdxBarPainter;

type
  TReportPromoParamsForm = class(TAncestorEnumForm)
...
initialization
  RegisterClass(TReportPromoParamsForm)
