inherited ReportPromoParamsForm: TReportPromoParamsForm
  ...
  inherited spSelect: TdsdStoredProc
    StoredProcName = 'gpSelect_Object_ReportPromoParams'
    Params = <
      item
        Name = 'inPlanDate'
        Value = 'NULL'
  ...
  object spInsertUpdate_Object_ReportSoldParams: TdsdStoredProc
    StoredProcName = 'gpInsertUpdate_Object_ReportPromoParams'
    DataSets = <>
    OutputType = otResult
    Params = <
      item
