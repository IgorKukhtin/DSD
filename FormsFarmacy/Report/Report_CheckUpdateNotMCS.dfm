object Report_CheckUpdateNotMCSForm: TReport_CheckUpdateNotMCSForm
  Left = 0
  Top = 0
  ...
  object dsdStoredProc: TdsdStoredProc
    StoredProcName = 'gpReport_CheckUpdateNotMCS'
    DataSet = ClientDataSet
    DataSets = <
      item
        DataSet = ClientDataSet
