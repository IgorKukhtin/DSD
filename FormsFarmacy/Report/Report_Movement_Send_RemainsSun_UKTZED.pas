unit Report_Movement_Send_RemainsSun_UKTZED;
...
type
  TReport_Movement_Send_RemainsSun_UKTZEDForm = class(TAncestorReportForm)
...
var
  Report_Movement_Send_RemainsSun_UKTZEDForm: TReport_Movement_Send_RemainsSun_UKTZEDForm;
...
initialization
  ...
  RegisterClass(TReport_Movement_Send_RemainsSun_UKTZEDForm)
end.
