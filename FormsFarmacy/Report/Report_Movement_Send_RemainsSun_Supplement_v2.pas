unit Report_Movement_Send_RemainsSun_Supplement_v2;
...
type
  TReport_Movement_Send_RemainsSun_Supplement_v2Form = class(TAncestorReportForm)
    ...
    Give_From: TcxGridDBBandedColumn;
...
var
  Report_Movement_Send_RemainsSun_Supplement_v2Form: TReport_Movement_Send_RemainsSun_Supplement_v2Form;
...
initialization
  ...
  RegisterClass(TReport_Movement_Send_RemainsSun_Supplement_v2Form)
end.
