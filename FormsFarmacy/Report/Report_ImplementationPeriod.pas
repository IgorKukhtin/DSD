unit Report_ImplementationPeriod;
...
type
  TReport_ImplementationPeriodForm = class(TParentForm)
    ...
    pvSummaSelling: TcxDBPivotGridField;
...
initialization
  RegisterClass(TReport_ImplementationPeriodForm);
