unit Report_HouseholdInventoryRemainsCash;
...
type
  TReport_HouseholdInventoryRemainsCashForm = class(TAncestorReportForm)
...
initialization
  ...
  RegisterClass(TReport_HouseholdInventoryRemainsCashForm);
