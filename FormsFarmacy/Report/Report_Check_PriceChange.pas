...
type
  TReport_Check_PriceChangeForm = class(TAncestorReportForm)
    cxLabel3: TcxLabel;
...
var
  Report_Check_PriceChangeForm: TReport_Check_PriceChangeForm;
...
initialization
  ...
  RegisterClass(TReport_Check_PriceChangeForm)
end.
