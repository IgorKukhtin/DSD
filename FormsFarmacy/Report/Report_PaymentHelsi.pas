...
type
  TReport_PaymentHelsiForm = class(TAncestorReportForm)
...
var
  Report_PaymentHelsiForm: TReport_PaymentHelsiForm;
...
initialization
  ...
  RegisterClass(TReport_PaymentHelsiForm)
end.
