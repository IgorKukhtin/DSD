unit Report_PositionsUKTVEDonSUN;
...
type
  TReport_PositionsUKTVEDonSUNForm = class(TParentForm)
    ...
    InvNumbr: TcxGridDBColumn;
    OperDate: TcxGridDBColumn;
    UnitNameTo: TcxGridDBColumn;
...
initialization
  RegisterClass(TReport_PositionsUKTVEDonSUNForm);
