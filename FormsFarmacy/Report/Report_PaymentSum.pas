...
type
  TReport_PaymentSumForm = class(TParentForm)
    ...
    TotalSummUnComplete: TcxGridDBColumn;
    cxGridLevel: TcxGridLevel;
    DBViewAddOn: TdsdDBViewAddOn;
    TotalSummComplete: TcxGridDBColumn;
...
initialization
  RegisterClass(TReport_PaymentSumForm);
