unit Report_BanToTransferTimeGoods;
...
type
  TReport_BanToTransferTimeGoodsForm = class(TParentForm)
    ...
    isNotTransferTime: TcxGridDBColumn;
...
initialization
  RegisterClass(TReport_BanToTransferTimeGoodsForm);
