...
type
  TReport_SalesGoods_SUAForm = class(TAncestorReportForm)
    cxLabel3: TcxLabel;
...
var
  Report_SalesGoods_SUAForm: TReport_SalesGoods_SUAForm;
...
initialization
  ...
  RegisterClass(TReport_SalesGoods_SUAForm)
end.
