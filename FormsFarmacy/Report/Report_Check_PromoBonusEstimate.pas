unit Report_Check_PromoBonusEstimate;
...
type
  TReport_Check_PromoBonusEstimateForm = class(TParentForm)
    ...
    AmountCheckSumNew: TcxGridDBColumn;
...
initialization
  RegisterClass(TReport_Check_PromoBonusEstimateForm);
