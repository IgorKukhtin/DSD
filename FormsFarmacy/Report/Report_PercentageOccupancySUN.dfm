object Report_PercentageOccupancySUNForm: TReport_PercentageOccupancySUNForm
  Left = 0
  Top = 0
  ...
  object cxDBPivotGrid: TcxDBPivotGrid
    ...
    object pvAmountAll: TcxDBPivotGridField
      Area = faData
      AreaIndex = 0
      AllowedAreas = [faColumn, faRow, faData]
      IsCaptionAssigned = True
    ...
    object pvAmountSend: TcxDBPivotGridField
      ...
      Properties.DecimalPlaces = 4
      Properties.DisplayFormat = ',0.####;-,0.####; ;'
      Styles.ColumnHeader = dmMain.cxFooterStyle
      Visible = True
      UniqueName = #1055#1088#1086#1074#1077#1076#1077#1085#1086
    end
    object pvAmountAllCalc: TcxDBPivotGridField
      Area = faData
      AreaIndex = 3
      AllowedAreas = [faData]
      DataBinding.FieldName = 'AmountAllCalc'
      PropertiesClassName = 'TcxCurrencyEditProperties'
      Properties.DecimalPlaces = 4
      Properties.DisplayFormat = ',0.####;-,0.####; ;'
      Styles.ColumnHeader = dmMain.cxFooterStyle
      UniqueName = 'AmountAllCalc'
    end
    object pvAmountOccupancyCalc: TcxDBPivotGridField
      Area = faData
      AreaIndex = 4
      AllowedAreas = [faData]
      DataBinding.FieldName = 'AmountOccupancyCalc'
      PropertiesClassName = 'TcxCurrencyEditProperties'
      Properties.DecimalPlaces = 4
      Properties.DisplayFormat = ',0.####;-,0.####; ;'
      Styles.ColumnHeader = dmMain.cxFooterStyle
      UniqueName = 'AmountOccupancyCalc'
    end
    object pvPercentageOccupancy: TcxDBPivotGridField
      Area = faData
      AreaIndex = 2
      AllowedAreas = [faColumn, faRow, faData]
      IsCaptionAssigned = True
      ...
      Styles.ColumnHeader = dmMain.cxFooterStyle
      Visible = True
      UniqueName = #1055#1088#1086#1094#1077#1085#1090' '#1079#1072#1085#1091#1083#1077#1085#1080#1103
    end
  end
  ...
  object dsdStoredProc: TdsdStoredProc
    StoredProcName = 'gpReport_PercentageOccupancySUN'
    DataSet = ClientDataSet
    DataSets = <
      item
        DataSet = ClientDataSet
  ...
  object dsdPivotGridCalcFields1: TdsdPivotGridCalcFields
    PivotGrid = cxDBPivotGrid
    CalcField = pvPercentageOccupancy
    GridFields = <
      item
        Field = pvAmountOccupancyCalc
      end
      item
        Field = pvAmountAllCalc
      end>
