unit Report_Movement_CheckWithPennies;
...
type
  TReport_Movement_CheckWithPenniesForm = class(TParentForm)
...
initialization
  RegisterClass(TReport_Movement_CheckWithPenniesForm);
