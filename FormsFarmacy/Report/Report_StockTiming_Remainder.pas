unit Report_StockTiming_Remainder;
...
type
  TReport_StockTiming_RemainderForm = class(TAncestorReportForm)
    cxLabel3: TcxLabel;
...
var
  Report_StockTiming_RemainderForm: TReport_StockTiming_RemainderForm;
...
initialization
  ...
  RegisterClass(TReport_StockTiming_RemainderForm)
end.
