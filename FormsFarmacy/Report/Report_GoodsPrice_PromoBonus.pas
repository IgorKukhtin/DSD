unit Report_GoodsPrice_PromoBonus;
...
type
  TReport_GoodsPrice_PromoBonusForm = class(TAncestorReportForm)
    cxLabel4: TcxLabel;
    ...
    MarginPercentBonus: TcxGridDBColumn;
    PromoBonus: TcxGridDBColumn;
    isTop_calc: TcxGridDBColumn;
  private
...
initialization
  ...
  RegisterClass(TReport_GoodsPrice_PromoBonusForm);
