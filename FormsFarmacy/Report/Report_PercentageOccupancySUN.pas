unit Report_PercentageOccupancySUN;
...
type
  TReport_PercentageOccupancySUNForm = class(TParentForm)
    ...
    pvAmountAll: TcxDBPivotGridField;
    ...
    pvAmountSend: TcxDBPivotGridField;
    pvAmountAllCalc: TcxDBPivotGridField;
    pvAmountOccupancyCalc: TcxDBPivotGridField;
    pvPercentageOccupancy: TcxDBPivotGridField;
    dsdPivotGridCalcFields1: TdsdPivotGridCalcFields;
  private
  public
  end;
...
initialization
  RegisterClass(TReport_PercentageOccupancySUNForm);
