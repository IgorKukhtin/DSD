unit Report_Movement_Send_RemainsSunOut;
...
type
  TReport_Movement_Send_RemainsSunOutForm = class(TAncestorReportForm)
...
var
  Report_Movement_Send_RemainsSunOutForm: TReport_Movement_Send_RemainsSunOutForm;
...
initialization
  ...
  RegisterClass(TReport_Movement_Send_RemainsSunOutForm)
end.
