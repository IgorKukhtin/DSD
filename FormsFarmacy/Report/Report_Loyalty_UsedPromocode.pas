unit Report_Loyalty_UsedPromocode;
...
type
  TReport_Loyalty_UsedPromocodeForm = class(TAncestorReportForm)
...
var
  Report_Loyalty_UsedPromocodeForm: TReport_Loyalty_UsedPromocodeForm;
...
initialization
  RegisterClass(TReport_Loyalty_UsedPromocodeForm);
