...
type
  TReport_RestTermGoodsForm = class(TAncestorReportForm)
    cxLabel3: TcxLabel;
...
var
  Report_RestTermGoodsForm: TReport_RestTermGoodsForm;
...
initialization
  ...
  RegisterClass(TReport_RestTermGoodsForm)
end.
