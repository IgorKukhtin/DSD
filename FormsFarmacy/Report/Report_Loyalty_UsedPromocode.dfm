inherited Report_Loyalty_UsedPromocodeForm: TReport_Loyalty_UsedPromocodeForm
  Caption = #1054#1090#1095#1077#1090' <'#1054#1090#1095#1105#1090' '#1080#1089#1087#1086#1083#1100#1079#1086#1074#1072#1085#1085#1099#1077' '#1087#1088#1086#1084#1086#1082#1086#1076#1099'>'
  ClientHeight = 566
  ClientWidth = 720
  ...
  inherited spSelect: TdsdStoredProc
    StoredProcName = 'gpReport_Loyalty_UsedPromocode'
    DataSet = HeaderCDS
    DataSets = <
      item
        DataSet = HeaderCDS
