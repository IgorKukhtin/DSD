...
type
  TReport_FoundPositionsSUNForm = class(TParentForm)
    ...
    CommentSendChangeName: TcxGridDBColumn;
    SummaFine: TcxGridDBColumn;
    Acted: TcxGridDBColumn;
...
initialization
  RegisterClass(TReport_FoundPositionsSUNForm);
