unit Report_HouseholdInventoryRemains;
...
type
  TReport_HouseholdInventoryRemainsForm = class(TAncestorReportForm)
    cxLabel4: TcxLabel;
...
initialization
  ...
  RegisterClass(TReport_HouseholdInventoryRemainsForm);
