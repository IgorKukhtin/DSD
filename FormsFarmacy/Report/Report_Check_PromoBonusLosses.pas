unit Report_Check_PromoBonusLosses;
...
type
  TReport_Check_PromoBonusLossesForm = class(TParentForm)
    ...
    AmountCheckSum: TcxGridDBColumn;
    bbUpdate: TdxBarButton;
    AmountCheckSumOld: TcxGridDBColumn;
    Delta: TcxGridDBColumn;
  private
  public
  end;
...
initialization
  RegisterClass(TReport_Check_PromoBonusLossesForm);
