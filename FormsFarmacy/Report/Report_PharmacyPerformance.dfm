inherited Report_PharmacyPerformanceForm: TReport_PharmacyPerformanceForm
  ...
  inherited ActionList: TActionList
    ...
    object ExecuteDialog: TExecuteDialog
      ...
      ImageIndex = 35
      FormName = 'TReport_PharmacyPerformanceDialogForm'
      FormNameParam.Value = 'TReport_PharmacyPerformanceDialogForm'
  ...
  inherited spSelect: TdsdStoredProc
    StoredProcName = 'gpReport_PharmacyPerformance'
    DataSets = <
      item
        DataSet = MasterCDS
      end
