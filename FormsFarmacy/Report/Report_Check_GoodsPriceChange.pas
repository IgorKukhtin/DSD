unit Report_Check_GoodsPriceChange;
...
type
  TReport_Check_GoodsPriceChangeForm = class(TAncestorReportForm)
    cxLabel3: TcxLabel;
    ...
    OurJuridicalName_Partion: TcxGridDBColumn;
...
var
  Report_Check_GoodsPriceChangeForm: TReport_Check_GoodsPriceChangeForm;
...
initialization
  ...
  RegisterClass(TReport_Check_GoodsPriceChangeForm)
end.
