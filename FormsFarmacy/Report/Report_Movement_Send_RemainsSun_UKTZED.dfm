inherited Report_Movement_Send_RemainsSun_UKTZEDForm: TReport_Movement_Send_RemainsSun_UKTZEDForm
  Caption = #1054#1090#1095#1077#1090' <'#1085#1072#1079#1086#1074#1077#1084' '#1057#1059#1053' '#1087#1086' '#1059#1050#1058#1042#1069#1044' ('#1086#1090#1087#1088#1072#1074#1082#1072')>'
  ClientHeight = 673
  ClientWidth = 960
  ...
  inherited spSelect: TdsdStoredProc
    StoredProcName = 'gpReport_Movement_Send_RemainsSun_UKTZED'
    Params = <
      item
        Name = 'inOperDate'
        Value = 41395d
  ...
  object spSendSUN: TdsdStoredProc
    StoredProcName = 'gpInsert_Movement_Send_RemainsSun_UKTZED'
    DataSets = <
      item
      end>
    OutputType = otResult
