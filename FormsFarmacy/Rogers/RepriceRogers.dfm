inherited RepriceRogersForm: TRepriceRogersForm
        ...
        inherited cxGridDBTableView: TcxGridDBTableView
          DataController.Summary.FooterSummaryItems = <
            ...
            item
              Format = ',0.00'
              Kind = skSum
              FieldName = 'SummRepriceRogers'
              Column = SummRepriceRogers
            end>
          ...
          object SummRepriceRogers: TcxGridDBColumn
            Caption = #1057#1091#1084#1084#1072
            DataBinding.FieldName = 'SummRepriceRogers'
            PropertiesClassName = 'TcxCurrencyEditProperties'
  ...
  inherited ActionList: TActionList
    ...
    object actExportToXML: TdsdExportToXML
      Category = 'DSDLib'
      MoveParams = <>
      RootParams = <
        item
  ...
  inherited BarManager: TdxBarManager
    ...
    object bbRepriceRogersMI: TdxBarButton
      Action = actExportToXML
      Category = 0
    end
    object bbRepriceRogersMIAll: TdxBarButton
      Caption = 
  ...
  object spMovementItem_Reprice_XML: TdsdStoredProc
    StoredProcName = 'gpSelect_MovementItem_Reprice_XML'
    DataSets = <>
    Params = <
      item
        Name = 'inMovementId'
