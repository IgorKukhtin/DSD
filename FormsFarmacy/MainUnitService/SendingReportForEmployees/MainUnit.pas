...
begin
  ...
  begin
    ...
    begin
      Add_Log('Начало выгрузки <Участие сотрудников в популяризации мобильного приложения по аптекам>');
      FMessage.Text := 'Участие сотрудников в популяризации мобильного приложения по аптекам';
    end else
    begin
      Add_Log('Начало выгрузки <Участие сотрудников в популяризации мобильного приложения по аптекам за (' + FormatDateTime('dddd', IncDay(Date, - 1)) + ')');
      FMessage.Text := 'Участие сотрудников в популяризации мобильного приложения по аптекам за (' + FormatDateTime('dddd', IncDay(Date, - 1)) + ')';
    end;
