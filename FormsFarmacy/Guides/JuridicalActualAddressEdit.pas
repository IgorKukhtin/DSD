unit JuridicalActualAddressEdit;
...
type
  TJuridicalActualAddressEditForm = class(TParentForm)
    edName: TcxTextEdit;
    cxLabel1: TcxLabel;
    cxButton1: TcxButton;
    cxButton2: TcxButton;
    ...
    cxLabel2: TcxLabel;
    edAddress: TcxButtonEdit;
    GuidesAddress: TdsdGuides;
  private
...
{$R *.dfm}
initialization
  RegisterClass(TJuridicalActualAddressEditForm);
