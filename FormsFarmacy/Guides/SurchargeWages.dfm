inherited SurchargeWagesForm: TSurchargeWagesForm
  ...
  inherited ActionList: TActionList
    ...
    object dsdUpdateMaster: TdsdUpdateDataSet
      ...
      StoredProc = spInsertUpdateSurchargeWages
      StoredProcList = <
        item
          StoredProc = spInsertUpdateSurchargeWages
        end>
  ...
  inherited spSelect: TdsdStoredProc
    StoredProcName = 'gpSelect_Object_SurchargeWages'
    Params = <
      item
        Name = 'inShowAll'
        Value = Null
  ...
  object spInsertUpdateSurchargeWages: TdsdStoredProc
    StoredProcName = 'gpInsertUpdate_Object_SurchargeWages'
    DataSets = <>
    OutputType = otResult
    Params = <
      item
