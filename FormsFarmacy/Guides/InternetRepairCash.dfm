object InternetRepairCashForm: TInternetRepairCashForm
  Left = 0
  Top = 0
  ...
  object ActionList: TActionList
    ...
    object actUpdate: TdsdInsertUpdateAction
      ...
      ShortCut = 115
      ImageIndex = 1
      FormName = 'TInternetRepairCashEditForm'
      FormNameParam.Value = 'TInternetRepairCashEditForm'
  ...
  object spSelect: TdsdStoredProc
    StoredProcName = 'gpSelect_Object_InternetRepair_Cash'
    DataSet = ClientDataSet
    DataSets = <
      item
        DataSet = ClientDataSet
