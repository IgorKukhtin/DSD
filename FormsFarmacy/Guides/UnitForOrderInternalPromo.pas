unit UnitForOrderInternalPromo;
...
type
  TUnitForOrderInternalPromoForm = class(TAncestorEnumForm)
    JuridicalName: TcxGridDBColumn;
    actShowAll: TBooleanStoredProcAction;
    bbShowAll: TdxBarButton;
    spUpdate_OrderPromo_Yes: TdsdStoredProc;
    spUpdate_OrderPromo_No: TdsdStoredProc;
    actUpdateOrderPromo_No: TdsdExecStoredProc;
    actUpdateOrderPromo_Yes: TdsdExecStoredProc;
    macUpdateisOrderPromoL_No: TMultiAction;
    macUpdateisOrderPromoL_Yes: TMultiAction;
    bbUpdateisGoodsCategoryYes: TdxBarButton;
    bbUpdateisGoodsCategoryNo: TdxBarButton;
    macUpdateisOrderPromo_No: TMultiAction;
    macUpdateisOrderPromo_Yes: TMultiAction;
  private
...
{$R *.dfm}
 initialization
  RegisterClass(TUnitForOrderInternalPromoForm);
end.
