...
uses
  ...
  dxSkinsDefaultPainters, dxSkinsdxBarPainter, dxBarExtItems, dxBar, cxClasses;

type
  TInstructionsEditForm = class(TParentForm)
    edName: TcxTextEdit;
    cxLabel1: TcxLabel;
    cxButton1: TcxButton;
    cxButton2: TcxButton;
    ...
    ceInstructionsKind: TcxButtonEdit;
    cxLabel5: TcxLabel;
...
{$R *.dfm}
initialization
  RegisterClass(TInstructionsEditForm);
