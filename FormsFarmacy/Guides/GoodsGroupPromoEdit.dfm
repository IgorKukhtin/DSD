object GoodsGroupPromoEditForm: TGoodsGroupPromoEditForm
  Left = 0
  Top = 0
  ...
  object spInsertUpdate: TdsdStoredProc
    StoredProcName = 'gpInsertUpdate_Object_GoodsGroupPromo'
    DataSets = <>
    OutputType = otResult
    Params = <
      item
  ...
  object spGet: TdsdStoredProc
    StoredProcName = 'gpGet_Object_GoodsGroupPromo'
    DataSets = <>
    OutputType = otResult
    Params = <
      item
