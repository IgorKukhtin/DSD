object GoodsSignOriginEditForm: TGoodsSignOriginEditForm
  Left = 0
  Top = 0
  ...
  object spInsertUpdate: TdsdStoredProc
    StoredProcName = 'gpInsertUpdate_Object_GoodsSignOrigin'
    DataSets = <>
    OutputType = otResult
    Params = <
      item
  ...
  object spGet: TdsdStoredProc
    StoredProcName = 'gpGet_Object_GoodsSignOrigin'
    DataSets = <>
    OutputType = otResult
    Params = <
      item
