object PriceGoodsDialogForm: TPriceGoodsDialogForm
  Left = 0
  Top = 0
  BorderStyle = bsDialog
  Caption = #1055#1072#1088#1072#1084#1077#1090#1088#1099' <'#1055#1088#1072#1081#1089' - '#1083#1080#1089#1090#1072' '#1090#1077#1082#1091#1097#1080#1081'>'
  ClientHeight = 185
  ClientWidth = 342
  Color = clBtnFace
