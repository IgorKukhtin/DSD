...
type
  TBanCommentSendEditForm = class(TParentForm)
    cxLabel1: TcxLabel;
    cxButton1: TcxButton;
    cxButton2: TcxButton;
    Код: TcxLabel;
    ...
    edCommentSend: TcxButtonEdit;
    GuidesCommentSend: TdsdGuides;
  private
...
{$R *.dfm}
initialization
  RegisterClass(TBanCommentSendEditForm);
