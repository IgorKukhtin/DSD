inherited GoodsForm: TGoodsForm
    ...
    inherited tsMain: TcxTabSheet
      ...
      inherited cxGrid: TcxGrid
        ...
        inherited cxGridDBTableView: TcxGridDBTableView
          ...
          object isNewUKTZED: TcxGridDBColumn
            Caption = #1053#1086#1074#1099#1081' '#1059#1050#1058#1042#1069#1044
            DataBinding.FieldName = 'isNewUKTZED'
            HeaderAlignmentHorz = taCenter
            HeaderAlignmentVert = vaCenter
            Options.Editing = False
            Width = 70
          end
          object isNoRegUKTZED: TcxGridDBColumn
            Caption = #1053#1077' '#1079#1072#1088#1077#1075'. '#1059#1050#1058#1042#1069#1044
            DataBinding.FieldName = 'isNoRegUKTZED'
            HeaderAlignmentHorz = taCenter
            HeaderAlignmentVert = vaCenter
            Options.Editing = False
            Width = 69
  ...
  inherited ActionList: TActionList
    ...
    object mactUpdate_CodeUKTZED: TMultiAction
      Category = 'DSDLib'
      MoveParams = <>
      AfterAction = actRefresh
  ...
  inherited DBViewAddOn: TdsdDBViewAddOn
    ...
    ColorRuleList = <
      ...
      item
        ColorColumn = CodeUKTZED
        BackGroundValueColumn = Color_UKTZED
        ColorValueList = <>
      end
      item
        ColorColumn = isNewUKTZED
        BackGroundValueColumn = Color_UKTZED
        ColorValueList = <>
      end
      item
        ColorColumn = isNoRegUKTZED
        BackGroundValueColumn = Color_UKTZED
        ColorValueList = <>
      end>
