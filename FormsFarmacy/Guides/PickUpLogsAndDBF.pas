...
type
  TPickUpLogsAndDBFForm = class(TParentForm)
    cxGrid: TcxGrid;
    ...
    isLoaded: TcxGridDBColumn;
    DateLoaded: TcxGridDBColumn;
    ...
    bbUploadPickUpLogsAndDBF: TdxBarButton;
    bbUpdateClear: TdxBarButton;
    spLoadedClear: TdsdStoredProc;
...
initialization
  RegisterClass(TPickUpLogsAndDBFForm);
end.
