unit DiscountExternalJuridicalEdit;
...
type
  TDiscountExternalJuridicalEditForm = class(TParentForm)
    cxLabel1: TcxLabel;
    cxButton1: TcxButton;
    cxButton2: TcxButton;
    Код: TcxLabel;
    ...
    cxLabel2: TcxLabel;
    ceExternalJuridical: TcxTextEdit;
  private
...
{$R *.dfm}
initialization
  RegisterClass(TDiscountExternalJuridicalEditForm);
