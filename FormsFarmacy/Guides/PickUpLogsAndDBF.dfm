object PickUpLogsAndDBFForm: TPickUpLogsAndDBFForm
  Left = 0
  Top = 0
  ...
  object cxGrid: TcxGrid
    ...
    object cxGridDBTableView: TcxGridDBTableView
      ...
      object DateLoaded: TcxGridDBColumn
        ...
        DataBinding.FieldName = 'DateLoaded'
        HeaderAlignmentHorz = taCenter
        HeaderAlignmentVert = vaCenter
        Options.Editing = False
        Width = 107
  ...
  object dxBarManager: TdxBarManager
    ...
    object bbUploadPickUpLogsAndDBF: TdxBarButton
  ...
  object ActionList: TActionList
    ...
    object actLoadedClear: TdsdExecStoredProc
      Category = 'DSDLib'
      MoveParams = <>
      AfterAction = actRefresh
      PostDataSetBeforeExecute = False
      StoredProc = spLoadedClear
      StoredProcList = <
        item
          StoredProc = spLoadedClear
        end>
  ...
  object spInsertUpdate: TdsdStoredProc
    StoredProcName = 'gpInsertUpdate_Object_PickUpLogsAndDBF'
    DataSets = <>
    OutputType = otResult
    Params = <
      item
  ...
  object spLoadedClear: TdsdStoredProc
    StoredProcName = 'gpUpdate_Object_PickUpLogsAndDBF_Clear'
    DataSets = <>
    OutputType = otResult
    Params = <
      item
