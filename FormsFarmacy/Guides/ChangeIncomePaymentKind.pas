...
uses
  ...
  cxGrid, cxPC, dxSkinBlack, dxSkinBlue, dxSkinBlueprint, dxSkinCaramel,
...
type
  TChangeIncomePaymentKindForm = class(TAncestorEnumForm)
...
var
  ChangeIncomePaymentKindForm: TChangeIncomePaymentKindForm;

implementation

{$R *.dfm}
initialization
  RegisterClass(TChangeIncomePaymentKindForm);
end.
