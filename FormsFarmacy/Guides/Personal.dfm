object PersonalForm: TPersonalForm
  ...
  object ActionList: TActionList
    ...
    object actUpdateIsDateOut: TdsdExecStoredProc
      Category = 'DSDLib'
      MoveParams = <>
      PostDataSetBeforeExecute = False
      StoredProc = spUpdateisDateOut
      StoredProcList = <
        item
          StoredProc = spUpdateisDateOut
        end>
  ...
  object spInsertUpdate_Property: TdsdStoredProc
  ...
  object spUpdateisDateOut: TdsdStoredProc
    StoredProcName = 'gpUpdate_isDateOut'
    DataSets = <>
    OutputType = otResult
    Params = <
      item
  ...
  object spUpdate_isMain: TdsdStoredProc
    StoredProcName = 'gpUpdate_isMain'
    DataSets = <>
    OutputType = otResult
    Params = <
      item
