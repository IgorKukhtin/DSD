...
type
  TPayrollTypeVIPEditForm = class(TParentForm)
    edName: TcxTextEdit;
    cxLabel1: TcxLabel;
    cxButton1: TcxButton;
    cxButton2: TcxButton;
    ...
    cePercentPhone: TcxCurrencyEdit;
    cxLabel6: TcxLabel;
    cePercentOther: TcxCurrencyEdit;
    cxLabel2: TcxLabel;
...
{$R *.dfm}
initialization
  RegisterClass(TPayrollTypeVIPEditForm);
