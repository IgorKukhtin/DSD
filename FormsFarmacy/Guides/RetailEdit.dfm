object RetailEditForm: TRetailEditForm
  ...
  object edOccupancySUN: TcxCurrencyEdit
    Left = 10
    Top = 343
    Properties.DecimalPlaces = 2
    Properties.DisplayFormat = ',0.##'
  ...
  object cxLabel7: TcxLabel
    Left = 10
    Top = 322
    Caption = #1047#1072#1087#1086#1083#1085#1103#1077#1084#1086#1089#1090#1100' '#1076#1086#1082#1091#1084#1077#1085#1090#1072' '#1087#1086' '#1057#1059#1053' '
  end
