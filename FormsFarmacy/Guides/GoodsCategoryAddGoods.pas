...
type
  TGoodsCategoryAddGoodsForm = class(TParentForm)
    cxGrid: TcxGrid;
    ...
    spSelect_GoodsCategoryAddGoods: TdsdStoredProc;
    actSelect_GoodsCategoryAddGoods: TdsdExecStoredProc;
    mactSelect_GoodsCategoryAddGoods: TMultiAction;
...
initialization
  RegisterClass(TGoodsCategoryAddGoodsForm);
