...
type
  TClientsByBankEditForm = class(TParentForm)
    edName: TcxTextEdit;
    cxLabel1: TcxLabel;
    cxButton1: TcxButton;
    cxButton2: TcxButton;
    ...
    edRegAddress: TcxTextEdit;
    edSendingAddress: TcxTextEdit;
    edAccounting: TcxTextEdit;
    edPhoneAccountancy: TcxTextEdit;
    edINN: TcxTextEdit;
    cxLabel10: TcxLabel;
  private
...
{$R *.dfm}
initialization
  RegisterClass(TClientsByBankEditForm);
