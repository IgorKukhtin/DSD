...
uses
  ...
  dxCore, cxDateUtils, cxDropDownEdit, cxCalendar, Vcl.ExtCtrls;

type
  TGoodsPromoChoiceForm = class(TAncestorEnumForm)
...
initialization
  RegisterClass(TGoodsPromoChoiceForm);
