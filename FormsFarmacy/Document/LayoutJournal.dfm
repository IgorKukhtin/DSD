inherited LayoutJournalForm: TLayoutJournalForm
  ...
  inherited ActionList: TActionList
    ...
    object actOpenFormLayout: TdsdOpenForm
      Category = 'DSDLib'
      MoveParams = <>
  ...
  inherited spSelect: TdsdStoredProc
    StoredProcName = 'gpSelect_Movement_Layout'
    Params = <
      item
        Name = 'instartdate'
        Value = 41640d
  ...
  inherited BarManager: TdxBarManager
    ...
    object bbOpenFormLayout: TdxBarButton
      Action = actOpenFormLayout
      Category = 0
    end
