inherited LoyaltyPresentJournalForm: TLoyaltyPresentJournalForm
  ...
  AddOnFormData.AddOnFormRefresh.GetStoredProc = spGet_Movement_LoyaltyPresent
  ExplicitWidth = 785
  ExplicitHeight = 530
  PixelsPerInch = 96
  TextHeight = 13
  ...
  inherited ActionList: TActionList
    ...
    inherited actInsert: TdsdInsertUpdateAction
      FormName = 'TLoyaltyPresentForm'
      FormNameParam.Value = 'TLoyaltyPresentForm'
    end
  ...
  inherited spSelect: TdsdStoredProc
    StoredProcName = 'gpSelect_Movement_LoyaltyPresent'
  end
  ...
  inherited spMovementComplete: TdsdStoredProc
    StoredProcName = 'gpComplete_Movement_LoyaltyPresent'
  end
  inherited spMovementUnComplete: TdsdStoredProc
    StoredProcName = 'gpUnComplete_Movement_LoyaltyPresent'
    Left = 384
    Top = 264
  end
  inherited spMovementSetErased: TdsdStoredProc
    StoredProcName = 'gpSetErased_Movement_LoyaltyPresent'
    Left = 384
    Top = 216
  end
  ...
  inherited spMovementReComplete: TdsdStoredProc
    StoredProcName = 'gpReComplete_Movement_LoyaltyPresent'
    Left = 384
    Top = 120
  end
  object spGet_Movement_LoyaltyPresent: TdsdStoredProc
    StoredProcName = 'gpGet_Movement_LoyaltyPresent'
    DataSets = <>
    OutputType = otResult
    Params = <
      item
