inherited SalePromoGoodsJournalForm: TSalePromoGoodsJournalForm
  ...
  AddOnFormData.AddOnFormRefresh.GetStoredProc = spGet_Movement_SalePromoGoods
  ExplicitWidth = 785
  ExplicitHeight = 530
  PixelsPerInch = 96
  TextHeight = 13
  ...
  inherited ActionList: TActionList
    ...
    inherited actInsert: TdsdInsertUpdateAction
      FormName = 'TSalePromoGoodsForm'
      FormNameParam.Value = 'TSalePromoGoodsForm'
    end
  ...
  inherited spSelect: TdsdStoredProc
    StoredProcName = 'gpSelect_Movement_SalePromoGoods'
  end
  ...
  inherited spMovementComplete: TdsdStoredProc
    StoredProcName = 'gpComplete_Movement_SalePromoGoods'
  end
  inherited spMovementUnComplete: TdsdStoredProc
    StoredProcName = 'gpUnComplete_Movement_SalePromoGoods'
    Left = 384
    Top = 264
  end
  inherited spMovementSetErased: TdsdStoredProc
    StoredProcName = 'gpSetErased_Movement_SalePromoGoods'
    Left = 384
    Top = 216
  end
  ...
  inherited spMovementReComplete: TdsdStoredProc
    StoredProcName = 'gpReComplete_Movement_SalePromoGoods'
    Left = 384
    Top = 120
  end
  object spGet_Movement_SalePromoGoods: TdsdStoredProc
