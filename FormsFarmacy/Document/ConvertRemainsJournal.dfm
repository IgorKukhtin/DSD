inherited ConvertRemainsJournalForm: TConvertRemainsJournalForm
  Caption = #1046#1091#1088#1085#1072#1083' '#1076#1086#1082#1091#1084#1077#1085#1090#1086#1074' <'#1050#1086#1085#1074#1077#1088#1090#1072#1094#1080#1103' '#1086#1089#1090#1072#1090#1082#1086#1074'>'
  ClientHeight = 535
  ClientWidth = 937
  ...
  inherited ActionList: TActionList
    ...
    object actConvertRemains_Formation: TMultiAction
      Category = 'DSDLib'
      MoveParams = <>
      ActionList = <
        item
          Action = actExecConvertRemains_Formation
        end
        item
          Action = actRefresh
        end>
    ...
    object actExecConvertRemains_Formation: TdsdExecStoredProc
      Category = 'DSDLib'
      MoveParams = <>
      PostDataSetBeforeExecute = False
      StoredProc = spConvertRemains_Formation
      StoredProcList = <
        item
          StoredProc = spConvertRemains_Formation
        end>
      Caption = 'actExecConvertRemains_Formation'
    end
    ...
    object actAddRedCheck: TdsdExecStoredProc
      Category = 'DSDLib'
      MoveParams = <>
      AfterAction = actOpenConvertRemains
    ...
    object actOpenConvertRemains: TdsdOpenForm
      Category = 'DSDLib'
      MoveParams = <>
      AfterAction = actRefresh
      Caption = 'actOpenConvertRemains'
      FormName = 'TConvertRemainsForm'
      FormNameParam.Value = 'TConvertRemainsForm'
      FormNameParam.DataType = ftString
      FormNameParam.MultiSelectSeparator = ','
      GuiParams = <
        item
    ...
    object actInsertConvertRemains: TdsdExecStoredProc
      Category = 'DSDLib'
      MoveParams = <>
      AfterAction = actOpenConvertRemains
      BeforeAction = actChoiceUnitTreeForm
      PostDataSetBeforeExecute = False
      StoredProc = spInsertConvertRemains
      StoredProcList = <
        item
          StoredProc = spInsertConvertRemains
        end>
  ...
  inherited spSelect: TdsdStoredProc
    StoredProcName = 'gpSelect_Movement_ConvertRemains'
    Params = <
      item
        Name = 'instartdate'
        Value = 41640d
  ...
  inherited BarManager: TdxBarManager
    ...
    object bbPrint: TdxBarButton
      Action = actConvertRemains_Formation
      Category = 0
    end
    ...
    object dxBarButton2: TdxBarButton
      Action = actInsertConvertRemains
      Category = 0
    end
  end
  ...
  inherited spMovementUnComplete: TdsdStoredProc
    StoredProcName = 'gpUnComplete_Movement_ConvertRemains'
    Params = <
      item
        Name = 'inmovementid'
        Value = Null
  ...
  inherited spMovementSetErased: TdsdStoredProc
    StoredProcName = 'gpSetErased_Movement_ConvertRemains'
    Params = <
      item
        Name = 'inmovementid'
        Value = Null
  ...
  inherited FormParams: TdsdFormParams
    Params = <
      ...
      item
        Name = 'ReportNameConvertRemainsTax'
        Value = Null
        DataType = ftString
        ParamType = ptInput
        MultiSelectSeparator = ','
  ...
  inherited spMovementReComplete: TdsdStoredProc
    StoredProcName = 'gpReComplete_Movement_ConvertRemains'
    Left = 176
    Top = 304
  end
  ...
  object spSelectPrint: TdsdStoredProc
    StoredProcName = 'gpSelect_Movement_ConvertRemains_Print'
    DataSet = PrintHeaderCDS
    DataSets = <
      item
        DataSet = PrintHeaderCDS
  ...
  object spConvertRemains_Formation: TdsdStoredProc
    StoredProcName = 'gpInsertUpdate_Movement_ConvertRemains_Formation'
    DataSets = <>
    OutputType = otResult
    Params = <>
    PackSize = 1
  ...
  object spInsertRedCheck: TdsdStoredProc
    StoredProcName = 'gpInsert_Movement_ConvertRemains_RedCheck'
    DataSets = <>
    OutputType = otResult
    Params = <
      item
  ...
  object spInsertConvertRemains: TdsdStoredProc
    StoredProcName = 'gpInsert_Movement_ConvertRemains_Add'
    DataSets = <>
    OutputType = otResult
    Params = <
      item
