unit WriteOffHouseholdInventoryJournal;
...
type
  TWriteOffHouseholdInventoryJournalForm = class(TAncestorJournalForm)
...
{$R *.dfm}
initialization
  RegisterClass(TWriteOffHouseholdInventoryJournalForm);
end.
