inherited PromoCodeJournalForm: TPromoCodeJournalForm
  ...
  inherited ActionList: TActionList
    ...
    inherited actInsert: TdsdInsertUpdateAction
      FormName = 'TPromoCodeMovementForm'
      FormNameParam.Value = 'TPromoCodeMovementForm'
    end
  ...
  inherited spSelect: TdsdStoredProc
    StoredProcName = 'gpSelect_Movement_PromoCode'
  end
