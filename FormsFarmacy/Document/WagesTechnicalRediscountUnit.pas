unit WagesTechnicalRediscountUnit;
...
type
  TWagesTechnicalRediscountUnitForm = class(TAncestorJournalForm)
...
{$R *.dfm}
initialization
  RegisterClass(TWagesTechnicalRediscountUnitForm);
end.
