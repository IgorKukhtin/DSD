inherited LayoutFileForm: TLayoutFileForm
  ...
  inherited ActionList: TActionList
    ...
    object actSendFile: TdsdFTP
      ...
      BeforeAction = actOpenLayoutFile
      HostParam.Value = ''
    ...
    object actDownloadAndRunFile: TdsdFTP
      Category = 'DSDLib'
      MoveParams = <>
      BeforeAction = actLayoutFileFTPParams
      HostParam.Value = ''
      HostParam.Component = FormParams
      HostParam.ComponentItem = 'Host'
      HostParam.DataType = ftString
      ...
      FileNameParam.DataType = ftString
      FileNameParam.MultiSelectSeparator = ','
      DownloadFolderParam.Value = 'LayoutFile'
      DownloadFolderParam.DataType = ftString
      DownloadFolderParam.MultiSelectSeparator = ','
    ...
    object actLayoutFileFTPParams: TdsdExecStoredProc
      Category = 'DSDLib'
      MoveParams = <>
      PostDataSetBeforeExecute = False
      StoredProc = spLayoutFileFTPParams
      StoredProcList = <
        item
          StoredProc = spLayoutFileFTPParams
        end>
      Caption = 'actLayoutFileFTPParams'
    end
    object actOpenLayoutFile: TFileDialogAction
      Category = 'DSDLib'
      MoveParams = <>
      BeforeAction = actLayoutFileFTPParams
  ...
  inherited spSelect: TdsdStoredProc
    StoredProcName = 'gpSelect_MovementItem_LayoutFile'
    Params = <
      item
        Name = 'inMovementId'
        Value = Null
  ...
  inherited spChangeStatus: TdsdStoredProc
    StoredProcName = 'gpUpdate_Status_LayoutFile'
    NeedResetData = True
  ...
  inherited spGet: TdsdStoredProc
    StoredProcName = 'gpGet_Movement_LayoutFile'
    Params = <
      item
        Name = 'inMovementId'
        Value = Null
  ...
  inherited spInsertUpdateMovement: TdsdStoredProc
    StoredProcName = 'gpInsertUpdate_Movement_LayoutFile'
    Params = <
      item
        Name = 'ioId'
        Value = Null
  ...
  inherited spErasedMIMaster: TdsdStoredProc
    StoredProcName = 'gpMovementItem_LayoutFile_SetErased'
    Left = 382
    Top = 400
  end
  inherited spUnErasedMIMaster: TdsdStoredProc
    StoredProcName = 'gpMovementItem_LayoutFile_SetUnErased'
    Left = 518
    Top = 200
  end
  inherited spInsertUpdateMIMaster: TdsdStoredProc
    StoredProcName = 'gpInsertUpdate_MovementItem_LayoutFile'
    Params = <
      item
        Name = 'ioId'
        Value = Null
  ...
  object spMovementComplete: TdsdStoredProc
    StoredProcName = 'gpComplete_Movement_LayoutFile'
    DataSets = <>
    OutputType = otResult
    Params = <
      item
  ...
  object spLayoutFileFTPParams: TdsdStoredProc
    StoredProcName = 'gpSelect_Movement_LayoutFileFTPParams'
    DataSets = <>
    OutputType = otResult
    Params = <
      item
  ...
  object spUpdate_FileName: TdsdStoredProc
    StoredProcName = 'gpUpdate_Movement_LayoutFile_FileName'
    DataSets = <>
    OutputType = otResult
    Params = <
      item
