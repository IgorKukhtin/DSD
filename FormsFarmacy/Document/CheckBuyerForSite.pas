...
uses
  ...
  cxDBEdit, Vcl.ExtCtrls, cxLabel;

type
  TCheckBuyerForSiteForm = class(TAncestorDBGridForm)
    cxGrid1: TcxGrid;
    ...
    Panel2: TPanel;
    BuyerForSiteDS: TDataSource;
    BuyerForSiteCDS: TClientDataSet;
...
initialization
  RegisterClass(TCheckBuyerForSiteForm)
