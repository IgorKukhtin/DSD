unit TechnicalRediscountCashierJournal;
...
type
  TTechnicalRediscountCashierJournalForm = class(TAncestorJournalForm)
...
{$R *.dfm}
initialization
  RegisterClass(TTechnicalRediscountCashierJournalForm);
end.
