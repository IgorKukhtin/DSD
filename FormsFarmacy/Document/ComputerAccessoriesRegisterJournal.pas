unit ComputerAccessoriesRegisterJournal;
...
type
  TComputerAccessoriesRegisterJournalForm = class(TAncestorJournalForm)
...
{$R *.dfm}
initialization
  RegisterClass(TComputerAccessoriesRegisterJournalForm);
end.
