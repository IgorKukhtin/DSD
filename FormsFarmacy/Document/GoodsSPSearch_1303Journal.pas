unit GoodsSPSearch_1303Journal;
...
type
  TGoodsSPSearch_1303JournalForm = class(TAncestorJournalForm)
    OperDateStart: TcxGridDBColumn;
    OperDateEnd: TcxGridDBColumn;
    PrintHeaderCDS: TClientDataSet;
    PrintItemsCDS: TClientDataSet;
    spSelectPrint_GoodsSPSearch_1303: TdsdStoredProc;
...
{$R *.dfm}
initialization
  RegisterClass(TGoodsSPSearch_1303JournalForm);
end.
