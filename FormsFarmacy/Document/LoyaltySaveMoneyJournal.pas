...
type
  TLoyaltySaveMoneyJournalForm = class(TAncestorJournalForm)
    spGet_Movement_LoyaltySaveMoney: TdsdStoredProc;
    Id: TcxGridDBColumn;
...
initialization
  RegisterClass(TLoyaltySaveMoneyJournalForm);
