inherited WagesVIPJournalForm: TWagesVIPJournalForm
  Caption = #1046#1091#1088#1085#1072#1083' "'#1047'/'#1055' VIP '#1084#1077#1085#1077#1076#1078#1077#1088#1086#1074'"'
  ClientHeight = 491
  ClientWidth = 782
  AddOnFormData.ExecuteDialogAction = ExecuteDialog
  AddOnFormData.AddOnFormRefresh.SelfList = 'WagesVIP'
  ...
  AddOnFormData.AddOnFormRefresh.GetStoredProc = spGet_Movement_WagesVIP
  ExplicitWidth = 798
  ExplicitHeight = 530
  PixelsPerInch = 96
  TextHeight = 13
  ...
  inherited ActionList: TActionList
    ...
    inherited actInsert: TdsdInsertUpdateAction
      ...
      FormName = 'TWagesVIPForm'
      FormNameParam.Value = 'TWagesVIPForm'
      GuiParams = <
        item
          Name = 'Id'
          Value = Null
  ...
  inherited spSelect: TdsdStoredProc
    StoredProcName = 'gpSelect_Movement_WagesVIP'
  end
  ...
  inherited spMovementComplete: TdsdStoredProc
    StoredProcName = 'gpComplete_Movement_WagesVIP'
  end
  inherited spMovementUnComplete: TdsdStoredProc
    StoredProcName = 'gpUnComplete_Movement_WagesVIP'
    Left = 384
    Top = 264
  end
  inherited spMovementSetErased: TdsdStoredProc
    StoredProcName = 'gpSetErased_Movement_WagesVIP'
    Left = 384
    Top = 216
  end
  ...
  inherited spMovementReComplete: TdsdStoredProc
    StoredProcName = 'gpReComplete_Movement_WagesVIP'
    Left = 384
    Top = 120
  end
  object spGet_Movement_WagesVIP: TdsdStoredProc
