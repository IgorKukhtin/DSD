unit GoodsSPInform_1303Journal;
...
type
  TGoodsSPInform_1303JournalForm = class(TAncestorJournalForm)
    OperDateStart: TcxGridDBColumn;
    OperDateEnd: TcxGridDBColumn;
    PrintHeaderCDS: TClientDataSet;
    PrintItemsCDS: TClientDataSet;
    spSelectPrint_GoodsSPInform_1303: TdsdStoredProc;
...
{$R *.dfm}
initialization
  RegisterClass(TGoodsSPInform_1303JournalForm);
end.
