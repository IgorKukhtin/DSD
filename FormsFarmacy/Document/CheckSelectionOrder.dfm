inherited CheckSelectionOrderForm: TCheckSelectionOrderForm
  Caption = #1042#1099#1073#1086#1088' '#1079#1072#1082#1072#1079#1072' '#1076#1083#1103' '#1079#1072#1075#1088#1091#1079#1082#1080
  ClientHeight = 421
  ClientWidth = 736
  ...
  inherited spSelect: TdsdStoredProc
    StoredProcName = 'gpSelect_Movement_CheckSelectionOrder'
    DataSets = <
      item
        DataSet = MasterCDS
      end
