inherited AsinoPharmaSPJournalForm: TAsinoPharmaSPJournalForm
  ...
  inherited ActionList: TActionList
    ...
    object actInsertMask1: TdsdInsertUpdateAction [5]
      ...
      ShortCut = 16429
      FormName = 'TAsinoPharmaSP_1303Form'
      FormNameParam.Value = 'TAsinoPharmaSP_1303Form'
    ...
    inherited actInsert: TdsdInsertUpdateAction
      FormName = 'TAsinoPharmaSPForm'
      FormNameParam.Value = 'TAsinoPharmaSPForm'
      GuiParams = <
        item
          Name = 'Id'
          Value = Null
  ...
  inherited spSelect: TdsdStoredProc
    StoredProcName = 'gpSelect_Movement_AsinoPharmaSP'
    Params = <
      item
        Name = 'instartdate'
        Value = 41640d
  ...
  inherited spMovementComplete: TdsdStoredProc
    StoredProcName = 'gpComplete_Movement_AsinoPharmaSP'
    Params = <
      item
        Name = 'inmovementid'
        Value = Null
  ...
  inherited spMovementUnComplete: TdsdStoredProc
    StoredProcName = 'gpUnComplete_Movement_AsinoPharmaSP'
    Params = <
      item
        Name = 'inmovementid'
        Value = Null
  ...
  inherited spMovementSetErased: TdsdStoredProc
    StoredProcName = 'gpSetErased_Movement_AsinoPharmaSP'
    Params = <
      item
        Name = 'inmovementid'
        Value = Null
  ...
  inherited spMovementReComplete: TdsdStoredProc
    StoredProcName = 'gpReComplete_Movement_AsinoPharmaSP'
    Top = 128
  end
end
