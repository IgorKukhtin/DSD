...
type
  TLoyaltyPresentJournalForm = class(TAncestorJournalForm)
    spGet_Movement_LoyaltyPresent: TdsdStoredProc;
    Id: TcxGridDBColumn;
...
initialization
  RegisterClass(TLoyaltyPresentJournalForm);
