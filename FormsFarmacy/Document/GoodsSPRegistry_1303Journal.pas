unit GoodsSPRegistry_1303Journal;
...
type
  TGoodsSPRegistry_1303JournalForm = class(TAncestorJournalForm)
    OperDateStart: TcxGridDBColumn;
    OperDateEnd: TcxGridDBColumn;
    PrintHeaderCDS: TClientDataSet;
    PrintItemsCDS: TClientDataSet;
    spSelectPrint_GoodsSPRegistry_1303: TdsdStoredProc;
...
{$R *.dfm}
initialization
  RegisterClass(TGoodsSPRegistry_1303JournalForm);
end.
