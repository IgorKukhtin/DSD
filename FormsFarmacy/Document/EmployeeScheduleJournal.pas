...
type
  TEmployeeScheduleJournalForm = class(TAncestorJournalForm)
    spGet_Movement_EmployeeSchedule: TdsdStoredProc;
    Id: TcxGridDBColumn;
...
initialization
  RegisterClass(TEmployeeScheduleJournalForm);
