inherited SendPartionDateChangeJournalForm: TSendPartionDateChangeJournalForm
  Caption = #1046#1091#1088#1085#1072#1083' '#1076#1086#1082#1091#1084#1077#1085#1090#1086#1074' <'#1047#1072#1103#1074#1082#1080' '#1080#1079#1084#1077#1085#1077#1085#1080#1103' '#1089#1088#1086#1082#1072' '#1075#1086#1076#1085#1086#1089#1090#1080'>'
  ClientHeight = 478
  ClientWidth = 841
  ...
  inherited ActionList: TActionList
    ...
    inherited actInsert: TdsdInsertUpdateAction
      FormName = 'TSendPartionDateChangeForm'
      FormNameParam.Value = 'TSendPartionDateChangeForm'
    end
    ...
    object actExecuteUpdatePercent: TExecuteDialog
      ...
      FormName = 'TSendPartionDateChange_UpdatePercentDialogForm'
      FormNameParam.Value = 'TSendPartionDateChange_UpdatePercentDialogForm'
      FormNameParam.DataType = ftString
      FormNameParam.MultiSelectSeparator = ','
      GuiParams = <
        item
  ...
  inherited spSelect: TdsdStoredProc
    StoredProcName = 'gpSelect_Movement_SendPartionDateChange'
    Params = <
      item
        Name = 'instartdate'
        Value = 41640d
  ...
  inherited spMovementComplete: TdsdStoredProc
    StoredProcName = 'gpComplete_Movement_SendPartionDateChange'
    Params = <
      item
        Name = 'inmovementid'
        Value = Null
  ...
  inherited spMovementUnComplete: TdsdStoredProc
    StoredProcName = 'gpUnComplete_Movement_SendPartionDateChange'
    Params = <
      item
        Name = 'inmovementid'
        Value = Null
  ...
  inherited spMovementSetErased: TdsdStoredProc
    StoredProcName = 'gpSetErased_Movement_SendPartionDateChange'
    Params = <
      item
        Name = 'inmovementid'
        Value = Null
  ...
  inherited spMovementReComplete: TdsdStoredProc
    StoredProcName = 'gpReComplete_Movement_SendPartionDateChange'
    Left = 496
    Top = 184
  end
  ...
  object spSelectPrint: TdsdStoredProc
    StoredProcName = 'gpSelect_Movement_SendPartionDateChange_Print'
    DataSet = PrintHeaderCDS
    DataSets = <
      item
        DataSet = PrintHeaderCDS
  ...
  object spExecUpdatePercent: TdsdStoredProc
    StoredProcName = 'gpUpdatePercent_Movement_SendPartionDateChange'
    DataSets = <>
    OutputType = otResult
    Params = <
      item
