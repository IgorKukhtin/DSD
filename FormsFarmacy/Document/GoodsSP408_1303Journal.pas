...
type
  TGoodsSP408_1303JournalForm = class(TAncestorJournalForm)
    OperDateStart: TcxGridDBColumn;
    OperDateEnd: TcxGridDBColumn;
    PrintHeaderCDS: TClientDataSet;
    PrintItemsCDS: TClientDataSet;
    spSelectPrint_GoodsSP408_1303: TdsdStoredProc;
...
{$R *.dfm}
initialization
  RegisterClass(TGoodsSP408_1303JournalForm);
end.
