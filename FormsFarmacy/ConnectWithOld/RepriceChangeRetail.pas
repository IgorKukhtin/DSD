...
type
  TRepriceСhangeRetailForm = class(TForm)
    btnReprice: TButton;
...
procedure TRepriceСhangeRetailForm.btnRepriceClick(Sender: TObject);
...
procedure TRepriceСhangeRetailForm.btnRepriceSelYesClick(Sender: TObject);
...
procedure TRepriceСhangeRetailForm.btnRepriceSelNoClick(Sender: TObject);
var i, RecIndex: integer;
    oldId:String;
begin
...
procedure TRepriceСhangeRetailForm.btnSelectNewPriceClick(Sender: TObject);
...
procedure TRepriceСhangeRetailForm.BtnUnitsListClick(Sender: TObject);
begin
...
procedure TRepriceСhangeRetailForm.cdsResultCalcFields(DataSet: TDataSet);
begin
...
procedure TRepriceСhangeRetailForm.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  UserSettingsStorageAddOn.SaveUserSettings;
  Action:=caFree;
end;

procedure TRepriceСhangeRetailForm.FormCreate(Sender: TObject);
begin
  FStartReprice := False;
  GetUnitsList.Execute;
  UnitsCDS.First;
...
procedure TRepriceСhangeRetailForm.FormShow(Sender: TObject);
begin
  UserSettingsStorageAddOn.LoadUserSettings
end;

initialization
  RegisterClass(TRepriceСhangeRetailForm);
