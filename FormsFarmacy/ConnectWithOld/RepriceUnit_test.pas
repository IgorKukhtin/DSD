...
type
  TRepriceUnit_testForm = class(TForm)
    btnReprice: TButton;
...
procedure TRepriceUnit_testForm.btnRepriceClick(Sender: TObject);
...
procedure TRepriceUnit_testForm.btnRepriceSelYesClick(Sender: TObject);
...
procedure TRepriceUnit_testForm.btnRepriceSelNoClick(Sender: TObject);
var i, RecIndex: integer;
    oldId:String;
begin
...
procedure TRepriceUnit_testForm.btnSelectNewPriceClick(Sender: TObject);
...
procedure TRepriceUnit_testForm.BtnUnitsListClick(Sender: TObject);
begin
...
procedure TRepriceUnit_testForm.cdsResultCalcFields(DataSet: TDataSet);
begin
...
procedure TRepriceUnit_testForm.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  dsdUserSettingsStorageAddOn.SaveUserSettings;
  Action:=caFree;
end;

procedure TRepriceUnit_testForm.FormCreate(Sender: TObject);
begin
  FStartReprice := False;
  GetUnitsList.Execute;
  UnitsCDS.First;
...
procedure TRepriceUnit_testForm.FormShow(Sender: TObject);
begin
  dsdUserSettingsStorageAddOn.LoadUserSettings
end;

initialization
  RegisterClass(TRepriceUnit_testForm);
