...
function CashCloseReturnDialogExecute(ASummaTotal: Currency; Var ASalerCash, ASalerCashAdd: Currency; var APaidType: TPaidType;
...
function CashCloseReturnDialogExecute(ASummaTotal: Currency; Var ASalerCash, ASalerCashAdd: Currency; var APaidType: TPaidType;
                                var ABankPOSTerminal, APOSTerminalCode : integer):Boolean;
Begin
  if NOT assigned(CashCloseReturnDialogForm) then
    CashCloseReturnDialogForm := TCashCloseReturnDialogForm.Create(Application);
  With CashCloseReturnDialogForm do
  Begin
    try
