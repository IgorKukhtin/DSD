inherited MainCashForm2: TMainCashForm2
  ...
  object pnlSP: TPanel [6]
    ...
    object Panel3: TPanel
      ...
      object btnGoodsSPReceiptList: TcxButton
        Left = 510
        Top = 0
        Width = 28
        Height = 34
        Hint = #1042#1099#1087#1080#1089#1072#1085#1086' '#1074' '#1088#1077#1094#1077#1087#1090#1077
        Align = alRight
  ...
  inherited ActionList: TActionList
    ...
    object actCheckJackdawsGreenJournalCash: TdsdOpenForm
      Category = #1044#1086#1082#1091#1084#1077#1085#1090#1099
      MoveParams = <>
      Caption = #1055#1088#1086#1073#1080#1090#1080#1077' '#1092#1080#1089#1082#1072#1083#1100#1085#1086#1075#1086' '#1095#1077#1082#1072' '#1087#1086' '#1076#1086#1082#1091#1084#1077#1085#1090#1072#1084' '#1089' '#1079#1077#1083#1077#1085#1086#1081' '#1075#1072#1083#1082#1086#1081
    ...
    object actGoodsSPReceiptList: TdsdOpenForm
      Category = #1044#1086#1082#1091#1084#1077#1085#1090#1099
      MoveParams = <>
      Caption = #1042#1099#1087#1080#1089#1072#1085#1086' '#1074' '#1088#1077#1094#1077#1087#1090#1077
      FormName = 'TGoodsSPReceiptListForm'
      FormNameParam.Value = 'TGoodsSPReceiptListForm'
      FormNameParam.DataType = ftString
      FormNameParam.MultiSelectSeparator = ','
      GuiParams = <
        item
    ...
    object actDownloadAndRunFile: TdsdFTP
      ...
      HostParam.ComponentItem = 'LayoutFileHost'
      ...
      DirParam.ComponentItem = 'LayoutFileDir'
    ...
    object actChoiceLayoutFileCash: TOpenChoiceForm
      Category = 'DSDLib'
      MoveParams = <>
      PostDataSetBeforeExecute = False
      Caption = 'actChoicePromoCodeDoctor'
      FormName = 'TLayoutFileCashForm'
      FormNameParam.Value = 'TLayoutFileCashForm'
      FormNameParam.DataType = ftString
      FormNameParam.MultiSelectSeparator = ','
      GuiParams = <
        item
