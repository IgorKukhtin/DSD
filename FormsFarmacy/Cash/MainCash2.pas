      ...
      begin
        ...
        begin
          if ShowPUSHMessageCash('После проведения предыдущего чека возникла ошибка…'#13#10 +
                                 ...
                                 'Если не пройдет - сделайте X отчет и повторите пробитие.'#13#10 +
                                 'Аннулируйте или закройте чек через FpWinX (раздел Продажи)', cResult) then actPutCheckToCashExecute(Nil);
          Exit;
        end;
      end
      else
