object Check_RefusalConfirmedForm: TCheck_RefusalConfirmedForm
  Left = 0
  Top = 0
  Caption = #1054#1073#1088#1072#1073#1086#1090#1082#1072' '#1087#1088#1086#1089#1088#1086#1095#1077#1085#1085#1086#1075#1086' '#1079#1072#1082#1072#1079#1072
  ClientHeight = 395
  ClientWidth = 470
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object cxLabel4: TcxLabel
      Left = 8
      Top = 27
      Caption = #1042#1099#1073#1080#1088#1080#1090#1077' '#1076#1077#1081#1089#1090#1074#1080#1077' '#1089' '#1079#1072#1082#1072#1079#1086#1084':'
      ParentFont = False
      Style.Font.Charset = DEFAULT_CHARSET
      Style.Font.Color = clWindowText
      Style.Font.Height = -13
  ...
  object Panel2: TPanel
    ...
    object cxButton1: TcxButton
      ...
      Width = 161
      Height = 25
      Action = actUpdate_RefusalConfirmed
      TabOrder = 0
    end
  ...
  object ActionList: TActionList
    ...
    object actUpdate_RefusalConfirmed: TdsdExecStoredProc
      Category = 'DSDLib'
      MoveParams = <>
      AfterAction = FormClose
      PostDataSetBeforeExecute = False
      StoredProc = spUpdate_RefusalConfirmed
      StoredProcList = <
        item
          StoredProc = spUpdate_RefusalConfirmed
        end>
      Caption = #1055#1086#1082#1091#1087#1072#1090#1077#1083#1100' '#1085#1077' '#1087#1088#1080#1076#1077#1090
      Hint = #1055#1086#1082#1091#1087#1072#1090#1077#1083#1100' '#1085#1077' '#1087#1088#1080#1076#1077#1090
      ImageIndex = 80
  ...
  object spUpdate_RefusalConfirmed: TdsdStoredProc
    StoredProcName = 'gpUpdate_Movement_Check_RefusalConfirmed'
    DataSets = <>
    OutputType = otResult
    Params = <
      item
