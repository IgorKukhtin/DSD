inherited CheckHelsiSignForm: TCheckHelsiSignForm
  ...
  object cxCheckHelsiSignGrid: TcxGrid [1]
    Left = 0
    Top = 59
    Width = 921
    Height = 459
    ...
    object cxCheckHelsiSignGridLevel1: TcxGridLevel
      GridView = cxCheckHelsiSignGridDBBandedTableView1
    end
  end
  ...
  inherited cxPropertiesStore: TcxPropertiesStore
    Components = <
      item
        Component = cxCheckHelsiSignGrid
        Properties.Strings = (
          'Width')
      end
      item
  ...
  object dsdStoredProc: TdsdStoredProc
    StoredProcName = 'gpSelect_Movement_CheckHelsi'
    DataSet = ClientDataSet
    DataSets = <
      item
        DataSet = ClientDataSet
  ...
  object dsdDBViewAddOn: TdsdDBViewAddOn
    ...
    View = cxCheckHelsiSignGridDBBandedTableView1
