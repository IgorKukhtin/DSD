...
type
  TCheck_RefusalConfirmedForm = class(TParentForm)
    ...
    cxLabel3: TcxLabel;
    cxLabel4: TcxLabel;
    spUpdate_RefusalConfirmed: TdsdStoredProc;
...
initialization
  RegisterClass(TCheck_RefusalConfirmedForm);
