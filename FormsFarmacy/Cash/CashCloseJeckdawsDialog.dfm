inherited CashCloseJeckdawsDialogForm: TCashCloseJeckdawsDialogForm
  ...
  object spGet_Movement: TdsdStoredProc
    StoredProcName = 'gpGet_Movement_CashCloseJeckdaws'
    DataSets = <>
    OutputType = otResult
    Params = <
      item
  ...
  object spCheck_Recreating: TdsdStoredProc
    StoredProcName = 'gpSelect_Movement_Check_Recreating'
    DataSets = <>
    OutputType = otResult
    Params = <
      item
  ...
  object spUpdate_CashRegister: TdsdStoredProc
    StoredProcName = 'gpUpdate_Movement_Check_CashRegister'
    DataSets = <>
    OutputType = otResult
    Params = <
      item
