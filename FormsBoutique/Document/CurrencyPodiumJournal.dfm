inherited CurrencyPodiumJournalForm: TCurrencyPodiumJournalForm
  ...
  inherited ActionList: TActionList
    inherited actInsert: TdsdInsertUpdateAction
      ...
      FormName = 'TCurrencyPodiumMovementForm'
      FormNameParam.Value = 'TCurrencyPodiumMovementForm'
      GuiParams = <
        item
          Name = 'Id'
          Value = Null
  ...
  object spGetImportSettingDopId: TdsdStoredProc
    ...
    Params = <
      item
        Name = 'inDefaultKey'
        Value = 
          'TCurrencyPodiumJournalForm;zc_Object_ImportSetting_CurrencyPodiu' +
          'mJournal'
        DataType = ftString
        ParamType = ptInput
        MultiSelectSeparator = ','
