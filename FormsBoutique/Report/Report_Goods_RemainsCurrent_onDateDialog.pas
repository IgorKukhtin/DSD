unit Report_Goods_RemainsCurrent_onDateDialog;
...
type
  TReport_Goods_RemainsCurrent_onDateDialogForm = class(TParentForm)
    cxButton1: TcxButton;
    cxButton2: TcxButton;
...
initialization
  RegisterClass(TReport_Goods_RemainsCurrent_onDateDialogForm);
