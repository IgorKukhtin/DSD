unit Report_Goods_RemainsCurrent_onDate;
...
type
  TReport_Goods_RemainsCurrent_onDateForm = class(TAncestorReportForm)
    cxLabel3: TcxLabel;
...
var
  Report_Goods_RemainsCurrent_onDateForm: TReport_Goods_RemainsCurrent_onDateForm;
...
initialization
  ...
  RegisterClass(TReport_Goods_RemainsCurrent_onDateForm)
end.
