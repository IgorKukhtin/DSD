...
type
  TReport_MotionByClientForm = class(TAncestorReportForm)
    cxLabel3: TcxLabel;
...
var
  Report_MotionByClientForm: TReport_MotionByClientForm;
...
initialization
  ...
  RegisterClass(TReport_MotionByClientForm)
end.
