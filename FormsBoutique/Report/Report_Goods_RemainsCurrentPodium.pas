unit Report_Goods_RemainsCurrentPodium;
...
type
  TReport_Goods_RemainsCurrentPodiumForm = class(TAncestorReportForm)
    cxLabel3: TcxLabel;
...
var
  Report_Goods_RemainsCurrentPodiumForm: TReport_Goods_RemainsCurrentPodiumForm;
...
initialization
  ...
  RegisterClass(TReport_Goods_RemainsCurrentPodiumForm)
end.
