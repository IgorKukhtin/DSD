...
type
  TReport_Sale_AnalysisAllForm = class(TAncestorReportForm)
    cxLabel3: TcxLabel;
...
var
  Report_Sale_AnalysisAllForm: TReport_Sale_AnalysisAllForm;
...
initialization
  ...
  RegisterClass(TReport_Sale_AnalysisAllForm)
end.
