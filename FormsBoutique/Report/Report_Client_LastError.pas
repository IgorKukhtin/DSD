...
type
  TReport_Client_LastErrorForm = class(TAncestorReportForm)
...
var
  Report_Client_LastErrorForm: TReport_Client_LastErrorForm;
...
initialization
  ...
  RegisterClass(TReport_Client_LastErrorForm)
end.
