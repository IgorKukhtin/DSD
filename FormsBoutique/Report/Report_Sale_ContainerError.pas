unit Report_Sale_ContainerError;
...
type
  TReport_Sale_ContainerErrorForm = class(TAncestorReportForm)
...
var
  Report_Sale_ContainerErrorForm: TReport_Sale_ContainerErrorForm;
...
initialization
  ...
  RegisterClass(TReport_Sale_ContainerErrorForm)
end.
