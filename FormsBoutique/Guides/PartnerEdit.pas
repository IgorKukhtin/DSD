...
type
  TPartnerEditForm = class(TParentForm)
    ...
    cxLabel3: TcxLabel;
    ceBrandName: TcxButtonEdit;
    PartnerBrandGuides: TdsdGuides;
    cxLabel4: TcxLabel;
    cxLabel5: TcxLabel;
    cxLabel6: TcxLabel;
    edPeriodYear: TcxCurrencyEdit;
    ceFabrikaName: TcxButtonEdit;
    cePeriodName: TcxButtonEdit;
    PartnerFabrikaGuides: TdsdGuides;
    PartnerPeriodGuides: TdsdGuides;
