object DiscountPeriodForm: TDiscountPeriodForm
  Left = 0
  Top = 0
  ...
  object ActionList: TActionList
    ...
    object actInsert: TdsdInsertUpdateAction
      ...
      ShortCut = 45
      ImageIndex = 0
      FormName = 'TDiscountPeriodEditForm'
      FormNameParam.Value = 'TDiscountPeriodEditForm'
  ...
  object spSelect: TdsdStoredProc
    StoredProcName = 'gpSelect_Object_DiscountPeriod'
    DataSet = MasterCDS
    DataSets = <
      item
        DataSet = MasterCDS
  ...
  object spUnErased: TdsdStoredProc
    StoredProcName = 'gpUpdate_Object_isErased_DiscountPeriod'
    DataSets = <>
    OutputType = otResult
    Params = <
      item
  ...
  object spUpdate: TdsdStoredProc
    StoredProcName = 'gpUpdate_Object_DiscountPeriod'
    DataSets = <>
    OutputType = otResult
    Params = <
      item
