object GoodsItemForm: TGoodsItemForm
  Left = 0
  Top = 0
  Caption = #1057#1087#1088#1072#1074#1086#1095#1085#1080#1082' <'#1058#1086#1074#1072#1088#1099' '#1089' '#1088#1072#1079#1084#1077#1088#1072#1084#1080'>'
  ClientHeight = 376
  ClientWidth = 774
  Color = clBtnFace
  ...
  object spSelect: TdsdStoredProc
    StoredProcName = 'gpSelect_Object_GoodsItem'
    DataSet = MasterCDS
    DataSets = <
      item
        DataSet = MasterCDS
