unit DiscountPeriodGoodsPodiumItemEdit;
...
type
  TDiscountPeriodGoodsPodiumItemEditForm = class(TParentForm)
    cxButton1: TcxButton;
    cxButton2: TcxButton;
    cxLabel3: TcxLabel;
    cxLabel2: TcxLabel;
...
{$R *.dfm}
initialization
  RegisterClass(TDiscountPeriodGoodsPodiumItemEditForm);
end.
