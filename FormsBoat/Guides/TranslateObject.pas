...
uses
  ...
  cxContainer, dsdGuides, cxLabel, cxTextEdit, cxMaskEdit, cxButtonEdit,
  Vcl.ExtCtrls;

type
  TTranslateObjectForm = class(TParentForm)
    ...
    bbLanguage: TdxBarControlContainerItem;
...
initialization
  RegisterClass(TTranslateObjectForm);
