...
type
  TTranslateWordEditForm = class(TParentForm)
    edName: TcxTextEdit;
    cxLabel1: TcxLabel;
    cxButton1: TcxButton;
    cxButton2: TcxButton;
    ...
    ceTranslateWord: TcxButtonEdit;
    GuidesTranslateWord: TdsdGuides;
    cxLabel7: TcxLabel;
    cxLabel14: TcxLabel;
...
initialization
  RegisterClass(TTranslateWordEditForm);
