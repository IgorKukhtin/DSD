object ProdEngineForm: TProdEngineForm
  Left = 0
  Top = 0
  ...
  object ActionList: TActionList
    ...
    object actInsert: TdsdInsertUpdateAction
      ...
      ShortCut = 45
      ImageIndex = 0
      FormName = 'TProdEngineEditForm'
      FormNameParam.Value = 'TProdEngineEditForm'
  ...
  object spSelect: TdsdStoredProc
    StoredProcName = 'gpSelect_Object_ProdEngine'
    DataSet = MasterCDS
    DataSets = <
      item
        DataSet = MasterCDS
  ...
  object spErased: TdsdStoredProc
    StoredProcName = 'gpUpdate_Object_isErased_ProdEngine'
    DataSets = <>
    OutputType = otResult
    Params = <
      item
