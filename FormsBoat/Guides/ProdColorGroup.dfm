object ProdColorGroupForm: TProdColorGroupForm
  Left = 0
  Top = 0
  Caption = #1057#1087#1088#1072#1074#1086#1095#1085#1080#1082' <'#1050#1086#1085#1092#1080#1075#1091#1088#1072#1090#1086#1088' - '#1069#1083#1077#1084#1077#1085#1090#1099'>'
  ClientHeight = 376
  ClientWidth = 552
  Color = clBtnFace
