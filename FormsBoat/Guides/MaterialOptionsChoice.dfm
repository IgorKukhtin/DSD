object MaterialOptionsChoiceForm: TMaterialOptionsChoiceForm
  ...
  object dxBarManager: TdxBarManager
    ...
    object dxBarManagerBar1: TdxBar
      ...
      ItemLinks = <
        ...
        item
          Visible = True
          ItemName = 'bbProdOptionsText'
        end
        item
          Visible = True
          ItemName = 'bbProdOptions'
        end
        item
          Visible = True
          ItemName = 'dxBarStatic'
    ...
    object bbProdOptionsText: TdxBarControlContainerItem
      Caption = 'ProdOptionsText'
      Category = 0
      Hint = 'ProdOptionsText'
      Visible = ivAlways
      Control = cxLabel6
    end
    object bbProdOptions: TdxBarControlContainerItem
      Caption = 'ProdOptions'
      Category = 0
      Hint = 'ProdOptions'
      Visible = ivAlways
  ...
  object ActionList: TActionList
    ...
    object actInsert: TdsdInsertUpdateAction
      ...
      ShortCut = 45
      ImageIndex = 0
      FormName = 'TMaterialOptionsEditForm'
      FormNameParam.Value = 'TMaterialOptionsEditForm'
