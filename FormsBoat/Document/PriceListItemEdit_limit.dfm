object PriceListItemEdit_limitForm: TPriceListItemEdit_limitForm
  Left = 0
  Top = 0
  Caption = #1044#1086#1073#1072#1074#1080#1090#1100' '#1089#1090#1088#1086#1082#1091' <'#1055#1088#1072#1081#1089'-'#1083#1080#1089#1090#1072'> ('#1083#1080#1084#1080#1090')'
  ClientHeight = 304
  ClientWidth = 424
  Color = clBtnFace
