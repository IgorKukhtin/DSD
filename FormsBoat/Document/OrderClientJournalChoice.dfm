    ...
    object cxGridDBTableView: TcxGridDBTableView
      ...
      DataController.Summary.DefaultGroupSummaryItems = <
        ...
        item
          Format = ',0.####'
          Kind = skSum
          Column = Amount_Order_pay
        end
        item
          Format = ',0.####'
          Kind = skSum
          Column = Amount_Invoice_find
        end
        item
          Format = ',0.####'
          Kind = skSum
          Column = Amount_Invoice_pay_find
        end>
      ...
      object Amount_Order_pay: TcxGridDBColumn
        ...
        HeaderAlignmentHorz = taCenter
        HeaderAlignmentVert = vaCenter
        HeaderHint = #1048#1090#1086#1075#1086' '#1089#1091#1084#1084#1074' '#1086#1087#1083#1072#1090#1099' '#1087#1086' '#1047#1072#1082#1072#1079#1091' '#1050#1083#1080#1077#1085#1090#1072
        Width = 70
      end
      ...
      object TotalSumm: TcxGridDBColumn
        ...
        HeaderAlignmentHorz = taCenter
        HeaderAlignmentVert = vaCenter
        HeaderHint = #1048#1058#1054#1043#1054' '#1089' '#1091#1095#1077#1090#1086#1084' % '#1089#1082#1080#1076#1086#1082', '#1073#1077#1079' '#1058#1088#1072#1085#1089#1087#1086#1088#1090#1072', '#1057#1091#1084#1084#1072' '#1087#1088#1086#1076#1072#1078#1080' '#1073#1077#1079' '#1053#1044#1057
        Width = 80
      end
      ...
      object Amount_Invoice_find: TcxGridDBColumn
        Caption = '***'#1057#1091#1084#1084#1072' '#1087#1086' '#1089#1095#1077#1090#1091' ('#1087#1086#1080#1089#1082')'
        DataBinding.FieldName = 'Amount_Invoice_find'
        PropertiesClassName = 'TcxCurrencyEditProperties'
        Properties.DecimalPlaces = 4
        Properties.DisplayFormat = ',0.####;-,0.####; ;'
        Visible = False
      ...
      object Amount_Invoice_pay_find: TcxGridDBColumn
        Caption = '***'#1054#1087#1083#1072#1090#1072' '#1087#1086' '#1089#1095#1077#1090#1091' ('#1087#1086#1080#1089#1082')'
        DataBinding.FieldName = 'Amount_Invoice_pay_find'
        PropertiesClassName = 'TcxCurrencyEditProperties'
        Properties.DecimalPlaces = 4
        Properties.DisplayFormat = ',0.####;-,0.####; ;'
        Visible = False
