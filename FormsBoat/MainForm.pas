...
uses AncestorMain, dsdAction, frxExportXML, frxExportXLS, frxClass,
  ...
  Vcl.Controls, cxLabel, frxBarcode, dxSkinsdxBarPainter, dsdTranslator;
...
type
  TMainForm = class(TAncestorMainForm)
    ...
    miLine83: TMenuItem;
    miLine84: TMenuItem;
    actReport_Goods_Remains: TdsdOpenForm;
    miLine51: TMenuItem;
    miReport_Goods_Remains: TMenuItem;
    ...
    üøProductionUnion: TMenuItem;
    actReport_ProductionOLAP: TdsdOpenForm;
    N3: TMenuItem;
    N5: TMenuItem;
    N8: TMenuItem;
    dsdTranslator: TdsdTranslator;
