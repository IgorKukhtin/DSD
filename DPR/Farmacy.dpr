...
uses
  ...
  RepriceChangeRetail in '..\FormsFarmacy\ConnectWithOld\RepriceChangeRetail.pas' {RepriceÑhangeRetailForm},
...
begin
  ...
  //Åñëè âñå õîðîøî ñîçäàåì ãëàâíóþ ôîðìó Application.CreateForm();
