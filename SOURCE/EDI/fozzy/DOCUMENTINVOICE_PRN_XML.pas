...
{                                 XML Data Binding                                  }
{                                                                                   }
{         Generated on: 23.12.2021 0:02:34                                          }
{       Generated from: D:\Project-Basis\DATABASE\DOCUMENTINVOICE_PRN_example.xml   }
{   Settings stored in: D:\Project-Basis\DATABASE\DOCUMENTINVOICE_PRN_example.xdb   }
{                                                                                   }
{***********************************************************************************}

unit DOCUMENTINVOICE_PRN_XML;
...
{ IXMLDocumentInvoiceType }
  ...
  IXMLDocumentInvoiceType = interface(IXMLNode)
    ['{251ED614-D926-43C1-9DC9-1581EF24B034}']
    { Property Accessors }
...
{ IXMLInvoiceHeaderType }
  ...
  IXMLInvoiceHeaderType = interface(IXMLNode)
    ['{C2E637E3-3A15-4B78-B278-259D73D4E72A}']
    { Property Accessors }
...
{ IXMLInvoiceReferenceType }
  ...
  IXMLInvoiceReferenceType = interface(IXMLNode)
    ['{2C09DE4C-5069-4602-A2B9-16B5B6C570E6}']
    { Property Accessors }
...
{ IXMLOrderType }
  ...
  IXMLOrderType = interface(IXMLNode)
    ['{5CBE69A5-5BBD-4B72-AFD5-F40693AE3A7E}']
    { Property Accessors }
...
{ IXMLInvoicePartiesType }
  ...
  IXMLInvoicePartiesType = interface(IXMLNode)
    ['{16FAC317-554F-4842-8AFC-7720DBFFE22E}']
    { Property Accessors }
...
{ IXMLInvoiceLinesType }
  ...
  IXMLInvoiceLinesType = interface(IXMLNodeCollection)
    ['{8ED585C2-4C89-4893-89F7-00B7A465D4BD}']
    { Property Accessors }
...
{ IXMLLineType }
  ...
  IXMLLineType = interface(IXMLNode)
    ['{DD7104E0-77B8-4607-B74E-5339645D5B73}']
    { Property Accessors }
...
function TXMLInvoiceHeaderType.Get_InvoiceSequences: Integer;
begin
  Result := ChildNodes['InvoiceSequences'].NodeValue;
end;

procedure TXMLInvoiceHeaderType.Set_InvoiceSequences(Value: Integer);
begin
  ChildNodes['InvoiceSequences'].NodeValue := Value;
end;
