...
(*  OLAPField := TDataOLAPField.Create;
  ...
  OLAPField := TDataOLAPField.Create;
  OLAPField.Caption := '% замен+возврат';
  ...
  OLAPField := TDataOLAPField.Create;
  OLAPField.Caption := 'Себестоимость реализация-возврат';
  OLAPField.FieldName := 'PRIMECOST';
  FFields.AddObject(OLAPField.FieldName, OLAPField);

  OLAPField := TDataOLAPField.Create;
  OLAPField.Caption := 'Доход реализация-возврат';
  OLAPField.FieldName := 'INCOME';
  FFields.AddObject(OLAPField.FieldName, OLAPField);

  OLAPField := TDataOLAPField.Create;
  OLAPField.Caption := 'Прибыль реализация-возврат';
  OLAPField.FieldName := 'PROFIT';
  FFields.AddObject(OLAPField.FieldName, OLAPField);

  OLAPField := TDataOLAPField.Create;
  OLAPField.Caption := '% наценки';
  ...
  OLAPField := TDataOLAPField.Create;
  OLAPField.Caption := 'Количество в БЕ';
  OLAPField.FieldName := 'QTY';
  OLAPField.DisplayFormat := ',0.000';
  FFields.AddObject(OLAPField.FieldName, OLAPField);

  DimensionOLAPField := TDimensionOLAPField.Create;
  DimensionOLAPField.Caption := 'Филиал';
  ...
  DimensionOLAPField := TDimensionOLAPField.Create;
  DimensionOLAPField.Caption := 'Категория товара производителя';
  ...
  DimensionOLAPField := TDimensionOLAPField.Create;
  DimensionOLAPField.Caption := 'Производитель';
  ...
  DimensionOLAPField := TDimensionOLAPField.Create;
  DimensionOLAPField.Caption := 'Тип товара дистрибьютора';
  ...
  DimensionOLAPField := TDimensionOLAPField.Create;
  DimensionOLAPField.Caption := 'Канал сбыта дистрибьютора';
  ...
  DimensionOLAPField := TDimensionOLAPField.Create;
  DimensionOLAPField.Caption := 'Тип товара производителя';
  ...
  DimensionOLAPField := TDimensionOLAPField.Create;
  DimensionOLAPField.Caption := 'ТМЦ';
  ...
  DimensionOLAPField := TDimensionOLAPField.Create;
  DimensionOLAPField.Caption := 'Тип цен';
  ...
  DimensionOLAPField := TDimensionOLAPField.Create;
  DimensionOLAPField.Caption := 'Контракт';
  ...
  DimensionOLAPField := TDimensionOLAPField.Create;
  DimensionOLAPField.Caption := 'Подразделение';
  ...
  DimensionOLAPField := TDimensionOLAPField.Create;
  DimensionOLAPField.Caption := 'Должность ТА';
  ...
  DimensionOLAPField := TDimensionOLAPField.Create;
  DimensionOLAPField.Caption := 'ФИО ТА';
  ...
  DimensionOLAPField := TDimensionOLAPField.Create;
  DimensionOLAPField.Caption := 'РТТ';
  ...
  DimensionOLAPField := TDimensionOLAPField.Create;
  DimensionOLAPField.Caption := 'Время доставки';
 ...
 // DimensionOLAPField.FieldType := ftDateTime;
  ...
  DimensionOLAPField := TDimensionOLAPField.Create;
  DimensionOLAPField.Caption := 'Реальное время доставки';
  ...
  DimensionOLAPField := TDimensionOLAPField.Create;
  DimensionOLAPField.Caption := 'Автомобиль';
  ...
  DimensionOLAPField := TDimensionOLAPField.Create;
  DimensionOLAPField.Caption := 'СПД';
  ...
  DimensionOLAPField := TDimensionOLAPField.Create;
  DimensionOLAPField.Caption := 'ТЭГ документа';
