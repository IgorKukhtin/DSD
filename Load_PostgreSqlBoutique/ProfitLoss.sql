...
union select '60103', 'Расходы с прибыли', 'Финансовая деятельность', 'Курсовая разница'
union select '60201', 'Расходы с прибыли', 'Списание дебиторской задолженности', 'Списание дебиторской задолженности'
union select '60301', 'Расходы с прибыли', 'Прочие', 'Прочее'
