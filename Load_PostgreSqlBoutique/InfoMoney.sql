...
union select '20401', 'Общефирменные', 'Командировочные', '***Командировочные'
union select '20501', 'Общефирменные', 'услуги полученные', '***Комп. и оргтехника'
union select '20502', 'Общефирменные', 'услуги полученные', '***Строительные'
union select '20503', 'Общефирменные', 'услуги полученные', '***Услуги связи'
union select '20504', 'Общефирменные', 'услуги полученные', 'Услуги банка'
union select '20505', 'Общефирменные', 'услуги полученные', '***Аренда помещений'
union select '20506', 'Общефирменные', 'услуги полученные', 'Юридические, нотариальные'
union select '20507', 'Общефирменные', 'услуги полученные', '***Прочие услуги, работы'
union select '20508', 'Общефирменные', 'услуги полученные', '***Реклама'
union select '20509', 'Общефирменные', 'услуги полученные', 'Услуги гос.служб'
union select '20601', 'Общефирменные', 'Коммунальные услуги', 'Электроэнергия'
union select '20602', 'Общефирменные', 'Коммунальные услуги', 'Вода'
union select '20603', 'Общефирменные', 'Коммунальные услуги', 'Газ'
union select '20604', 'Общефирменные', 'Коммунальные услуги', 'вывоз ТБО'
...
union select '70101', 'Собственный капитал', 'Первоначальный капитал', 'Первоначальный капитал'
union select '70201', 'Собственный капитал', 'Дополнительный капитал', 'Дополнительный капитал'
union select '70301', 'Собственный капитал', 'Расчеты с участниками', '*1'
union select '70302', 'Собственный капитал', 'Расчеты с участниками', '*2'
union select '70303', 'Собственный капитал', 'Расчеты с участниками', '*3'
union select '70304', 'Собственный капитал', 'Расчеты с участниками', '*4'
union select '70401', 'Собственный капитал', 'прибыль текущего периода', 'прибыль текущего периода'
union select '70501', 'Собственный капитал', 'Прочие', 'Расходы с прибыли'
union select '70502', 'Собственный капитал', 'Прочие', 'Расходы учредителей'
) as tmp
)
