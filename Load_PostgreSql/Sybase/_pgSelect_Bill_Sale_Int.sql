   ...
   then
     ...
     insert into dba._pgBillLoad_union (BillId, BillId_union)
      ...
      from dba.Bill
           ...
           left join dba.BillItems on BillItems.BillId = Bill.Id and BillItems.GoodsPropertyId = 5510 -- BillItems.OperCount<>0 and BillItems.GoodsPropertyId <> 5510 -- –”À‹ ¿ ¬¿–≈Õ¿ﬂ ‚ Ô‡ÍÂÚÂ ‰Îˇ Á‡ÔÂÍ‡ÌËˇ
...
from (select Bill.Id, 0 as Id_Postgres, 30201 as CodeIM -- ÃˇÒÌÓÂ Ò˚¸Â
