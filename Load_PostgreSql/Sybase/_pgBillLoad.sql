...
select '179559' as InvNumber, zc_UnitId_StoreSale()        as FromId, 0 as ToId -- Склад реализации
union select '183998' as InvNumber, zc_UnitId_StoreSale()        as FromId, 0 as ToId -- Склад реализации
