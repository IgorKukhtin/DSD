...
select '177777' as InvNumber, zc_UnitId_StoreSale()        as FromId, 0 as ToId -- Склад реализации
union select '174360' as InvNumber, zc_UnitId_StoreSale()        as FromId, 0 as ToId -- Склад реализации
