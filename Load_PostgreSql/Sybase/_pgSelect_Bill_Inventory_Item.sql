...
/*  insert into _tmpList_Unit (BillId, UnitId, isPartionDate)
  ...
  then
   ...
   then 
    ...
    -- my delete - 1
    delete from _tmpList_Remains_byPartionStr where PartionStr_MB = '' or fCheckUnitClientParentID (4178, UnitID) = zc_rvNo(); -- ÑÊËÀÄ ÌßÑÍÎÃÎ ÑÛÐÜß
...
/*    delete from _tmpList_Remains_byPartionStr where GoodsPropertyId in (select GoodsPropertyId
    ...
    -- my delete - 3
    delete from _tmpList_Remains_byKindPackage where GoodsPropertyId = 4165 and UnitId = 1325 ; -- Ñâèíèíà í/ê (òðàíçèòíàÿ) + Öåõ Óïàêîâêè
