...
begin
     ...
     with fromFlQuery,Sql do begin
        ...
        Add('     , case when 1=0 and Bill.FromId in (2535,2842) then '+zc_Enum_DocumentTaxKind_CorrectiveSummaryPartnerR // ФУДМАРКЕТ ВМ № 05,Вел.Киш.,Дн-вск,Зоряний,1-а + ФУДМАРКЕТ ВК № 51,Жовт.Води Вел. киш
...
// +'  and MovementId_Postgres = 10154'
        ...
        cbTaxCorrective.Caption:='8.2.('+IntToStr(SaveCount)+')('+IntToStr(RecordCount)+')Корректировки';
        //
        fStop:=cbOnlyOpen.Checked;
        if cbOnlyOpen.Checked then exit;
        //
