object CashJournalForm: TCashJournalForm
  ...
  object cxGrid: TcxGrid
    ...
    object cxGridDBTableView: TcxGridDBTableView
      ...
      object UnitNameFull: TcxGridDBColumn
        ...
        HeaderAlignmentHorz = taCenter
        HeaderAlignmentVert = vaCenter
        HeaderHint = #1055#1086#1083#1085#1086#1077' '#1085#1072#1079#1074#1072#1085#1080#1077' '#1086#1090#1076#1077#1083#1072
        Options.Editing = False
        Width = 300
      end
      object UnitGroupNameFull: TcxGridDBColumn
        ...
        HeaderAlignmentHorz = taCenter
        HeaderAlignmentVert = vaCenter
        HeaderHint = #1043#1088#1091#1087#1087#1072' '#1086#1090#1076#1077#1083
        Options.Editing = False
        Width = 100
      end
      object UnitCode: TcxGridDBColumn
        ...
        HeaderAlignmentHorz = taCenter
        HeaderAlignmentVert = vaCenter
        HeaderHint = #1050#1086#1076' '#1086#1090#1076#1077#1083
        Options.Editing = False
        Width = 55
      end
      ...
      object UpdateName_mi: TcxGridDBColumn
        ...
        HeaderAlignmentHorz = taCenter
        HeaderAlignmentVert = vaCenter
        HeaderHint = #1055#1086#1083#1100#1079#1086#1074#1072#1090#1077#1083#1100' ('#1082#1086#1088#1088#1077#1082#1090#1080#1088#1086#1074#1082#1072', '#1101#1083#1077#1084#1077#1085#1090')'
        Options.Editing = False
        Width = 101
      end
      object UpdateDate_mi: TcxGridDBColumn
        ...
        HeaderAlignmentHorz = taCenter
        HeaderAlignmentVert = vaCenter
        HeaderHint = #1044#1072#1090#1072'/'#1042#1088#1077#1084#1103' ('#1082#1086#1088#1088#1077#1082#1090#1080#1088#1086#1074#1082#1072', '#1101#1083#1077#1084#1077#1085#1090')'
        Options.Editing = False
        Width = 78
      end
    end
  ...
  object ActionList: TActionList
    ...
    object ExecuteDialog: TExecuteDialog
      ...
      ImageIndex = 35
      FormName = 'TMovement_PeriodDialogCashForm'
      FormNameParam.Value = 'TMovement_PeriodDialogCashForm'
      FormNameParam.DataType = ftString
      FormNameParam.MultiSelectSeparator = ','
      GuiParams = <
        item
  ...
  object spGetImportSettingId: TdsdStoredProc
    ...
    Params = <
      item
        Name = 'inDefaultKey'
        Value = 'TCashJournalForm;zc_Object_ImportSetting_CashJournal'
        DataType = ftString
        ParamType = ptInput
        MultiSelectSeparator = ','
      end
