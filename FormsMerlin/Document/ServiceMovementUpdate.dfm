object ServiceMovementUpdateForm: TServiceMovementUpdateForm
  Left = 0
  Top = 0
  Caption = #1044#1086#1082#1091#1084#1077#1085#1090' <'#1059#1089#1083#1086#1074#1080#1103' '#1072#1088#1077#1085#1076#1099' ('#1085#1072' '#1076#1072#1090#1091')>'
  ClientHeight = 466
  ClientWidth = 759
  Color = clBtnFace
