inherited CashChildMovementForm: TCashChildMovementForm
  ...
  Caption = #1044#1086#1082#1091#1084#1077#1085#1090' <'#1050#1086#1088#1088#1077#1082#1090#1080#1088#1086#1074#1082#1072' '#1050#1072#1089#1089#1072'>'
  ClientHeight = 427
  ClientWidth = 341
  ExplicitWidth = 357
  ExplicitHeight = 466
  ...
  inherited spGet: TdsdStoredProc
    StoredProcName = 'gpGet_Movement_Cash_Child'
    Params = <
      item
        Name = 'inMovementId'
        Value = '0'
