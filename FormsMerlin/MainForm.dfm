inherited MainForm: TMainForm
  ...
  inherited ActionList: TActionList
    Left = 336
    Top = 8
    object actCashJournal_out: TdsdOpenForm [0]
    ...
    object actReport_UnitBalance: TdsdOpenForm [1]
    ...
    object actCashChildJournal_out: TdsdOpenForm [2]
      Category = #1044#1086#1082#1091#1084#1077#1085#1090#1099
      MoveParams = <>
    ...
    object actCashChildJournal_in: TdsdOpenForm [3]
      Category = #1044#1086#1082#1091#1084#1077#1085#1090#1099
      MoveParams = <>
    ...
    object actCashJournal_in: TdsdOpenForm [4]
      Category = #1044#1086#1082#1091#1084#1077#1085#1090#1099
      MoveParams = <>
    ...
    object actCashSendJournal: TdsdOpenForm [5]
      Category = #1044#1086#1082#1091#1084#1077#1085#1090#1099
      MoveParams = <>
    ...
    object actServiceJournal: TdsdOpenForm [7]
      Category = #1044#1086#1082#1091#1084#1077#1085#1090#1099
      MoveParams = <>
    ...
    inherited actInfoMoney: TdsdOpenForm [8]
    ...
    object actUnitTree: TdsdOpenForm [9]
    ...
    object actInfoMoneyTree: TdsdOpenForm [10]
    ...
    object actUnit: TdsdOpenForm [12]
      Category = #1057#1087#1088#1072#1074#1086#1095#1085#1080#1082#1080
      MoveParams = <>
    ...
    object actInfoMoneyDetail: TdsdOpenForm [13]
      Category = #1057#1087#1088#1072#1074#1086#1095#1085#1080#1082#1080
      MoveParams = <>
    ...
    object actCashTree: TdsdOpenForm [14]
      Category = #1057#1087#1088#1072#1074#1086#1095#1085#1080#1082#1080
      MoveParams = <>
    ...
    object actCommentMoveMoney: TdsdOpenForm [15]
      Category = #1057#1087#1088#1072#1074#1086#1095#1085#1080#1082#1080
      MoveParams = <>
    ...
    object actCommentInfoMoney: TdsdOpenForm [16]
      Category = #1057#1087#1088#1072#1074#1086#1095#1085#1080#1082#1080
      MoveParams = <>
    ...
    object actServiceItem: TdsdOpenForm [17]
    ...
    inherited actExit: TFileExit [21]
      Category = #1057#1083#1091#1078#1077#1073#1085#1099#1077
    end
    inherited actAbout: TAction [22]
    end
    inherited actUpdateProgram: TAction [23]
    end
    inherited actLookAndFeel: TAction [24]
    end
    ...
    inherited actImportSettings: TdsdOpenForm [26]
    end
    inherited actImportGroup: TdsdOpenForm [27]
    end
    inherited actImportType: TdsdOpenForm [28]
    end
    ...
    object actRole: TdsdOpenForm [30]
      Category = #1057#1083#1091#1078#1077#1073#1085#1099#1077
      MoveParams = <>
    ...
    inherited actImportExportLink: TdsdOpenForm [31]
      Enabled = False
    end
    inherited actProtocolUser: TdsdOpenForm [32]
    end
    inherited actProtocolMovement: TdsdOpenForm [33]
    end
    inherited actProtocol: TdsdOpenForm [34]
    end
    inherited actInfoMoneyGroup: TdsdOpenForm [35]
    end
    inherited actInfoMoneyDestination: TdsdOpenForm [36]
    end
