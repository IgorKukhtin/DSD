object CommentInfoMoneyForm: TCommentInfoMoneyForm
  Left = 0
  Top = 0
  Caption = #1057#1087#1088#1072#1074#1086#1095#1085#1080#1082' <'#1055#1088#1080#1084#1077#1095#1072#1085#1080#1077' '#1055#1088#1080#1093#1086#1076'/'#1088#1072#1089#1093#1086#1076'>'
  ClientHeight = 375
  ClientWidth = 708
  Color = clBtnFace
  ...
  object ActionList: TActionList
    ...
    object actInsert: TdsdInsertUpdateAction
      ...
      ShortCut = 45
      ImageIndex = 0
      FormName = 'TCommentInfoMoneyEditForm'
      FormNameParam.Value = 'TCommentInfoMoneyEditForm'
    ...
    object actGetImportSetting: TdsdExecStoredProc
      ...
      Hint = #1047#1072#1075#1088#1091#1079#1080#1090#1100' <'#1055#1088#1080#1084#1077#1095#1072#1085#1080#1077' '#1055#1088#1080#1093#1086#1076'/'#1088#1072#1089#1093#1086#1076'> '#1080#1079' '#1092#1072#1081#1083#1072
    end
    object macStartLoad: TMultiAction
      ...
      QuestionBeforeExecute = #1047#1072#1075#1088#1091#1079#1080#1090#1100' '#1076#1072#1085#1085#1099#1077' <'#1055#1088#1080#1084#1077#1095#1072#1085#1080#1077' '#1055#1088#1080#1093#1086#1076'/'#1088#1072#1089#1093#1086#1076'> '#1080#1079' '#1092#1072#1081#1083#1072'?'
      InfoAfterExecute = #1047#1072#1075#1088#1091#1079#1082#1072' '#1079#1072#1074#1077#1088#1096#1077#1085#1072
      Caption = #1047#1072#1075#1088#1091#1079#1080#1090#1100' <'#1055#1088#1080#1084#1077#1095#1072#1085#1080#1077' '#1055#1088#1080#1093#1086#1076'/'#1088#1072#1089#1093#1086#1076'> '#1080#1079' '#1092#1072#1081#1083#1072
      Hint = #1047#1072#1075#1088#1091#1079#1080#1090#1100' <'#1055#1088#1080#1084#1077#1095#1072#1085#1080#1077' '#1055#1088#1080#1093#1086#1076'/'#1088#1072#1089#1093#1086#1076'> '#1080#1079' '#1092#1072#1081#1083#1072
      ImageIndex = 41
      WithoutNext = True
    end
  ...
  object spUpdate_IsUserAll_Yes: TdsdStoredProc
    StoredProcName = 'gpUpdate_Object_CommentInfoMoney_UserAll'
    DataSets = <>
    OutputType = otResult
    Params = <
      item
  ...
  object spGetImportSettingId: TdsdStoredProc
    ...
    Params = <
      item
        Name = 'inDefaultKey'
        Value = 'TCommentInfoMoneyForm;zc_Object_ImportSetting_CommentInfoMoney'
        DataType = ftString
        ParamType = ptInput
        MultiSelectSeparator = ','
      end
